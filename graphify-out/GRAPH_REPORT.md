...
## Corpus Check
- 4465 files · ~6,356,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22091 nodes · 85498 edges · 1090 communities (938 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13795 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0440586d`
...
- `initialState()` --calls--> `mountTetraUI`  [EXTRACTED]
  compiler/internal/backend/native_shell/codegen.go → reports/plan250/waveJ-reviewer-v0_3_gate/artifacts/test-all/web-ui-smoke.dom.html
- `bindingValue()` --calls--> `mountTetraUI`  [EXTRACTED]
  compiler/internal/backend/native_shell/codegen.go → reports/plan250/waveJ-reviewer-v0_3_gate/artifacts/test-all/web-ui-smoke.dom.html
- `TestRunRejectsSkipDBReportWithoutAllowance()` --calls--> `contains()`  [INFERRED]
  tools/cmd/validate-techempower-report/main_test.go → compiler/internal/semantics/generics.go
- `TestRunRequiresReportPath()` --calls--> `contains()`  [INFERRED]
  tools/cmd/validate-techempower-report/main_test.go → compiler/internal/semantics/generics.go

## Communities (1090 total, 152 thin omitted)
...
Cohesion: 0.01
Nodes (399): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+391 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (427): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode() (+419 more)
...
Cohesion: 0.02
Nodes (249): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+241 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (231): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary(), bindFreshResourceTree() (+223 more)
...
Cohesion: 0.03
Nodes (148): branchScopeInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases() (+140 more)
...
Cohesion: 0.03
Nodes (164): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+156 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (171): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEpic04ExpressionTypingDisplayTextAndBoundary(), TestEpic04ExpressionTypingNegativeDiagnostic(), TestEpic04ExpressionTypingPositiveAndInferenceCrossModule(), TestEpic04LocalInferenceNegativeAndDisplayText(), TestEpic04SemanticCheckerCoreCrossModuleParity(), TestEpic04SemanticCheckerCoreDisplayTextStability() (+163 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (156): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+148 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (154): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+146 more)
...
Cohesion: 0.05
Nodes (60): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+52 more)
...
Cohesion: 0.03
Nodes (129): requireCheckFileErrorContains(), requireCheckFileOK(), TestTaskGroupCancelAllowsTypedErrorResult(), TestTaskSpawnAllowsImmutableGlobalTarget(), TestOwnershipGenericFunctionTypedGlobalPreservesConsumeMarker(), TestOwnershipLoopBreakExitReportsMaybeConsumedWithBreakLabel(), TestOwnershipLoopBreakMakesFollowingBodyStatementsUnreachable(), TestOwnershipLoopContinueExitReportsMaybeConsumedWithContinueLabel() (+121 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (100): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+92 more)
...
Cohesion: 0.05
Nodes (97): TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipOptionalPayloadConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumCopyAfterConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructCopyAfterConsumeCode() (+89 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (106): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+98 more)
...
Cohesion: 0.05
Nodes (108): capsuleArtifact, capsuleDependency, capsuleManifest, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString() (+100 more)
...
Cohesion: 0.06
Nodes (95): resolveFieldChainLower(), assignTargetInfo, cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), resolveCallSigForInference(), firstCapture() (+87 more)
...
Cohesion: 0.05
Nodes (93): TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses() (+85 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+77 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (98): TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+90 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (77): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+69 more)
...
Cohesion: 0.1
Nodes (90): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs(), functionAssignmentValueTouchesMutableGlobals() (+82 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (68): countCallsNamed(), hasCall(), lowerProgramForCatchTest(), programFuncNames(), programHasFunc(), requireIRFunc(), TestLowerCatchHandlerCollectsStagedTypedTaskWrapper(), TestLowerMatchExprCollectsStagedTypedTaskWrapper() (+60 more)
...
Cohesion: 0.14
Nodes (6): ParseFile(), diagnosticErrorf(), parser, buildFieldAccess(), ParseFile(), plannedFeatureError()

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (40): AssignStmt, itoa(), BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+32 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (74): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+66 more)
...
Cohesion: 0.07
Nodes (61): ActorStateField, TestEnsureTypeInfoArrayRejectsUnsupportedSubset(), TestEnsureTypeInfoArraySupportedSubset(), TestEnsureTypeInfoRejectsTargetLayoutOnlyNativeIntegers(), classifyCallableEscape(), TestClassifyCallableEscapeRejectsMutableCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeRejectsMutableEscapingCapture(), TestClassifyCallableEscapeRejectsResourceCaptureAcrossThreadBoundary() (+53 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (64): requireCheckOK(), requireFileSemanticErrorContains(), TestBudgetPrivacyEffectsAndPolicyGroup(), TestCallbackWrapperDeclaredEffectsCannotBypassSemanticClauses(), TestCallbackWrapperRequiresImportedTargetEffects(), TestCallbackWrapperRequiresLocalSymbolBackedTargetEffects(), TestCallbackWrapperRequiresTargetEffects(), TestDirectClosureLiteralCallbackArgumentDiagnosticUsesClosureLiteralName() (+56 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (20): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, FieldAccessExpr (+12 more)
...
Cohesion: 0.06
Nodes (56): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+48 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (56): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+48 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (57): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, abiObjectHasSymbol(), abiObjectHasSymbolSignature(), compareAggregateLayout(), containsMovEaxImm32(), elapsedMillis() (+49 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (6): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.12
Nodes (55): runInterface(), writeDiagnostic(), writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember() (+47 more)
...
Cohesion: 0.09
Nodes (52): irVerifierError(), irVerifierErrorAt(), lowerDiagnostic(), runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt(), matchesBudgetGuardBefore() (+44 more)
...
Cohesion: 0.11
Nodes (28): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16() (+20 more)
...
Cohesion: 0.11
Nodes (37): Column, Conn, Frame, payloadReader, Result, Row, StartupConfig, AppendBind() (+29 more)
...
Cohesion: 0.13
Nodes (43): applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript(), initialState(), itoa() (+35 more)
...
Cohesion: 0.11
Nodes (41): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, appendDataRow(), authSASLContinuePayload() (+33 more)
...
Cohesion: 0.1
Nodes (42): errForPlan250RuntimeDiagnostic, findPlan250IRFunc(), firstPlan250InstrKind(), hasPlan250BudgetGuardBefore(), hasPlan250InstrKind(), matchesPlan250BudgetGuardAt(), requireCheckFileErrorContainsAll(), TestPlan250LinkObjectRejectsWrongCompilerVersionMetadata() (+34 more)
...
Cohesion: 0.15
Nodes (42): buildCapsuleArtifacts(), capsuleSectionHeader(), writeEcoLock(), validateCapsuleGraph(), parseCapsuleGraphArgs(), runEcoVerify(), validateCapsuleGraph(), writeEcoLock() (+34 more)

### Community 110 - "Community 110"
Cohesion: 0.13
Nodes (38): validateWorkspaceReportFormat(), TestValidateWorkspaceExecAcceptsBuildPassReport(), TestValidateWorkspaceExecAcceptsTestFailureAndSkipReport(), TestValidateWorkspaceExecRejectsCountMismatch(), TestValidateWorkspaceExecRejectsDuplicateMember(), TestValidateWorkspaceExecRejectsInvalidCommand(), TestValidateWorkspaceExecRejectsInvalidMemberPaths(), TestValidateWorkspaceExecRejectsMissingRequiredReportFields() (+30 more)
...
Cohesion: 0.06
Nodes (44): API Diff Docs Snapshot (hash 0966...ca390), api diff no-change step, API Docs Snapshot (hash 623d...53917), API Docs Snapshot (hash 09e8...50e66), API Hash sha256:0966... (81 modules, 226 entries), API Hash sha256:09e8... (83 modules, 228 entries), API Hash sha256:623d... (49 modules, 97 entries), Release Artifact tetra.release.v0_2_0.test-all-summary.v1 (+36 more)

### Community 115 - "Community 115"
Cohesion: 0.1
Nodes (39): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+31 more)
...
Cohesion: 0.06
Nodes (42): API Snapshot sha256:0966ebbb..., API Snapshot sha256:09e83e7a..., Docs Manifest Freshness Check, Short Fuzz Nightly Mode, v0.3.0 Release Gate, tetra.api.v1alpha1 API Documentation, tetra.ui.v1 Shell Preview, Unstable Seed Tracking Policy (+34 more)

### Community 124 - "Community 124"
Cohesion: 0.15
Nodes (27): isUpdateQuery(), newFakeWorldDB(), parseWorldUpdate(), pgAppendCString(), pgAppendInt16(), pgAppendInt32(), pgBackendKeyPayload(), pgCStringPayload() (+19 more)
...
Cohesion: 0.12
Nodes (29): createImports(), instantiateTetra(), memoryView(), readUTF8(), runTetra(), createImports(), instantiateTetra(), memoryView() (+21 more)
...
Cohesion: 0.11
Nodes (33): InterfaceFingerprintFromT4I(), ValidateInterfaceAgainstSource(), TestGeneratedInterfaceFunctionTypeRefsCheckAndLowerAcrossModules(), TestGeneratedInterfaceGenericStructTypeArgsCheckAndLowerAcrossModules(), TestGenerateInterfaceFromSourceEmitsProtocolImplDeclarationsBeforeFunctions(), TestGenerateInterfaceFromSourceEmitsTypecheckableExtensionDeclarations(), TestGenerateInterfaceFromSourceFiltersPrivateSurfaceAndHashesPublicAPI(), TestGenerateInterfaceFromSourceKeepsImportsRequiredByFunctionTypeRefs() (+25 more)

### Community 137 - "Community 137"
Cohesion: 0.17
Nodes (32): DataReloc, alignUp(), patchRipDisp32From64(), validDisp32PatchOffset(), WriteMachO64MacOSX64(), writeMachOName(), writeMachOU32(), writeMachOU64() (+24 more)

### Community 138 - "Community 138"
Cohesion: 0.06
Nodes (28): TestActorSpawnRejectsMutableGlobalTarget(), TestActorSpawnRejectsThrowingTarget(), TestAsyncRejectAwaitOutsideAsync(), TestAsyncRejectBareAsyncCall(), TestAsyncSmokeExampleBuildAndRun(), TestAsyncTypedErrorBoundaryRejectsAwaitTryForm(), TestTaskJoinTypedErrorRequiresTry(), TestTaskSmokeExampleBuildAndRun() (+20 more)
...
Cohesion: 0.12
Nodes (28): LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects() (+20 more)
...
Cohesion: 0.15
Nodes (30): defaultCapsulePath(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+22 more)
...
Cohesion: 0.16
Nodes (31): addVaultRecord(), readVaultIndex(), runEcoTrust(), runEcoTrustSnapshot(), runEcoVault(), runEcoVaultAdd(), runEcoVaultList(), runEcoVaultVerify() (+23 more)
...
Cohesion: 0.14
Nodes (24): effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), normalizeEffects(), sortedEffectSet() (+16 more)

### Community 156 - "Community 156"
Cohesion: 0.11
Nodes (24): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+16 more)

### Community 157 - "Community 157"
Cohesion: 0.13
Nodes (24): emitX64ReturnSlotPushes(), TestX64ABICallsZeroThroughTenArgs(), TestX64ABIReturnSlotsThreeAndFourRegisterMapping(), TestX64BuildOnlySmokeAcrossNativeTargets(), x64ReturnSlotName(), argCountName(), containsMovEaxImm32(), emitReturnSlotPushes() (+16 more)
...
Cohesion: 0.22
Nodes (29): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+21 more)
...
Cohesion: 0.2
Nodes (27): FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver() (+19 more)

### Community 162 - "Community 162"
Cohesion: 0.12
Nodes (29): TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionDuplicateRecursiveWorkMonomorphizesOnce(), TestGenericFunctionInfersOptionalParameterElement(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionMultiTypeParametersMonomorphized(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses() (+21 more)
...
Cohesion: 0.15
Nodes (22): TestRunBenchmarkFailsWhenThresholdIsMissed(), TestRunBenchmarkRecordsLatencyPercentilesAndIntegrityMetadata(), TestPprofHandlerExposesIndex(), NewServer(), dialServer(), readUntil(), startBenchmarkServer(), startPlaintextServer() (+14 more)

### Community 166 - "Community 166"
Cohesion: 0.13
Nodes (23): importPatch, CodegenObjectMacOSX64(), CodegenObjectMacOSX64WithOptions(), CodegenObjectMacOSX64WithOptionsAndDataPrefix(), BuildObject(), BuildObjectWithDataPrefix(), TestObjectBuildCollectsRelocsAndSymbols(), TestObjectBuildEmitsFunctionAddressRelocDistinctFromCall() (+15 more)
...
Cohesion: 0.1
Nodes (25): checkFileProgram(), TestCapsuleAndPropertyAcceptedTogether(), TestCapsuleMetadataPositiveNoRuntimeImpact(), TestCapsuleMetadataSemanticDiagnostics(), requireFileCheckOK(), TestCapabilityAttenuationPermissionIntegrationEdges(), TestCapabilityAttenuationRequiresCapsulePermission(), TestCapsulePermissionVocabularyDoesNotAliasCoreEffects() (+17 more)
...
Cohesion: 0.16
Nodes (21): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+13 more)
...
Cohesion: 0.13
Nodes (22): classifyOwnershipAuditResult(), isOwnershipAuditSeparatorRow(), main(), normalizeOwnershipAuditStatus(), ownershipAuditSection(), parseOwnershipAuditRows(), parseOwnershipAuditStatus(), splitOwnershipAuditTableRow() (+14 more)
...
Cohesion: 0.07
Nodes (18): TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke(), TestBuildGlobalVarPtrZeroInitializerSmoke(), TestBuildGlobalVarStringFieldAccessAfterAssignmentSmoke(), TestBuildGlobalVarStringLiteralInitializerSmoke() (+10 more)
...
Cohesion: 0.18
Nodes (22): releaseV030FakeRepo(), runReleaseV030Gate(), finalReleaseStateRefreshFollowsSummary(), TestReleaseV030GateHashesEntireReportDirectory(), TestReleaseV030GateRefreshesReleaseStateAfterFinalSummaryWrite(), TestReleaseV030GateRequireCleanRejectsDirtyWorktree(), TestReleaseV030GateValidatesFuzzArtifactsAfterShortFuzz(), TestReleaseV030GateValidatesGateSummaryArtifacts() (+14 more)
...
Cohesion: 0.16
Nodes (22): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), TestNewTechEmpowerServerAppliesConfigAndRoutes(), TestRegisterTechEmpowerRoutesMountsAllEndpoints(), TestRegisterTechEmpowerRoutesRequiresPool(), TestNormalizeQueryCount(), dbErrorResponse() (+14 more)

### Community 206 - "Community 206"
Cohesion: 0.19
Nodes (23): containsString(), decodeStrictJSON(), hasDOMAttribute(), main(), requireRegularFile(), resolveUIBundleSchemaArtifactPath(), validateDOMSnapshotArtifact(), validateRuntimeTrace() (+15 more)
...
Cohesion: 0.15
Nodes (24): requireFileCheckErrorContains(), TestSemanticClauseFunctionTypedGlobalCallbackArgumentDiagnosticUsesArgumentName(), TestSemanticClauseFunctionTypedGlobalDirectCallDiagnosticUsesGlobalName(), TestOwnershipRejectsBorrowedFixedArrayGlobalAssignment(), TestOwnershipRejectsBorrowedFixedArrayOptionalGlobalAssignment(), TestOwnershipRejectsBorrowedPtrAggregateOptionalGlobalAssignment(), TestOwnershipRejectsBorrowedPtrAggregateParamGlobalAssignment(), TestOwnershipRejectsBorrowedPtrAggregateParamGlobalFieldAssignment() (+16 more)
...
Cohesion: 0.15
Nodes (11): emitIndexLoad(), emitIndexStore(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite(), emitRawStore() (+3 more)

### Community 213 - "Community 213"
Cohesion: 0.14
Nodes (7): emitAllocBytes(), emitExit(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), emitWrite(), patchExitBranch()
...
Cohesion: 0.17
Nodes (18): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+10 more)

### Community 223 - "Community 223"
Cohesion: 0.17
Nodes (14): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths(), ModuleRelPath() (+6 more)
...
Cohesion: 0.21
Nodes (14): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+6 more)
...
Cohesion: 0.18
Nodes (12): countingRWC, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections(), TestPoolStatsTrackOpenIdleInUseAndClosedState(), fakeFortuneDB (+4 more)
...
Cohesion: 0.11
Nodes (20): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+12 more)

### Community 250 - "Community 250"
Cohesion: 0.33
Nodes (17): ClosureCapture, captureMode, addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures(), collectDeferCaptures() (+9 more)
...
Cohesion: 0.18
Nodes (12): FuzzLexer(), FuzzParser(), hexValue(), isDigit(), isHexDigit(), isIdentPart(), isIdentStart(), newLexer() (+4 more)
...
Cohesion: 0.23
Nodes (12): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), replaceOwnershipAuditRowEvidence(), TestValidateOwnershipAuditAcceptsRowEvidenceDetails(), TestValidateOwnershipAuditAcceptsBlockedAudit() (+4 more)
...
Cohesion: 0.14
Nodes (11): TestBuildIslandMakeBoolSliceSmoke(), TestBuildMakeBoolSliceSmoke(), TestSliceBoolSemanticsAcceptance(), TestSliceBoolWasmBuildOnlyIslandMakeBoolSmoke(), TestSliceBoolWasmBuildOnlyMakeBoolSmoke(), TestSliceWasmBuildOnlyIslandMakeU8I32Smoke(), TestBuildIslandMakeU16SliceSmoke(), TestBuildMakeU16SliceSmoke() (+3 more)
...
Cohesion: 0.17
Nodes (8): emitEntryStubSysVUnixX64(), emitEntryStubWin64X64(), emitEntryStubSysVLinuxX86(), linkLinuxSysV(), LinkLinuxX32(), LinkLinuxX64(), LinkLinuxX86(), LinkMacOSX64()

### Community 314 - "Community 314"
Cohesion: 0.18
Nodes (13): containsMovEaxImm32LinkerTest(), emitEntryStubForTestX86(), TestLinkLinuxRejectsNonLinuxTargetObject(), TestLinkLinuxX32DataRelocsUseELF32X32Layout(), TestLinkLinuxX32RejectsNonX32TargetObject(), TestLinkLinuxX32UsesX32ExitSyscall(), TestLinkLinuxX64RejectsAbsoluteDataRelocs(), TestLinkLinuxX64RejectsAbsoluteFunctionAddressRelocs() (+5 more)
...
Cohesion: 0.28
Nodes (13): decodeStrictNativeUIJSON(), main(), validateNativeUISmoke(), validateNativeUIView(), nativeUIBindingTrace, nativeUIEventTrace, nativeUIOperationTrace, nativeUIPropertyTrace (+5 more)
...
Cohesion: 0.27
Nodes (12): stringSliceContains(), TestCIWorkflowArtifactNamesAreReleaseAware(), TestCIWorkflowHasLeastPrivilegeConcurrencyAndTimeouts(), TestCIWorkflowIncludesCanonicalV030ReleaseGateJob(), TestCIWorkflowIncludesCurrentV040ReleaseReadinessJob(), TestCIWorkflowIncludesMinimalActionAndShellLinting(), TestCIWorkflowIncludesStabilizationAndRobustnessJobs(), TestCIWorkflowIncludesSupplyChainVulnerabilityScan() (+4 more)
...
Cohesion: 0.33
Nodes (11): buildNeedMap(), collectTransitiveNeeds(), runEcoNeedMap(), runEcoTrust(), runEcoTrustSnapshot(), scoreCapsuleTrust(), ecoNeedMap, ecoNeedMapEdge (+3 more)
...
Cohesion: 0.28
Nodes (11): containsMovEaxImm32(), emitObjectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryLinuxX32BuildsI64AndWeakAtomicObject(), TestEmitLibraryLinuxX32WritesRealX32TOBJ(), TestEmitLibraryLinuxX86StillRejectsMissingObjectBackend(), TestEmitLibraryLinuxX86WritesRealI386TOBJ() (+3 more)
...
Cohesion: 0.41
Nodes (10): cliModuleRelPathMatches(), defaultInputPath(), isCLIManagedSourceFile(), modulePathFromSource(), moduleRelPath(), moduleRelPathWithExtension(), moduleRootFromEntry(), rewriteModuleDecl() (+2 more)
...
Cohesion: 0.44
Nodes (9): hashedArtifact, hashManifest, decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main(), validateHashManifest() (+1 more)

### Community 378 - "Community 378"
Cohesion: 0.36
Nodes (9): featuresReport, formatsReport, atomicPointerWidthBits(), buildTargetReportEntries(), describeTargetForText(), runFeatures(), runTargets(), targetReportEntry (+1 more)
...
Cohesion: 0.42
Nodes (7): buildHashManifest(), TestArtifactHashManifestRejectsInvalidHashFormat(), TestArtifactHashManifestRejectsModifiedArtifact(), TestArtifactHashManifestRejectsTrailingJSONDocument(), TestArtifactHashManifestRejectsUnlistedArtifact(), TestArtifactHashManifestRejectsUnsortedPaths(), TestArtifactHashManifestValidatesGeneratedFiles()
...
Cohesion: 0.57
Nodes (6): capsuleNameFromPath(), capsuleSlug(), runNew(), runNewApp(), runNewAppArgs(), newAppOptions
...
Cohesion: 0.6
Nodes (3): TestValidateReportAcceptsExecutableLinuxX64NativeRuntimeEvidence(), TestValidateReportRejectsMissingStateTransition(), TestValidateReportRejectsNativeShellSidecarOnlyEvidence()

### Community 557 - "Community 557"
Cohesion: 0.7
Nodes (3): documentedCLICommands(), TestCLIContractDocumentedCommandsHaveHelpAndInvalidArgBehavior(), TestVersionCommand()
