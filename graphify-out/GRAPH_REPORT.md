...
## Corpus Check
- 4465 files · ~6,362,403 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22105 nodes · 85553 edges · 1070 communities (917 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13809 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c8302bf`
...
## Communities (1070 total, 153 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (523): buildAndRun(), buildAndRunFiles(), TestBuildMultiFileAliasCall(), TestBuildStructCrossModule(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke() (+515 more)
...
Cohesion: 0.01
Nodes (321): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+313 more)
...
Cohesion: 0.03
Nodes (227): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary(), bindPatternSecretTaintLocals() (+219 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (215): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildAndRunFile(), buildOnly() (+207 more)
...
Cohesion: 0.03
Nodes (164): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFileWithOptions(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithImportedSignatureType(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithStructReturnStub(), TestBuildInterfaceOnlyModeAllowsT4IDependencyWithoutOutput() (+156 more)
...
Cohesion: 0.03
Nodes (110): BuildMacOSX64(), assertObjectHasSymbols(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType(), TestActorDeclarationRejectsUnsupportedStateFieldType(), TestActorDeclarationRequiresStateFieldInitializer() (+102 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (71): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+63 more)
...
Cohesion: 0.05
Nodes (95): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+87 more)
...
Cohesion: 0.04
Nodes (98): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+90 more)
...
Cohesion: 0.05
Nodes (72): AuditReport, CaseReport, ContractReport, ProcessReport, Report, decodeStrict(), rejectPaperEvidence(), validateAudit() (+64 more)
...
Cohesion: 0.08
Nodes (79): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+71 more)
...
Cohesion: 0.06
Nodes (72): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+64 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (82): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+74 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (82): hasPrefix(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendUniqueString(), buildEcoLock(), buildNeedMap(), capsuleIDDirectory() (+74 more)
...
Cohesion: 0.09
Nodes (77): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), borrowedPtrOwnerFromExpr(), resourcePathForExpr(), resourceSourceForExpr(), resourceSourceForPath(), actorTaskWorkerBoundaryEffect() (+69 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt (+14 more)
...
Cohesion: 0.1
Nodes (43): resolveFieldChainLower(), assignTargetInfo, bindMatchPatternLocalsForInference(), cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), resolveCallSigForInference() (+35 more)
...
Cohesion: 0.12
Nodes (46): itoa(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript(), initialState() (+38 more)
...
Cohesion: 0.09
Nodes (45): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+37 more)
...
Cohesion: 0.11
Nodes (42): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, authSASLContinuePayload(), authSASLFinalPayload() (+34 more)
...
Cohesion: 0.11
Nodes (46): capsuleArtifact, capsuleDependency, capsuleManifest, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), buildEcoLockWithArtifactHashes() (+38 more)
...
Cohesion: 0.12
Nodes (29): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+21 more)
...
Cohesion: 0.2
Nodes (28): capsuleSectionHeader(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), describeProjectDependency(), discoverProjectDepsContext(), findCapsuleDepsSection(), formatCapsuleDependencyLine() (+20 more)
...
Cohesion: 0.2
Nodes (26): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), describeProjectDependencyCycle() (+18 more)
...
Cohesion: 0.22
Nodes (20): findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget(), TestELFLinuxLayoutStaysInSyncWithWriter() (+12 more)
...
Cohesion: 0.25
Nodes (16): LowerUI(), uiCommandOperations(), uiCompoundStateDeltaOperation(), uiExprSummary(), uiStateAddOperation(), uiStateDeltaOperation(), UILoweredAccessibility, UILoweredBinding (+8 more)
...
Cohesion: 0.42
Nodes (9): newRegionState(), TestCheckNoConsumedDescendantsCanonicalizesAliasPaths(), TestCheckNotConsumedCanonicalizesAliasPaths(), TestCheckNotConsumedCanonicalizesAliasPathsWhenConsumedBeforeAlias(), TestCheckNotConsumedNestedAliasCanonicalizesPath(), TestClearConsumedTreeClearsAliasEquivalentPaths(), TestClearConsumedTreeClearsAliasForConsumedBasePath(), TestMergeFlowWithLabelsIntersectsOwnershipAliases() (+1 more)
