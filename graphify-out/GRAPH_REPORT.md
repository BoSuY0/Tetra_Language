...
## Corpus Check
- 696 files · ~1,421,243 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18777 nodes · 73905 edges · 514 communities (440 shown, 74 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13553 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6fdaa65`
...
## Communities (514 total, 74 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (504): buildAndRun(), buildAndRunFiles(), TestBuildMultiFileCrossModuleCall(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke() (+496 more)
...
Cohesion: 0.02
Nodes (367): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode() (+359 more)
...
Cohesion: 0.02
Nodes (241): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+233 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (241): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata() (+233 more)
...
Cohesion: 0.04
Nodes (128): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+120 more)
...
Cohesion: 0.05
Nodes (110): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+102 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (115): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+107 more)

### Community 43 - "Community 43"
Cohesion: 0.08
Nodes (110): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+102 more)
...
Cohesion: 0.04
Nodes (52): branchScopeInfo, bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), catchExprHasCompleteEnumPatterns(), matchExprHasCompleteEnumPatterns(), matchExprHasCompleteOptionalPatterns() (+44 more)
...
Cohesion: 0.07
Nodes (96): resolveFieldChainLower(), assignTargetInfo, bindBorrowedPtrAliasFromExpr(), borrowedPtrOwnerFromExpr(), resourcePathForExpr(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName() (+88 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (89): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), featuresReport, formatsReport, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason() (+81 more)
...
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke(), TestBuildFunctionTypedEnumPayloadAliasSmoke(), TestBuildFunctionTypedEnumPayloadCallbackArgumentSmoke(), TestBuildFunctionTypedEnumPayloadCapturedClosureFromReturnedEnumSmoke(), TestBuildFunctionTypedEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedEnumPayloadDirectClosureLiteralSmoke(), TestBuildFunctionTypedEnumPayloadFromCrossModuleCapturedReturnedEnumSmoke() (+77 more)
...
Cohesion: 0.06
Nodes (79): assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject(), loadLSPTranscriptFixture() (+71 more)
...
Cohesion: 0.05
Nodes (61): TestBuildRejectsInterfaceImplementationMissingSymbol(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip() (+53 more)
...
Cohesion: 0.11
Nodes (57): writeInterfaceHashOnlySurface(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail() (+49 more)
...
Cohesion: 0.15
Nodes (38): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+30 more)
...
Cohesion: 0.16
Nodes (31): currentReleaseGatePath(), TestCurrentReleaseGatePathMapsV100ToV10Directory(), TestCurrentSupportedSurfaceDocumentIsReleaseAligned(), TestCurrentSupportedSurfaceDocumentIsReleaseAligned(), currentGitHead(), currentReleaseVersion(), releaseV040SecurityReviewPathFakeRepo(), releaseV10SecurityReviewPathFakeRepo() (+23 more)
...
Cohesion: 0.14
Nodes (22): BrokerReport, CaseReport, FrameCounts, ProcessReport, Report, decodeStrict(), TestValidateReportAcceptsExecutableLinuxX64Evidence(), TestValidateReportRejectsMissingFailureCase() (+14 more)
...
Cohesion: 0.13
Nodes (12): emitIndexLoad(), emitIndexStore(), emitMmapFailureBranch(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+4 more)
...
Cohesion: 0.18
Nodes (21): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), isInternalRuntimeExportedSymbol(), quotedAfter(), targetExportedFFIAggregateParamDiagnostic(), targetExportedFFIAggregateReturnDiagnostic(), targetExportedFFIPointerParamDiagnostic(), targetExportedFFIPointerReturnDiagnostic() (+13 more)
...
Cohesion: 0.21
Nodes (15): apiDocTitle(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), disambiguatedAPIDocTitles(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+7 more)
...
Cohesion: 0.17
Nodes (3): atomicFetchCASLoop32(), emitAllocBytes(), patchExitBranch()
