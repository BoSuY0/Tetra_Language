...
## Corpus Check
- 4465 files · ~6,357,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22094 nodes · 85513 edges · 1064 communities (912 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13798 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc230082`
...
## Communities (1064 total, 152 thin omitted)
...
Cohesion: 0.03
Nodes (237): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+229 more)
...
Cohesion: 0.04
Nodes (157): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost() (+149 more)
...
Cohesion: 0.04
Nodes (143): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+135 more)
...
Cohesion: 0.05
Nodes (139): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, artifactRepairCommand(), appendGeneratedArtifactsToCapsule(), artifactRepairCommand() (+131 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (135): resolveFieldChainLower(), assignTargetInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals() (+127 more)
...
Cohesion: 0.05
Nodes (113): AnalyzeLSPFile(), AnalyzeLSPSource(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail() (+105 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (103): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+95 more)
...
Cohesion: 0.06
Nodes (98): BrokerReport, CaseReport, FrameCounts, ProcessReport, Report, decodeStrict(), TestValidateReportAcceptsExecutableLinuxX64Evidence(), TestValidateReportRejectsMissingFailureCase() (+90 more)
...
Cohesion: 0.09
Nodes (102): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+94 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke() (+77 more)
...
Cohesion: 0.14
Nodes (6): ParseFile(), diagnosticErrorf(), Expr, parser, buildFieldAccess(), ParseFile()

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (76): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+68 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (39): AssignStmt, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl, EnumCasePatternExpr (+31 more)
...
Cohesion: 0.05
Nodes (19): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, ClosureExpr, FieldAccessExpr, IdentExpr (+11 more)
...
Cohesion: 0.07
Nodes (37): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+29 more)
...
Cohesion: 0.09
Nodes (38): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+30 more)
...
Cohesion: 0.12
Nodes (30): atomicBuiltinOpPrefix, atomicBuiltinValueType, BuiltinManifest, addAtomicBuiltinSigs(), atomicBuiltinAllOrders(), atomicBuiltinDiagnostic(), atomicBuiltinDiagnosticWidth(), atomicBuiltinOpPrefixes() (+22 more)
...
Cohesion: 0.21
Nodes (15): effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), normalizeEffects(), sortedEffectSet() (+7 more)
