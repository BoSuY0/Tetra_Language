# Graph Report - Tetra_Language  (2026-05-26)

## Corpus Check
- 4465 files · ~6,367,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22117 nodes · 85588 edges · 1071 communities (922 shown, 149 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13817 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8085be10`
...
## Communities (1071 total, 149 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (522): buildAndRun(), buildAndRunFiles(), TestBuildMultiFileAliasCall(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+514 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (382): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+374 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (424): TestGenerateAPIDocs(), TestGenerateAPIDocsSkipsCapsuleManifestInProjectDirectory(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildCommandWASMProjectLockDoesNotRequireNativeArtifacts(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode() (+416 more)
...
Cohesion: 0.03
Nodes (258): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+250 more)
...
Cohesion: 0.03
Nodes (228): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+220 more)
...
Cohesion: 0.04
Nodes (160): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot() (+152 more)
...
Cohesion: 0.04
Nodes (150): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+142 more)
...
Cohesion: 0.05
Nodes (130): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindMatchPatternLocalsForInference(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns() (+122 more)
...
Cohesion: 0.04
Nodes (122): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+114 more)
...
Cohesion: 0.05
Nodes (120): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+112 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (90): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+82 more)
...
Cohesion: 0.04
Nodes (88): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+80 more)
...
Cohesion: 0.07
Nodes (102): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+94 more)
...
Cohesion: 0.05
Nodes (88): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), isCommandEnvAssignment(), isMatrixHarnessGoRunTarget(), isMatrixHarnessScript(), matrixCoverageKey() (+80 more)
...
Cohesion: 0.08
Nodes (57): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+49 more)
...
Cohesion: 0.08
Nodes (51): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+43 more)
...
Cohesion: 0.06
Nodes (21): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, ClosureExpr, lexer, hexValue() (+13 more)
...
Cohesion: 0.1
Nodes (48): sameStringSet(), sortedStrings(), capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot(), findCapsuleManifest(), main() (+40 more)
...
Cohesion: 0.1
Nodes (28): buildReport(), failedCase(), intPtr(), main(), memoryProductionAudit(), processExitCode(), requiredPassingCases(), runCommand() (+20 more)
...
Cohesion: 0.14
Nodes (38): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+30 more)
...
Cohesion: 0.13
Nodes (20): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd8() (+12 more)

### Community 119 - "Community 119"
Cohesion: 0.16
Nodes (38): itoa(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript(), initialState() (+30 more)
...
Cohesion: 0.12
Nodes (24): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+16 more)
...
Cohesion: 0.11
Nodes (10): emitCmp(), emitFunc(), emitMMIOReadI32(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+2 more)
...
Cohesion: 0.24
Nodes (21): emitActorYield(), BuildWindowsX64(), emitActorExitWindowsX64(), emitActorNoArgWrapperWindowsX64(), emitActorOneArgWrapperWindowsX64(), emitActorSendBeginWrapperWindowsX64(), emitActorSendMsgWrapperWindowsX64(), emitActorSendSlotWrapperWindowsX64() (+13 more)
...
Cohesion: 0.12
Nodes (13): LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), emitEntryStubSysVUnixX64(), emitEntryStubWin64X64() (+5 more)
...
Cohesion: 0.16
Nodes (8): atomicFetchAdd32(), atomicFetchSub32(), emitAllocBytes(), emitExit(), emitMakeSlice(), emitMMIOWriteI32(), emitWrite(), patchExitBranch()
...
Cohesion: 0.16
Nodes (12): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), buildWASMUIFixture(), TestNativeShellUIExampleWritesMetadataPreviewSidecar(), TestWASIDogfoodTargetBuildOnlyAndNoUIRuntimeArtifacts(), TestWASMUIExamplesBuildWithDeterministicMetadataSidecars(), TestWASMUISidecarsAreDeterministicAcrossBuilds(), TestWebUIDogfoodBuildWritesSchemaCheckedArtifacts() (+4 more)
...
Cohesion: 0.26
Nodes (18): emitActorNetPump(), emitActorNodeConnect(), emitActorSpawnRemote(), emitActorWireControlFrame(), emitLeaRdiRspDisp(), emitLeaRsiRspDisp(), emitMovEaxRspDisp(), emitMovMem16RspDispAx() (+10 more)

### Community 269 - "Community 269"
Cohesion: 0.16
Nodes (15): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+7 more)
...
Cohesion: 0.19
Nodes (5): emitIndexLoad(), emitIndexStore(), emitMmapFailureBranch(), emitRawStore(), scaleIndex()
