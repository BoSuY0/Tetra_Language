...
## Corpus Check
- 4465 files · ~6,370,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22126 nodes · 85617 edges · 1060 communities (907 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13823 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ba2968a`
...
Cohesion: 0.03
Nodes (219): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+211 more)
...
Cohesion: 0.03
Nodes (183): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+175 more)
...
Cohesion: 0.03
Nodes (168): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+160 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (157): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), findCapsulePath(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+149 more)
...
Cohesion: 0.04
Nodes (144): BuildMacOSX64(), atomicIRTargetInfo(), TestAtomicIRTargetInfoUsesX32PointerWidth(), TestX86RejectsI64AtomicWithTargetDiagnostic(), targetAtomicDiagnostic(), validateTargetAtomicIR(), atomicIRInfo, BuildStats (+136 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (106): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+98 more)
...
Cohesion: 0.04
Nodes (133): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+125 more)
...
Cohesion: 0.08
Nodes (113): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+105 more)
...
Cohesion: 0.08
Nodes (101): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+93 more)
...
Cohesion: 0.07
Nodes (83): defaultOutput(), main(), TestDefaultOutputUsesTargetExtensionAndEmitMode(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity() (+75 more)
...
Cohesion: 0.07
Nodes (10): emitCall(), emitExit(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitReturn(), emitWrite() (+2 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (71): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+63 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (68): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+60 more)
...
Cohesion: 0.1
Nodes (63): capsuleSectionHeader(), FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs() (+55 more)
...
Cohesion: 0.08
Nodes (56): endpointKind(), endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest() (+48 more)
...
Cohesion: 0.06
Nodes (51): GitHub CI Workflow, CLI Contracts Spec, Current Supported Surface Spec, V0 1 1 Release Gate, V0 1 2 Release Gate, V0 1 3 Release Gate, V0 4 0 Release Gate, V1 0 Release Gate (+43 more)
...
Cohesion: 0.12
Nodes (42): makePublishFixture(), runPublishValidator(), runPublishValidatorWithChannel(), TestValidateEcoPublishAcceptsStableMetadata(), TestValidateEcoPublishAcceptsValidMetadata(), TestValidateEcoPublishRejectsDownloadPathMismatch(), TestValidateEcoPublishRejectsHashMismatch(), TestValidateEcoPublishRejectsTrustSnapshotHashMismatch() (+34 more)

### Community 103 - "Community 103"
Cohesion: 0.09
Nodes (37): BuiltinManifest, Manifest, GetManifest(), manifestAtomicPointerWidthBits(), assertSymbolSequence(), TestManifestBuiltinsExposeStableUnsafePoliciesForPublicSurface(), TestManifestRuntimeABIIncludesFullRequiredSymbolSets(), RuntimeManifest (+29 more)
...
Cohesion: 0.16
Nodes (37): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+29 more)
...
Cohesion: 0.11
Nodes (25): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64() (+17 more)
...
Cohesion: 0.16
Nodes (29): formatInterfaceExtensionMethodDetail(), interfaceCallbackArgumentName(), interfaceCapturedClosureLiteral(), interfaceFunctionBody(), interfaceFunctionClosureLiteral(), interfaceFunctionMatchReturnBody(), interfaceFunctionReturnExpr(), interfaceFunctionReturnParamPath() (+21 more)
...
Cohesion: 0.29
Nodes (24): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+16 more)
...
Cohesion: 0.2
Nodes (21): emitActorNetPump(), emitActorNodeConnect(), emitActorSpawnRemote(), emitActorWireControlFrame(), emitLeaRdiRspDisp(), emitLeaRsiRspDisp(), emitMovEaxRspDisp(), emitMovMem16RspDispAx() (+13 more)
...
Cohesion: 0.17
Nodes (6): emitAllocBytes(), emitIndexStore(), emitMakeSlice(), emitMmapFailureBranch(), emitRawStore(), patchExitBranch()
...
Cohesion: 0.33
Nodes (3): emitIndexLoad(), emitRawLoad(), scaleIndex()

### Community 494 - "Community 494"
Cohesion: 0.71
Nodes (5): smokeCases(), smokeCasesForTarget(), smokeRegistryCases(), smokeCase, smokeSourceSet
...
Cohesion: 1.0
Nodes (3): Plan250 Consolidated Evidence Index, Wave-E Implementer 1 Plan Integrity, Wave-E Implementer 2 Integrity Check
