...
## Corpus Check
- 4465 files · ~6,368,214 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22118 nodes · 85592 edges · 1068 communities (914 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13818 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d173692`
...
## Communities (1068 total, 154 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (523): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestExprStmtQualified(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke() (+515 more)
...
Cohesion: 0.02
Nodes (298): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestLSPCommandSmoke(), assertCLIJSONLifetimeDiagnostic(), assertCLIJSONOwnershipDiagnostic(), documentedCLICommands() (+290 more)
...
Cohesion: 0.02
Nodes (238): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+230 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (244): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+236 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (206): TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+198 more)
...
Cohesion: 0.03
Nodes (148): releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind(), TestReleaseV10APIDiffRejectsMissingBaselineBeforeDocsWork() (+140 more)
...
Cohesion: 0.04
Nodes (138): BuildMacOSX64(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt() (+130 more)
...
Cohesion: 0.04
Nodes (123): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+115 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (139): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+131 more)
...
Cohesion: 0.05
Nodes (108): assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject(), lspTestLocationsContainRange() (+100 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (50): branchScopeInfo, copySecretTaintMap(), mergeControlFlowWithLabels(), mergeLoopFlowExits(), mergeSecretTaintMaps(), recordLoopFlowExit(), returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect() (+42 more)
...
Cohesion: 0.07
Nodes (98): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendUniqueString(), buildEcoLock(), buildEcoLockWithArtifactHashes(), buildNeedMap(), capsuleIDDirectory() (+90 more)

### Community 51 - "Community 51"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+77 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke() (+90 more)

### Community 53 - "Community 53"
Cohesion: 0.1
Nodes (94): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType(), collectLocals() (+86 more)
...
Cohesion: 0.07
Nodes (78): TypeRefKind, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures() (+70 more)
...
Cohesion: 0.09
Nodes (79): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion() (+71 more)
...
Cohesion: 0.07
Nodes (65): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+57 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (59): LoadWorld(), LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile() (+51 more)

### Community 69 - "Community 69"
Cohesion: 0.1
Nodes (65): CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript() (+57 more)
...
Cohesion: 0.08
Nodes (9): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitReturn(), emitWrite(), guardAllocationBaseRawAccess(), guardAllocationOffsetRawAccess() (+1 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (64): Render(), TestRenderDispatchesCommandOperationsInOrder(), TestRenderDispatchesStateSetFromSameStateField(), TestRenderDispatchesStateSubtractOperations(), TestRenderDispatchesStringStateSetWithoutLiteralQuotes(), TestRenderIncludesStateAndViewMetadata(), TestRenderJSONIncludesDispatchTrace(), TestRenderJSONIncludesNativeWidgetTree() (+56 more)
...
Cohesion: 0.07
Nodes (48): BuiltinManifest, FeatureInfo, FeatureRegistry(), TestFeatureRegistryCLICoreCoversDocumentedPublicCommands(), TestFeatureRegistryCoversReleaseStatusesAndKeyBoundaries(), TestFeatureRegistryReturnsDefensiveCopy(), TestManifestBuiltinsExposeCanonicalSafetyEffectsAndPolicies(), FeatureStatus (+40 more)
...
Cohesion: 0.08
Nodes (52): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+44 more)
...
Cohesion: 0.1
Nodes (46): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+38 more)
...
Cohesion: 0.07
Nodes (48): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), requireUnsupportedReasonContains(), targetMetaForTest(), targetsJSONForTest() (+40 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (37): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+29 more)
...
Cohesion: 0.11
Nodes (40): formatEntry, formatsReport, decodeStrictJSON(), main(), sameStringSequence(), validateFormatEntry(), validateFormats(), lspDiagnostic (+32 more)

### Community 114 - "Community 114"
Cohesion: 0.14
Nodes (40): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+32 more)
...
Cohesion: 0.08
Nodes (38): Current Supported Surface Spec, V0 1 1 Release Gate, V0 1 2 Release Gate, V0 1 3 Release Gate, V0 4 0 Release Gate, V1 0 Release Gate, Known Issues, 2026 04 27 Tetra Real Stabilization Agent Backlog (+30 more)
...
Cohesion: 0.16
Nodes (27): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+19 more)
...
Cohesion: 0.13
Nodes (30): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+22 more)
...
Cohesion: 0.14
Nodes (7): emitAllocBytes(), emitExit(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), emitMMIOWriteI32(), patchExitBranch()
...
Cohesion: 0.13
Nodes (19): GitHub CI Workflow, CLI Contracts Spec, Eco Publishing Model v1, Eco Package Guide, Plan250 Consolidated Evidence Index, Release Gate Blocked by Web UI Smoke Failure, release_v0_3_0_gate.sh, release_v1_0_security_review.sh (+11 more)

### Community 266 - "Community 266"
Cohesion: 0.25
Nodes (16): Examples Index, examplesIndexRow, cheatsheetDocsExampleScript(), cheatsheetEcoPackUnpackSnippet(), cheatsheetShellCommandsInSection(), examplesIndexRowsByPath(), markdownShellCommandsInSection(), splitMarkdownRow() (+8 more)
...
Cohesion: 0.21
Nodes (14): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+6 more)
