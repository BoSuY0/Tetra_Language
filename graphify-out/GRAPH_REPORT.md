...
## Corpus Check
- 4465 files · ~6,504,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22047 nodes · 85375 edges · 1066 communities (915 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13773 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c20ffe0`
...
Cohesion: 0.01
Nodes (307): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+299 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (386): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes() (+378 more)
...
Cohesion: 0.03
Nodes (256): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+248 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (245): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+237 more)
...
Cohesion: 0.03
Nodes (179): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+171 more)
...
Cohesion: 0.04
Nodes (170): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+162 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (152): lspID, flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment(), validateFile() (+144 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (160): TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+152 more)
...
Cohesion: 0.05
Nodes (61): FormatPos(), budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr() (+53 more)
...
Cohesion: 0.04
Nodes (114): TestActorStateLowerUsesRuntimeLoadStoreCalls(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), requiredActorRuntimeSymbols(), requiredActorStateRuntimeSymbols(), requiredFilesystemRuntimeSymbols(), requiredTaskGroupRuntimeSymbols(), requiredTaskRuntimeSymbols(), requiredTimeRuntimeSymbols() (+106 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (114): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+106 more)
...
Cohesion: 0.08
Nodes (117): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+109 more)
...
Cohesion: 0.06
Nodes (96): resolveFieldChainLower(), assignTargetInfo, bindMatchPatternLocalsForInference(), cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), resolveCallSigForInference() (+88 more)
...
Cohesion: 0.04
Nodes (45): branchScopeInfo, mergeControlFlowWithLabels(), returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope() (+37 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke() (+90 more)
...
Cohesion: 0.06
Nodes (72): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost() (+64 more)
...
Cohesion: 0.09
Nodes (77): borrowedPtrOwnerFromExpr(), resourcePathForExpr(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), bareEnumPatternTypeAndCase(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion() (+69 more)
...
Cohesion: 0.07
Nodes (66): hasPrefix(), FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), isCapsuleSemver() (+58 more)
...
Cohesion: 0.08
Nodes (56): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+48 more)
...
Cohesion: 0.06
Nodes (60): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+52 more)
...
Cohesion: 0.11
Nodes (53): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), findCapsulePath(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots() (+45 more)
...
Cohesion: 0.14
Nodes (51): appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers(), encodeWorkspaceJSON(), findWorkspacePath() (+43 more)
...
Cohesion: 0.07
Nodes (49): BenchmarkEnvironment, EndpointReport, GitState, matrixEndpointSpecs(), parseMatrixResourceTimestamp(), requiredMatrixSemanticProbeNames(), validateMatrixArtifacts(), validateMatrixBuild() (+41 more)
...
Cohesion: 0.1
Nodes (30): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+22 more)
...
Cohesion: 0.14
Nodes (25): ClosureCapture, captureMode, cloneBoolMap(), copySecretTaintMap(), mergeLoopFlowExits(), recordLoopFlowExit(), addPatternCaptureBindings(), appendClosureCaptureArgs() (+17 more)
...
Cohesion: 0.16
Nodes (20): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+12 more)
