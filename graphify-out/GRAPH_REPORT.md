...
## Corpus Check
- 4465 files · ~6,495,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22027 nodes · 85315 edges · 1073 communities (919 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13760 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d206830c`
...
## Communities (1073 total, 154 thin omitted)
...
Cohesion: 0.01
Nodes (365): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+357 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (403): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestDocCommandDiscoversCapsuleProjectSources(), TestDocCommandGeneratedOutputPassesAPIValidator(), TestDocCommandJSONDiagnostics(), TestDocCommandWritesAPIDocsToFile(), TestDocCommandWritesAPIDocsToStdout() (+395 more)
...
Cohesion: 0.03
Nodes (270): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+262 more)
...
Cohesion: 0.04
Nodes (117): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+109 more)
...
Cohesion: 0.05
Nodes (125): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+117 more)
...
Cohesion: 0.06
Nodes (95): TypeRefKind, resolveFieldChainLower(), assignTargetInfo, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType() (+87 more)
...
Cohesion: 0.05
Nodes (41): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+33 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (87): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+79 more)
...
Cohesion: 0.04
Nodes (45): AssignStmt, AwaitExpr, BreakStmt, CallExpr, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt (+37 more)
...
Cohesion: 0.08
Nodes (82): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindResourceFromExpr(), resourceSourceForExpr(), resourceSourceForPath(), returnResourceSummaryForExpr(), ownershipDiagnosticf() (+74 more)
...
Cohesion: 0.06
Nodes (73): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+65 more)
...
Cohesion: 0.09
Nodes (75): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+67 more)
...
Cohesion: 0.06
Nodes (22): BinaryExpr, BoolLitExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr, lexer (+14 more)

### Community 86 - "Community 86"
Cohesion: 0.13
Nodes (55): parseCapsuleBareOrQuoted(), parseCapsuleString(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers() (+47 more)
...
Cohesion: 0.13
Nodes (23): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd32() (+15 more)

### Community 110 - "Community 110"
Cohesion: 0.1
Nodes (35): bodyPrefix(), hasSymbol(), symbolBody(), TestActorNetPumpIsExportedButOnlyLinuxHasRuntimePump(), TestBuiltinRuntimeExportsActorStateSymbols(), TestLinuxDistributedRuntimeUsesWideStackSubFor128ByteFrames(), TestLinuxRuntimeExportsDistributedActorSymbols(), TestLinuxRuntimeExportsFilesystemSymbol() (+27 more)
...
Cohesion: 0.15
Nodes (39): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+31 more)
...
Cohesion: 0.18
Nodes (34): capsuleSectionHeader(), writeEcoLock(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), checkProjectLockOnly(), checkProjectSync(), describeProjectDependency() (+26 more)
...
Cohesion: 0.11
Nodes (24): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkMacOSX64(), LinkWindowsX64() (+16 more)
...
Cohesion: 0.19
Nodes (30): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver(), normalizeCapsuleArtifactKind() (+22 more)
...
Cohesion: 0.12
Nodes (18): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+10 more)
...
Cohesion: 0.17
Nodes (18): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+10 more)
...
Cohesion: 0.17
Nodes (22): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+14 more)
