...
## Corpus Check
- 721 files · ~1,470,186 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18804 nodes · 74082 edges · 496 communities (417 shown, 79 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13556 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ef27d08`
...
## Communities (496 total, 79 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (506): buildAndRun(), buildAndRunFiles(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke() (+498 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (415): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation(), TestBuildCommandJSONDiagnosticsForTooManyInputs() (+407 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (279): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+271 more)
...
Cohesion: 0.02
Nodes (311): TestFilesystemRuntimeRejectsUnsupportedNativeTargets(), TestRuntimeObjectOverrideRejectsMissingFilesystemSymbols(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestLSPCommandSmoke(), assertCLIJSONLifetimeDiagnostic() (+303 more)
...
Cohesion: 0.03
Nodes (226): parseSCRAMAttributes(), scramSHA256Client, decodeWorldResponse(), get(), getWorldArray(), runSemanticProbe(), validateFortunesHTTP(), validateWorld() (+218 more)
...
Cohesion: 0.02
Nodes (165): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEpic04ExpressionTypingDisplayTextAndBoundary(), TestEpic04ExpressionTypingNegativeDiagnostic(), TestEpic04ExpressionTypingPositiveAndInferenceCrossModule(), TestEpic04LocalInferenceNegativeAndDisplayText(), TestEpic04SemanticCheckerCoreCrossModuleParity(), TestEpic04SemanticCheckerCoreDisplayTextStability() (+157 more)
...
Cohesion: 0.04
Nodes (120): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), BuildOptions, executableMatrixCase, featuresReport, formatsReport, runInterface(), allTargetsOutput() (+112 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (121): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+113 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (121): resolveFunctionFieldName(), classifyCallableEscape(), TestClassifyCallableEscapeRejectsMutableCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeRejectsMutableEscapingCapture(), TestClassifyCallableEscapeRejectsResourceCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeUsesFnptrForBoundedLocalSnapshot(), TestClassifyCallableEscapeUsesHandleForOversizedReturn(), callableEscapeBoundary (+113 more)
...
Cohesion: 0.04
Nodes (42): branchScopeInfo, borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+34 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (99): CheckWorldOpt(), ActorStateField, TestEnsureTypeInfoArrayRejectsUnsupportedSubset(), TestEnsureTypeInfoArraySupportedSubset(), TestEnsureTypeInfoRejectsTargetLayoutOnlyNativeIntegers(), CheckedEnum, CheckedFunc, CheckedProgram (+91 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentSmoke() (+77 more)

### Community 51 - "Community 51"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+90 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (90): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+82 more)
...
Cohesion: 0.04
Nodes (75): TestBuildRejectsInterfaceImplementationMissingSymbol(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip() (+67 more)
...
Cohesion: 0.05
Nodes (66): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+58 more)
...
Cohesion: 0.07
Nodes (70): FormatPos(), TypeRefKind, resolveFieldChainLower(), assignTargetInfo, addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), bindMatchPatternLocalsForInference(), catchExprHasCompleteEnumPatterns() (+62 more)
...
Cohesion: 0.07
Nodes (70): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+62 more)
...
Cohesion: 0.1
Nodes (72): ownershipAt(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion(), borrowedOwnerFromExpr(), callbackExpectedThrowsType() (+64 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (69): hasPrefix(), validatePlaintext(), apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata() (+61 more)

### Community 67 - "Community 67"
Cohesion: 0.1
Nodes (7): importedFunctionTargetFromExpr(), isNoneExpr(), lowerer, EnsureTypedTaskHandleType(), IsTypedTaskHandleTypeName(), TypedTaskHandleTypeName(), TypedTaskHandleTypesCompatible()
...
Cohesion: 0.1
Nodes (60): functionTypeRefSignatureAndEffects(), firstCapture(), unsupportedGenericClosureCaptureError(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), cloneClosureCaptures() (+52 more)
...
Cohesion: 0.09
Nodes (46): diagnosticError, budgetDiagnosticf(), effectDiagnosticf(), genericClosureDirectCallRequirementMessage(), genericClosurePointerEscapeMessage(), lifetimeDiagnosticf(), privacyDiagnosticf(), safetyDiagnosticf() (+38 more)
...
Cohesion: 0.07
Nodes (48): atomicMaskedFetchAdd(), atomicMaskedFetchXor(), atomicStressIterations(), atomicStressYield(), atomicSuiteOrderAllowed(), atomicSuiteTargetPrefix(), checkAtomicABAStampedPointer(), checkAtomicConcurrencyStressOracle() (+40 more)
...
Cohesion: 0.09
Nodes (26): callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitIndexLoad() (+18 more)
...
Cohesion: 0.13
Nodes (32): buildNeedMap(), collectTransitiveNeeds(), runEcoNeedMap(), runEcoTrust(), runEcoTrustSnapshot(), scoreCapsuleTrust(), addVaultRecord(), readVaultIndex() (+24 more)
...
Cohesion: 0.23
Nodes (14): discoverExamples(), isSmokeSourceFile(), main(), requiredCasesForReport(), validateSmokeListWithExamplesRoot(), smokeExcludedExample, smokeListCase, smokeListReport (+6 more)
