...
## Corpus Check
- 4465 files · ~6,489,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22014 nodes · 85253 edges · 1070 communities (918 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13741 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b3d2db4`
...
## Communities (1070 total, 152 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (508): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestExprStmtQualified(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke() (+500 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (454): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile() (+446 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (346): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+338 more)
...
Cohesion: 0.03
Nodes (246): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata() (+238 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (230): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+222 more)
...
Cohesion: 0.04
Nodes (190): FormatPos(), resolveFunctionFieldName(), runPlatformWindowProbe(), runPlatformWindowProbe(), builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), classifyCallableEscape() (+182 more)
...
Cohesion: 0.04
Nodes (165): capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+157 more)
...
Cohesion: 0.04
Nodes (146): lspID, canRunLinuxX32OnHost(), probeLinuxX32Execution(), fuzzJSONArtifacts, fuzzStep, fuzzSummary, fuzzSummaryJSON, fuzzSummaryJSONStep (+138 more)
...
Cohesion: 0.06
Nodes (105): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+97 more)
...
Cohesion: 0.05
Nodes (99): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+91 more)
...
Cohesion: 0.07
Nodes (90): resolveFieldChainLower(), assignTargetInfo, collectExprLocals(), firstCapture(), unsupportedGenericClosureCaptureError(), genericDef, genericProtocolInfo, arrayElemName() (+82 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (44): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+36 more)
...
Cohesion: 0.05
Nodes (94): buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl() (+86 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke() (+90 more)
...
Cohesion: 0.04
Nodes (45): AssignStmt, AwaitExpr, BinaryExpr, BoolLitExpr, BreakStmt, CallExpr, CapsuleEntryDecl, CatchExpr (+37 more)
...
Cohesion: 0.05
Nodes (70): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+62 more)
...
Cohesion: 0.12
Nodes (68): checkStmts(), collectionElementType(), collectLocals(), collectPatternLocals(), collectScopedLocal(), functionEnumPayloadInfoFromCallArgument(), functionFieldInfoFromCallArgument(), functionTypedReturnParamRefMetadata() (+60 more)
...
Cohesion: 0.1
Nodes (63): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+55 more)
...
Cohesion: 0.11
Nodes (60): hasPrefix(), decisionEvidence, featuresReport, containsForbiddenStructuredEvidence(), decodeJSON(), forbiddenStructuredEvidenceValue(), hasActorDistributedRuntimeDocsEvidence(), hasActorDistributedRuntimeGateArtifact() (+52 more)
...
Cohesion: 0.06
Nodes (61): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+53 more)
...
Cohesion: 0.06
Nodes (22): DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, IslandStmt, LetStmt, lexer (+14 more)
...
Cohesion: 0.09
Nodes (37): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+29 more)
...
Cohesion: 0.1
Nodes (35): FeatureInfo, FeatureRegistry(), TestFeatureRegistryCLICoreCoversDocumentedPublicCommands(), TestFeatureRegistryCoversReleaseStatusesAndKeyBoundaries(), TestFeatureRegistryReturnsDefensiveCopy(), TestManifestBuiltinsExposeCanonicalSafetyEffectsAndPolicies(), FeatureStatus, collectCalleesFromExpr() (+27 more)
...
Cohesion: 0.15
Nodes (22): TestRunBenchmarkChecksEndpointsAndWritesReport(), TestRunBenchmarkFailsWhenThresholdIsMissed(), TestPprofHandlerExposesIndex(), NewServer(), dialServer(), readUntil(), startBenchmarkServer(), startPlaintextServer() (+14 more)
...
Cohesion: 0.16
Nodes (17): countingRWC, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections(), TestPoolStatsTrackOpenIdleInUseAndClosedState(), TestNewTechEmpowerServerAppliesConfigAndRoutes() (+9 more)
...
Cohesion: 0.15
Nodes (23): appendEscapedByte(), AppendMessageObject(), AppendString(), AppendValue(), AppendWorldArray(), AppendWorldObject(), ParseValue(), assertValidJSONString() (+15 more)
...
Cohesion: 0.19
Nodes (20): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), TestRegisterTechEmpowerRoutesRequiresPool(), startDBBenchmarkServerWithRandom(), TestNormalizeQueryCount(), dbErrorResponse(), DBHandler() (+12 more)
...
Cohesion: 0.13
Nodes (22): Tetra Tooling Summary Schema v1alpha1, WaveH Test-All Tooling Summary, WaveI Test-All Tooling Summary, WaveI Reviewer Test-All Tooling Summary, WaveB Stabilization API Docs Snapshot, WaveB Stabilization Tetra Docs Snapshot, WaveB Stabilization Tooling Summary, WaveB Gate Test-All API Docs Snapshot (+14 more)

### Community 229 - "Community 229"
Cohesion: 0.1
Nodes (22): Docs Manifest Freshness Check, Short Fuzz Nightly Mode, Unstable Seed Tracking Policy, Web UI Smoke DOM (test-all-20260429-145050), Tetra UI Schema v1, Security Evidence Web UI DOM, Fuzz Short Summary (v0.3-stabilization), Web UI Smoke DOM (v0.3-stabilization) (+14 more)
...
Cohesion: 0.29
Nodes (13): writeInterfaceStruct(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail(), formatLSPImplName() (+5 more)
