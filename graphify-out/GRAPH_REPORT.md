...
## Corpus Check
- 4465 files · ~6,509,023 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22065 nodes · 85419 edges · 1062 communities (912 shown, 150 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13777 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6aa1881b`
...
Cohesion: 0.01
Nodes (507): buildAndRun(), buildAndRunFiles(), TestBuildStructCrossModule(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke() (+499 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (384): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+376 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (437): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics() (+429 more)
...
Cohesion: 0.02
Nodes (242): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+234 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (234): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindFreshResourceTree() (+226 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (205): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+197 more)
...
Cohesion: 0.04
Nodes (163): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+155 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (159): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+151 more)
...
Cohesion: 0.04
Nodes (127): flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment(), validateFile(), validatePaths() (+119 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (131): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+123 more)
...
Cohesion: 0.06
Nodes (124): appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+116 more)

### Community 44 - "Community 44"
Cohesion: 0.03
Nodes (123): requireCheckFileErrorContains(), TestOwnershipGenericFunctionTypedGlobalPreservesConsumeMarker(), TestOwnershipLoopBreakExitReportsMaybeConsumedWithBreakLabel(), TestOwnershipLoopContinueExitReportsMaybeConsumedWithContinueLabel(), TestOwnershipRejectsGenericFunctionTypedGlobalOwnershipMismatch(), TestOwnershipRejectsIndirectRecursiveEnumPayloadCycle(), TestOwnershipRejectsInterproceduralStructReturnResourceLeafDoubleFree(), TestActorConsumeRejectsAggregateAliasConsumedTwiceInSingleCall() (+115 more)
...
Cohesion: 0.05
Nodes (109): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+101 more)
...
Cohesion: 0.09
Nodes (108): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectLocals() (+100 more)
...
Cohesion: 0.05
Nodes (56): GenerateAPIDocs(), GenerateAPIDocsFromSource(), TestGenerateAPIDocs(), TestGenerateAPIDocsIncludesTestsAndDoctestFixtures(), TestGenerateAPIDocsLabelsExperimentalModules(), TestGenerateAPIDocsSkipsCapsuleManifestInProjectDirectory(), TestGenerateAPIDocsStablePublicSurfaceSnapshot(), TestExtensionNoLongerPlannedDiagnostic() (+48 more)
...
Cohesion: 0.09
Nodes (7): emitCall(), emitFunc(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitter
...
Cohesion: 0.06
Nodes (20): ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, LetStmt, lexer (+12 more)
...
Cohesion: 0.09
Nodes (39): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+31 more)
...
Cohesion: 0.12
Nodes (22): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd8() (+14 more)
...
Cohesion: 0.05
Nodes (36): TestActorSpawnOwnershipMatrix(), requireCheckFileOK(), TestActorSpawnRejectsMutableGlobalTarget(), TestActorSpawnRejectsThrowingTarget(), TestAsyncRejectAwaitOutsideAsync(), TestAsyncRejectBareAsyncCall(), TestAsyncSmokeExampleBuildAndRun(), TestAsyncTypedErrorBoundaryRejectsAwaitTryForm() (+28 more)
...
Cohesion: 0.09
Nodes (29): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkMacOSX64(), LinkWindowsX64() (+21 more)
...
Cohesion: 0.14
Nodes (25): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+17 more)
...
Cohesion: 0.13
Nodes (22): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+14 more)
...
Cohesion: 0.17
Nodes (23): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+15 more)
...
Cohesion: 0.18
Nodes (22): capsuleIDDirectory(), containsString(), isSupportedPublishChannel(), main(), parseSHA256Hash(), publishSchemaForChannel(), validatePublishedPackage(), validateRelativeMetadataPath() (+14 more)
...
Cohesion: 0.14
Nodes (13): requireCheckWorldFilesOK(), TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+5 more)
...
Cohesion: 0.31
Nodes (5): FuzzLexer(), FuzzParser(), newLexer(), FuzzValidateManifestDoesNotPanic(), TestManifestNegativePropertySuite()
