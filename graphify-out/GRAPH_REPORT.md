...
## Corpus Check
- 620 files · ~1,273,379 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18683 nodes · 73352 edges · 504 communities (426 shown, 78 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13551 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `517ea6a7`
...
## Communities (504 total, 78 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (499): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+491 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (504): buildAndRun(), buildAndRunFiles(), TestBuildStructCrossModule(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke() (+496 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (277): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+269 more)
...
Cohesion: 0.02
Nodes (261): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+253 more)
...
Cohesion: 0.03
Nodes (241): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+233 more)
...
Cohesion: 0.05
Nodes (92): LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths() (+84 more)
...
Cohesion: 0.07
Nodes (102): bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), catchPatternType() (+94 more)
...
Cohesion: 0.03
Nodes (90): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+82 more)
...
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+77 more)
...
Cohesion: 0.07
Nodes (82): artifactCheck, fakeFileInfo, fileInfo, freshnessCheck, gateEvidenceReport, generatedArtifactsReport, generatedEvidenceRule, gitStatusClassification (+74 more)
...
Cohesion: 0.04
Nodes (41): AssignStmt, itoa(), AwaitExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt (+33 more)
...
Cohesion: 0.07
Nodes (57): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost() (+49 more)
...
Cohesion: 0.08
Nodes (48): runFlowOnlyValidator(), TestValidateFlowOnlyAcceptsFlowSource(), TestValidateFlowOnlyAcceptsFlowTestBlock(), TestValidateFlowOnlyAcceptsT4FlowSource(), TestValidateFlowOnlyIgnoresCommentsAndStrings(), TestValidateFlowOnlyRejectsLegacyBlockAndSemicolon(), TestValidateFlowOnlyRejectsLegacyBracedTestSyntax(), TestValidateFlowOnlyRejectsLegacyBraceFunction() (+40 more)

### Community 87 - "Community 87"
Cohesion: 0.1
Nodes (44): FuzzLexer(), FuzzParser(), sameStringSet(), sortedStrings(), capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot() (+36 more)
...
Cohesion: 0.13
Nodes (31): apiDocTitle(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), disambiguatedAPIDocTitles(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+23 more)
...
Cohesion: 0.11
Nodes (24): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64() (+16 more)

### Community 142 - "Community 142"
Cohesion: 0.17
Nodes (24): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB (+16 more)
...
Cohesion: 0.14
Nodes (6): emitIndexLoad(), emitIndexStore(), emitMakeSlice(), emitMmapFailureBranch(), patchExitBranch(), scaleIndex()
