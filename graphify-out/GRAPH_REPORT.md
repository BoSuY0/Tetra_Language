...
## Corpus Check
- 4465 files · ~6,500,027 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22037 nodes · 85348 edges · 1063 communities (912 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13768 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28c71eb8`
...
Cohesion: 0.01
Nodes (397): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+389 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (434): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes() (+426 more)
...
Cohesion: 0.03
Nodes (193): assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects(), TestBuildCacheTransitiveDoesNotRebuildRoot() (+185 more)
...
Cohesion: 0.02
Nodes (167): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEpic04ExpressionTypingDisplayTextAndBoundary(), TestEpic04ExpressionTypingNegativeDiagnostic(), TestEpic04ExpressionTypingPositiveAndInferenceCrossModule(), TestEpic04LocalInferenceNegativeAndDisplayText(), TestEpic04SemanticCheckerCoreCrossModuleParity(), TestEpic04SemanticCheckerCoreDisplayTextStability() (+159 more)
...
Cohesion: 0.04
Nodes (77): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+69 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (156): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+148 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (152): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary() (+144 more)
...
Cohesion: 0.05
Nodes (130): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+122 more)
...
Cohesion: 0.05
Nodes (124): canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile() (+116 more)
...
Cohesion: 0.05
Nodes (107): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+99 more)
...
Cohesion: 0.06
Nodes (82): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+74 more)
...
Cohesion: 0.04
Nodes (45): AssignStmt, BreakStmt, CapsuleEntryDecl, CatchExpr, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+37 more)
...
Cohesion: 0.08
Nodes (82): writeFileAPIDocs(), addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr() (+74 more)
...
Cohesion: 0.12
Nodes (83): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs() (+75 more)
...
Cohesion: 0.05
Nodes (42): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+34 more)
...
Cohesion: 0.06
Nodes (21): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, ClosureExpr, EnumCasePatternExpr, IndexExpr, lexer (+13 more)
...
Cohesion: 0.13
Nodes (41): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+33 more)
...
Cohesion: 0.1
Nodes (36): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+28 more)
...
Cohesion: 0.09
Nodes (28): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+20 more)
...
Cohesion: 0.16
Nodes (6): atomicFetchCASLoop32(), emitAllocBytes(), emitExit(), emitMakeSlice(), emitWrite(), patchExitBranch()
...
Cohesion: 0.2
Nodes (15): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+7 more)
...
Cohesion: 0.18
Nodes (14): TypeRefKind, TestCheckWorldRejectsDuplicateInterfaceFunctionParams(), TestResolutionDiagnosticForInvalidAliasCallShape(), TestResolutionDisplayTextForEnumCaseUsesLocalTypeName(), TestResolutionImportAliasConflictWithTopLevelDeclaration(), TestResolutionImportAliasRequiredBoundary(), TestResolutionImportPathRequiredBoundary(), TestResolutionModuleImportAliasResolvesCallAndType() (+6 more)
