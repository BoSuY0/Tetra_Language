...
## Corpus Check
- 4465 files · ~6,358,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22097 nodes · 85523 edges · 1073 communities (909 shown, 164 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13801 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `55e5182d`
...
## Communities (1073 total, 164 thin omitted)
...
Cohesion: 0.01
Nodes (450): assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue(), TestCapturedFunctionTypedInlineParameterReturnCannotEscapeIntoGlobalFunctionValue() (+442 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (443): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+435 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (416): writeFile(), intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts() (+408 more)
...
Cohesion: 0.03
Nodes (251): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+243 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (237): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+229 more)
...
Cohesion: 0.05
Nodes (122): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultOutput() (+114 more)
...
Cohesion: 0.07
Nodes (119): TestReleaseV011GateValidatesJSONDiagnostics(), testAllFakeRepo(), assertExitCode(), decodeTestAllSummary(), hasTestAllStep(), readReleaseV06GateScript(), readTestAllScript(), runTestAll() (+111 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (120): resolveFieldChainLower(), assignTargetInfo, bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), catchPatternType() (+112 more)
...
Cohesion: 0.06
Nodes (106): AnalyzeLSPFile(), AnalyzeLSPSource(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPSourceActorDeclarationDiagnostic(), TestAnalyzeLSPSourceImportedFileDoesNotReportMissingWorkspace(), TestAnalyzeLSPSourcePrivacyConsentDiagnosticCode(), TestAnalyzeLSPSourceRecursiveSecretSignatureDiagnosticCode(), TestAnalyzeLSPSourceSemanticDiagnostics() (+98 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedDirectClosureLiteralReturnSmoke() (+77 more)
...
Cohesion: 0.05
Nodes (38): branchScopeInfo, appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree(), constructorRegionFromTree(), containsSyntheticOwnershipSegment() (+30 more)
...
Cohesion: 0.07
Nodes (83): main(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry() (+75 more)
...
Cohesion: 0.05
Nodes (78): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+70 more)
...
Cohesion: 0.06
Nodes (70): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError() (+62 more)
...
Cohesion: 0.06
Nodes (53): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames(), TestObjectWriteRejectsMalformedSymbolAndRelocRanges() (+45 more)
...
Cohesion: 0.11
Nodes (43): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPIDisplayTextForBoundaryError(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), TestPublicCheckAPISingleSourcePositive(), writeTestFiles(), tamperTodexEntry(), testCommand(), TestEcoBetaPublishDownloadAndTetraHubPath() (+35 more)
...
Cohesion: 0.09
Nodes (41): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+33 more)
...
Cohesion: 0.12
Nodes (26): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), classifyOwnershipAuditResult(), isOwnershipAuditSeparatorRow(), normalizeOwnershipAuditStatus() (+18 more)
...
Cohesion: 0.15
Nodes (25): exampleIndexEntry, main(), parseExampleIndex(), runValidateExampleIndex(), splitMarkdownTableRow(), TestRunAcceptsDocsFlagWithoutSmokeList(), TestValidateExampleDocsAcceptsT4ProjectEntry(), TestValidateExampleDocsRejectsUnsupportedExtension() (+17 more)
...
Cohesion: 0.13
Nodes (24): bodyPrefix(), hasSymbol(), symbolBody(), TestActorNetPumpIsExportedButOnlyLinuxHasRuntimePump(), TestBuiltinRuntimeExportsActorStateSymbols(), TestLinuxDistributedRuntimeUsesWideStackSubFor128ByteFrames(), TestLinuxRuntimeExportsDistributedActorSymbols(), TestLinuxRuntimeExportsFilesystemSymbol() (+16 more)
...
Cohesion: 0.18
Nodes (20): isUpdateQuery(), parseWorldUpdate(), pgAppendCString(), pgAppendInt16(), pgAppendInt32(), pgBackendKeyPayload(), pgCStringPayload(), pgCStringsPayload() (+12 more)
...
Cohesion: 0.17
Nodes (20): TestPprofHandlerExposesIndex(), NewServer(), dialServer(), readUntil(), startBenchmarkServer(), startPlaintextServer(), TestServerHandlesPartialRequestRead(), TestServerJSONEndpointKeepAliveAndPipelining() (+12 more)
...
Cohesion: 0.08
Nodes (15): TestTypedErrorsCatchBindingScopeDiagnostic(), TestTypedErrorsCatchDefaultMustBeLastDiagnostic(), TestTypedErrorsCatchDuplicateUnguardedEnumPayloadCaseDiagnostic(), TestTypedErrorsCatchGuardedEnumPayloadCaseIsNotExhaustive(), TestTypedErrorsCatchNoPayloadCaseRejectsPayloadSyntaxDiagnostic(), TestTypedErrorsCatchPayloadCaseRequiresDestructuringDiagnostic(), TestTypedErrorsCatchRejectsHandlerTypeMismatch(), TestTypedErrorsCatchRejectsNonThrowingCall() (+7 more)
...
Cohesion: 0.48
Nodes (5): TestWritePE64WindowsX64RejectsEntryOffsetOutOfRange(), TestWritePE64WindowsX64RejectsMissingImage(), TestWritePE64WindowsX64RejectsMissingImports(), TestWritePE64WindowsX64RejectsOverflowSizedRelocOffsets(), TestWritePE64WindowsX64RejectsRDataRelocTargetOutOfRange()
...
Cohesion: 0.33
Nodes (3): TestExtensionNoLongerPlannedDiagnostic(), TestExtensionRejectsDuplicateMethodName(), TestImportedExtensionStaticCallAndDocsSurface()
...
Cohesion: 0.53
Nodes (4): TestWriteMachO64MacOSX64RejectsDataRelocTargetOutOfRange(), TestWriteMachO64MacOSX64RejectsEntryOffsetOutOfRange(), TestWriteMachO64MacOSX64RejectsMissingImage(), TestWriteMachO64MacOSX64RejectsOverflowSizedDataRelocOffset()
...
Cohesion: 0.6
Nodes (3): TestReleasePostV04CompilerProductionSmokeScriptRunsExecutableValidator(), TestReleasePostV04MemoryParallelCompilerGateRunsOrderedLayerGates(), TestReleasePostV04ScopeDocsAdvertiseCompilerProductionGate()
