...
## Corpus Check
- 4465 files · ~6,369,927 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22124 nodes · 85609 edges · 1066 communities (914 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13821 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3321b7fc`
...
## Communities (1066 total, 152 thin omitted)
...
Cohesion: 0.03
Nodes (230): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+222 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (231): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+223 more)
...
Cohesion: 0.04
Nodes (169): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+161 more)
...
Cohesion: 0.04
Nodes (135): canRunLinuxX32OnHost(), probeLinuxX32Execution(), fuzzJSONArtifacts, fuzzStep, fuzzSummary, fuzzSummaryJSON, fuzzSummaryJSONStep, expectedFuzzCommand() (+127 more)
...
Cohesion: 0.03
Nodes (130): assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject(), loadLSPTranscriptFixture() (+122 more)
...
Cohesion: 0.04
Nodes (118): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+110 more)
...
Cohesion: 0.05
Nodes (126): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases() (+118 more)
...
Cohesion: 0.04
Nodes (90): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+82 more)
...
Cohesion: 0.06
Nodes (105): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultTarget() (+97 more)
...
Cohesion: 0.06
Nodes (93): TypeRefKind, resolveFieldChainLower(), assignTargetInfo, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType() (+85 more)
...
Cohesion: 0.05
Nodes (43): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), ownershipPathParent(), ownershipPathPrefix(), splitOwnershipPathSegments(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope() (+35 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke() (+77 more)
...
Cohesion: 0.05
Nodes (91): BenchmarkEnvironment, endpointIdentity, EndpointReport, GitState, formatIntSequence(), isCommandEnvAssignment(), isMatrixHarnessGoRunTarget(), isMatrixHarnessScript() (+83 more)
...
Cohesion: 0.05
Nodes (45): TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsMismatchedImplSignature(), TestGenericFunctionProtocolBoundRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsNonProtocolBound() (+37 more)
...
Cohesion: 0.08
Nodes (55): endpointKind(), endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest() (+47 more)

### Community 84 - "Community 84"
Cohesion: 0.1
Nodes (55): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+47 more)
...
Cohesion: 0.26
Nodes (14): atomicBuiltinOpPrefix, atomicBuiltinValueType, addAtomicBuiltinSigs(), atomicBuiltinAllOrders(), atomicBuiltinDiagnostic(), atomicBuiltinDiagnosticWidth(), atomicBuiltinOpPrefixes(), atomicBuiltinOrderAllowed() (+6 more)
...
Cohesion: 0.29
Nodes (11): featuresReport, formatsReport, targetReportEntryForTest(), TestTargetMetadataCheck(), atomicPointerWidthBits(), buildTargetReportEntries(), describeTargetForText(), runFeatures() (+3 more)
