...
## Corpus Check
- 4465 files · ~6,364,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22108 nodes · 85563 edges · 1075 communities (923 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13811 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `628b8952`
...
## Communities (1075 total, 152 thin omitted)
...
Cohesion: 0.02
Nodes (262): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+254 more)
...
Cohesion: 0.03
Nodes (249): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+241 more)
...
Cohesion: 0.05
Nodes (63): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+55 more)
...
Cohesion: 0.04
Nodes (124): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+116 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (127): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindMatchPatternLocalsForInference(), bindResourceFromExpr(), borrowedPtrOwnerFromExpr() (+119 more)
...
Cohesion: 0.03
Nodes (88): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+80 more)
...
Cohesion: 0.04
Nodes (84): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+76 more)
...
Cohesion: 0.07
Nodes (79): flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment(), validateFile(), validatePaths() (+71 more)
...
Cohesion: 0.06
Nodes (67): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+59 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (66): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+58 more)
...
Cohesion: 0.06
Nodes (71): TestOwnershipAllowsBorrowInoutDistinctStructFields(), TestOwnershipAllowsBorrowInoutWithDistinctLocals(), TestOwnershipAllowsBorrowToBorrowForwarding(), TestOwnershipAllowsConsumedStructFieldReassignment(), TestOwnershipAllowsConsumeInoutWithDistinctLocals(), TestOwnershipAllowsPartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsPartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipAllowsProtocolImplMatchingParameterOwnership() (+63 more)
...
Cohesion: 0.08
Nodes (9): emitCall(), emitExit(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitWrite(), guardAllocationOffsetRawAccess() (+1 more)
...
Cohesion: 0.11
Nodes (58): writeInterfaceHashOnlySurface(), AnalyzeLSPFile(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail() (+50 more)
...
Cohesion: 0.09
Nodes (53): IRInstrKind, irVerifierError(), irVerifierErrorAt(), lowerDiagnostic(), runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt() (+45 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (22): BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, LetStmt (+14 more)
...
Cohesion: 0.07
Nodes (52): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+44 more)
...
Cohesion: 0.12
Nodes (38): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+30 more)
...
Cohesion: 0.11
Nodes (24): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+16 more)
...
Cohesion: 0.2
Nodes (26): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), findCapsulePath(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+18 more)
...
Cohesion: 0.12
Nodes (5): emitAllocBytes(), emitFunc(), emitMakeSlice(), emitMMIOWriteI32(), patchExitBranch()
...
Cohesion: 0.26
Nodes (20): countCallsNamed(), hasCall(), lowerProgramForCatchTest(), programFuncNames(), programHasFunc(), requireIRFunc(), TestLowerCatchHandlerCollectsStagedTypedTaskWrapper(), TestLowerMatchExprCollectsStagedTypedTaskWrapper() (+12 more)
