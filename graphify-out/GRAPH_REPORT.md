...
## Corpus Check
- 4465 files · ~6,502,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22042 nodes · 85362 edges · 1072 communities (918 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13771 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fee2c36d`
...
## Communities (1072 total, 154 thin omitted)
...
Cohesion: 0.02
Nodes (243): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+235 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (242): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+234 more)
...
Cohesion: 0.04
Nodes (95): FormatPos(), budgetCharge, importedFunctionTargetFromExpr(), deferFrame, inoutReturnLocal, inoutWriteback, loopLabels, budgetChargedInstr() (+87 more)
...
Cohesion: 0.02
Nodes (149): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+141 more)
...
Cohesion: 0.04
Nodes (145): BuildOptions, multiValue, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost() (+137 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (155): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+147 more)
...
Cohesion: 0.04
Nodes (81): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+73 more)
...
Cohesion: 0.06
Nodes (102): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), collectExprLocals(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect() (+94 more)
...
Cohesion: 0.04
Nodes (87): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+79 more)
...
Cohesion: 0.04
Nodes (40): AssignStmt, BinaryExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+32 more)
...
Cohesion: 0.12
Nodes (59): hasPrefix(), apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs() (+51 more)
...
Cohesion: 0.05
Nodes (19): AwaitExpr, BoolLitExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr (+11 more)
...
Cohesion: 0.1
Nodes (55): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+47 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (57): isSupportedEcoPublishChannel(), attachEcoPublishTrust(), availableEcoPackageTargets(), buildEcoPublishMetadata(), capsuleIDDirectory(), decodeEcoPublishMetadata(), downloadPackage(), ecoPublishDownloadPath() (+49 more)
...
Cohesion: 0.08
Nodes (45): InterfaceFingerprintFromSource(), InterfaceFingerprintFromT4I(), TestInterfaceFingerprintFromSourceIsPublicAPIStable(), TestInterfaceFingerprintFromSourceTracksHashOnlyPublicSurface(), containsMovEaxImm32(), emitObjectHasSymbol(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryLinuxX32BuildsI64AndWeakAtomicObject() (+37 more)
...
Cohesion: 0.08
Nodes (36): LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports() (+28 more)
...
Cohesion: 0.07
Nodes (46): BenchmarkEnvironment, EndpointReport, GitState, parseMatrixResourceTimestamp(), requiredMatrixSemanticProbeNames(), validateMatrixBuild(), validateMatrixPostgres(), ValidateMatrixReport() (+38 more)
...
Cohesion: 0.08
Nodes (34): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+26 more)
...
Cohesion: 0.15
Nodes (26): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+18 more)
...
Cohesion: 0.17
Nodes (17): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), Lower(), LowerModule(), LowerModules() (+9 more)
...
Cohesion: 0.18
Nodes (18): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+10 more)

### Community 213 - "Community 213"
Cohesion: 0.28
Nodes (19): IATReloc, BuildImportSection(), buildRelocSection(), importKey(), normalizeImportKey(), parseImportName(), patchRipDisp32(), validDisp32PatchOffset() (+11 more)
