...
## Corpus Check
- 4465 files · ~6,360,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22102 nodes · 85541 edges · 1060 communities (909 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13806 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6017f5ab`
...
## Communities (1060 total, 151 thin omitted)
...
Cohesion: 0.01
Nodes (413): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+405 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (466): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), releaseV10GateFakeRepo(), assertReleaseV10RejectsNonDirectoryReportPath(), releaseV10MinimalGateRoot(), TestReleaseV10GateAcceptsDashPrefixedFreshReportDirBeforeBootstrapSentinel(), TestReleaseV10GateAcceptsDashPrefixedSecuritySignoff() (+458 more)
...
Cohesion: 0.03
Nodes (242): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindMatchPatternLocalsForInference() (+234 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (205): BuildMacOSX64(), TestActorDeclarationSpawnBuildAndRunBuiltinRuntime(), TestActorsPingPongBuildAndRunBuiltinRuntime(), TestActorsPingPongBuildAndRunSelfHostRuntime(), TestActorsPingPongRuntimeModeParity(), TestActorsTaggedStressBuildAndRunWithBothRuntimes(), TestArrayMVPWasmBuildSmoke(), assertModules() (+197 more)
...
Cohesion: 0.03
Nodes (141): branchScopeInfo, appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindResourceFromExpr(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr() (+133 more)
...
Cohesion: 0.03
Nodes (153): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+145 more)
...
Cohesion: 0.05
Nodes (130): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+122 more)
...
Cohesion: 0.05
Nodes (123): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+115 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (113): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+105 more)
...
Cohesion: 0.05
Nodes (115): atomicIRTargetInfo(), TestAtomicIRTargetInfoUsesX32PointerWidth(), TestX86RejectsI64AtomicWithTargetDiagnostic(), targetAtomicDiagnostic(), validateTargetAtomicIR(), atomicIRInfo, BuildStats, checkedBuildWorld (+107 more)
...
Cohesion: 0.05
Nodes (91): runAPIDocsValidator(), TestValidateAPIDocsAcceptsGeneratedShape(), TestValidateAPIDocsRejectsAPIMetadataHashMismatch(), TestValidateAPIDocsRejectsBrokenInternalLink(), TestValidateAPIDocsRejectsDuplicateModules(), TestValidateAPIDocsRejectsEmptyDocument(), TestValidateAPIDocsRejectsEntryBeforeSection(), TestValidateAPIDocsRejectsErrorOutput() (+83 more)
...
Cohesion: 0.04
Nodes (89): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+81 more)
...
Cohesion: 0.06
Nodes (75): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+67 more)
...
Cohesion: 0.05
Nodes (39): AssignStmt, itoa(), BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+31 more)
...
Cohesion: 0.06
Nodes (40): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64() (+32 more)
...
Cohesion: 0.06
Nodes (56): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+48 more)
...
Cohesion: 0.09
Nodes (43): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+35 more)
...
Cohesion: 0.16
Nodes (22): ClosureCapture, captureMode, cloneBoolMap(), copySecretTaintMap(), mergeLoopFlowExits(), recordLoopFlowExit(), addPatternCaptureBindings(), appendClosureCaptureArgs() (+14 more)
