...
## Corpus Check
- 4465 files · ~6,490,428 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22016 nodes · 85262 edges · 1075 communities (922 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13743 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3be2c213`
...
## Communities (1075 total, 153 thin omitted)
...
Cohesion: 0.01
Nodes (428): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode() (+420 more)
...
Cohesion: 0.03
Nodes (234): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+226 more)
...
Cohesion: 0.04
Nodes (170): FormatPos(), resolveFieldChainLower(), runPlatformWindowProbe(), runPlatformWindowProbe(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin() (+162 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (158): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+150 more)
...
Cohesion: 0.03
Nodes (146): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+138 more)
...
Cohesion: 0.04
Nodes (159): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+151 more)
...
Cohesion: 0.04
Nodes (129): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+121 more)
...
Cohesion: 0.05
Nodes (117): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+109 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (67): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+59 more)
...
Cohesion: 0.04
Nodes (97): TestActorSpawnsTaskAndReceivesCompletionBuildAndRun(), TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses() (+89 more)
...
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedEnumPayloadAliasSmoke(), TestBuildFunctionTypedEnumPayloadCapturedClosureFromReturnedEnumSmoke() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke() (+90 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (90): cliProjectContext, dependencyArtifactBuildOptions(), buildCapsuleArtifacts(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), FuzzParseCapsuleDoesNotPanic(), writeEcoLock(), appendCapsuleArtifact() (+82 more)
...
Cohesion: 0.08
Nodes (75): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures(), collectDeferCaptures() (+67 more)
...
Cohesion: 0.05
Nodes (65): TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType(), TestActorDeclarationRejectsUnsupportedStateFieldType() (+57 more)
...
Cohesion: 0.09
Nodes (40): decodeStrictJSON(), main(), TestValidateProjectDepsReportAcceptsCheckFailReport(), TestValidateProjectDepsReportAcceptsCheckPassReport(), TestValidateProjectDepsReportAcceptsListReport(), TestValidateProjectDepsReportRejectsBadDependencyFields(), TestValidateProjectDepsReportRejectsFailWithoutIssue(), TestValidateProjectDepsReportRejectsInvalidTopLevelStatus() (+32 more)
...
Cohesion: 0.08
Nodes (34): TestELFLinuxLayoutStaysInSyncWithWriter(), alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage() (+26 more)
...
Cohesion: 0.12
Nodes (29): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+21 more)
...
Cohesion: 0.15
Nodes (28): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+20 more)

### Community 154 - "Community 154"
Cohesion: 0.11
Nodes (29): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+21 more)
...
Cohesion: 0.18
Nodes (22): decodeStrictJSON(), main(), readTargetsReport(), TestReadTargetsReportDefaultsToTargetsCommand(), TestReadTargetsReportReportsTargetsCommandFailure(), TestValidateRunContractAcceptsHostProbedBuildOnly(), TestValidateTargetsReportAcceptsExpectedShape(), TestValidateTargetsReportAcceptsMissingWASIRunner() (+14 more)
...
Cohesion: 0.6
Nodes (5): assertPtrOptionalPayloadCallDiagnostic(), ptrOptionalPayloadCallBody(), ptrOptionalPayloadCallEscapeSource(), ptrOptionalPayloadSinkSource(), TestSafetyDiagnosticCodesForPtrOptionalPayloadCallRejections()
