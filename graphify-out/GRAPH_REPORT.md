# Graph Report - v0.4.0-final-production  (2026-05-20)

## Corpus Check
- 2626 files · ~2,787,217 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16874 nodes · 68441 edges · 453 communities (376 shown, 77 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 12393 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b003947f`
...
- `runFormats()` --calls--> `T4 Formats`  [INFERRED]
  /home/tetra/Desktop/Projects/Tetra_Language/cli/cmd/tetra/metadata.go → docs/spec/t4_formats.md
- `BuildFile()` --calls--> `TestBuildWindowsPEMmio()`  [INFERRED]
  /home/tetra/Desktop/Projects/Tetra_Language/compiler/compiler.go → compiler/pe_test.go
- `BuildFile()` --calls--> `TestX64BuildOnlySmokeAcrossNativeTargets()`  [INFERRED]
  /home/tetra/Desktop/Projects/Tetra_Language/compiler/compiler.go → compiler/x64_abi_test.go
- `TestX64ABICallsZeroThroughTenArgs()` --calls--> `buildAndRun()`  [INFERRED]
  compiler/x64_abi_test.go → /home/tetra/Desktop/Projects/Tetra_Language/compiler/compiler_test.go
- `TestBuildConstGlobalSmoke()` --calls--> `buildAndRun()`  [INFERRED]
  compiler/const_test.go → /home/tetra/Desktop/Projects/Tetra_Language/compiler/compiler_test.go

## Communities (453 total, 77 thin omitted)
...
Cohesion: 0.02
Nodes (349): TestELFHasRWDataSegmentAndStringNotInText(), GenerateInterfaceFile(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes() (+341 more)
...
Cohesion: 0.02
Nodes (232): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK(), TestBuildAsyncSmoke(), TestBuildBoolBranchSmoke() (+224 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (202): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), bindPatternSecretTaintLocals(), bindResourceTreeFromPathOrUnknown() (+194 more)
...
Cohesion: 0.03
Nodes (157): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+149 more)
...
Cohesion: 0.04
Nodes (133): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+125 more)
...
Cohesion: 0.05
Nodes (100): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+92 more)
...
Cohesion: 0.1
Nodes (93): hasPrefix(), resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), checkStmts(), collectionElementType(), collectLocals() (+85 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (80): FormatPos(), resolveFieldChainLower(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), functionTypedClosureAssignmentTargetPhrase(), functionTypedClosureCaptureBoundaryPhrase() (+72 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (92): capsuleArtifact, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand(), artifactSlug() (+84 more)
...
Cohesion: 0.05
Nodes (74): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+66 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (85): builtinCapsulePermission(), builtinNeedsUnsafe(), appendResourceProvenance(), bindCatchErrorResourceSummary(), bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), mergeResourceSourceResults(), recordTryCallThrowResourceSummary() (+77 more)

### Community 54 - "Community 54"
Cohesion: 0.1
Nodes (86): buildSysVUnixX64(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi(), clampEdiNonNegativeIntoEcx() (+78 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (79): artifactCheck, fakeFileInfo, fileInfo, freshnessCheck, gateEvidenceReport, generatedArtifactsReport, generatedEvidenceRule, gitStatusClassification (+71 more)
...
Cohesion: 0.08
Nodes (75): main(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry() (+67 more)
...
Cohesion: 0.1
Nodes (69): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches(), interfaceAggregateReturnFromStmts() (+61 more)
...
Cohesion: 0.08
Nodes (55): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOptions(), defaultTarget(), discoverWASIRunner(), discoverWebRunner() (+47 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (57): ActorStateField, TestEnsureTypeInfoArrayRejectsUnsupportedSubset(), TestEnsureTypeInfoArraySupportedSubset(), TestClassifyCallableEscapeRejectsMutableCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeRejectsMutableEscapingCapture(), TestClassifyCallableEscapeRejectsResourceCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeUsesFnptrForBoundedLocalSnapshot(), TestClassifyCallableEscapeUsesHandleForOversizedReturn() (+49 more)
...
Cohesion: 0.12
Nodes (51): firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures(), cloneExpr() (+43 more)

### Community 68 - "Community 68"
Cohesion: 0.12
Nodes (4): importedFunctionTargetFromExpr(), isNoneExpr(), isTypedTaskJoinCall(), lowerer
...
Cohesion: 0.1
Nodes (48): assignTargetInfo, ResolveBuiltinAlias(), bindMatchPatternLocalsForInference(), catchExprHasCompleteEnumPatterns(), catchPatternType(), cloneLocalMap(), collectExprLocals(), collectPatternLocals() (+40 more)
...
Cohesion: 0.14
Nodes (18): formatFuncSigDecl(), formatTypeRef(), sourcePrinter, ActorDecl, CapsuleDecl, EnumDecl, ExtensionDecl, FuncDecl (+10 more)
...
Cohesion: 0.1
Nodes (49): IRInstrKind, runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt(), matchesBudgetGuardBefore(), matchesBudgetInitializerAt(), matchesConsentGuardAt() (+41 more)
...
Cohesion: 0.17
Nodes (43): checkCallableProgram(), countCall(), countCallableClosureCalls(), countCallableKind(), countInstr(), countStoresAfterCalls(), lowerCallableFileProgram(), lowerCallableFunc() (+35 more)
...
Cohesion: 0.11
Nodes (36): FuzzLexer(), FuzzParser(), lspDiagnostic, lspHover, lspSmokeEnvelope, lspSymbol, main(), strictDecodeJSON() (+28 more)
...
Cohesion: 0.09
Nodes (41): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+33 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (31): budgetCharge, deferFrame, loopLabels, budgetChargedInstr(), budgetChargeForInstr(), clauseConstI32(), collectStagedTypedTaskTargets(), collectTypedTaskWrappers() (+23 more)
...
Cohesion: 0.1
Nodes (27): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64(), LoadWorld() (+19 more)
...
Cohesion: 0.15
Nodes (29): CodegenOptions, AlignStackSize(), TestABIAlignStackSize(), TestObjectPatchRel32ForwardAndBackward(), TestObjectPatchRel32RejectsInvalidPatchOffsets(), TestObjectPatchRel32RejectsOutOfRangeTargets(), LinuxSysV(), NewEmitFunc() (+21 more)
...
Cohesion: 0.12
Nodes (25): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+17 more)
...
Cohesion: 0.1
Nodes (24): TestBuildRejectsInterfaceImplementationMissingSymbol(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+16 more)
...
Cohesion: 0.13
Nodes (28): AnalyzeLSPFile(), AnalyzeLSPSource(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail() (+20 more)
...
Cohesion: 0.16
Nodes (24): BuildSigMap(), BuildTypeSigMap(), cacheDir(), cacheKey(), cachePath(), DepSigHashFromDeps(), DepSigHashFromDepsWithInterfaceHashes(), formatFuncSig() (+16 more)
...
Cohesion: 0.14
Nodes (22): DataDisp32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects(), readI32LE(), TestCollectImportsSortsAndDedupes(), TestLinkX64ObjectsCollectsDataRelocs() (+14 more)
...
Cohesion: 0.13
Nodes (6): CodegenObjectMacOSX64(), CodegenObjectMacOSX64WithOptions(), CodegenObjectMacOSX64WithOptionsAndDataPrefix(), MacSysV(), SysVUnix, Win64

### Community 141 - "Community 141"
Cohesion: 0.14
Nodes (21): callPatch, importPatch, leaPatch, validateRuntimeEntrySymbols(), BuildObject(), BuildObjectWithDataPrefix(), TestObjectBuildCollectsRelocsAndSymbols(), TestObjectBuildRejectsDuplicateSymbols() (+13 more)
...
Cohesion: 0.22
Nodes (21): assertFrame(), dialTestNode(), readTestFrame(), startTestBroker(), TestBrokerReportsNodeDownForMissingDestination(), TestBrokerRoutesFramesBetweenLoopbackNodesAndWritesReport(), TestClosedConnectionErrorsIncludePeerReset(), writeTestFrame() (+13 more)
...
Cohesion: 0.17
Nodes (19): emitX64ReturnSlotPushes(), TestX64ABICallsZeroThroughTenArgs(), TestX64ABIReturnSlotsThreeAndFourRegisterMapping(), TestX64BuildOnlySmokeAcrossNativeTargets(), x64ReturnSlotName(), argCountName(), emitReturnSlotPushes(), hasImportPatch() (+11 more)
...
Cohesion: 0.24
Nodes (16): BuiltinManifest, Manifest, RuntimeManifest, TargetManifest, BuiltinManifest, builtinFuncSigs(), builtinEffects(), DescribeBuiltins() (+8 more)
...
Cohesion: 0.22
Nodes (18): decodeStrictJSON(), main(), TestValidateTargetsReportAcceptsExpectedShape(), TestValidateTargetsReportAcceptsMissingWASIRunner(), TestValidateTargetsReportRejectsDuplicate(), TestValidateTargetsReportRejectsLinuxHostNativeMarkedUnsupported(), TestValidateTargetsReportRejectsMissingMetadata(), TestValidateTargetsReportRejectsMissingStatus() (+10 more)
...
Cohesion: 0.27
Nodes (15): Frame, DecodeFrame(), DecodeRemoteHandle(), EncodeFrame(), EncodeRemoteHandle(), isKnownFrameType(), IsRemoteHandle(), TestDecodeRejectsBadHeaderAndInvalidSlotCount() (+7 more)
...
Cohesion: 0.23
Nodes (13): RequiredActorStateSymbols(), RequiredActorSymbols(), RequiredDistributedActorSymbols(), RequiredFilesystemSymbols(), RequiredTaskGroupSymbols(), RequiredTaskSymbols(), RequiredTimeSymbols(), RequiredTypedTaskSymbols() (+5 more)
...
Cohesion: 0.4
Nodes (11): bodyPrefix(), hasSymbol(), symbolBody(), TestActorNetPumpIsExportedButOnlyLinuxHasRuntimePump(), TestBuiltinRuntimeExportsActorStateSymbols(), TestLinuxDistributedRuntimeUsesWideStackSubFor128ByteFrames(), TestLinuxRuntimeExportsDistributedActorSymbols(), TestLinuxRuntimeExportsFilesystemSymbol() (+3 more)

### Community 260 - "Community 260"
Cohesion: 0.28
Nodes (9): alignUp(), LinuxX64Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF64LinuxX64RejectsEntryOffsetOutOfRange(), TestWriteELF64LinuxX64RejectsMissingImage(), WriteELF64LinuxX64(), writeLE(), Image (+1 more)
...
Cohesion: 0.46
Nodes (6): emitObjectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain()
...
Cohesion: 0.46
Nodes (8): actorGroupPtrFromEaxToRdi(), emitSpawn(), emitTaskSpawnGroupI32(), emitTaskSpawnI32(), emitTaskSpawnI32To(), setPendingSpawnGroupFromEdx(), storeActorGroupForHandleInRaxGroupInRdx(), storeActorSavedGroupForActorPtrInRdiGroupInRdx()
...
## Knowledge Gaps
- **240 isolated node(s):** `runtimeCallSig`, `RuntimeCallSignature`, `elfProgramHeader`, `machoSection`, `machoInfo` (+235 more)
