...
## Corpus Check
- 4465 files · ~6,518,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22083 nodes · 85474 edges · 1071 communities (920 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13791 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfcd2400`
...
Cohesion: 0.03
Nodes (268): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+260 more)
...
Cohesion: 0.03
Nodes (179): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+171 more)
...
Cohesion: 0.04
Nodes (148): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+140 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (139): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+131 more)
...
Cohesion: 0.04
Nodes (127): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+119 more)
...
Cohesion: 0.05
Nodes (117): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultTarget() (+109 more)
...
Cohesion: 0.08
Nodes (114): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+106 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (99): TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes() (+91 more)
...
Cohesion: 0.05
Nodes (42): branchScopeInfo, borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree() (+34 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+77 more)
...
Cohesion: 0.07
Nodes (86): resolveFieldChainLower(), assignTargetInfo, ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion(), borrowedOwnerFromExpr() (+78 more)
...
Cohesion: 0.06
Nodes (76): validateWorkspaceReportFormat(), decodeStrictJSON(), main(), TestValidateProjectDepsReportAcceptsCheckFailReport(), TestValidateProjectDepsReportAcceptsCheckPassReport(), TestValidateProjectDepsReportAcceptsListReport(), TestValidateProjectDepsReportRejectsBadDependencyFields(), TestValidateProjectDepsReportRejectsFailWithoutIssue() (+68 more)
...
Cohesion: 0.05
Nodes (70): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+62 more)
...
Cohesion: 0.06
Nodes (63): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+55 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, IslandStmt, LetStmt (+14 more)
...
Cohesion: 0.11
Nodes (35): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+27 more)
...
Cohesion: 0.12
Nodes (30): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+22 more)
...
Cohesion: 0.07
Nodes (37): API Diff Docs Snapshot (hash 0966...ca390), api diff no-change step, API Docs Snapshot (hash 623d...53917), API Docs Snapshot (hash 09e8...50e66), API Hash sha256:0966... (81 modules, 226 entries), API Hash sha256:09e8... (83 modules, 228 entries), API Hash sha256:623d... (49 modules, 97 entries), Release Artifact tetra.release.v0_2_0.test-all-summary.v1 (+29 more)
...
Cohesion: 0.21
Nodes (18): BuiltinManifest, Manifest, manifestAtomicPointerWidthBits(), RuntimeManifest, TargetManifest, BuiltinManifest, builtinEffects(), DescribeBuiltins() (+10 more)
...
Cohesion: 0.2
Nodes (17): atomicBuiltinOpPrefix, atomicBuiltinValueType, addAtomicBuiltinSigs(), atomicBuiltinAllOrders(), atomicBuiltinDiagnostic(), atomicBuiltinDiagnosticWidth(), atomicBuiltinOpPrefixes(), atomicBuiltinOrderAllowed() (+9 more)
...
Cohesion: 0.24
Nodes (10): Web UI Smoke DOM (test-all-20260429-145050), Tetra UI Schema v1, Security Evidence Web UI DOM, Web UI Smoke DOM (v0.3-stabilization), WaveB Stabilization Web UI Smoke DOM, WaveB Gate Test-All Web UI Smoke DOM, WaveD Reviewer Test-All Web UI Smoke DOM, WaveD Web UI Smoke Contract (+2 more)
...
Cohesion: 0.43
Nodes (7): WaveD v0.3 Gate Recovery, WaveD Reviewer v0.3 Gate Summary, WaveD Reviewer v0.3 Gate Release State, WaveD Stabilization Summary, WaveD Stabilization Tetra Docs, WaveD v0.3 Gate Release State, WaveD v0.3 Gate Summary
