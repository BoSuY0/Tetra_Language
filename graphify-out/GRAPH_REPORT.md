...
## Corpus Check
- 4465 files · ~6,510,865 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22068 nodes · 85429 edges · 1058 communities (905 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13780 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c36302f4`
...
Cohesion: 0.01
Nodes (328): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+320 more)
...
Cohesion: 0.02
Nodes (205): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+197 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (205): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), capsulePermissionEntry() (+197 more)
...
Cohesion: 0.03
Nodes (165): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildAndRunFile(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+157 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (147): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+139 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (149): canRunLinuxX32OnHost(), probeLinuxX32Execution(), hashedArtifact, hashManifest, decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths() (+141 more)
...
Cohesion: 0.05
Nodes (113): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultOutput() (+105 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (105): AnalyzeLSPFile(), AnalyzeLSPSource(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPSourceActorDeclarationDiagnostic(), TestAnalyzeLSPSourceImportedFileDoesNotReportMissingWorkspace(), TestAnalyzeLSPSourcePrivacyConsentDiagnosticCode(), TestAnalyzeLSPSourceRecursiveSecretSignatureDiagnosticCode(), TestAnalyzeLSPSourceSemanticDiagnostics() (+97 more)
...
Cohesion: 0.05
Nodes (88): Column, Conn, Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, Frame (+80 more)
...
Cohesion: 0.05
Nodes (45): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+37 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (88): TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes() (+80 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (99): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+91 more)
...
Cohesion: 0.06
Nodes (80): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+72 more)
...
Cohesion: 0.09
Nodes (70): TypeRefKind, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures() (+62 more)
...
Cohesion: 0.05
Nodes (68): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), featuresReport, formatsReport (+60 more)
...
Cohesion: 0.1
Nodes (6): isNoneExpr(), lowerCallExprWithBuiltinAlias(), lowerCallExprWithName(), lowerer, IsTypedTaskHandleTypeName(), TypedTaskHandleTypesCompatible()
...
Cohesion: 0.07
Nodes (64): TestArrayMVPCheckAcceptsIndexAndForOnFixedArray(), TestOwnershipAllowsBorrowInoutWithDistinctLocals(), TestOwnershipAllowsConsumeInoutWithDistinctLocals(), TestOwnershipAllowsProtocolImplMatchingParameterOwnership(), TestOwnershipAllowsWholeStructConsume(), TestOwnershipAllowsWholeStructReassignmentAfterPartialFieldConsume(), checkEffectsFileProgram(), checkEffectsProgram() (+56 more)

### Community 78 - "Community 78"
Cohesion: 0.06
Nodes (63): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+55 more)
...
Cohesion: 0.1
Nodes (52): FormatPos(), rejectMutableGlobalFunctionCaptures(), unsupportedGlobalFunctionCaptureStorageError(), unsupportedGlobalFunctionMutableCaptureStorageError(), unsupportedGlobalFunctionParameterStorageError(), validateFunctionTypeClosurePointerAssignment(), validateFunctionTypeClosurePointerBinding(), validateFunctionTypedReturnCallAssignment() (+44 more)
...
Cohesion: 0.09
Nodes (52): appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+44 more)
...
Cohesion: 0.09
Nodes (40): TestEmitTaskJoinTypedSlotBounds(), TestEmitTaskJoinTypedWrapperWindowsX64SlotBounds(), budgetCharge, deferFrame, inoutReturnLocal, inoutWriteback, loopLabels, budgetChargedInstr() (+32 more)
...
Cohesion: 0.16
Nodes (28): ClosureCapture, captureMode, bindMatchPatternLocalsForInference(), cloneBoolMap(), cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType() (+20 more)
...
Cohesion: 0.13
Nodes (27): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+19 more)
...
Cohesion: 0.16
Nodes (23): resolveFieldChainLower(), assignTargetInfo, collectImportAliases(), ensureFuncVisible(), ensureTypeVisible(), TestCheckWorldRejectsDuplicateInterfaceFunctionParams(), TestResolutionDiagnosticForInvalidAliasCallShape(), TestResolutionDisplayTextForEnumCaseUsesLocalTypeName() (+15 more)
...
Cohesion: 0.14
Nodes (21): isOwnershipAuditSeparatorRow(), main(), normalizeOwnershipAuditStatus(), ownershipAuditSection(), parseOwnershipAuditRows(), parseOwnershipAuditStatus(), splitOwnershipAuditTableRow(), replaceOwnershipAuditRowEvidence() (+13 more)
