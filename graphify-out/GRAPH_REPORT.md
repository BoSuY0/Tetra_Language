...
## Corpus Check
- 595 files · ~1,164,307 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18546 nodes · 73021 edges · 495 communities (417 shown, 78 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 13522 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be39ab2a`
...
- `GenerateAPIDocs()` --calls--> `BenchmarkGenerateAPIDocsDogfoodProjects()`  [INFERRED]
  /home/tetra/Desktop/Projects/Tetra_Language/compiler/docs.go → compiler/performance_benchmark_test.go
...
## Communities (495 total, 78 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (522): buildAndRun(), buildAndRunFiles(), TestBuildImportedGlobalOnlyModuleSmoke(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+514 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (363): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+355 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (405): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget() (+397 more)
...
Cohesion: 0.02
Nodes (244): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+236 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (238): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+230 more)
...
Cohesion: 0.02
Nodes (185): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+177 more)
...
Cohesion: 0.04
Nodes (126): TestSelfHostRuntimeObjectsExportRequiredSymbols(), requiredActorRuntimeSymbols(), requiredActorStateRuntimeSymbols(), requiredFilesystemRuntimeSymbols(), requiredTaskGroupRuntimeSymbols(), requiredTaskRuntimeSymbols(), requiredTimeRuntimeSymbols(), requiredTypedTaskRuntimeSymbols() (+118 more)
...
Cohesion: 0.08
Nodes (104): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+96 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+90 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke() (+77 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (85): resolveFieldChainLower(), assignTargetInfo, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds() (+77 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (93): bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindResourceFromExpr(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr(), borrowedPtrOwnerFromExpr(), copyResourceTreeFromPath(), joinResourcePath() (+85 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (39): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree(), constructorRegionFromTree() (+31 more)
...
Cohesion: 0.04
Nodes (83): benchLevel, benchmarkEnvironment, buildEvidence, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState, latencyStats (+75 more)
...
Cohesion: 0.09
Nodes (69): TestLowerCoreAtomicI32BuiltinsToIR(), TestLowerCoreAtomicI64AndWeakCompareExchangeBuiltinsToIR(), TestLowerCoreAtomicSmallAndPointerBuiltinsToIR(), TestLowerCoreAtomicWeakCompareExchangeReportsExplicitDiagnostic(), checkCallableProgram(), countCall(), countCallableClosureCalls(), countCallableKind() (+61 more)
...
Cohesion: 0.04
Nodes (41): AssignStmt, itoa(), BreakStmt, CapsuleEntryDecl, CatchExpr, CatchExprCase, ContinueStmt, DeferStmt (+33 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (68): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+60 more)
...
Cohesion: 0.08
Nodes (69): main(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry() (+61 more)
...
Cohesion: 0.09
Nodes (69): runLSPStdio(), assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject() (+61 more)
...
Cohesion: 0.09
Nodes (35): countingRWC, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections(), TestNewTechEmpowerServerAppliesConfigAndRoutes(), TestRegisterTechEmpowerRoutesMountsAllEndpoints() (+27 more)
...
Cohesion: 0.09
Nodes (45): extractTetraDoctests(), releaseTruthDocExcluded(), TestCurrentReleaseTruthDocPathsCoverCurrentUserAndSpecDocs(), TestExtractTetraDoctestsParsesCommentFence(), TestVerifyDoctestBlocks(), TestVerifyDoctestBlocksRejectsUnterminatedBlock(), TestVerifyEpic14ExampleIndexAcceptsRequiredCoverage(), TestVerifyEpic14ExampleIndexRejectsMissingEntry() (+37 more)
...
Cohesion: 0.09
Nodes (39): Fortune, AppendEscaped(), RenderFortunes(), FuzzAppendEscapedRemovesRawHTMLSpecials(), TestAppendEscapedEscapesHTMLSpecialsAndPreservesUTF8(), TestRenderFortunesSortsByMessageAndEscapesMessages(), appendEscapedByte(), AppendMessageObject() (+31 more)
...
Cohesion: 0.1
Nodes (36): apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader(), writeFileAPIDocs() (+28 more)
...
Cohesion: 0.17
Nodes (35): capsuleSectionHeader(), writeEcoLock(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), checkProjectLockOnly(), checkProjectSync(), describeProjectDependency() (+27 more)
...
Cohesion: 0.11
Nodes (24): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LoadWorld() (+16 more)

### Community 140 - "Community 140"
Cohesion: 0.12
Nodes (24): importPatch, CodegenObjectMacOSX64(), CodegenObjectMacOSX64WithOptions(), CodegenObjectMacOSX64WithOptionsAndDataPrefix(), MacSysV(), BuildObject(), BuildObjectWithDataPrefix(), TestObjectBuildCollectsRelocsAndSymbols() (+16 more)
...
Cohesion: 0.11
Nodes (30): requireLinuxX86Execution(), requireLocalTCPBind(), requireX32ExecutableFile(), TestExecWebProgramWithBrowserRunnerParsesBrowserExitResult(), TestExecWebProgramWithRunnerParsesBrowserExitResult(), TestRunCommandJSONDiagnosticsForHostTargetMismatch(), TestRunCommandJSONDiagnosticsForLinuxX32HostUnsupported(), TestRunCommandJSONDiagnosticsForWASMWebRuntimeUnsupported() (+22 more)
...
Cohesion: 0.14
Nodes (23): TestValidateReportAcceptsLinuxX64ParallelProductionEvidence(), TestValidateReportRejectsMissingCompletionAudit(), TestValidateReportRejectsMissingParallelEdgeCases(), TestValidateReportRejectsMissingRequiredLifecycleCases(), TestValidateReportRejectsMissingSafeUnsafeForbiddenBoundaryCoverageCase(), TestValidateReportRejectsMissingStableParallelDiagnosticsAudit(), TestValidateReportRejectsPaperOnlyParallelEvidence(), validParallelProductionReport() (+15 more)

### Community 157 - "Community 157"
Cohesion: 0.22
Nodes (25): makePublishFixture(), runPublishValidator(), runPublishValidatorWithChannel(), TestValidateEcoPublishAcceptsStableMetadata(), TestValidateEcoPublishAcceptsValidMetadata(), TestValidateEcoPublishRejectsDownloadPathMismatch(), TestValidateEcoPublishRejectsHashMismatch(), TestValidateEcoPublishRejectsTrustSnapshotHashMismatch() (+17 more)
...
Cohesion: 0.28
Nodes (17): emitActorNetPump(), emitActorNodeConnect(), emitActorSpawnRemote(), emitActorWireControlFrame(), emitLeaRdiRspDisp(), emitLeaRsiRspDisp(), emitMovEaxRspDisp(), emitMovMem16RspDispAx() (+9 more)
...
Cohesion: 0.61
Nodes (7): TestValidateReadinessBlockersAcceptsBlockedV040Artifact(), TestValidateReadinessBlockersRejectsEmptyBlockers(), TestValidateReadinessBlockersRejectsUnknownFields(), TestValidateReadinessBlockersRejectsUnsafeSourceLog(), TestValidateReadinessBlockersRejectsWrongVersion(), writeReadinessBlockers(), validateReadinessBlockersFile()
