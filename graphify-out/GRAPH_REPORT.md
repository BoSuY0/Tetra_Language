...
## Corpus Check
- 620 files · ~1,271,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18669 nodes · 73301 edges · 510 communities (431 shown, 79 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13534 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44848260`
...
## Communities (510 total, 79 thin omitted)
...
Cohesion: 0.01
Nodes (409): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+401 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (301): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+293 more)
...
Cohesion: 0.03
Nodes (212): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary(), bindPatternSecretTaintLocals() (+204 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (194): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+186 more)
...
Cohesion: 0.03
Nodes (170): BuildMacOSX64(), TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc() (+162 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (161): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+153 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (158): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot() (+150 more)
...
Cohesion: 0.04
Nodes (127): releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind(), TestReleaseV10APIDiffRejectsMissingBaselineBeforeDocsWork() (+119 more)
...
Cohesion: 0.08
Nodes (119): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType() (+111 more)
...
Cohesion: 0.04
Nodes (48): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+40 more)
...
Cohesion: 0.07
Nodes (87): appendResourceProvenance(), bindFreshResourceTree(), bindResourceFromExpr(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr(), bindResourceTreeFromPathOrUnknown(), borrowedPtrOwnerFromExpr(), copyResourceTreeFromPath() (+79 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (81): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+73 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (86): assertActorAliasTransferDiagnostic(), assertActorTaskOptionalPayloadAliasTransferDiagnostic(), assertBorrowedNestedSliceEnumPayloadDiagnostic(), assertBorrowedNestedSliceStructDiagnostic(), assertBorrowedPtrAggregateGlobalFieldDiagnostic(), assertBorrowedPtrAggregateOptionalGlobalAssignmentDiagnostic(), assertBorrowedPtrAggregateReturnDiagnostic(), assertBorrowedPtrEnumAliasReturnDiagnostic() (+78 more)
...
Cohesion: 0.1
Nodes (64): resolveCallSigForInference(), firstCapture(), unsupportedGenericClosureCaptureError(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds() (+56 more)
...
Cohesion: 0.1
Nodes (66): validateDiagnosticsMode(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers(), encodeWorkspaceJSON() (+58 more)
...
Cohesion: 0.1
Nodes (5): importedFunctionTargetFromExpr(), isNoneExpr(), lowerer, IsTypedTaskHandleTypeName(), TypedTaskHandleTypesCompatible()

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (57): BuiltinManifest, Manifest, manifestAtomicPointerWidthBits(), RuntimeManifest, TargetManifest, buildWasmTargets(), runWasmWebMainWithNode(), TestWasmBuildOnlyCallableAliasSmoke() (+49 more)
...
Cohesion: 0.11
Nodes (56): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+48 more)
...
Cohesion: 0.1
Nodes (46): FormatPos(), unsupportedGlobalFunctionCaptureStorageError(), unsupportedGlobalFunctionMutableCaptureStorageError(), unsupportedGlobalFunctionParameterStorageError(), validateSemanticClauses(), diagnosticError, budgetDiagnosticf(), effectDiagnosticf() (+38 more)
...
Cohesion: 0.1
Nodes (42): TypeRefKind, resolveFieldChainLower(), assignTargetInfo, cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), validateGenericFuncDecl() (+34 more)
...
Cohesion: 0.12
Nodes (33): apiDocTitle(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), disambiguatedAPIDocTitles(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+25 more)
...
Cohesion: 0.11
Nodes (36): TestCurrentReleaseTruthDocPathsCoverCurrentUserAndSpecDocs(), TestExtractTetraDoctestsParsesCommentFence(), TestVerifyDoctestBlocks(), TestVerifyDoctestBlocksRejectsUnterminatedBlock(), TestVerifyEpic14ExampleIndexAcceptsRequiredCoverage(), TestVerifyEpic14ExampleIndexRejectsMissingEntry(), TestVerifyEpic14ExampleIndexRejectsMissingGenericStructEntry(), TestVerifyEpic14ExampleIndexRejectsMissingPrimaryT4ProjectEntry() (+28 more)
...
Cohesion: 0.11
Nodes (26): TestNormalizeFlowForMigrationAPI(), TestNormalizeFlowForMigrationAPICoversFlowTestAndMatchSurface(), Diagnostic, DiagnosticError, DiagnosticForError(), hintForDiagnosticMessage(), shiftDiagnosticColumn(), TestNormalizeFlowForMigrationHandlesIfLetAndMatchCases() (+18 more)
...
Cohesion: 0.2
Nodes (21): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB (+13 more)
...
Cohesion: 0.16
Nodes (28): bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), catchExprHasCompleteEnumPatterns(), catchPatternType() (+20 more)
...
Cohesion: 0.09
Nodes (11): alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitFunc(), emitReturn() (+3 more)
...
Cohesion: 0.31
Nodes (6): TestWASMBuildRejectsCapabilityBuiltinBeforeBackendEmission(), TestWASMPolicyRejectsUnsafeCapabilityMemoryMMIOAndCtxSwitchIR(), sha256File(), TestBuildCacheHitNoLowering(), TestBuildDeterministicAcrossJobs(), TestConcurrentBuildsSameCache()
