...
## Corpus Check
- 4453 files · ~6,442,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21969 nodes · 85035 edges · 1075 communities (921 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13711 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ff57c54`
...
Cohesion: 0.02
Nodes (380): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly() (+372 more)
...
Cohesion: 0.02
Nodes (226): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildAndRunFile(), buildAndRunFileWithOptions() (+218 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (208): BuildMacOSX64(), TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse() (+200 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (214): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), bindResourceTreeFromPathOrUnknown() (+206 more)
...
Cohesion: 0.03
Nodes (166): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+158 more)
...
Cohesion: 0.03
Nodes (139): requireCheckFileErrorContains(), requireCheckFileOK(), TestTaskGroupCancelAllowsTypedErrorResult(), TestTaskSpawnAllowsImmutableGlobalTarget(), readRepoFileForEpic06(), TestEpic06CapabilityAndIslandExamplesUseAuditedEffects(), TestEpic06DocsAndReleaseGateAlignWithUsesCapabilityUnsafeOwnershipIslandCoverage(), TestEpic06EffectsCapabilitiesUnsafeOwnershipIslandPrivacyBudgetMatrix() (+131 more)
...
Cohesion: 0.04
Nodes (92): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+84 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (124): capsuleArtifact, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString() (+116 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (116): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases() (+108 more)
...
Cohesion: 0.04
Nodes (50): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+42 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (96): TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses() (+88 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics() (+77 more)

### Community 56 - "Community 56"
Cohesion: 0.1
Nodes (93): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata() (+85 more)
...
Cohesion: 0.04
Nodes (45): AwaitExpr, BinaryExpr, BoolLitExpr, BreakStmt, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase (+37 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (83): canRunLinuxX32OnHost(), probeLinuxX32Execution(), artifactCheck, fakeFileInfo, fileInfo, freshnessCheck, gateEvidenceReport, generatedArtifactsReport (+75 more)
...
Cohesion: 0.07
Nodes (9): atomicFetchCASLoop32(), emitCall(), emitFunc(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitReturn(), guardAllocationOffsetRawAccess() (+1 more)
...
Cohesion: 0.08
Nodes (61): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, parseBuildTargetOrReport(), writeDiagnostic(), writeDiagnosticObject(), writeDiagnosticWithHint(), abiObjectHasSymbol() (+53 more)
...
Cohesion: 0.12
Nodes (58): defaultTarget(), projectBuildTargets(), projectDefaultTarget(), runBuild(), writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath() (+50 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, lexer (+14 more)
...
Cohesion: 0.06
Nodes (46): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+38 more)

### Community 85 - "Community 85"
Cohesion: 0.1
Nodes (50): resolveFieldChainLower(), assignTargetInfo, bindMatchPatternLocalsForInference(), catchExprHasCompleteEnumPatterns(), catchPatternType(), cloneLocalMap(), collectExprLocals(), collectPatternLocals() (+42 more)
...
Cohesion: 0.08
Nodes (47): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+39 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (53): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+45 more)
...
Cohesion: 0.1
Nodes (44): assertImportHas(), findSection(), parsePEInfo(), readCString(), readPEImports(), rvaToOffset(), sectionData(), TestBuildWindowsPEActors() (+36 more)
...
Cohesion: 0.11
Nodes (39): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+31 more)

### Community 110 - "Community 110"
Cohesion: 0.08
Nodes (30): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+22 more)
...
Cohesion: 0.16
Nodes (38): capsuleSectionHeader(), validateCapsuleGraph(), parseCapsuleGraphArgs(), runEcoVerify(), writeEcoLock(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport() (+30 more)

### Community 136 - "Community 136"
Cohesion: 0.1
Nodes (26): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+18 more)
...
Cohesion: 0.09
Nodes (34): Tetra Tooling Summary Schema v1alpha1, WaveH Test-All Tooling Summary, WaveI Test-All API Docs, WaveI Test-All Tetra Docs, WaveI Test-All Tooling Summary, WaveI Reviewer Test-All API Docs, WaveI Reviewer Test-All Tooling Summary, WaveB Stabilization API Docs Snapshot (+26 more)
...
Cohesion: 0.18
Nodes (18): dialServer(), readUntil(), startBenchmarkServer(), startPlaintextServer(), TestServerHandlesPartialRequestRead(), TestServerJSONEndpointKeepAliveAndPipelining(), TestServerPlaintextKeepAliveAndPipelining(), TestServerRejectsMalformedRequest() (+10 more)
...
Cohesion: 0.17
Nodes (18): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+10 more)
...
Cohesion: 0.14
Nodes (8): emitAllocBytes(), emitExit(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), emitMMIOWriteI32(), emitWrite(), patchExitBranch()
...
Cohesion: 0.21
Nodes (16): effectDiagnosticf(), effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), normalizeEffects() (+8 more)
...
Cohesion: 0.15
Nodes (17): errForPlan250RuntimeDiagnostic, firstPlan250InstrKind(), hasPlan250BudgetGuardBefore(), matchesPlan250BudgetGuardAt(), requireCheckFileErrorContainsAll(), TestPlan250RuntimeDiagnosticsPreserveExitAndPanicBoundaries(), TestPlan250RuntimeRejectsReservedExportOutsideRuntimeModule(), TestPlan250SafetyBorrowEscapeAcrossBranchMerge() (+9 more)
