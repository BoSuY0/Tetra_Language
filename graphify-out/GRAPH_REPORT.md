...
## Corpus Check
- 4427 files · ~6,351,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21897 nodes · 84766 edges · 1080 communities (928 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13705 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2589f5d`
...
- `TestCIWorkflowIncludesCurrentV040ReleaseReadinessJob()` --calls--> `contains()`  [INFERRED]
  tools/scriptstest/ci_workflow_test.go → compiler/internal/semantics/generics.go
...
## Communities (1080 total, 152 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (525): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+517 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (439): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+431 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (408): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes() (+400 more)
...
Cohesion: 0.02
Nodes (250): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+242 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (233): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindMatchPatternLocalsForInference() (+225 more)
...
Cohesion: 0.03
Nodes (145): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+137 more)
...
Cohesion: 0.04
Nodes (148): branchScopeInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases() (+140 more)
...
Cohesion: 0.03
Nodes (142): requireCheckErrorContains(), TestOwnershipRejectsBorrowDerivedValueAsInoutArgument(), TestOwnershipRejectsBorrowedFixedArrayInoutAssignment(), TestOwnershipRejectsBorrowedOptionalPtrConsumedByFunctionTypedEnumPayload(), TestOwnershipRejectsBorrowedOptionalPtrConsumedByFunctionTypedParameter(), TestOwnershipRejectsBorrowedOptionalPtrConsumedByFunctionTypedStructField(), TestOwnershipRejectsBorrowedOptionalPtrInoutFunctionTypedEnumPayload(), TestOwnershipRejectsBorrowedOptionalPtrInoutFunctionTypedParameter() (+134 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (140): TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+132 more)
...
Cohesion: 0.04
Nodes (126): TestSelfHostRuntimeObjectsExportRequiredSymbols(), requiredActorRuntimeSymbols(), requiredActorStateRuntimeSymbols(), requiredFilesystemRuntimeSymbols(), requiredNetRuntimeSymbols(), requiredTaskGroupRuntimeSymbols(), requiredTaskRuntimeSymbols(), requiredTimeRuntimeSymbols() (+118 more)
...
Cohesion: 0.07
Nodes (123): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+115 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (102): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+94 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (116): capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand(), artifactSlug() (+108 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (99): TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipOptionalPayloadConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumCopyAfterConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructCopyAfterConsumeCode() (+91 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (108): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+100 more)
...
Cohesion: 0.03
Nodes (107): requireCheckWorldFilesErrorContains(), requireCheckWorldFilesOK(), TestOwnershipAllowsCrossModulePartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsCrossModulePartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipBorrowParamCannotMutate(), TestOwnershipConsumeArgumentCannotBeReused(), TestOwnershipConsumedValueCannotBeReassigned(), TestOwnershipInoutRequiresMutableLocal() (+99 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (91): resolveFieldChainLower(), assignTargetInfo, collectExprLocals(), firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType() (+83 more)
...
Cohesion: 0.09
Nodes (97): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType(), collectLocals() (+89 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+90 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (93): assertActorAliasTransferDiagnostic(), assertActorTaskOptionalPayloadAliasTransferDiagnostic(), assertBorrowedNestedSliceEnumPayloadDiagnostic(), assertBorrowedNestedSliceStructDiagnostic(), assertBorrowedPtrAggregateGlobalFieldDiagnostic(), assertBorrowedPtrAggregateOptionalGlobalAssignmentDiagnostic(), assertBorrowedPtrAggregateReturnDiagnostic(), assertBorrowedPtrEnumAliasReturnDiagnostic() (+85 more)
...
Cohesion: 0.04
Nodes (40): AssignStmt, AwaitExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+32 more)
...
Cohesion: 0.06
Nodes (63): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost() (+55 more)
...
Cohesion: 0.1
Nodes (59): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), validateCapsuleGraph(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots() (+51 more)

### Community 73 - "Community 73"
Cohesion: 0.06
Nodes (58): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+50 more)

### Community 74 - "Community 74"
Cohesion: 0.05
Nodes (19): BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr (+11 more)
...
Cohesion: 0.06
Nodes (6): ownershipPathParent(), copyRegionTree(), formatOwnershipJoinState(), parentOwnershipPath(), resourceFinalizationAllows(), regionState
...
Cohesion: 0.06
Nodes (45): objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), InterfaceFingerprintFromSource(), TestBuildRejectsInterfaceImplementationGenericExport() (+37 more)
...
Cohesion: 0.11
Nodes (35): Column, Conn, Frame, payloadReader, Result, Row, StartupConfig, AppendBind() (+27 more)

### Community 99 - "Community 99"
Cohesion: 0.11
Nodes (42): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, appendDataRow(), appendRowDescription() (+34 more)
...
Cohesion: 0.12
Nodes (22): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd32() (+14 more)
...
Cohesion: 0.14
Nodes (40): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+32 more)
...
Cohesion: 0.1
Nodes (27): nativeLinuxX86ExecutableBackend(), callPatch, buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitIndexLoad() (+19 more)
...
Cohesion: 0.11
Nodes (30): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+22 more)
...
Cohesion: 0.11
Nodes (32): InterfaceFingerprintFromT4I(), TestGeneratedInterfaceFunctionTypeRefsCheckAndLowerAcrossModules(), TestGeneratedInterfaceGenericStructTypeArgsCheckAndLowerAcrossModules(), TestGenerateInterfaceFromSourceEmitsProtocolImplDeclarationsBeforeFunctions(), TestGenerateInterfaceFromSourceEmitsTypecheckableExtensionDeclarations(), TestGenerateInterfaceFromSourceFiltersPrivateSurfaceAndHashesPublicAPI(), TestGenerateInterfaceFromSourceKeepsImportsRequiredByFunctionTypeRefs(), TestGenerateInterfaceFromSourceKeepsImportsRequiredByPublicAPI() (+24 more)
...
Cohesion: 0.15
Nodes (29): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+21 more)
...
Cohesion: 0.17
Nodes (30): addVaultRecord(), readVaultIndex(), runEcoTrustSnapshot(), runEcoVault(), runEcoVaultAdd(), runEcoVaultList(), runEcoVaultVerify(), scoreCapsuleTrust() (+22 more)
...
Cohesion: 0.12
Nodes (23): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkMacOSX64(), LoadWorld() (+15 more)
...
Cohesion: 0.13
Nodes (22): TestEmitTaskJoinTypedSlotBounds(), TestEmitTaskJoinTypedWrapperWindowsX64SlotBounds(), emitActorExitWindowsX64(), emitActorNoArgWrapperWindowsX64(), emitActorOneArgWrapperWindowsX64(), emitActorSendBeginWrapperWindowsX64(), emitActorSendMsgWrapperWindowsX64(), emitActorSendSlotWrapperWindowsX64() (+14 more)

### Community 178 - "Community 178"
Cohesion: 0.15
Nodes (18): countingRWC, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections(), TestPoolStatsTrackOpenIdleInUseAndClosedState(), TestNewTechEmpowerServerAppliesConfigAndRoutes() (+10 more)

### Community 179 - "Community 179"
Cohesion: 0.18
Nodes (19): NewServer(), dialServer(), readUntil(), startBenchmarkServer(), startPlaintextServer(), TestServerHandlesPartialRequestRead(), TestServerJSONEndpointKeepAliveAndPipelining(), TestServerPlaintextKeepAliveAndPipelining() (+11 more)
...
Cohesion: 0.18
Nodes (23): isInternalRuntimeExportedSymbol(), quotedAfter(), targetExportedFFIAggregateParamDiagnostic(), targetExportedFFIAggregateReturnDiagnostic(), targetExportedFFIPointerParamDiagnostic(), targetExportedFFIPointerReturnDiagnostic(), targetExportedFFIRequiresAggregateABI(), targetExportedFFIRequiresPointerBoundaryGate() (+15 more)
...
Cohesion: 0.2
Nodes (20): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), startDBBenchmarkServerWithRandom(), TestNormalizeQueryCount(), dbErrorResponse(), DBHandler(), fetchFortunes() (+12 more)
...
Cohesion: 0.1
Nodes (22): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+14 more)
...
Cohesion: 0.31
Nodes (18): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+10 more)
...
Cohesion: 0.17
Nodes (18): BenchmarkEnvironment, EndpointReport, GitState, Options, Report, decodeStrict(), expectedContentTypePrefix(), hasSkipDBLimitation() (+10 more)
...
Cohesion: 0.2
Nodes (15): dialTCP4Localhost(), netListenTCP4Localhost(), runtimeObjectWithNetRuntimeSignatures(), TestCollectNetRuntimeUsage(), TestNetRuntimeEpollReadinessBuildAndRunLinuxX64(), TestNetRuntimeEpollWaitOneIntoBuildAndRunLinuxX64(), TestNetRuntimeHTTPPipelinedPlaintextJSONBuildAndRunLinuxX64(), TestNetRuntimeHTTPPlaintextServerBuildAndRunLinuxX64() (+7 more)
...
Cohesion: 0.12
Nodes (3): alignUp(), emitCmp(), emitFunc()
...
Cohesion: 0.28
Nodes (14): writeInterfaceHashOnlySurface(), writeInterfaceImpl(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail() (+6 more)
...
Cohesion: 0.29
Nodes (13): requireUnsupportedReasonContains(), targetMetaForTest(), targetsJSONForTest(), TestFeaturesCommandJSON(), TestFeaturesCommandRejectsUnsupportedFormat(), TestFormatsCommandListsOfficialT4Family(), TestTargetsCommandJSON(), TestTargetsCommandJSONMarksWASIRunSupportedWhenRunnerExists() (+5 more)
...
Cohesion: 0.31
Nodes (11): stringSliceContains(), TestCIWorkflowArtifactNamesAreReleaseAware(), TestCIWorkflowHasLeastPrivilegeConcurrencyAndTimeouts(), TestCIWorkflowIncludesCanonicalV030ReleaseGateJob(), TestCIWorkflowIncludesCurrentV040ReleaseReadinessJob(), TestCIWorkflowIncludesMinimalActionAndShellLinting(), TestCIWorkflowIncludesStabilizationAndRobustnessJobs(), TestCIWorkflowIncludesSupplyChainVulnerabilityScan() (+3 more)
...
Cohesion: 0.22
Nodes (7): LinkLinuxX64(), emitEntryStubSysVUnixX64(), emitEntryStubWin64X64(), linkLinuxSysV(), LinkLinuxX32(), LinkLinuxX64(), LinkMacOSX64()
...
Cohesion: 0.33
Nodes (9): endpointName(), expectedContentType(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsWeakEvidenceAndBadCounters(), TestValidateReportRequiresExplicitSkipDBAllowance() (+1 more)
...
## Knowledge Gaps
- **397 isolated node(s):** `executableMatrixCase`, `apiDocTitle`, `ABICheck`, `targetRuntimeBoundaryCase`, `AtomicStressCheck` (+392 more)
