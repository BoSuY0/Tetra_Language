...
## Corpus Check
- 4465 files · ~6,361,484 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22103 nodes · 85546 edges · 1072 communities (921 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13807 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `774acfdc`
...
## Communities (1072 total, 151 thin omitted)
...
Cohesion: 0.01
Nodes (347): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+339 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (417): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestDocCommandDiscoversCapsuleProjectSources(), TestDocCommandGeneratedOutputPassesAPIValidator(), TestDocCommandJSONDiagnostics(), TestDocCommandWritesAPIDocsToFile(), TestDocCommandWritesAPIDocsToStdout(), TestEcoArtifactsBuildAllTargetsSkipsWASMObjectTargets() (+409 more)
...
Cohesion: 0.02
Nodes (210): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), buildAndRunFile(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+202 more)
...
Cohesion: 0.03
Nodes (163): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+155 more)
...
Cohesion: 0.03
Nodes (154): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+146 more)
...
Cohesion: 0.04
Nodes (140): BuildMacOSX64(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt() (+132 more)
...
Cohesion: 0.06
Nodes (121): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), borrowedPtrOwnerFromExpr() (+113 more)
...
Cohesion: 0.06
Nodes (107): capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+99 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (91): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+83 more)
...
Cohesion: 0.11
Nodes (88): resolveFunctionFieldName(), CallableEscapeKind, checkStmts(), collectionElementType(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs() (+80 more)
...
Cohesion: 0.04
Nodes (43): AssignStmt, BreakStmt, CallExpr, CapsuleEntryDecl, CatchExprCase, ClosureExpr, ContinueStmt, DeferStmt (+35 more)
...
Cohesion: 0.05
Nodes (81): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+73 more)
...
Cohesion: 0.08
Nodes (69): resolveCallSigForInference(), firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures() (+61 more)
...
Cohesion: 0.07
Nodes (61): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+53 more)
...
Cohesion: 0.05
Nodes (24): AwaitExpr, BinaryExpr, BoolLitExpr, CatchExpr, FieldAccessExpr, IdentExpr, IndexExpr, lexer (+16 more)
...
Cohesion: 0.09
Nodes (54): IRInstrKind, irVerifierError(), irVerifierErrorAt(), lowerDiagnostic(), lowerUnsupportedError(), runtimeCallSig, RuntimeCallSignature, stackState (+46 more)
...
Cohesion: 0.11
Nodes (51): artifactSlug(), buildCapsuleArtifacts(), capsuleSourceModules(), defaultCapsulePath(), FuzzParseCapsuleDoesNotPanic(), interfaceArtifactRelPath(), writeEcoLock(), appendCapsuleArtifact() (+43 more)
...
Cohesion: 0.09
Nodes (44): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+36 more)

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (41): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+33 more)
...
Cohesion: 0.13
Nodes (43): isLSPIdentifierChar(), isLSPIdentifierStart(), lspCodeActionDiagnosticsFromCompiler(), lspCodeActions(), lspCodeLineDeclaresLocalName(), lspCodeOnly(), lspCompletionItems(), lspCompletionKind() (+35 more)
...
Cohesion: 0.14
Nodes (41): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+33 more)
...
Cohesion: 0.15
Nodes (27): TestNewTechEmpowerServerAppliesConfigAndRoutes(), TestRegisterTechEmpowerRoutesMountsAllEndpoints(), newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray() (+19 more)
...
Cohesion: 0.12
Nodes (25): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleRelPath(), SourceExtensions() (+17 more)
...
Cohesion: 0.2
Nodes (29): capsuleSectionHeader(), findCapsulePath(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), checkProjectLockOnly(), describeProjectDependency(), discoverProjectDepsContext() (+21 more)
...
Cohesion: 0.21
Nodes (27): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), describeProjectDependencyCycle() (+19 more)
...
Cohesion: 0.18
Nodes (20): Web UI Smoke DOM (test-all-20260429-145050), Tetra UI Schema v1, Security Evidence Web UI DOM, Web UI Smoke DOM (v0.3-stabilization), addLine(), applyTetraCommand(), bindingValue(), initialState() (+12 more)
...
Cohesion: 0.3
Nodes (19): writeFileAPIDocs(), writeInterfaceHashOnlySurface(), writeInterfaceStruct(), AnalyzeLSPFile(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail() (+11 more)
...
Cohesion: 0.2
Nodes (19): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), TestRegisterTechEmpowerRoutesRequiresPool(), TestNormalizeQueryCount(), dbErrorResponse(), DBHandler(), fetchFortunes() (+11 more)
...
Cohesion: 0.11
Nodes (13): TestBuildIslandMakeBoolSliceSmoke(), TestBuildMakeBoolSliceSmoke(), TestSliceBoolSemanticsAcceptance(), TestSliceBoolWasmBuildOnlyIslandMakeBoolSmoke(), TestSliceBoolWasmBuildOnlyMakeBoolSmoke(), TestSliceWasmBuildOnlyIslandMakeU8I32Smoke(), TestBuildIslandMakeU16SliceSmoke(), TestBuildMakeU16SliceSmoke() (+5 more)
...
Cohesion: 0.16
Nodes (6): atomicFetchAdd32(), emitAllocBytes(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), patchExitBranch()
...
Cohesion: 0.38
Nodes (8): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader()
...
Cohesion: 0.33
Nodes (6): WaveD Fuzz Seed Triage Policy, Wave H Reviewer Short Fuzz Summary, Wave H Reviewer Unstable Seed Promotion Policy, Wave H Reviewer Unstable Seeds Log, WaveJ Reviewer Fuzz Nightly Short Summary, WaveJ Reviewer Unstable Fuzz Seeds Log
