...
## Corpus Check
- 4465 files · ~6,498,029 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22034 nodes · 85340 edges · 1064 communities (912 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13766 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65e9a8ef`
...
Cohesion: 0.01
Nodes (477): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes() (+469 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (386): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+378 more)
...
Cohesion: 0.03
Nodes (219): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals() (+211 more)
...
Cohesion: 0.03
Nodes (162): BuildFileWithStatsOpt(), loadCheckedBuildWorld(), TestBuildTagFromOptionsIncludesLinkedObjectContentDeterministically(), TestPipelineLoadCheckedBuildWorldRequireMainStage(), TestPipelineNativeModulePlanCacheStages(), TestPipelineNativeModulePlanInvalidatesWhenLinkedObjectContentChanges(), TestPipelineResolveNativeTargetStage(), buildAndRunFileWithOptions() (+154 more)
...
Cohesion: 0.04
Nodes (149): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+141 more)
...
Cohesion: 0.04
Nodes (127): assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject(), lspTestLocationsContainRange() (+119 more)
...
Cohesion: 0.05
Nodes (111): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+103 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (121): TestActorSpawnsTaskAndReceivesCompletionBuildAndRun(), TestActorStateLowerUsesRuntimeLoadStoreCalls(), TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), requiredActorRuntimeSymbols(), requiredActorStateRuntimeSymbols(), requiredFilesystemRuntimeSymbols(), requiredNetRuntimeSymbols() (+113 more)
...
Cohesion: 0.05
Nodes (119): flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment(), validateFile(), validatePaths() (+111 more)
...
Cohesion: 0.06
Nodes (119): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases() (+111 more)
...
Cohesion: 0.05
Nodes (102): atomicIRTargetInfo(), TestAtomicIRTargetInfoUsesX32PointerWidth(), TestX86RejectsI64AtomicWithTargetDiagnostic(), targetAtomicDiagnostic(), validateTargetAtomicIR(), atomicIRInfo, BuildStats, checkedBuildWorld (+94 more)
...
Cohesion: 0.09
Nodes (103): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType(), collectLocals() (+95 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (97): cliProjectContext, dependencyArtifactBuildOptions(), buildCapsuleArtifacts(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), FuzzParseCapsuleDoesNotPanic(), writeEcoLock(), appendCapsuleArtifact() (+89 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke() (+77 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (42): branchScopeInfo, mergeControlFlowWithLabels(), returnRegionSummaryForInterfaceExpr(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable() (+34 more)
...
Cohesion: 0.08
Nodes (79): ClosureCapture, captureMode, cloneBoolMap(), resolveCallSigForInference(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText() (+71 more)
...
Cohesion: 0.09
Nodes (7): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitWrite(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.08
Nodes (34): LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects() (+26 more)
...
Cohesion: 0.08
Nodes (43): BenchmarkEnvironment, EndpointReport, GitState, requiredMatrixSemanticProbeNames(), validateMatrixBuild(), validateMatrixPostgres(), ValidateMatrixReport(), validateMatrixResource() (+35 more)
...
Cohesion: 0.23
Nodes (13): collectNetRuntimeUsage(), dialTCP4Localhost(), netListenTCP4Localhost(), TestCollectNetRuntimeUsage(), TestNetRuntimeEpollReadinessBuildAndRunLinuxX64(), TestNetRuntimeEpollWaitOneIntoBuildAndRunLinuxX64(), TestNetRuntimeHTTPPipelinedPlaintextJSONBuildAndRunLinuxX64(), TestNetRuntimeHTTPPlaintextServerBuildAndRunLinuxX64() (+5 more)
...
Cohesion: 0.23
Nodes (13): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+5 more)
