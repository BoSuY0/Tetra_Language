...
## Corpus Check
- 4465 files · ~6,501,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22039 nodes · 85354 edges · 1072 communities (920 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13770 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f20a065d`
...
## Communities (1072 total, 152 thin omitted)
...
Cohesion: 0.01
Nodes (408): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+400 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (424): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+416 more)
...
Cohesion: 0.03
Nodes (229): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindMatchPatternLocalsForInference(), bindPatternSecretTaintLocals() (+221 more)
...
Cohesion: 0.04
Nodes (160): branchScopeInfo, appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals() (+152 more)
...
Cohesion: 0.04
Nodes (157): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+149 more)
...
Cohesion: 0.03
Nodes (146): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+138 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (136): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+128 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (137): BuildMacOSX64(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt() (+129 more)
...
Cohesion: 0.05
Nodes (136): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+128 more)
...
Cohesion: 0.05
Nodes (119): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+111 more)
...
Cohesion: 0.04
Nodes (101): requiredTaskGroupRuntimeSymbols(), requiredTaskRuntimeSymbols(), requiredTypedTaskRuntimeSymbols(), buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs() (+93 more)
...
Cohesion: 0.06
Nodes (90): resolveFieldChainLower(), assignTargetInfo, collectExprLocals(), firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType() (+82 more)
...
Cohesion: 0.09
Nodes (98): resolveFunctionFieldName(), CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), collectLocals(), collectPatternLocals(), collectScopedLocal() (+90 more)
...
Cohesion: 0.04
Nodes (72): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+64 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (70): FormatPos(), ClosureCapture, captureMode, cloneBoolMap(), unsupportedGlobalFunctionCaptureStorageError(), unsupportedGlobalFunctionParameterStorageError(), validateFunctionTypeClosurePointerAssignment(), validateFunctionTypeClosurePointerBinding() (+62 more)
...
Cohesion: 0.05
Nodes (65): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+57 more)
...
Cohesion: 0.08
Nodes (6): emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.07
Nodes (5): ownershipPathParent(), formatResourceParamPath(), parentOwnershipPath(), resourceFinalizationAllows(), regionState
...
Cohesion: 0.09
Nodes (40): BuiltinManifest, Manifest, GetManifest(), manifestAtomicPointerWidthBits(), assertSymbolSequence(), TestManifestBuiltinsExposeStableUnsafePoliciesForPublicSurface(), TestManifestRuntimeABIIncludesFullRequiredSymbolSets(), RuntimeManifest (+32 more)
...
Cohesion: 0.1
Nodes (44): capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot(), findCapsuleManifest(), main(), parseSHA256Hash(), readRegularUnpackedFile() (+36 more)
...
Cohesion: 0.11
Nodes (37): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+29 more)
...
Cohesion: 0.08
Nodes (33): InterfaceFingerprintFromSource(), TestBuildRejectsInterfaceImplementationGenericExport(), TestBuildRejectsInterfaceImplementationMissingSignatureMetadata(), TestBuildRejectsInterfaceImplementationMissingSymbol(), TestBuildRejectsInterfaceImplementationSignatureMismatch(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString() (+25 more)
...
Cohesion: 0.19
Nodes (17): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+9 more)
...
Cohesion: 0.14
Nodes (7): atomicFetchAdd32(), atomicFetchCASLoop32(), emitAllocBytes(), emitExit(), emitMakeSlice(), emitWrite(), patchExitBranch()
...
Cohesion: 0.2
Nodes (5): TestCheckDistributedActorRuntimeBuiltins(), TestCheckDistributedActorRuntimeBuiltinsRequireRuntimeEffect(), TestCheckSpawnRemoteRejectsNonLiteralTarget(), TestRunRejectsSkipDBReportWithoutAllowance(), TestRunRequiresReportPath()
