...
## Corpus Check
- 4465 files · ~6,486,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22002 nodes · 85207 edges · 1055 communities (901 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13731 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9f200f7`
...
## Communities (1055 total, 154 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (604): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+596 more)
...
Cohesion: 0.02
Nodes (224): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildAndRunFile(), buildOnly() (+216 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (229): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+221 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (191): BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFileWithOptions(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithImportedSignatureType(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithStructReturnStub(), TestBuildInterfaceOnlyModeAllowsT4IDependencyWithoutOutput(), TestBuildInterfaceOnlyModeDoesNotRequireMain(), TestBuildInterfaceOnlyModeFunctionTypedEnumParameterWholeReturnGlobalEscapeDiagnostic() (+183 more)
...
Cohesion: 0.04
Nodes (114): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+106 more)
...
Cohesion: 0.04
Nodes (73): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+65 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (109): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindResourceFromExpr(), cloneLocalMap(), collectExprLocals() (+101 more)
...
Cohesion: 0.09
Nodes (105): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType(), collectLocals() (+97 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (81): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+73 more)
...
Cohesion: 0.06
Nodes (87): runEcoMirrorValidator(), TestValidateEcoMirrorAcceptsHTTPSourceStore(), TestValidateEcoMirrorAcceptsValidReport(), TestValidateEcoMirrorRejectsBadHash(), TestValidateEcoMirrorRejectsOneSidedTrustHash(), TestValidateEcoMirrorRejectsPathMismatch(), TestValidateEcoMirrorRejectsUnknownField(), validMirrorReport() (+79 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (92): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+84 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics() (+90 more)
...
Cohesion: 0.05
Nodes (65): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+57 more)
...
Cohesion: 0.07
Nodes (10): atomicFetchCASLoop32(), emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitReturn(), emitWrite() (+2 more)
...
Cohesion: 0.06
Nodes (61): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+53 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (57): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, parseBuildTargetOrReport(), abiObjectHasSymbol(), abiObjectHasSymbolSignature(), compareAggregateLayout(), containsMovEaxImm32() (+49 more)

### Community 81 - "Community 81"
Cohesion: 0.1
Nodes (52): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+44 more)
...
Cohesion: 0.12
Nodes (57): parseCapsuleBareOrQuoted(), parseCapsuleString(), defaultTarget(), writeDiagnostic(), writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath() (+49 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, FreeStmt, IslandStmt (+14 more)
...
Cohesion: 0.13
Nodes (51): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept(), makeV040PassingReleaseGateSummaryReportInOrder(), stepLogSlug() (+43 more)
...
Cohesion: 0.11
Nodes (33): isUpdateQuery(), newFakeWorldDB(), parseWorldUpdate(), pgAppendCString(), pgAppendInt16(), pgAppendInt32(), pgBackendKeyPayload(), pgCStringPayload() (+25 more)
...
Cohesion: 0.15
Nodes (36): CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript() (+28 more)
...
Cohesion: 0.11
Nodes (27): BuildFile(), findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio() (+19 more)
...
Cohesion: 0.21
Nodes (27): main(), actualForExpected(), artifactCases(), buildOnlyCases(), caseJSON(), intLiteral(), runtimeCases(), runtimeReport() (+19 more)
...
Cohesion: 0.25
Nodes (24): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver(), normalizeCapsuleArtifactKind() (+16 more)
...
Cohesion: 0.17
Nodes (20): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+12 more)
...
Cohesion: 0.29
Nodes (5): emitAllocBytes(), emitExit(), emitMakeSlice(), emitMMIOWriteI32(), patchExitBranch()
