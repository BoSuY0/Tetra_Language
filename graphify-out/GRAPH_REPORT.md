...
## Corpus Check
- 4465 files · ~6,480,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21983 nodes · 85130 edges · 1063 communities (912 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13718 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6777339e`
...
## Communities (1063 total, 151 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (519): buildAndRun(), buildAndRunFiles(), TestBuildMultiFileAliasCall(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+511 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (422): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue(), TestCapturedFunctionTypedInlineParameterReturnCannotEscapeIntoGlobalFunctionValue(), TestCapturedFunctionTypedInlineParameterReturnedEnumPayloadCannotEscapeIntoGlobalFunctionValue(), TestCapturedFunctionTypedInlineParameterReturnedNestedStructFieldCannotEscapeIntoGlobalFunctionValue() (+414 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (443): TestActorStateSlotLimitRejectsMoreThanEightBeforeRuntime(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildCommandWASMProjectLockDoesNotRequireNativeArtifacts(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes() (+435 more)
...
Cohesion: 0.03
Nodes (239): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+231 more)
...
Cohesion: 0.03
Nodes (152): branchScopeInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases() (+144 more)
...
Cohesion: 0.03
Nodes (176): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+168 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (179): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+171 more)
...
Cohesion: 0.03
Nodes (154): assertObjectHasSymbols(), TestActorGlueExportsProgramRuntimeSymbols(), TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy() (+146 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (152): canRunLinuxX32OnHost(), probeLinuxX32Execution(), hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile() (+144 more)
...
Cohesion: 0.04
Nodes (154): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+146 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (132): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+124 more)
...
Cohesion: 0.03
Nodes (144): TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+136 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (61): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+53 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (127): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+119 more)
...
Cohesion: 0.05
Nodes (124): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+116 more)
...
Cohesion: 0.04
Nodes (124): TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType(), TestActorDeclarationRejectsUnsupportedStateFieldType(), TestActorDeclarationRequiresStateFieldInitializer(), TestActorDeclarationSpawnBuildAndRunBuiltinRuntime(), TestActorDeclarationStateFieldAccessUsesConstInitializer() (+116 more)
...
Cohesion: 0.11
Nodes (82): collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs(), functionAssignmentValueTouchesMutableGlobals(), functionDirectSnapshotAliasForExpr(), functionEnumPayloadInfoFromCallArgument(), functionFieldInfoFromCallArgument() (+74 more)
...
Cohesion: 0.07
Nodes (70): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+62 more)
...
Cohesion: 0.1
Nodes (63): firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures(), cloneExpr() (+55 more)
...
Cohesion: 0.08
Nodes (8): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), guardAllocationBaseRawAccess(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.11
Nodes (60): hasPrefix(), apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs() (+52 more)
...
Cohesion: 0.08
Nodes (52): TestOwnershipGenericFunctionTypedGlobalPreservesConsumeMarker(), TestOwnershipLoopBreakExitReportsMaybeConsumedWithBreakLabel(), TestOwnershipLoopContinueExitReportsMaybeConsumedWithContinueLabel(), TestOwnershipRejectsGenericFunctionTypedGlobalOwnershipMismatch(), TestOwnershipRejectsIndirectRecursiveEnumPayloadCycle(), TestOwnershipRejectsInterproceduralStructReturnResourceLeafDoubleFree(), errForPlan250RuntimeDiagnostic, findPlan250IRFunc() (+44 more)
...
Cohesion: 0.07
Nodes (39): objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), InterfaceFingerprintFromSource(), TestBuildRejectsInterfaceImplementationGenericExport() (+31 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (39): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+31 more)
...
Cohesion: 0.11
Nodes (35): resolveFieldChainLower(), assignTargetInfo, catchExprHasCompleteEnumPatterns(), catchPatternType(), collectPatternLocals(), matchExprHasCompleteEnumPatterns(), matchHasCompleteEnumPatterns(), validateEnumCasePatternPayload() (+27 more)
...
Cohesion: 0.17
Nodes (37): makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), TestValidateReleaseGateSummaryAcceptsBlockedPreflightReport(), TestValidateReleaseGateSummaryAcceptsPassingV030Report(), TestValidateReleaseGateSummaryAcceptsPassingV040ReportWithCompilerProductionArtifact(), TestValidateReleaseGateSummaryAcceptsV040ReportWithExpectedIdentity(), TestValidateReleaseGateSummaryRejectsBlockedReportWithoutFailingStep(), TestValidateReleaseGateSummaryRejectsCountMismatch() (+29 more)
...
Cohesion: 0.13
Nodes (34): validateWorkspaceReportFormat(), decodeStrictJSON(), isASCIIAlpha(), isWorkspaceExecWindowsAbsPath(), main(), validateWorkspaceExecMember(), validateWorkspaceExecReportShape(), workspaceExecMember (+26 more)
...
Cohesion: 0.08
Nodes (37): tetra.release.v0_3_0.gate-report.v1, tetra.release.v0_3_0.test-all-summary.v1, API Diff No-Change Enforcement, Release Gate v0.3.0, Short Fuzz Nightly Run, Stabilization Test-All Pipeline, Tetra UI v1 Bundle Validation, Unstable Fuzz Seed Promotion Policy (+29 more)
...
Cohesion: 0.22
Nodes (30): TestValidateUIBundleArtifactRejectsMissingRequiredNestedField(), TestValidateUIBundleArtifactRejectsTrailingJSONPayload(), TestValidateUIBundleArtifactRejectsUnsupportedCommandOperation(), TestValidateUIBundleSchemaArtifactAcceptsCheckedInSchema(), TestValidateUIBundleSchemaArtifactRejectsInvalidID(), TestValidateUIBundleSchemaArtifactRejectsTrailingJSONPayload(), TestValidateWebUISmokeReportAcceptsCommandOperations(), TestValidateWebUISmokeReportAcceptsHostBlockedReport() (+22 more)
...
Cohesion: 0.12
Nodes (28): BuildFile(), findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget() (+20 more)
...
Cohesion: 0.11
Nodes (12): emitCmp(), emitIndexLoad(), emitIndexStore(), emitMMIOReadI32(), emitRawLoad(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+4 more)
...
Cohesion: 0.21
Nodes (22): addVaultRecord(), readVaultIndex(), runEcoVault(), runEcoVaultAdd(), runEcoVaultList(), runEcoVaultVerify(), sortVaultRecords(), upsertVaultRecord() (+14 more)
...
Cohesion: 0.17
Nodes (12): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), SourceExtensions(), Info (+4 more)
...
Cohesion: 0.12
Nodes (19): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+11 more)
...
Cohesion: 0.38
Nodes (11): ModuleRelPath(), cliModuleRelPathMatches(), defaultInputPath(), isCLIManagedSourceFile(), modulePathFromSource(), moduleRelPath(), moduleRelPathWithExtension(), moduleRootFromEntry() (+3 more)
