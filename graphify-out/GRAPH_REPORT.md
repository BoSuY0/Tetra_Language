...
## Corpus Check
- 4465 files · ~6,488,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22010 nodes · 85236 edges · 1056 communities (904 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13737 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f48c172`
...
## Communities (1056 total, 152 thin omitted)
...
Cohesion: 0.01
Nodes (432): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes() (+424 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (330): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+322 more)
...
Cohesion: 0.03
Nodes (225): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), capsulePermissionEntry() (+217 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (196): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+188 more)
...
Cohesion: 0.03
Nodes (191): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+183 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (184): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+176 more)
...
Cohesion: 0.04
Nodes (127): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+119 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (133): lspID, canRunLinuxX32OnHost(), probeLinuxX32Execution(), fuzzJSONArtifacts, fuzzStep, fuzzSummary, fuzzSummaryJSON, fuzzSummaryJSONStep (+125 more)
...
Cohesion: 0.06
Nodes (109): appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+101 more)
...
Cohesion: 0.05
Nodes (95): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+87 more)
...
Cohesion: 0.09
Nodes (101): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType() (+93 more)
...
Cohesion: 0.08
Nodes (76): ClosureCapture, captureMode, addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures(), collectDeferCaptures() (+68 more)
...
Cohesion: 0.04
Nodes (40): AssignStmt, BreakStmt, CapsuleEntryDecl, CatchExpr, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+32 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (56): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+48 more)
...
Cohesion: 0.07
Nodes (58): LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths() (+50 more)
...
Cohesion: 0.06
Nodes (67): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError() (+59 more)
...
Cohesion: 0.05
Nodes (70): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+62 more)

### Community 75 - "Community 75"
Cohesion: 0.05
Nodes (54): GenerateAPIDocs(), GenerateAPIDocsFromSource(), TestGenerateAPIDocs(), TestGenerateAPIDocsIncludesTestsAndDoctestFixtures(), TestGenerateAPIDocsLabelsExperimentalModules(), TestGenerateAPIDocsSkipsCapsuleManifestInProjectDirectory(), TestGenerateAPIDocsStablePublicSurfaceSnapshot(), TestExtensionNoLongerPlannedDiagnostic() (+46 more)
...
Cohesion: 0.09
Nodes (59): decodeEcoLock(), lockGraphFingerprint(), ecoLockArtifact, ecoLockCapsule, ecoLockDependency, ecoLockEnvelope, cleanArtifactPath(), containsString() (+51 more)

### Community 80 - "Community 80"
Cohesion: 0.11
Nodes (59): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept() (+51 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (19): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, ClosureExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr (+11 more)
...
Cohesion: 0.11
Nodes (45): itoa(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript(), initialState() (+37 more)
...
Cohesion: 0.13
Nodes (38): runEcoMirrorValidator(), TestValidateEcoMirrorAcceptsHTTPSourceStore(), TestValidateEcoMirrorAcceptsValidReport(), TestValidateEcoMirrorRejectsBadHash(), TestValidateEcoMirrorRejectsOneSidedTrustHash(), TestValidateEcoMirrorRejectsPathMismatch(), TestValidateEcoMirrorRejectsUnknownField(), validMirrorReport() (+30 more)
...
Cohesion: 0.14
Nodes (20): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd32() (+12 more)
...
Cohesion: 0.16
Nodes (35): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+27 more)
...
Cohesion: 0.17
Nodes (25): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+17 more)
...
Cohesion: 0.2
Nodes (20): capsuleIDDirectory(), decodeStrictJSON(), isHTTPStoreURL(), isSupportedMirrorChannel(), main(), parseSHA256Hash(), validateEcoMirror(), validateMirrorRelativePath() (+12 more)
...
Cohesion: 0.17
Nodes (16): dialTCP4Localhost(), netListenTCP4Localhost(), TestCollectNetRuntimeUsage(), TestNetRuntimeEpollReadinessBuildAndRunLinuxX64(), TestNetRuntimeEpollWaitOneIntoBuildAndRunLinuxX64(), TestNetRuntimeHTTPPipelinedPlaintextJSONBuildAndRunLinuxX64(), TestNetRuntimeHTTPPlaintextServerBuildAndRunLinuxX64(), TestNetRuntimeRejectsUnsupportedNativeTargets() (+8 more)
