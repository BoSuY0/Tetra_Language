...
## Corpus Check
- 4465 files · ~6,369,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22122 nodes · 85602 edges · 1072 communities (920 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13819 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5071826e`
...
Cohesion: 0.01
Nodes (431): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestObjectRoundTrip(), Version(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF() (+423 more)
...
Cohesion: 0.03
Nodes (243): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+235 more)
...
Cohesion: 0.02
Nodes (199): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+191 more)
...
Cohesion: 0.04
Nodes (156): capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+148 more)
...
Cohesion: 0.06
Nodes (117): assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindMatchPatternLocalsForInference(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), catchPatternType() (+109 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (119): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions() (+111 more)
...
Cohesion: 0.08
Nodes (118): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+110 more)
...
Cohesion: 0.05
Nodes (82): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+74 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke() (+90 more)
...
Cohesion: 0.05
Nodes (90): BenchmarkEnvironment, endpointIdentity, EndpointReport, GitState, formatIntSequence(), isCommandEnvAssignment(), isMatrixHarnessGoRunTarget(), isMatrixHarnessScript() (+82 more)
...
Cohesion: 0.09
Nodes (53): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+45 more)
...
Cohesion: 0.1
Nodes (51): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+43 more)
...
Cohesion: 0.08
Nodes (54): endpointKind(), endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest() (+46 more)
...
Cohesion: 0.12
Nodes (34): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd32() (+26 more)
...
Cohesion: 0.1
Nodes (38): addLine(), applyTetraCommand(), bindingValue(), initialState(), mountTetraUI(), parseInit(), renderBindings(), stateForView() (+30 more)
...
Cohesion: 0.12
Nodes (28): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+20 more)
...
Cohesion: 0.33
Nodes (3): emitIndexStore(), emitRawStore(), scaleIndex()
