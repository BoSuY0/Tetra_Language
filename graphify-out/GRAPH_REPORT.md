...
## Corpus Check
- 4465 files · ~6,507,834 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22059 nodes · 85405 edges · 1077 communities (925 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13776 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dc46d60`
...
## Communities (1077 total, 152 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (494): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile() (+486 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (504): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke() (+496 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (366): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+358 more)
...
Cohesion: 0.03
Nodes (239): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+231 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (231): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK() (+223 more)
...
Cohesion: 0.02
Nodes (190): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+182 more)
...
Cohesion: 0.03
Nodes (172): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+164 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (154): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+146 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (161): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+153 more)
...
Cohesion: 0.05
Nodes (153): resolveFieldChainLower(), assignTargetInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals() (+145 more)
...
Cohesion: 0.05
Nodes (109): FormatPos(), ClosureCapture, atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName() (+101 more)
...
Cohesion: 0.03
Nodes (106): requireCheckWorldFilesErrorContains(), TestOwnershipBorrowParamCannotMutate(), TestOwnershipConsumeArgumentCannotBeReused(), TestOwnershipConsumedValueCannotBeReassigned(), TestOwnershipInoutRequiresMutableLocal(), TestOwnershipRejectsBorrowEscapeViaAliasReturn(), TestOwnershipRejectsBorrowInoutAlias(), TestOwnershipRejectsConsumeInoutAlias() (+98 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+90 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+77 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (92): assertActorAliasTransferDiagnostic(), assertActorTaskOptionalPayloadAliasTransferDiagnostic(), assertBorrowedNestedSliceEnumPayloadDiagnostic(), assertBorrowedNestedSliceStructDiagnostic(), assertBorrowedPtrAggregateGlobalFieldDiagnostic(), assertBorrowedPtrAggregateOptionalGlobalAssignmentDiagnostic(), assertBorrowedPtrAggregateReturnDiagnostic(), assertBorrowedPtrEnumAliasReturnDiagnostic() (+84 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (46): itoa(), AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase (+38 more)
...
Cohesion: 0.05
Nodes (35): branchScopeInfo, mergeControlFlowWithLabels(), ownershipPathParent(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree(), constructorRegionFromTree(), containsSyntheticOwnershipSegment() (+27 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (75): BuildOptions, featuresReport, formatsReport, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+67 more)
...
Cohesion: 0.11
Nodes (84): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs() (+76 more)
...
Cohesion: 0.07
Nodes (79): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendUniqueString(), buildEcoLock(), buildEcoLockWithArtifactHashes(), buildNeedMap(), capsuleIDDirectory() (+71 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (68): TypeRefKind, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures() (+60 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (75): TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionReturningGenericStructMonomorphizesStruct(), buildAndRunWithOptionsTimeout(), containsString(), findIRFunc() (+67 more)

### Community 64 - "Community 64"
Cohesion: 0.06
Nodes (59): BuildMacOSX64(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+51 more)
...
Cohesion: 0.06
Nodes (60): BuildSigMap(), BuildTypeSigMap(), cacheDir(), cacheKey(), cachePath(), DepSigHashFromDeps(), DepSigHashFromDepsWithInterfaceHashes(), formatFuncSig() (+52 more)

### Community 67 - "Community 67"
Cohesion: 0.1
Nodes (70): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+62 more)
...
Cohesion: 0.06
Nodes (65): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+57 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (54): readLinkObjects(), objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), InterfaceFingerprintFromSource() (+46 more)
...
Cohesion: 0.06
Nodes (62): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+54 more)

### Community 78 - "Community 78"
Cohesion: 0.09
Nodes (58): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, parseBuildTargetOrReport(), abiObjectHasSymbol(), abiObjectHasSymbolSignature(), compareAggregateLayout(), containsMovEaxImm32() (+50 more)
...
Cohesion: 0.06
Nodes (57): BenchmarkEnvironment, EndpointReport, GitState, matrixCoverageKey(), matrixEndpointSpecs(), matrixLevelKey(), matrixRunIdentityKey(), parseMatrixArtifactEndpoints() (+49 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, BreakStmt, ExprStmt, ForRangeStmt, IslandStmt, LetStmt, lexer, hexValue() (+14 more)
...
Cohesion: 0.12
Nodes (56): parseCapsuleBareOrQuoted(), parseCapsuleString(), defaultTarget(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember() (+48 more)
...
Cohesion: 0.1
Nodes (47): isCapsuleSemver(), doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus() (+39 more)

### Community 90 - "Community 90"
Cohesion: 0.08
Nodes (49): ActorStateField, TestEnsureTypeInfoArrayRejectsUnsupportedSubset(), TestEnsureTypeInfoArraySupportedSubset(), TestEnsureTypeInfoRejectsTargetLayoutOnlyNativeIntegers(), TestClassifyCallableEscapeRejectsMutableCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeRejectsMutableEscapingCapture(), TestClassifyCallableEscapeRejectsResourceCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeUsesFnptrForBoundedLocalSnapshot() (+41 more)
...
Cohesion: 0.12
Nodes (45): CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript() (+37 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (27): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16() (+19 more)
...
Cohesion: 0.09
Nodes (43): AuditReport, CaseReport, ContractReport, ProcessReport, Report, decodeStrict(), rejectPaperEvidence(), validateAudit() (+35 more)
...
Cohesion: 0.07
Nodes (46): BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats, averageMS() (+38 more)

### Community 106 - "Community 106"
Cohesion: 0.1
Nodes (37): Web UI Smoke DOM (test-all-20260429-145050), Tetra UI Schema v1, Security Evidence Web UI DOM, Web UI Smoke DOM (v0.3-stabilization), createImports(), instantiateTetra(), memoryView(), readUTF8() (+29 more)

### Community 107 - "Community 107"
Cohesion: 0.11
Nodes (40): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, authSASLContinuePayload(), authSASLFinalPayload() (+32 more)

### Community 108 - "Community 108"
Cohesion: 0.1
Nodes (39): FuzzLexer(), FuzzParser(), sameStringSet(), sortedStrings(), lspDiagnostic, lspHover, lspSmokeEnvelope, lspSymbol (+31 more)
...
Cohesion: 0.11
Nodes (29): LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects() (+21 more)
...
Cohesion: 0.18
Nodes (34): capsuleSectionHeader(), parseCapsuleGraphArgs(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), checkProjectLockOnly(), checkProjectSync(), describeProjectDependency() (+26 more)

### Community 145 - "Community 145"
Cohesion: 0.07
Nodes (36): API Diff Docs Snapshot (hash 0966...ca390), api diff no-change step, API Docs Snapshot (hash 623d...53917), API Docs Snapshot (hash 09e8...50e66), API Hash sha256:0966... (81 modules, 226 entries), API Hash sha256:09e8... (83 modules, 228 entries), API Hash sha256:623d... (49 modules, 97 entries), Release Artifact tetra.release.v0_2_0.test-all-summary.v1 (+28 more)
...
Cohesion: 0.17
Nodes (25): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB (+17 more)
...
Cohesion: 0.08
Nodes (33): API Snapshot sha256:0966ebbb..., API Snapshot sha256:09e83e7a..., v0.3.0 Release Gate, tetra.api.v1alpha1 API Documentation, tetra.ui.v1 Shell Preview, Unstable Fuzz Seed Triage, v0.3.0 Release Gate Pass State, WaveK ImplB Fuzz Nightly Summary (+25 more)

### Community 157 - "Community 157"
Cohesion: 0.13
Nodes (23): effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), sortedEffectSet(), normalizedEffects (+15 more)

### Community 158 - "Community 158"
Cohesion: 0.15
Nodes (26): formatTestExpr(), NewTestRunnerReport(), sanitizeTestName(), TestTestRunnerReportAggregatesFilesDeterministically(), TestTestRunnerReportCountsPassFailMetadata(), TestTestRunnerSourcesBuildModuleDeclaredCase(), TestTestRunnerSourcesDeclareEffectsForSyntheticFunctions(), TestTestRunnerSourcesIncludeCaseMetadata() (+18 more)
...
Cohesion: 0.11
Nodes (26): BuildFile(), findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio() (+18 more)
...
Cohesion: 0.12
Nodes (29): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+21 more)
...
Cohesion: 0.2
Nodes (26): FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver() (+18 more)
...
Cohesion: 0.15
Nodes (21): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleRelPath(), SourceExtensions() (+13 more)
...
Cohesion: 0.14
Nodes (24): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+16 more)
...
Cohesion: 0.19
Nodes (24): parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles(), parseEcoPackArgs() (+16 more)

### Community 197 - "Community 197"
Cohesion: 0.15
Nodes (19): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+11 more)

### Community 198 - "Community 198"
Cohesion: 0.14
Nodes (25): requireLinuxX86Execution(), requireLocalTCPBind(), requireX32ExecutableFile(), TestExecWebProgramWithBrowserRunnerParsesBrowserExitResult(), TestExecWebProgramWithRunnerParsesBrowserExitResult(), TestRunCommandJSONDiagnosticsForWASMWebRuntimeUnsupported(), TestRunCommandPropagatesLinuxX86AllocBytesZeroExitCode(), TestRunCommandPropagatesLinuxX86DirectCallbackExitCode() (+17 more)
...
Cohesion: 0.13
Nodes (22): LinkLinuxX64(), TestELFLinuxLayoutStaysInSyncWithWriter(), alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract() (+14 more)
...
Cohesion: 0.22
Nodes (24): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), describeProjectDependencyCycle() (+16 more)
...
Cohesion: 0.25
Nodes (22): LoadWorld(), LoadWorldOpt(), ModuleCandidateRelPaths(), cleanModuleRoots(), cleanSourceRoots(), describeModuleSourceRootPaths(), LoadWorld(), LoadWorldOpt() (+14 more)
...
Cohesion: 0.17
Nodes (20): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), requireUnsupportedReasonContains(), targetMetaForTest() (+12 more)

### Community 212 - "Community 212"
Cohesion: 0.17
Nodes (18): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), Lower(), LowerModule() (+10 more)
...
Cohesion: 0.24
Nodes (19): assertImportHas(), findSection(), parsePEInfo(), readCString(), readPEImports(), rvaToOffset(), sectionData(), TestBuildWindowsPEActors() (+11 more)
...
Cohesion: 0.16
Nodes (13): VerifyIRProgram(), TestLowerModuleCallableFunctionTypedCrossModulePath(), TestPublicIRVerifierRejectsProgramAndFunctionDriftWithStableDiagnostic(), boundedFuzzInt(), byteAt(), FuzzFormatSourceIdempotent(), FuzzLoweringPipelineVerifiesIR(), loweringFuzzSource() (+5 more)

### Community 250 - "Community 250"
Cohesion: 0.18
Nodes (7): emitAllocBytes(), emitExit(), emitMakeSlice(), emitMmapFailureBranch(), emitMMIOWriteI32(), emitWrite(), patchExitBranch()

### Community 251 - "Community 251"
Cohesion: 0.15
Nodes (15): buildObjectsForEntry(), TestLinkCrossModuleCall(), TestLinkCrossModuleCallSevenPlusArgs(), TestLinkUnresolvedSymbol(), assertResourceAliasFinalizationDiagnostic(), assertTaskGroupAliasCloseDiagnostic(), assertTaskHandleAliasJoinDiagnostic(), TestSafetyDiagnosticCodesForEnumConstructorReturnResourceAliases() (+7 more)
...
Cohesion: 0.18
Nodes (16): errForPlan250RuntimeDiagnostic, firstPlan250InstrKind(), hasPlan250BudgetGuardBefore(), matchesPlan250BudgetGuardAt(), requireCheckFileErrorContainsAll(), TestPlan250LinkObjectRejectsWrongCompilerVersionMetadata(), TestPlan250RuntimeDiagnosticsPreserveExitAndPanicBoundaries(), TestPlan250RuntimeRejectsReservedExportOutsideRuntimeModule() (+8 more)
...
Cohesion: 0.23
Nodes (14): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+6 more)

### Community 295 - "Community 295"
Cohesion: 0.17
Nodes (13): emitEntryStubSysVLinuxX86(), LinkLinuxX86(), containsMovEaxImm32LinkerTest(), emitEntryStubForTestX86(), TestLinkLinuxRejectsNonLinuxTargetObject(), TestLinkLinuxX32RejectsNonX32TargetObject(), TestLinkLinuxX32UsesX32ExitSyscall(), TestLinkLinuxX64RejectsAbsoluteDataRelocs() (+5 more)
...
Cohesion: 0.29
Nodes (14): writeFileAPIDocs(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail() (+6 more)
...
Cohesion: 0.25
Nodes (10): buildWASMUIFixture(), TestNativeShellUIExampleWritesMetadataPreviewSidecar(), TestWASIDogfoodTargetBuildOnlyAndNoUIRuntimeArtifacts(), TestWASMUIExamplesBuildWithDeterministicMetadataSidecars(), TestWASMUISidecarsAreDeterministicAcrossBuilds(), TestWebUIDogfoodBuildWritesSchemaCheckedArtifacts(), sha256File(), TestBuildCacheHitNoLowering() (+2 more)
...
Cohesion: 0.22
Nodes (7): LinkMacOSX64(), emitEntryStubSysVUnixX64(), emitEntryStubWin64X64(), linkLinuxSysV(), LinkLinuxX32(), LinkLinuxX64(), LinkMacOSX64()
...
Cohesion: 0.32
Nodes (11): containsMovEaxImm32(), findELFLoadSegment(), parseELF64ProgramHeaders(), TestELF32LinuxX32ExecutableBuildHeaderContract(), TestELF32LinuxX86ExecutableBuildHeaderContract(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract() (+3 more)
...
Cohesion: 0.38
Nodes (11): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+3 more)
...
Cohesion: 0.27
Nodes (7): buildActorTaskStressFile(), TestActorTaskBoundedStressExamples(), TestAsyncSmokeExampleBuildAndRun(), TestTaskSmokeExampleBuildAndRun(), RepoPath(), RepoRoot(), RunBinary()
...
Cohesion: 0.22
Nodes (11): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+3 more)
...
Cohesion: 0.39
Nodes (8): findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget(), elfProgramHeader
...
Cohesion: 0.22
Nodes (6): TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), TestArrayMVPCheckAcceptsIndexAndForOnFixedArray(), TestArrayMVPWasmBuildSmoke(), TestParseArrayTypeRefInParamAndLocal()
...
Cohesion: 0.39
Nodes (3): WorkerFactory, WorkerGroup, ListenWorkers()
