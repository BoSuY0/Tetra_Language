...
## Corpus Check
- 4465 files · ~6,492,887 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22021 nodes · 85286 edges · 1067 communities (914 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13752 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `348e8476`
...
## Communities (1067 total, 153 thin omitted)
...
Cohesion: 0.01
Nodes (417): TestELFHasRWDataSegmentAndStringNotInText(), objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), TestBuildRejectsInterfaceImplementationMissingSymbol() (+409 more)
...
Cohesion: 0.03
Nodes (253): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+245 more)
...
Cohesion: 0.02
Nodes (246): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+238 more)
...
Cohesion: 0.03
Nodes (164): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+156 more)
...
Cohesion: 0.04
Nodes (158): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+150 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (148): canRunLinuxX32OnHost(), probeLinuxX32Execution(), fuzzJSONArtifacts, fuzzStep, fuzzSummary, fuzzSummaryJSON, fuzzSummaryJSONStep, expectedFuzzCommand() (+140 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (150): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+142 more)
...
Cohesion: 0.05
Nodes (127): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+119 more)
...
Cohesion: 0.04
Nodes (74): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+66 more)
...
Cohesion: 0.05
Nodes (107): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+99 more)
...
Cohesion: 0.07
Nodes (87): resolveFieldChainLower(), assignTargetInfo, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds() (+79 more)
...
Cohesion: 0.1
Nodes (69): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+61 more)
...
Cohesion: 0.08
Nodes (56): FormatPos(), unsupportedGlobalFunctionCaptureStorageError(), unsupportedGlobalFunctionMutableCaptureStorageError(), unsupportedGlobalFunctionParameterStorageError(), validateSemanticClauses(), diagnosticError, budgetDiagnosticf(), effectDiagnosticf() (+48 more)

### Community 72 - "Community 72"
Cohesion: 0.06
Nodes (60): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+52 more)
...
Cohesion: 0.06
Nodes (21): BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, FieldAccessExpr, IdentExpr, IndexExpr, lexer (+13 more)
...
Cohesion: 0.09
Nodes (40): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+32 more)
...
Cohesion: 0.11
Nodes (39): decodeStrictJSON(), knownSeverity(), main(), missingOrUnknown(), risksFieldIsArray(), TestValidateResidualRisksAcceptsOwnedBlockedRisk(), TestValidateResidualRisksRejectsNullRisks(), TestValidateResidualRisksRejectsUnknownFields() (+31 more)
...
Cohesion: 0.08
Nodes (29): nativeLinuxX86ExecutableBackend(), callPatch, buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitCmp() (+21 more)
...
Cohesion: 0.26
Nodes (21): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+13 more)
