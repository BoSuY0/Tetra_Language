...
## Corpus Check
- 620 files · ~1,271,926 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18677 nodes · 73332 edges · 511 communities (430 shown, 81 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13542 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0116fb42`
...
## Communities (511 total, 81 thin omitted)
...
Cohesion: 0.01
Nodes (357): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+349 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (360): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation(), TestBuildCommandJSONDiagnosticsForTooManyInputs() (+352 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (364): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestLSPCommandSmoke(), assertCLIJSONLifetimeDiagnostic(), assertCLIJSONOwnershipDiagnostic(), assertLSPTestError() (+356 more)
...
Cohesion: 0.03
Nodes (217): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+209 more)
...
Cohesion: 0.03
Nodes (184): TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+176 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (177): decodeWorldResponse(), get(), getWorldArray(), runSemanticProbe(), validateFortunesHTTP(), validateWorld(), validateWorldArrayHTTP(), capsuleArtifact (+169 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (160): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+152 more)
...
Cohesion: 0.03
Nodes (146): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+138 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (128): releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind(), TestReleaseV10APIDiffRejectsMissingBaselineBeforeDocsWork() (+120 more)
...
Cohesion: 0.04
Nodes (120): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+112 more)
...
Cohesion: 0.06
Nodes (112): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, cliProjectContext, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug() (+104 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (108): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultOutput() (+100 more)
...
Cohesion: 0.09
Nodes (76): bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), resourcePathForExpr(), resourceSourceForExpr(), resourceSourceForPath(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName() (+68 more)
...
Cohesion: 0.06
Nodes (58): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+50 more)
...
Cohesion: 0.1
Nodes (8): importedFunctionTargetFromExpr(), isNoneExpr(), isTypedTaskJoinCall(), rawPtrAddCall(), lowerer, EnsureTypedTaskHandleType(), IsTypedTaskHandleTypeName(), TypedTaskHandleTypesCompatible()
...
Cohesion: 0.05
Nodes (69): benchLevel, benchmarkEnvironment, buildEvidence, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState, latencyStats (+61 more)
...
Cohesion: 0.11
Nodes (60): firstCapture(), unsupportedGenericClosureCaptureError(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures() (+52 more)
...
Cohesion: 0.06
Nodes (56): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest(), targetsJSONForTest() (+48 more)
...
Cohesion: 0.1
Nodes (54): FormatPos(), allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), rejectMutableGlobalFunctionCaptures(), unsupportedGlobalFunctionCaptureStorageError(), unsupportedGlobalFunctionMutableCaptureStorageError(), unsupportedGlobalFunctionParameterStorageError(), validateFunctionTypeClosurePointerAssignment() (+46 more)
...
Cohesion: 0.09
Nodes (48): addVaultRecord(), buildNeedMap(), collectTransitiveNeeds(), runEcoNeedMap(), runEcoTrust(), runEcoTrustSnapshot(), scoreCapsuleTrust(), readVaultIndex() (+40 more)
...
Cohesion: 0.08
Nodes (41): TestEmitTaskJoinTypedSlotBounds(), TestEmitTaskJoinTypedWrapperWindowsX64SlotBounds(), budgetCharge, deferFrame, inoutReturnLocal, inoutWriteback, loopLabels, budgetChargedInstr() (+33 more)
...
Cohesion: 0.13
Nodes (35): bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), checkDeferBody(), checkStmts(), copyConsumedResources() (+27 more)
...
Cohesion: 0.09
Nodes (27): decodeStrictJSON(), main(), TestValidateProjectDepsReportAcceptsCheckFailReport(), TestValidateProjectDepsReportAcceptsCheckPassReport(), TestValidateProjectDepsReportAcceptsListReport(), TestValidateProjectDepsReportRejectsBadDependencyFields(), TestValidateProjectDepsReportRejectsFailWithoutIssue(), TestValidateProjectDepsReportRejectsInvalidTopLevelStatus() (+19 more)
...
Cohesion: 0.23
Nodes (27): TestObjectRoundTrip(), Version(), actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus() (+19 more)
...
Cohesion: 0.1
Nodes (12): emitCmp(), emitIndexLoad(), emitIndexStore(), emitMMIOWriteI32(), emitRawLoad(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+4 more)
...
Cohesion: 0.15
Nodes (20): isOwnershipAuditSeparatorRow(), main(), normalizeOwnershipAuditStatus(), ownershipAuditSection(), parseOwnershipAuditRows(), parseOwnershipAuditStatus(), splitOwnershipAuditTableRow(), ownershipAuditOptions (+12 more)
...
Cohesion: 0.44
Nodes (7): featuresReport, formatsReport, atomicPointerWidthBits(), buildTargetReportEntries(), describeTargetForText(), runTargets(), targetsReport

### Community 309 - "Community 309"
Cohesion: 0.22
Nodes (7): orderedMarkers(), parseLevels(), rewritePGHBAForSCRAM(), startSCRAMPostgres(), TestOrderedMarkers(), TestParseLevels(), TestRewritePGHBAForSCRAM()
