...
## Corpus Check
- 4465 files · ~6,519,983 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22085 nodes · 85480 edges · 1090 communities (938 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13792 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ba3dfce`
...
Cohesion: 0.03
Nodes (239): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+231 more)
...
Cohesion: 0.02
Nodes (188): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+180 more)
...
Cohesion: 0.04
Nodes (146): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+138 more)
...
Cohesion: 0.04
Nodes (142): markdownAuditRow(), renderBlockedOwnershipAudit(), TestOwnershipAuditFixtureHelpersLiveInFocusedFile(), TestOwnershipAuditValidatorPackageIsSplitByResponsibility(), TestValidateOwnershipAuditAcceptsBlockedAudit(), TestValidateOwnershipAuditRejectsAchievedStatusWithOpenRows(), TestValidateOwnershipAuditRejectsMissingActorAggregateAliasTransferTETRA2101Evidence(), TestValidateOwnershipAuditRejectsMissingActorAggregateTransferAliasRowEvidence() (+134 more)
...
Cohesion: 0.04
Nodes (101): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+93 more)
...
Cohesion: 0.05
Nodes (129): hasPrefix(), capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand() (+121 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (116): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), catchExprHasCompleteEnumPatterns(), cloneLocalMap(), collectExprLocals() (+108 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (103): TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes() (+95 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (90): Column, Conn, Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, Frame (+82 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (109): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+101 more)
...
Cohesion: 0.05
Nodes (45): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope() (+37 more)
...
Cohesion: 0.09
Nodes (98): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+90 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke() (+77 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (98): TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+90 more)
...
Cohesion: 0.04
Nodes (45): AssignStmt, AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase (+37 more)
...
Cohesion: 0.05
Nodes (61): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+53 more)

### Community 64 - "Community 64"
Cohesion: 0.05
Nodes (71): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+63 more)
...
Cohesion: 0.09
Nodes (64): main(), metricsHash(), validatePerformanceReport(), performanceMetric, performanceReport, performanceSummary, artifactCheck, fakeFileInfo (+56 more)
...
Cohesion: 0.1
Nodes (59): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+51 more)

### Community 75 - "Community 75"
Cohesion: 0.1
Nodes (61): main(), featureManifest, currentExperimentalModulePaths(), currentReleaseTruthDocPaths(), currentSpecMarkdownPaths(), currentStableModulePaths(), defaultMemoryProductionContractDocPaths(), defaultNetworkingRuntimeBoundaryDocPaths() (+53 more)
...
Cohesion: 0.06
Nodes (22): BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, IslandStmt (+14 more)
...
Cohesion: 0.05
Nodes (57): GitHub CI Workflow, CLI Contracts Spec, Current Supported Surface Spec, V0 1 1 Release Gate, V0 1 2 Release Gate, V0 1 3 Release Gate, V0 4 0 Release Gate, V1 0 Release Gate (+49 more)
...
Cohesion: 0.1
Nodes (45): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+37 more)
...
Cohesion: 0.1
Nodes (42): FuzzLexer(), FuzzParser(), capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot(), findCapsuleManifest(), main() (+34 more)
...
Cohesion: 0.16
Nodes (42): LinuxSysV(), NewEmitFunc(), addEdxImm32Bytes(), assertContainsBytes(), assertNotContainsBytes(), emitOneFunc(), emitOneFuncWithOptions(), emitWithArtifacts() (+34 more)
...
Cohesion: 0.14
Nodes (40): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+32 more)
...
Cohesion: 0.1
Nodes (36): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+28 more)
...
Cohesion: 0.14
Nodes (24): isUpdateQuery(), parseWorldUpdate(), pgAppendCString(), pgAppendInt16(), pgAppendInt32(), pgBackendKeyPayload(), pgCStringPayload(), pgCStringsPayload() (+16 more)
...
Cohesion: 0.06
Nodes (28): TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildOnly(), TestBuildBudgetedUnsafeCallsPreserveIRStack(), TestBuildBudgetRuntimeGuardAllowsAndFailsDeterministically(), TestBuildStructValFieldAssignFails(), TestBuildValAssignmentFails() (+20 more)
...
Cohesion: 0.13
Nodes (27): writeInterfaceHashOnlySurface(), AnalyzeLSPSource(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail() (+19 more)
...
Cohesion: 0.12
Nodes (28): requireLinuxX86Execution(), requireLocalTCPBind(), requireX32ExecutableFile(), TestExecWebProgramWithBrowserRunnerParsesBrowserExitResult(), TestExecWebProgramWithRunnerParsesBrowserExitResult(), TestRunCommandJSONDiagnosticsForLinuxX32HostUnsupported(), TestRunCommandJSONDiagnosticsForWASMWebRuntimeUnsupported(), TestRunCommandPropagatesLinuxX86AllocBytesZeroExitCode() (+20 more)

### Community 166 - "Community 166"
Cohesion: 0.18
Nodes (28): addVaultRecord(), readVaultIndex(), runEcoTrustSnapshot(), runEcoVault(), runEcoVaultAdd(), runEcoVaultList(), runEcoVaultVerify(), scoreCapsuleTrust() (+20 more)

### Community 167 - "Community 167"
Cohesion: 0.19
Nodes (22): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB (+14 more)
...
Cohesion: 0.14
Nodes (23): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+15 more)
...
Cohesion: 0.19
Nodes (23): ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles(), parseEcoPackArgs(), parseEcoUnpackArgs(), prepareEcoFileInsideRootNoSymlink() (+15 more)
...
Cohesion: 0.17
Nodes (24): emitActorNetPump(), emitActorNodeConnect(), emitActorSpawnRemote(), emitActorWireControlFrame(), emitLeaRdiRspDisp(), emitLeaRsiRspDisp(), emitMovEaxRspDisp(), emitMovMem16RspDispAx() (+16 more)
...
Cohesion: 0.22
Nodes (20): buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry(), parseAPIDocs() (+12 more)
...
Cohesion: 0.26
Nodes (19): ecoLockArtifact, ecoLockCapsule, ecoLockDependency, ecoLockEnvelope, cleanArtifactPath(), containsString(), isCapsuleSemver(), lockGraphFingerprint() (+11 more)
...
Cohesion: 0.11
Nodes (4): alignUp(), emitCmp(), emitFunc(), emitReturn()
...
Cohesion: 0.16
Nodes (19): Artifact Evidence Policy, Release Artifact Policy, Known Issues Evidence Contract v0.3.0, v0.3.0 Candidate Known Issues, RC Evidence Discipline, v1.0 Release Candidate Process, Tetra v0.1.1 Final Handoff, Tetra v0.3.0 Completion Audit (+11 more)
...
Cohesion: 0.28
Nodes (14): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+6 more)
...
Cohesion: 0.19
Nodes (14): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), auditParagraph(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence() (+6 more)
...
Cohesion: 0.31
Nodes (11): validateExportedOpaqueCapabilitySignature(), effectDiagnosticf(), effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl() (+3 more)
...
Cohesion: 0.19
Nodes (6): CodegenOptions, AlignStackSize(), TestABIAlignStackSize(), TestObjectPatchRel32ForwardAndBackward(), TestObjectPatchRel32RejectsInvalidPatchOffsets(), TestObjectPatchRel32RejectsOutOfRangeTargets()
