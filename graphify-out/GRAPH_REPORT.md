...
## Corpus Check
- 4465 files · ~6,517,846 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22081 nodes · 85468 edges · 1073 communities (922 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13790 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e6bb260c`
...
## Communities (1073 total, 151 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (421): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+413 more)
...
Cohesion: 0.02
Nodes (362): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+354 more)
...
Cohesion: 0.02
Nodes (332): TestDistributedActorRuntimeRejectsUnsupportedNativeTargets(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestLSPCommandSmoke(), assertCLIJSONLifetimeDiagnostic(), assertCLIJSONOwnershipDiagnostic(), assertCLIJSONSemanticDiagnostic(), assertLSPTestError() (+324 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (266): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+258 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (262): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions() (+254 more)
...
Cohesion: 0.04
Nodes (164): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+156 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (153): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+145 more)
...
Cohesion: 0.03
Nodes (136): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+128 more)
...
Cohesion: 0.04
Nodes (123): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+115 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (130): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+122 more)
...
Cohesion: 0.06
Nodes (118): capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand(), artifactSlug() (+110 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (105): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), cloneLocalMap(), collectExprLocals(), inferCatchExprType() (+97 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (99): BrokerReport, CaseReport, FrameCounts, ProcessReport, Report, decodeStrict(), TestValidateReportAcceptsExecutableLinuxX64Evidence(), TestValidateReportRejectsMissingFailureCase() (+91 more)
...
Cohesion: 0.04
Nodes (100): benchLevel, benchmarkEnvironment, buildEvidence, buildPlan, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState (+92 more)
...
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics() (+77 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke() (+90 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (40): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree() (+32 more)
...
Cohesion: 0.04
Nodes (45): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase, ClosureExpr (+37 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (69): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+61 more)
...
Cohesion: 0.04
Nodes (73): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+65 more)
...
Cohesion: 0.09
Nodes (72): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+64 more)
...
Cohesion: 0.09
Nodes (66): canRunLinuxX32OnHost(), probeLinuxX32Execution(), main(), metricsHash(), validatePerformanceReport(), performanceMetric, performanceReport, performanceSummary (+58 more)

### Community 67 - "Community 67"
Cohesion: 0.05
Nodes (69): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+61 more)
...
Cohesion: 0.08
Nodes (8): alignUp(), emitCall(), emitFunc(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitter
...
Cohesion: 0.06
Nodes (65): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+57 more)

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (59): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, parseBuildTargetOrReport(), writeDiagnostic(), abiObjectHasSymbol(), abiObjectHasSymbolSignature(), compareAggregateLayout() (+51 more)
...
Cohesion: 0.08
Nodes (50): FuzzLexer(), FuzzParser(), capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot(), findCapsuleManifest(), main() (+42 more)

### Community 79 - "Community 79"
Cohesion: 0.09
Nodes (50): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+42 more)
...
Cohesion: 0.13
Nodes (55): defaultTarget(), writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers() (+47 more)
...
Cohesion: 0.1
Nodes (46): runEcoMaterializationValidator(), TestValidateEcoMaterializationAcceptsEmptyTarget(), TestValidateEcoMaterializationAcceptsValidReport(), TestValidateEcoMaterializationRejectsBadLockHash(), TestValidateEcoMaterializationRejectsEmptyPackagePath(), TestValidateEcoMaterializationRejectsEmptyTrustSnapshot(), TestValidateEcoMaterializationRejectsMalformedJSON(), TestValidateEcoMaterializationRejectsMissingRequiredField() (+38 more)

### Community 87 - "Community 87"
Cohesion: 0.13
Nodes (50): actualForExpected(), artifactCases(), buildOnlyCases(), caseJSON(), intLiteral(), runtimeCases(), runtimeReport(), TestValidateWASISmokeReportAcceptsArtifactPreflightReport() (+42 more)
...
Cohesion: 0.13
Nodes (44): itoa(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName(), dispatchTranscript(), initialState() (+36 more)
...
Cohesion: 0.08
Nodes (45): atomicMaskedFetchAdd(), atomicMaskedFetchXor(), atomicStressIterations(), atomicStressYield(), atomicSuiteOrderAllowed(), atomicSuiteTargetPrefix(), checkAtomicABAStampedPointer(), checkAtomicConcurrencyStressOracle() (+37 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (42): featuresReport, formatsReport, allTargetsOutput(), discoverWASIRunner(), discoverWebRunner(), discoverWebRuntimeRunner(), execWASMProgram(), execWASMProgramWithRunner() (+34 more)
...
Cohesion: 0.13
Nodes (34): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+26 more)
...
Cohesion: 0.13
Nodes (36): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+28 more)

### Community 132 - "Community 132"
Cohesion: 0.16
Nodes (36): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+28 more)
...
Cohesion: 0.05
Nodes (27): TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke(), TestBuildGlobalVarPtrZeroInitializerSmoke(), TestBuildGlobalVarStringFieldAccessAfterAssignmentSmoke(), TestBuildGlobalVarStringLiteralInitializerSmoke() (+19 more)

### Community 135 - "Community 135"
Cohesion: 0.11
Nodes (34): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+26 more)
...
Cohesion: 0.05
Nodes (12): AssignStmt, BreakStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, LetStmt (+4 more)
...
Cohesion: 0.18
Nodes (34): capsuleSectionHeader(), appendDependencyToCapsule(), buildProjectDepsReport(), buildProjectInfoReport(), checkProjectLockOnly(), checkProjectSync(), describeProjectDependency(), discoverProjectDepsContext() (+26 more)
...
Cohesion: 0.11
Nodes (25): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+17 more)
...
Cohesion: 0.09
Nodes (15): emitCmp(), emitIndexLoad(), emitIndexStore(), emitMmapFailureBranch(), emitMMIOReadI32(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite() (+7 more)
...
Cohesion: 0.19
Nodes (28): FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver() (+20 more)
...
Cohesion: 0.18
Nodes (28): addVaultRecord(), readVaultIndex(), runEcoVault(), runEcoVaultAdd(), runEcoVaultList(), runEcoVaultVerify(), sortVaultRecords(), upsertVaultRecord() (+20 more)
...
Cohesion: 0.13
Nodes (24): BuildFile(), findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio() (+16 more)
...
Cohesion: 0.07
Nodes (21): TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsMismatchedImplSignature(), TestGenericFunctionProtocolBoundRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsNonProtocolBound() (+13 more)
...
Cohesion: 0.17
Nodes (20): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+12 more)
...
Cohesion: 0.19
Nodes (21): FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects(), readI32LE(), TestCollectImportsSortsAndDedupes(), TestLinkX64ObjectsCollectsAbsoluteDataRelocs(), TestLinkX64ObjectsCollectsAbsoluteFunctionAddressRelocs(), TestLinkX64ObjectsCollectsDataRelocs(), TestLinkX64ObjectsCollectsIATRelocs() (+13 more)
...
Cohesion: 0.23
Nodes (17): validateDiagnosticsMode(), firstFormatterDiffPosition(), runCheck(), runDoc(), runFmt(), diagnostic, main(), parseDiagnostic() (+9 more)
...
Cohesion: 0.13
Nodes (6): emitAllocBytes(), emitExit(), emitMakeSlice(), emitWrite(), guardAllocationOffsetRawAccess(), patchExitBranch()
...
Cohesion: 0.24
Nodes (10): lexer, hexValue(), isDigit(), isHexDigit(), isIdentPart(), isIdentStart(), newLexer(), token (+2 more)

### Community 234 - "Community 234"
Cohesion: 0.18
Nodes (13): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths(), ModuleRelPath() (+5 more)
...
Cohesion: 0.11
Nodes (21): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+13 more)
...
Cohesion: 0.35
Nodes (14): readTestFrame(), helloAckFrame(), TestLinuxRuntimeConnectsToLoopbackBroker(), TestLinuxRuntimeConnectWritesHelloFrame(), TestLinuxRuntimePumpsNodeDownIntoNodeStatus(), TestLinuxRuntimePumpsRemoteSendIntoRecv(), TestLinuxRuntimePumpsRemoteTypedFrameIntoRecvMsg(), TestLinuxRuntimePumpsRemoteTypedFrameIntoRecvTyped() (+6 more)
...
Cohesion: 0.14
Nodes (15): emitEntryStubSysVLinuxX86(), LinkLinuxX86(), containsMovEaxImm32LinkerTest(), emitEntryStubForTestX86(), TestLinkLinuxRejectsNonLinuxTargetObject(), TestLinkLinuxX32DataRelocsUseELF32X32Layout(), TestLinkLinuxX32RejectsNonX32TargetObject(), TestLinkLinuxX32UsesX32ExitSyscall() (+7 more)
...
Cohesion: 0.16
Nodes (17): WaveB Stabilization API Docs Snapshot, WaveB Stabilization Tetra Docs Snapshot, WaveB Stabilization Tooling Summary, WaveB Gate Test-All API Docs Snapshot, WaveB Gate Test-All Tooling Summary, WaveD API Snapshot sha256:09e83e7a..., WaveD Full API Docs, WaveD Full Tetra Docs (+9 more)
...
Cohesion: 0.25
Nodes (13): TestFuzzNightlyAcceptsDashPrefixedFreshOutDir(), TestFuzzNightlyDocsNameWrapperAndCrashers(), TestFuzzNightlyFailureSummaryRecordsExitCodes(), TestFuzzNightlyRejectsFuzztimeAbovePolicyBoundBeforeExecution(), TestFuzzNightlyRejectsInvalidFuzztimeBeforeExecution(), TestFuzzNightlyRejectsStaleNonEmptyOutDir(), TestFuzzNightlyRejectsUnsafeOutDirBeforeExecution(), TestFuzzNightlySummaryEscapesControlCharacters() (+5 more)
...
Cohesion: 0.29
Nodes (13): canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail(), formatLSPImplName() (+5 more)

### Community 325 - "Community 325"
Cohesion: 0.19
Nodes (8): LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), Result, LinkWindowsX64()
...
Cohesion: 0.15
Nodes (14): Docs Manifest Freshness Check, Short Fuzz Nightly Mode, Unstable Seed Tracking Policy, Fuzz Short Summary (v0.3-stabilization), Wave2 ImplD Fuzz Short Summary, Wave2 ImplD Gate Summary, Wave2 ImplD Release State, Wave2 ImplD Test-All API Docs (+6 more)
...
Cohesion: 0.42
Nodes (10): assertFrame(), dialTestNode(), startTestBroker(), TestBrokerReportsNodeDownForMissingDestination(), TestBrokerRoutesFramesBetweenLoopbackNodesAndWritesReport(), TestBrokerTreatsClosedDestinationWriteAsDroppedFrame(), TestClosedConnectionErrorsIncludePeerReset(), waitForBrokerReport() (+2 more)
...
Cohesion: 0.36
Nodes (8): TestValidateReportAcceptsLinuxX64MemoryProductionEvidence(), TestValidateReportRejectsMissingAllocatorFailureSemantics(), TestValidateReportRejectsMissingAllocatorInvalidSizePrecondition(), TestValidateReportRejectsMissingCompletionAudit(), TestValidateReportRejectsMissingRawPtrAddAllocationUpperBound(), TestValidateReportRejectsMissingRawPtrAddNegativeOffsetBounds(), TestValidateReportRejectsMissingRequiredSafetyCases(), TestValidateReportRejectsPaperOnlyMemoryEvidence()
...
Cohesion: 0.31
Nodes (10): functionTypedSliceCallbackAggregateValue(), functionTypedSliceCallbackBody(), functionTypedSliceCallbackCall(), functionTypedSliceCallbackCrossModuleFiles(), functionTypedSliceCallbackLocalName(), functionTypedSliceCallbackParam(), functionTypedSliceCallbackParamType(), functionTypedSliceCallbackSource() (+2 more)
...
Cohesion: 0.6
Nodes (4): TestLowerModuleCallableFunctionTypedCrossModulePath(), TestLowerPublicAPIVerifiesRepresentativeIR(), TestPublicCodegenRejectsInvalidIRBeforeBackend(), writeTestFiles()
