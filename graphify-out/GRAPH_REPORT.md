...
## Corpus Check
- 4465 files · ~6,484,771 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21993 nodes · 85175 edges · 1087 communities (934 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13727 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91ed98d3`
...
## Communities (1087 total, 153 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (507): buildAndRun(), buildAndRunFiles(), TestBuildMultiFileAliasCall(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke() (+499 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (411): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+403 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (424): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes() (+416 more)
...
Cohesion: 0.03
Nodes (233): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+225 more)
...
Cohesion: 0.03
Nodes (192): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+184 more)
...
Cohesion: 0.03
Nodes (160): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation(), TestBuildCommandJSONDiagnosticsForTooManyInputs() (+152 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (162): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+154 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (144): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+136 more)
...
Cohesion: 0.05
Nodes (144): assertLegacyFileRemoved(), assertOldGateDidNotCreateReportSubdirs(), assertOldGateRejectedBeforeSideEffects(), assertOldGateRejectsNonDirectoryReportPath(), assertOldGateRejectsNonEmptyReportDir(), assertOldGateRejectsNonEmptyReportDirWithArg(), normalizeDashLeadingReportDirForTest(), releaseOldGateMinimalRoot() (+136 more)
...
Cohesion: 0.05
Nodes (115): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+107 more)
...
Cohesion: 0.05
Nodes (111): BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions() (+103 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (112): assignTargetInfo, bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), catchPatternType(), cloneLocalMap(), collectExprLocals() (+104 more)
...
Cohesion: 0.05
Nodes (42): branchScopeInfo, mergeControlFlowWithLabels(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree() (+34 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (90): resolveFunctionFieldName(), CallableEscapeKind, checkStmts(), collectionElementType(), collectLocals(), copySecretTaintMap(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata() (+82 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+90 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke() (+77 more)
...
Cohesion: 0.08
Nodes (85): capsuleArtifact, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand(), artifactSlug() (+77 more)
...
Cohesion: 0.08
Nodes (8): atomicFetchCASLoop32(), emitCall(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), emitMmapFailureBranch(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.07
Nodes (64): TestArrayMVPCheckAcceptsIndexAndForOnFixedArray(), TestOwnershipAllowsConsumedStructFieldReassignment(), TestOwnershipAllowsPartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsPartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipAllowsProtocolImplMatchingParameterOwnership(), TestOwnershipAllowsStructFieldsFromDistinctBorrowRegions(), checkEffectsFileProgram(), checkEffectsProgram() (+56 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (58): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost() (+50 more)
...
Cohesion: 0.06
Nodes (48): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+40 more)
...
Cohesion: 0.06
Nodes (22): AssignStmt, BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ForRangeStmt, FreeStmt, IslandStmt (+14 more)
...
Cohesion: 0.06
Nodes (58): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+50 more)
...
Cohesion: 0.13
Nodes (53): writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers(), encodeWorkspaceJSON() (+45 more)
...
Cohesion: 0.08
Nodes (38): LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64(), DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports() (+30 more)

### Community 92 - "Community 92"
Cohesion: 0.1
Nodes (49): runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt(), matchesBudgetGuardBefore(), matchesBudgetInitializerAt(), matchesConsentGuardAt(), policyShapeError() (+41 more)
...
Cohesion: 0.07
Nodes (47): BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats, averageMS() (+39 more)

### Community 99 - "Community 99"
Cohesion: 0.11
Nodes (42): runEcoLockValidator(), TestValidateEcoLockAcceptsArtifacts(), TestValidateEcoLockAcceptsCapsulePolicy(), TestValidateEcoLockAcceptsDependencyGraph(), TestValidateEcoLockRejectsDependencyPermissionEscalation(), TestValidateEcoLockRejectsDuplicateCapsuleID(), TestValidateEcoLockRejectsDuplicateDependency(), TestValidateEcoLockRejectsDuplicateTarget() (+34 more)

### Community 100 - "Community 100"
Cohesion: 0.13
Nodes (26): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16() (+18 more)
...
Cohesion: 0.11
Nodes (40): hasPrefix(), parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles() (+32 more)
...
Cohesion: 0.15
Nodes (42): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept(), stepLogSlug(), TestValidateReleaseGateSummaryAcceptsBlockedPreflightReport() (+34 more)
...
Cohesion: 0.08
Nodes (42): BenchmarkEnvironment, EndpointReport, GitState, requiredMatrixSemanticProbeNames(), validateMatrixBuild(), validateMatrixPostgres(), ValidateMatrixReport(), validateMatrixResource() (+34 more)
...
Cohesion: 0.11
Nodes (27): bodyPrefix(), hasSymbol(), symbolBody(), TestActorNetPumpIsExportedButOnlyLinuxHasRuntimePump(), TestBuiltinRuntimeExportsActorStateSymbols(), TestLinuxDistributedRuntimeUsesWideStackSubFor128ByteFrames(), TestLinuxRuntimeExportsDistributedActorSymbols(), TestLinuxRuntimeExportsFilesystemSymbol() (+19 more)

### Community 136 - "Community 136"
Cohesion: 0.1
Nodes (26): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), Lower(), LowerModule() (+18 more)
...
Cohesion: 0.1
Nodes (31): BuildFile(), findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget() (+23 more)
...
Cohesion: 0.15
Nodes (31): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), findCapsulePath(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+23 more)
...
Cohesion: 0.12
Nodes (24): runtimeObjectSymbols(), runtimeObjectWithFilesystemRuntimeSignatures(), TestCollectFilesystemRuntimeUsage(), TestFilesystemRuntimeExistsBuildAndRunLinuxX64(), TestFilesystemRuntimeRejectsUnsupportedNativeTargets(), TestFilesystemRuntimeRequiredSymbolsAndSignatures(), TestRuntimeObjectOverrideRejectsMissingFilesystemSymbols(), TestValidateFilesystemRuntimeObjectChecksSignatureMetadata() (+16 more)
...
Cohesion: 0.08
Nodes (18): TestModuleBoundaryAllowsPublicImportedFunction(), TestModuleBoundaryRejectsPrivateImportedFunction(), TestPublicReExportSupportsSelectiveImport(), TestSelectiveImportRejectsDuplicateImportedSymbol(), TestSelectiveImportResolvesPublicFunctionAndType(), writeCompilerModuleFiles(), TestOptionalMatchMissingSomeCaseNeedsReturn(), TestOptionalNarrowingBindingsDoNotEscapeCaseScope() (+10 more)
...
Cohesion: 0.19
Nodes (27): capsuleIDDirectory(), decodeEcoPublishMetadata(), downloadPackage(), ecoPublishPackageHashHex(), ecoPublishSchemaForChannel(), ecoPublishSHA256HashHex(), fetchEcoHTTPStoreFile(), fetchPublishedPackage() (+19 more)
...
Cohesion: 0.13
Nodes (12): emitIndexLoad(), emitIndexStore(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite(), emitRawStore() (+4 more)

### Community 213 - "Community 213"
Cohesion: 0.26
Nodes (21): LoadWorld(), LoadWorldOpt(), cleanModuleRoots(), cleanSourceRoots(), describeModuleSourceRootPaths(), LoadWorld(), LoadWorldOpt(), moduleLoadCandidateRelPaths() (+13 more)
...
Cohesion: 0.15
Nodes (7): emitAllocBytes(), emitExit(), emitIslandFree(), emitMakeSlice(), emitMMIOWriteI32(), emitWrite(), patchExitBranch()
...
Cohesion: 0.26
Nodes (14): runInterface(), validateDiagnosticsMode(), diagnostic, main(), parseDiagnostic(), TestValidateDiagnosticAcceptsStableShape(), TestValidateDiagnosticRejectsInvalidSeverity(), TestValidateDiagnosticRejectsMissingRequiredFields() (+6 more)
...
Cohesion: 0.25
Nodes (11): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsWeakEvidenceAndBadCounters() (+3 more)
...
Cohesion: 0.37
Nodes (11): BuildObject(), TestObjectBuildCollectsRelocsAndSymbols(), TestObjectBuildEmitsFunctionAddressRelocDistinctFromCall(), TestObjectBuildRejectsDuplicateSymbols(), TestObjectBuildRejectsEmptyCallPatchName(), TestObjectBuildRejectsEmptyFunctionName(), TestObjectBuildRejectsEmptyImportPatchName(), TestObjectBuildRejectsInvalidDataPatchIndex() (+3 more)
...
Cohesion: 0.27
Nodes (5): TestListenWorkersClosesAlreadyStartedWorkersWhenLaterWorkerFails(), TestListenWorkersServesSharedPortAcrossMultipleEventLoops(), WorkerFactory, WorkerGroup, ListenWorkers()
...
Cohesion: 0.39
Nodes (8): TestValidateReportAcceptsTargetHostRuntimeEvidence(), TestValidateReportRejectsBlockedRuntimeLessEvidence(), TestValidateReportRejectsBuildOnlyEvidence(), TestValidateReportRejectsMissingRuntimeTraceMarkers(), TestValidateReportRejectsNonChildRunner(), TestValidateReportRejectsWindowOnlyPlatformProbe(), TestValidateReportWithOptionsRejectsStaleVersionAndGitHead(), validPlatformUIReport()
