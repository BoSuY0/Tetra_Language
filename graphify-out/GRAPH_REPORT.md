...
## Corpus Check
- 620 files · ~1,271,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18670 nodes · 73304 edges · 516 communities (440 shown, 76 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13536 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75639f0f`
...
## Communities (516 total, 76 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (515): buildAndRun(), buildAndRunFiles(), TestDeferRejectsBreakToOuterLoopInsideCleanup(), TestDeferRejectsLaterActorTransferOfCapturedIsland(), TestDeferRejectsLaterConsumeOfCapturedValue(), TestDeferRejectsReturnInsideCleanup(), TestDeferRejectsThrowInsideCleanup(), TestDeferRunsBeforeScopedIslandAutoFree() (+507 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (435): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+427 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (292): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+284 more)
...
Cohesion: 0.03
Nodes (218): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals() (+210 more)
...
Cohesion: 0.06
Nodes (110): capsuleArtifact, capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand() (+102 more)
...
Cohesion: 0.06
Nodes (107): appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+99 more)
...
Cohesion: 0.04
Nodes (51): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope() (+43 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (94): canRunLinuxX32OnHost(), probeLinuxX32Execution(), decodeStrictNativeUIJSON(), main(), validateNativeUISmoke(), validateNativeUIView(), nativeUIBindingTrace, nativeUIEventTrace (+86 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (85): runAPIDocsValidator(), TestValidateAPIDocsAcceptsGeneratedShape(), TestValidateAPIDocsRejectsAPIMetadataHashMismatch(), TestValidateAPIDocsRejectsBrokenInternalLink(), TestValidateAPIDocsRejectsDuplicateModules(), TestValidateAPIDocsRejectsEmptyDocument(), TestValidateAPIDocsRejectsEntryBeforeSection(), TestValidateAPIDocsRejectsErrorOutput() (+77 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+90 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (82): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+74 more)

### Community 52 - "Community 52"
Cohesion: 0.1
Nodes (94): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata() (+86 more)
...
Cohesion: 0.06
Nodes (78): BuildOptions, featuresReport, formatsReport, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+70 more)
...
Cohesion: 0.1
Nodes (6): importedFunctionTargetFromExpr(), isNoneExpr(), isTypedTaskJoinCall(), lowerer, IsTypedTaskHandleTypeName(), TypedTaskHandleTypesCompatible()
...
Cohesion: 0.08
Nodes (53): TypeRefKind, resolveFieldChainLower(), assignTargetInfo, bindMatchPatternLocalsForInference(), catchExprHasCompleteEnumPatterns(), catchPatternType(), cloneLocalMap(), collectExprLocals() (+45 more)
...
Cohesion: 0.07
Nodes (50): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), requireUnsupportedReasonContains(), targetMetaForTest() (+42 more)
...
Cohesion: 0.05
Nodes (53): API Diff No-Change Policy, API Snapshot sha256:0966ebbb..., API Snapshot sha256:09e83e7a..., Docs Manifest Freshness Check, Short Fuzz Nightly Mode, v0.3.0 Release Gate, tetra.api.v1alpha1 API Documentation, tetra.ui.v1 Shell Preview (+45 more)
...
Cohesion: 0.1
Nodes (37): budgetCharge, deferFrame, inoutReturnLocal, inoutWriteback, loopLabels, budgetChargedInstr(), budgetChargeForInstr(), clauseConstI32() (+29 more)
...
Cohesion: 0.1
Nodes (29): FeatureInfo, FeatureRegistry(), TestFeatureRegistryCLICoreCoversDocumentedPublicCommands(), TestFeatureRegistryCoversReleaseStatusesAndKeyBoundaries(), TestFeatureRegistryReturnsDefensiveCopy(), TestManifestBuiltinsExposeCanonicalSafetyEffectsAndPolicies(), FeatureStatus, buildWasmTargets() (+21 more)
...
Cohesion: 0.18
Nodes (26): apiDocTitle(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), disambiguatedAPIDocTitles(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+18 more)
...
Cohesion: 0.15
Nodes (4): atomicFetchCASLoop32(), emitAllocBytes(), emitMakeSlice(), patchExitBranch()
...
Cohesion: 0.36
Nodes (8): TestRunBenchmarkChecksEndpointsAndWritesReport(), TestRunBenchmarkFailsWhenThresholdIsMissed(), TestRunBenchmarkRecordsLatencyPercentilesAndIntegrityMetadata(), TestValidateReportAllowsFailedEndpointWithZeroRPS(), TestValidateReportRejectsWeakEvidenceMarkers(), TestValidateReportRequiresAllTechEmpowerEndpoints(), validTestReport(), NewServer()
