...
## Corpus Check
- 4465 files · ~6,485,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21994 nodes · 85183 edges · 1068 communities (917 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13729 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cda1269a`
...
## Communities (1068 total, 151 thin omitted)
...
Cohesion: 0.01
Nodes (305): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+297 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (401): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode() (+393 more)
...
Cohesion: 0.03
Nodes (242): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+234 more)
...
Cohesion: 0.03
Nodes (160): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+152 more)
...
Cohesion: 0.03
Nodes (162): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+154 more)
...
Cohesion: 0.04
Nodes (125): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+117 more)
...
Cohesion: 0.05
Nodes (98): TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipOptionalPayloadConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConstructorAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialEnumCopyAfterConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructConsumeCode(), TestCheckCommandJSONDiagnosticsForOwnershipPartialStructCopyAfterConsumeCode() (+90 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (55): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), ownershipPathParent(), ownershipPathPrefix(), splitOwnershipPathSegments(), appendRegionTree(), bindRegionTreeFromExpr() (+47 more)
...
Cohesion: 0.07
Nodes (106): resolveFieldChainLower(), assignTargetInfo, bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), borrowedPtrOwnerFromExpr() (+98 more)
...
Cohesion: 0.06
Nodes (104): capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+96 more)
...
Cohesion: 0.04
Nodes (45): AssignStmt, BoolLitExpr, BreakStmt, CapsuleEntryDecl, CatchExpr, CatchExprCase, ClosureExpr, ContinueStmt (+37 more)
...
Cohesion: 0.06
Nodes (63): BuildMacOSX64(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+55 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (66): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultTarget() (+58 more)
...
Cohesion: 0.1
Nodes (67): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+59 more)
...
Cohesion: 0.07
Nodes (62): runAPIDocsValidator(), TestValidateAPIDocsAcceptsGeneratedShape(), TestValidateAPIDocsRejectsAPIMetadataHashMismatch(), TestValidateAPIDocsRejectsBrokenInternalLink(), TestValidateAPIDocsRejectsDuplicateModules(), TestValidateAPIDocsRejectsEmptyDocument(), TestValidateAPIDocsRejectsEntryBeforeSection(), TestValidateAPIDocsRejectsErrorOutput() (+54 more)
...
Cohesion: 0.08
Nodes (64): TestRenderDispatchesCommandOperationsInOrder(), TestRenderDispatchesStateSetFromSameStateField(), TestRenderDispatchesStateSubtractOperations(), TestRenderDispatchesStringStateSetWithoutLiteralQuotes(), TestRenderIncludesStateAndViewMetadata(), TestRenderJSONIncludesDispatchTrace(), TestRenderJSONIncludesNativeWidgetTree(), TestRenderNilBundleIncludesNoMetadataMarker() (+56 more)
...
Cohesion: 0.06
Nodes (22): AwaitExpr, BinaryExpr, CallExpr, EnumCasePatternExpr, FieldAccessExpr, IndexExpr, lexer, hexValue() (+14 more)
...
Cohesion: 0.08
Nodes (28): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+20 more)
...
Cohesion: 0.15
Nodes (43): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept(), stepLogSlug(), TestValidateReleaseGateSummaryAcceptsBlockedPreflightReport() (+35 more)
...
Cohesion: 0.06
Nodes (45): API Diff Docs Snapshot (hash 0966...ca390), api diff no-change step, API Docs Snapshot (hash 623d...53917), API Docs Snapshot (hash 09e8...50e66), API Hash sha256:0966... (81 modules, 226 entries), API Hash sha256:09e8... (83 modules, 228 entries), API Hash sha256:623d... (49 modules, 97 entries), Release Artifact tetra.release.v0_2_0.test-all-summary.v1 (+37 more)
...
Cohesion: 0.13
Nodes (28): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+20 more)
...
Cohesion: 0.11
Nodes (30): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+22 more)
...
Cohesion: 0.12
Nodes (22): dialTCP4Localhost(), netListenTCP4Localhost(), TestCollectNetRuntimeUsage(), TestNetRuntimeEpollReadinessBuildAndRunLinuxX64(), TestNetRuntimeEpollWaitOneIntoBuildAndRunLinuxX64(), TestNetRuntimeHTTPPipelinedPlaintextJSONBuildAndRunLinuxX64(), TestNetRuntimeHTTPPlaintextServerBuildAndRunLinuxX64(), TestNetRuntimeRejectsUnsupportedNativeTargets() (+14 more)
...
Cohesion: 0.14
Nodes (21): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+13 more)
...
Cohesion: 0.23
Nodes (26): artifactSlug(), buildCapsuleArtifacts(), capsuleSourceModules(), defaultCapsulePath(), interfaceArtifactRelPath(), writeEcoLock(), parseCapsuleGraphArgs(), validateCapsuleGraph() (+18 more)
