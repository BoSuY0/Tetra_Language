...
## Corpus Check
- 4465 files · ~6,511,841 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22070 nodes · 85435 edges · 1078 communities (927 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13781 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a615aeef`
...
## Communities (1078 total, 151 thin omitted)
...
Cohesion: 0.01
Nodes (429): writeFile(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError() (+421 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (300): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+292 more)
...
Cohesion: 0.02
Nodes (266): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions() (+258 more)
...
Cohesion: 0.03
Nodes (217): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), capsulePermissionEntry() (+209 more)
...
Cohesion: 0.05
Nodes (109): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+101 more)
...
Cohesion: 0.04
Nodes (64): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+56 more)
...
Cohesion: 0.07
Nodes (100): appendResourceProvenance(), bindCatchErrorResourceSummary(), bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), matchExprHasCompleteEnumPatterns(), matchExprHasCompleteOptionalPatterns(), matchPatternCompatible() (+92 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (102): capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), artifactRepairCommand(), artifactSlug() (+94 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+90 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+77 more)
...
Cohesion: 0.11
Nodes (89): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), checkStmts(), collectionElementType(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata() (+81 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (79): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+71 more)
...
Cohesion: 0.06
Nodes (75): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+67 more)
...
Cohesion: 0.05
Nodes (68): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+60 more)
...
Cohesion: 0.09
Nodes (70): firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds(), cloneClosureCaptures(), cloneExpr() (+62 more)

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (6): ParseFile(), diagnosticErrorf(), parser, buildFieldAccess(), isFunctionLikeCallee(), ParseFile()
...
Cohesion: 0.04
Nodes (39): AssignStmt, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl, ExpectStmt (+31 more)
...
Cohesion: 0.06
Nodes (64): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+56 more)
...
Cohesion: 0.12
Nodes (47): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+39 more)
...
Cohesion: 0.06
Nodes (55): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+47 more)
...
Cohesion: 0.1
Nodes (6): atomicFetchCASLoop32(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitReturn(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.07
Nodes (38): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+30 more)
...
Cohesion: 0.1
Nodes (36): Web UI Smoke DOM (test-all-20260429-145050), Tetra UI Schema v1, Security Evidence Web UI DOM, Web UI Smoke DOM (v0.3-stabilization), createImports(), instantiateTetra(), memoryView(), readUTF8() (+28 more)
...
Cohesion: 0.14
Nodes (39): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+31 more)
...
Cohesion: 0.08
Nodes (33): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+25 more)
...
Cohesion: 0.09
Nodes (6): alignUp(), emitCall(), emitExit(), emitFunc(), emitIslandFree(), emitWrite()
...
Cohesion: 0.18
Nodes (30): ClosureCapture, classifyCallableEscape(), callableEscapeBoundary, captureMode, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), cloneBoolMap(), rejectMutableGlobalFunctionCaptures() (+22 more)
...
Cohesion: 0.13
Nodes (28): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+20 more)

### Community 165 - "Community 165"
Cohesion: 0.1
Nodes (29): hexValue(), isDigit(), isHexDigit(), isIdentPart(), isIdentStart(), newLexer(), token, TokenType (+21 more)
...
Cohesion: 0.24
Nodes (22): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), describeProjectDependencyCycle() (+14 more)
...
Cohesion: 0.18
Nodes (6): emitAllocBytes(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), emitMMIOWriteI32(), patchExitBranch()
