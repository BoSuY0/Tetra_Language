...
## Corpus Check
- 4465 files · ~6,483,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21990 nodes · 85158 edges · 1072 communities (922 shown, 150 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13724 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2de0d08`
...
## Communities (1072 total, 150 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (504): buildAndRun(), buildAndRunFiles(), TestBuildImportedGlobalOnlyModuleSmoke(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke() (+496 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (473): writeFile(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestReleaseV040GateRejectsNonEmptyReportDirBeforeSideEffects(), TestReleaseV040GateWritesBlockedSummaryOnReadinessFailure(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes() (+465 more)
...
Cohesion: 0.03
Nodes (177): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+169 more)
...
Cohesion: 0.04
Nodes (168): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot() (+160 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (149): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+141 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (152): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason() (+144 more)
...
Cohesion: 0.05
Nodes (131): flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment(), validateFile(), validatePaths() (+123 more)
...
Cohesion: 0.05
Nodes (105): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+97 more)
...
Cohesion: 0.06
Nodes (96): ClosureCapture, TypeRefKind, captureMode, bindMatchPatternLocalsForInference(), cloneBoolMap(), cloneLocalMap(), collectExprLocals(), inferCatchExprType() (+88 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (109): requireCheckWorldFilesErrorContains(), requireCheckWorldFilesOK(), TestOwnershipAllowsCrossModulePartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsCrossModulePartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipBorrowParamCannotMutate(), TestOwnershipConsumeArgumentCannotBeReused(), TestOwnershipConsumedValueCannotBeReassigned(), TestOwnershipInoutRequiresMutableLocal() (+101 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (98): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+90 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (102): DiagnosticForError(), exprString(), parseExpr(), TestParseActorDeclarationDesugarsMethods(), TestParseActorDeclarationPreservesMethodUsesActors(), TestParseActorDeclarationRejectsUnsupportedMembers(), TestParseActorDeclarationSupportsImmutableStateFields(), TestParseActorDeclarationSupportsMutableStateField() (+94 more)
...
Cohesion: 0.07
Nodes (94): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName() (+86 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (79): BuildMacOSX64(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+71 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (98): TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldCallbackSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics() (+90 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke() (+77 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (94): resolveFunctionFieldName(), CallableEscapeKind, collectLocals(), collectPatternLocals(), collectScopedLocal(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs() (+86 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (75): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns() (+67 more)
...
Cohesion: 0.07
Nodes (80): main(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry() (+72 more)

### Community 59 - "Community 59"
Cohesion: 0.15
Nodes (7): ParseFile(), DiagnosticError, diagnosticErrorf(), parser, buildFieldAccess(), ParseFile(), plannedFeatureError()

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (40): AssignStmt, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl, ExpectStmt (+32 more)
...
Cohesion: 0.07
Nodes (61): runAPIDocsValidator(), TestValidateAPIDocsAcceptsGeneratedShape(), TestValidateAPIDocsRejectsAPIMetadataHashMismatch(), TestValidateAPIDocsRejectsBrokenInternalLink(), TestValidateAPIDocsRejectsDuplicateModules(), TestValidateAPIDocsRejectsEmptyDocument(), TestValidateAPIDocsRejectsEntryBeforeSection(), TestValidateAPIDocsRejectsErrorOutput() (+53 more)
...
Cohesion: 0.05
Nodes (55): objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), TestBuildRejectsInterfaceImplementationMissingSymbol(), TestObjectReadRejectsInvalidMagicAndVersion() (+47 more)
...
Cohesion: 0.08
Nodes (56): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, abiObjectHasSymbol(), abiObjectHasSymbolSignature(), compareAggregateLayout(), containsMovEaxImm32(), elapsedMillis() (+48 more)

### Community 78 - "Community 78"
Cohesion: 0.09
Nodes (6): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.17
Nodes (54): TestReleaseV011GateValidatesJSONDiagnostics(), readReleaseV06GateScript(), readTestAllScript(), readReleaseV06GateScript(), readTestAllScript(), repoRoot(), Test_test_all_validates_tool011_eco_reports(), TestReleaseV012GateFormatterCoversRuntimeSources() (+46 more)
...
Cohesion: 0.06
Nodes (55): Agent 12 Stdlib API Docs, API Diff Docs Snapshot (hash 0966...ca390), api diff no-change step, API Docs Snapshot (hash 623d...53917), API Docs Snapshot (hash 09e8...50e66), API Hash sha256:0966... (81 modules, 226 entries), API Hash sha256:09e8... (83 modules, 228 entries), API Hash sha256:623d... (49 modules, 97 entries) (+47 more)
...
Cohesion: 0.08
Nodes (3): ownershipPathParent(), parentOwnershipPath(), regionState

### Community 94 - "Community 94"
Cohesion: 0.1
Nodes (44): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, appendDataRow(), appendRowDescription() (+36 more)
...
Cohesion: 0.08
Nodes (29): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+21 more)
...
Cohesion: 0.16
Nodes (39): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept(), stepLogSlug(), TestValidateReleaseGateSummaryAcceptsBlockedPreflightReport() (+31 more)
...
Cohesion: 0.05
Nodes (29): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsMismatchedImplSignature() (+21 more)
...
Cohesion: 0.19
Nodes (31): readWebSmokeReport(), releaseV10WebSmokeFakeRepo(), runReleaseV10WebSmoke(), writeReleaseV10FakeBrowser(), writeToolWrapper(), Test_release_v1_0_web_smokeAcceptsDashPrefixedReportPathAndSidecars(), Test_release_v1_0_web_smokeBrowserArgOverridesDiscovery(), Test_release_v1_0_web_smokeDiscoversGoogleChromeFallback() (+23 more)
...
Cohesion: 0.13
Nodes (28): Tetra CLI Cheatsheet, Examples Index, Getting Started With Tetra, examplesIndexRow, copyFile(), assertReleaseV040RejectsNonDirectoryReportPath(), releaseV040MinimalGateRoot(), TestReleaseV040GateRejectsDanglingReportDirSymlinkBeforeSideEffects() (+20 more)
...
Cohesion: 0.12
Nodes (25): Diagnostic, DiagnosticCodeInfo, defaultString(), DiagnosticCodeRegistry(), DiagnosticFromError(), TestDiagnosticCodeRegistryListsPublicCodes(), TestDiagnosticFromCapsuleParserError(), TestDiagnosticFromCrossModuleSemanticError() (+17 more)
...
Cohesion: 0.14
Nodes (23): newRegionState(), TestCheckNoConsumedDescendantsCanonicalizesAliasPaths(), TestCheckNotConsumedCanonicalizesAliasPaths(), TestCheckNotConsumedCanonicalizesAliasPathsWhenConsumedBeforeAlias(), TestCheckNotConsumedNestedAliasCanonicalizesPath(), TestClearConsumedTreeClearsAliasEquivalentPaths(), TestClearConsumedTreeClearsAliasForConsumedBasePath(), TestMergeFlowWithLabelsIntersectsOwnershipAliases() (+15 more)
...
Cohesion: 0.19
Nodes (24): releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind(), TestReleaseV10APIDiffRejectsMissingBaselineBeforeDocsWork() (+16 more)
...
Cohesion: 0.09
Nodes (26): Release Artifact tetra.release.v0_2_0.test-all-summary.v1, Fail Status, Pass Status, json diagnostic shape check, Test Report 2026-04-27 14:47:59 (v0.1.x quick fail), Test Report 2026-04-27 14:50:11 (v0.1.x quick pass), Test Report 2026-04-29 08:01:57 (v0.2.0 full pass), Test Report 2026-04-29 11:43:27 (v0.2.0 quick pass) (+18 more)
...
Cohesion: 0.15
Nodes (20): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+12 more)
...
Cohesion: 0.15
Nodes (16): TestBootstrapBuildsTetraAndTAlias(), assertLegacyFileRemoved(), assertNoLegacyMention(), normalizeDashLeadingPathForTest(), repoRoot(), TestReleaseV030ChecklistAndGateRequireSecuritySignoff(), TestReleaseV030ChecklistIsNonClaimingAndVersionScoped(), TestReleaseV030GateGoTestStepUnsetsReleaseInputEnv() (+8 more)
...
Cohesion: 0.18
Nodes (14): TestNormalizeFlowForMigrationAPI(), TestNormalizeFlowForMigrationAPICoversFlowTestAndMatchSurface(), TestNormalizeFlowForMigrationAPITabDiagnostic(), TestValidateReportAcceptsExecutableLinuxX64NativeRuntimeEvidence(), TestValidateReportRejectsMissingStateTransition(), TestValidateReportRejectsNativeShellSidecarOnlyEvidence(), TestValidateReportAcceptsLinuxX64ParallelProductionEvidence(), TestValidateReportRejectsMissingCompletionAudit() (+6 more)
...
Cohesion: 0.21
Nodes (16): AnalyzeLSPFile(), AnalyzeLSPSource(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPSourceActorDeclarationDiagnostic(), TestAnalyzeLSPSourceImportedFileDoesNotReportMissingWorkspace(), TestAnalyzeLSPSourcePrivacyConsentDiagnosticCode(), TestAnalyzeLSPSourceRecursiveSecretSignatureDiagnosticCode(), TestAnalyzeLSPSourceSemanticDiagnostics() (+8 more)
...
Cohesion: 0.1
Nodes (15): TestDeferRejectsBreakToOuterLoopInsideCleanup(), TestDeferRejectsLaterActorTransferOfCapturedIsland(), TestDeferRejectsLaterConsumeOfCapturedValue(), TestDeferRejectsReturnInsideCleanup(), TestDeferRejectsThrowInsideCleanup(), TestDeferRunsBeforeScopedIslandAutoFree(), TestDeferRunsBeforeThrowReturn(), TestDeferRunsLIFOAndPreservesReturnValue() (+7 more)
...
Cohesion: 0.2
Nodes (6): emitAllocBytes(), emitExit(), emitMakeSlice(), emitMmap2Anonymous(), emitWrite(), patchExitBranch()
...
Cohesion: 0.4
Nodes (13): copyReleaseV10ReproScripts(), releaseV10ReproOutputPathFakeRepo(), runReleaseV10Repro(), TestReleaseV10ReproAcceptsDashPrefixedReportPath(), TestReleaseV10ReproAllowsExistingRegularReportOverwrite(), TestReleaseV10ReproProofDoesNotChurnWallClockTimestamp(), TestReleaseV10ReproProofFailsForNonDeterministicBuildOutput(), TestReleaseV10ReproProofFailsForNonDeterministicSidecar() (+5 more)
...
Cohesion: 0.35
Nodes (12): releaseV10GateFakeRepo(), assertReleaseV10RejectsNonDirectoryReportPath(), releaseV10MinimalGateRoot(), TestReleaseV10GateAcceptsDashPrefixedFreshReportDirBeforeBootstrapSentinel(), TestReleaseV10GateAcceptsDashPrefixedSecuritySignoff(), TestReleaseV10GateRejectsDanglingReportDirSymlinkBeforeSideEffects(), TestReleaseV10GateRejectsMissingReportDirArgument(), TestReleaseV10GateRejectsNonDirectoryReportPathBeforeSideEffects() (+4 more)
...
Cohesion: 0.23
Nodes (9): TestNormalizeFlowForMigrationHandlesIfLetAndMatchCases(), TestNormalizeFlowForMigrationRewritesCompatibilitySurface(), TestNormalizeFlowForMigrationSpanCRLFUnicode(), TestNormalizeFlowForMigrationTabDiagnostic(), TestParseFileWithMigrationNormalizationParsesAndPreservesRawSource(), TestLowerInferUnsupportedExpressionNamesFeature(), TestLowerUnsupportedExpressionNamesFeature(), TestLowerUnsupportedOperatorsNameOperator() (+1 more)
...
Cohesion: 0.47
Nodes (10): copyReleaseV10BinarySizeScripts(), releaseV10BinarySizeOutputPathFakeRepo(), runReleaseV10BinarySize(), TestReleaseV10BinarySizeAcceptsDashPrefixedReportPath(), TestReleaseV10BinarySizeAllowsExistingRegularReportOverwrite(), TestReleaseV10BinarySizeRejectsDirectoryReportBeforeBuild(), TestReleaseV10BinarySizeRejectsMissingReportArgument(), TestReleaseV10BinarySizeReportFailsOnHardLimitBreach() (+2 more)
...
Cohesion: 0.24
Nodes (7): DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), Result, LinkWindowsX64()
...
Cohesion: 0.27
Nodes (10): Tetra Flow v1 Grammar (Canonical), Fuzz, Property, And Stress Suite, Islands Memory Model, Tetra Language Tour, Ownership And Effects Guide, Ownership Markers v1, UI v1 Surface, Unsafe Blocks (+2 more)

### Community 394 - "Community 394"
Cohesion: 0.4
Nodes (8): featureEntry, featuresReport, decodeStrictJSON(), fileExists(), main(), statFromRepoRoot(), validateFeatureDocs(), validateFeatures()
