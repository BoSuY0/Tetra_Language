# Graph Report - Tetra_Language  (2026-05-25)

## Corpus Check
- 4465 files · ~6,509,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22066 nodes · 85422 edges · 1083 communities (929 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13778 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d1881ff`
...
1. `contains()` - 2861 edges
2. `writeFile()` - 785 edges
3. `runCLI()` - 616 edges
4. `buildAndRun()` - 500 edges
5. `mountTetraUI()` - 353 edges
6. `mountTetraUI()` - 353 edges
7. `parseOperationValue()` - 352 edges
8. `bindingValue()` - 352 edges
9. `parseOperationValue()` - 352 edges
10. `bindingValue()` - 352 edges

## Surprising Connections (you probably didn't know these)
- `runFormats()` --calls--> `T4 Formats`  [INFERRED]
  cli/cmd/tetra/metadata.go → docs/spec/t4_formats.md
- `TestReleaseV10WebSmokeScriptWritesUTCGeneratedAt()` --calls--> `contains()`  [INFERRED]
  tools/scriptstest/release_v10_web_smoke_test.go → compiler/internal/semantics/generics.go
- `TestShellScriptsDoNotDefaultTetraArtifactsToTmpfs()` --calls--> `contains()`  [INFERRED]
  tools/scriptstest/shell_portability_test.go → compiler/internal/semantics/generics.go
- `contains()` --calls--> `TestBootstrapBuildsTetraAndTAlias()`  [INFERRED]
...
## Communities (1083 total, 154 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (507): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke() (+499 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (472): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject() (+464 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (306): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+298 more)
...
Cohesion: 0.02
Nodes (259): TestOwnershipAllowsBorrowInoutDistinctStructFields(), TestOwnershipAllowsBorrowInoutWithDistinctLocals(), TestOwnershipAllowsBorrowToBorrowForwarding(), TestOwnershipAllowsConsumedStructFieldReassignment(), TestOwnershipAllowsConsumeInoutWithDistinctLocals(), TestOwnershipAllowsCrossModulePartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsCrossModulePartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipAllowsCrossModuleProtocolImplMatchingParameterOwnership() (+251 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (249): TestActorTaskBoundedStressExamples(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK(), TestBuildAsyncSmoke() (+241 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (227): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals() (+219 more)
...
Cohesion: 0.04
Nodes (168): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+160 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (169): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEpic04ExpressionTypingDisplayTextAndBoundary(), TestEpic04ExpressionTypingNegativeDiagnostic(), TestEpic04ExpressionTypingPositiveAndInferenceCrossModule(), TestEpic04LocalInferenceNegativeAndDisplayText(), TestEpic04SemanticCheckerCoreCrossModuleParity(), TestEpic04SemanticCheckerCoreDisplayTextStability() (+161 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (152): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+144 more)
...
Cohesion: 0.03
Nodes (138): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+130 more)

### Community 24 - "Community 24"
Cohesion: 0.02
Nodes (148): requireCheckFileErrorContains(), requireCheckFileOK(), TestActorSpawnRejectsMutableGlobalTarget(), TestActorSpawnRejectsThrowingTarget(), TestAsyncRejectAwaitOutsideAsync(), TestAsyncRejectBareAsyncCall(), TestAsyncSmokeExampleBuildAndRun(), TestAsyncTypedErrorBoundaryRejectsAwaitTryForm() (+140 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (135): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+127 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (145): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary() (+137 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (147): TestArrayMVPCheckAcceptsIndexAndForOnFixedArray(), TestArrayMVPRejectsAssignmentToArrayLen(), TestArrayMVPRejectsAssignmentToArrayPtr(), TestArrayMVPRejectsAssignmentToNestedArrayLen(), TestArrayMVPRejectsNonPositiveSize(), TestArrayMVPRejectsUnsupportedElementType(), requireCheckErrorContains(), TestOwnershipRejectsBorrowDerivedValueAsInoutArgument() (+139 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (144): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), stableForbiddenCaseDiagnosticsFixtureEvidence(), TestOwnershipAuditFixtureHelpersLiveInFocusedFile(), TestOwnershipAuditValidatorPackageIsSplitByResponsibility(), TestValidateOwnershipAuditAcceptsBlockedAudit(), TestValidateOwnershipAuditRejectsAchievedStatusWithOpenRows() (+136 more)
...
Cohesion: 0.05
Nodes (58): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+50 more)
...
Cohesion: 0.04
Nodes (106): TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes() (+98 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (122): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+114 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (105): TestReleaseV011GateValidatesJSONDiagnostics(), testAllFakeRepo(), assertExitCode(), decodeTestAllSummary(), hasTestAllStep(), readReleaseV06GateScript(), readTestAllScript(), runTestAll() (+97 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (110): requireCheckWorldFilesErrorContains(), TestActorConsumeRejectsAggregateAliasConsumedTwiceInSingleCall(), TestActorConsumeRejectsAggregateAliasFieldReuse(), TestActorConsumeRejectsAliasConsumedTwiceInSingleCall(), TestActorConsumeRejectsAliasReuse(), TestActorConsumeRejectsCrossModuleEnumPayloadAliasReuse(), TestActorConsumeRejectsCrossModuleGenericStructFieldAliasReuse(), TestActorConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse() (+102 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (105): requireCheckWorldFilesErrorContains(), TestOwnershipAllowsCrossModuleProtocolImplMatchingParameterOwnership(), TestOwnershipBorrowParamCannotMutate(), TestOwnershipConsumeArgumentCannotBeReused(), TestOwnershipConsumedValueCannotBeReassigned(), TestOwnershipInoutRequiresMutableLocal(), TestOwnershipRejectsBorrowInoutAlias(), TestOwnershipRejectsConsumeInoutAlias() (+97 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (94): buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsMismatchedImplSignature() (+86 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (94): decodeStrictNativeUIJSON(), main(), validateNativeUISmoke(), validateNativeUIView(), nativeUIBindingTrace, nativeUIEventTrace, nativeUIOperationTrace, nativeUIPropertyTrace (+86 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (99): benchLevel, benchmarkEnvironment, buildEvidence, buildPlan, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState (+91 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (44): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope() (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (96): capsuleArtifact, capsuleDependency, capsuleManifest, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString() (+88 more)

### Community 52 - "Community 52"
Cohesion: 0.1
Nodes (95): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+87 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+77 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+90 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (96): assertActorAliasTransferDiagnostic(), assertActorTaskOptionalPayloadAliasTransferDiagnostic(), assertBorrowedNestedSliceEnumPayloadDiagnostic(), assertBorrowedNestedSliceStructDiagnostic(), assertBorrowedPtrAggregateGlobalFieldDiagnostic(), assertBorrowedPtrAggregateOptionalGlobalAssignmentDiagnostic(), assertBorrowedPtrAggregateReturnDiagnostic(), assertBorrowedPtrEnumAliasReturnDiagnostic() (+88 more)

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (76): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+68 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (73): Column, Conn, fakeColumn, Frame, partialWriteRWC, payloadReader, Result, Row (+65 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (45): AssignStmt, BoolLitExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt, EnumCaseDecl (+37 more)
...
Cohesion: 0.08
Nodes (77): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+69 more)
...
Cohesion: 0.09
Nodes (79): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+71 more)

### Community 64 - "Community 64"
Cohesion: 0.14
Nodes (7): ParseFile(), diagnosticErrorf(), parser, buildFieldAccess(), ParseFile(), plannedFeatureError(), parseCapsule()
...
Cohesion: 0.1
Nodes (71): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+63 more)

### Community 67 - "Community 67"
Cohesion: 0.07
Nodes (64): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+56 more)
...
Cohesion: 0.04
Nodes (69): requireCheckOK(), requireFileCheckOK(), requireFileSemanticErrorContains(), TestBudgetPrivacyEffectsAndPolicyGroup(), TestCallbackWrapperDeclaredEffectsCannotBypassSemanticClauses(), TestCallbackWrapperRequiresImportedTargetEffects(), TestCallbackWrapperRequiresLocalSymbolBackedTargetEffects(), TestCallbackWrapperRequiresTargetEffects() (+61 more)

### Community 70 - "Community 70"
Cohesion: 0.1
Nodes (65): BuildOptions, parseCapsuleBareOrQuoted(), parseCapsuleString(), buildOptions(), defaultTarget(), projectBuildTargets(), projectDefaultTarget(), runBuild() (+57 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (63): TestRenderDispatchesCommandOperationsInOrder(), TestRenderDispatchesStateSetFromSameStateField(), TestRenderDispatchesStateSubtractOperations(), TestRenderDispatchesStringStateSetWithoutLiteralQuotes(), TestRenderIncludesStateAndViewMetadata(), TestRenderJSONIncludesDispatchTrace(), TestRenderJSONIncludesNativeWidgetTree(), TestRenderNilBundleIncludesNoMetadataMarker() (+55 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (7): emitCall(), emitIslandFree(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), guardAllocationOffsetRawAccess(), emitter

### Community 73 - "Community 73"
Cohesion: 0.08
Nodes (63): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), parseBuildTargetOrReport(), abiObjectHasSymbol() (+55 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (60): ActorStateField, TestEnsureTypeInfoArrayRejectsUnsupportedSubset(), TestEnsureTypeInfoArraySupportedSubset(), TestEnsureTypeInfoRejectsTargetLayoutOnlyNativeIntegers(), TestClassifyCallableEscapeRejectsMutableCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeRejectsMutableEscapingCapture(), TestClassifyCallableEscapeRejectsResourceCaptureAcrossThreadBoundary(), TestClassifyCallableEscapeUsesFnptrForBoundedLocalSnapshot() (+52 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (62): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+54 more)
...
Cohesion: 0.08
Nodes (52): FuzzLexer(), FuzzParser(), sameStringSet(), sortedStrings(), capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot() (+44 more)

### Community 78 - "Community 78"
Cohesion: 0.1
Nodes (57): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+49 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (57): AuditReport, Bounds, CaseReport, EventReport, OperationReport, ProcessReport, Report, decodeStrict() (+49 more)
...
Cohesion: 0.09
Nodes (49): BuildSigMap(), BuildTypeSigMap(), cacheDir(), cacheKey(), cachePath(), DepSigHashFromDeps(), DepSigHashFromDepsWithInterfaceHashes(), formatFuncSig() (+41 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (59): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), API Snapshot sha256:09e83e.. (83 modules, 228 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs (+51 more)

### Community 84 - "Community 84"
Cohesion: 0.11
Nodes (33): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16() (+25 more)

### Community 85 - "Community 85"
Cohesion: 0.13
Nodes (19): formatTypeRef(), formatTypeRefPresent(), publicPrefix(), sourcePrinter, ActorDecl, CapsuleDecl, EnumDecl, ExtensionDecl (+11 more)
...
Cohesion: 0.09
Nodes (45): TestBootstrapBuildsTetraAndTAlias(), assertLegacyFileRemoved(), assertOldGateDidNotCreateReportSubdirs(), assertOldGateRejectedBeforeSideEffects(), assertOldGateRejectsNonDirectoryReportPath(), assertOldGateRejectsNonEmptyReportDir(), assertOldGateRejectsNonEmptyReportDirWithArg(), normalizeDashLeadingReportDirForTest() (+37 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (22): AwaitExpr, BinaryExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, IndexExpr, lexer (+14 more)

### Community 89 - "Community 89"
Cohesion: 0.14
Nodes (52): hasPrefix(), decisionEvidence, featuresReport, containsForbiddenStructuredEvidence(), decodeJSON(), forbiddenStructuredEvidenceValue(), hasActorDistributedRuntimeDocsEvidence(), hasActorDistributedRuntimeGateArtifact() (+44 more)
...
Cohesion: 0.1
Nodes (50): IRInstrKind, runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt(), matchesBudgetGuardBefore(), matchesBudgetInitializerAt(), matchesConsentGuardAt() (+42 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (48): AuditReport, CaseReport, ContractReport, ProcessReport, Report, decodeStrict(), rejectPaperEvidence(), validateAudit() (+40 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (51): buildCapsuleArtifacts(), capsuleSectionHeader(), defaultCapsulePath(), writeEcoLock(), parseCapsuleGraphArgs(), validateCapsuleGraph(), parseCapsuleArgs(), parseCapsuleGraphArgs() (+43 more)
...
Cohesion: 0.14
Nodes (45): TestObjectPatchRel32ForwardAndBackward(), TestObjectPatchRel32RejectsInvalidPatchOffsets(), TestObjectPatchRel32RejectsOutOfRangeTargets(), LinuxSysV(), NewEmitFunc(), addEdxImm32Bytes(), assertContainsBytes(), assertNotContainsBytes() (+37 more)

### Community 99 - "Community 99"
Cohesion: 0.07
Nodes (38): ABIClass, ABIExtension, ABILocation, ABIParam, ABIPlan, ABISignature, Classifier, abiExtensionFor() (+30 more)

### Community 100 - "Community 100"
Cohesion: 0.11
Nodes (41): lspCodeActionDiagnostic, lspCodeActionParams, lspDefinitionParams, lspDidChangeParams, lspDidCloseParams, lspDidOpenParams, lspHoverParams, lspID (+33 more)
...
Cohesion: 0.08
Nodes (42): featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), canRunLinuxX32OnHost(), discoverWASIRunner(), discoverWebRunner(), discoverWebRuntimeRunner() (+34 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (44): requireUnsupportedReasonContains(), targetMetaForTest(), targetsJSONForTest(), TestFeaturesCommandJSON(), TestFeaturesCommandRejectsUnsupportedFormat(), TestFormatsCommandListsOfficialT4Family(), TestTargetsCommandJSON(), TestTargetsCommandJSONMarksWASIRunSupportedWhenRunnerExists() (+36 more)
...
Cohesion: 0.09
Nodes (45): errForPlan250RuntimeDiagnostic, findPlan250IRFunc(), firstPlan250InstrKind(), hasPlan250BudgetGuardBefore(), hasPlan250InstrKind(), matchesPlan250BudgetGuardAt(), requireCheckFileErrorContainsAll(), TestPlan250LinkObjectRejectsWrongCompilerVersionMetadata() (+37 more)
...
Cohesion: 0.11
Nodes (42): addVaultRecord(), buildNeedMap(), collectTransitiveNeeds(), runEcoNeedMap(), runEcoTrust(), runEcoTrustSnapshot(), scoreCapsuleTrust(), readVaultIndex() (+34 more)
...
Cohesion: 0.11
Nodes (34): allowed_sysfs_write(), apply_profile(), BackendContext, battery_info(), build_arg_parser(), collect_snapshot(), CommandResult, cpu_info() (+26 more)
...
Cohesion: 0.15
Nodes (38): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+30 more)

### Community 115 - "Community 115"
Cohesion: 0.22
Nodes (42): buildReleaseStateReport(), errNotExist(), expectedReleaseArtifact(), expectedReleaseGateCommand(), parseGitStatus(), addRuntimeEvidenceFiles(), addSecurityReviewEvidenceFiles(), detachedSecurityReviewHash() (+34 more)

### Community 116 - "Community 116"
Cohesion: 0.14
Nodes (40): decodeEcoLock(), lockGraphFingerprint(), ecoLock, ecoLockArtifact, ecoLockCapsule, ecoSeedItem, cleanArtifactPath(), containsString() (+32 more)
...
Cohesion: 0.07
Nodes (42): tetra.release.v0_3_0.gate-report.v1, tetra.release.v0_3_0.test-all-summary.v1, API Diff No-Change Enforcement, Release Gate v0.3.0, Short Fuzz Nightly Run, Stabilization Test-All Pipeline, Tetra UI v1 Bundle Validation, Unstable Fuzz Seed Promotion Policy (+34 more)

### Community 127 - "Community 127"
Cohesion: 0.14
Nodes (37): isCapsuleSemver(), collectTransitiveNeeds(), decodeStrictJSON(), dedupeStrings(), isCapsuleSemver(), main(), nodesByID(), parseSHA256Hash() (+29 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (38): tamperTodexEntry(), testCommand(), TestEcoBetaPublishDownloadAndTetraHubPath(), TestEcoCapsuleFixtureMatrix(), TestEcoDocsDeclareLocalOnlyBetaScope(), TestEcoDogfoodFixtureLocalLifecycle(), TestEcoDownloadRejectsPublishMetadataUnknownFieldsAndKeyMismatches(), TestEcoDownloadRejectsTamperedPublishedPackage() (+30 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (27): CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64(), LinkWindowsX64() (+19 more)

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (29): Handler, Header, appendHeader(), AppendResponse(), applyHeaderMetadata(), containsControl(), matchParameterizedPath(), normalizeLimits() (+21 more)

### Community 131 - "Community 131"
Cohesion: 0.16
Nodes (37): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+29 more)

### Community 132 - "Community 132"
Cohesion: 0.12
Nodes (32): BuiltinManifest, Manifest, manifestAtomicPointerWidthBits(), RuntimeManifest, TargetManifest, atomicBuiltinOpPrefix, atomicBuiltinValueType, BuiltinManifest (+24 more)

### Community 133 - "Community 133"
Cohesion: 0.1
Nodes (35): InterfaceFingerprintFromSource(), InterfaceFingerprintFromT4I(), TestInterfaceFingerprintFromSourceIsPublicAPIStable(), TestInterfaceFingerprintFromSourceTracksHashOnlyPublicSurface(), TestGeneratedInterfaceFunctionTypeRefsCheckAndLowerAcrossModules(), TestGeneratedInterfaceGenericStructTypeArgsCheckAndLowerAcrossModules(), TestGenerateInterfaceFromSourceEmitsProtocolImplDeclarationsBeforeFunctions(), TestGenerateInterfaceFromSourceEmitsTypecheckableExtensionDeclarations() (+27 more)

### Community 134 - "Community 134"
Cohesion: 0.08
Nodes (38): BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats, averageMS() (+30 more)

### Community 135 - "Community 135"
Cohesion: 0.21
Nodes (36): runLSPStdio(), assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject() (+28 more)

### Community 136 - "Community 136"
Cohesion: 0.11
Nodes (27): emitX64ReturnSlotPushes(), TestX64ABICallsZeroThroughTenArgs(), TestX64ABIReturnSlotsThreeAndFourRegisterMapping(), TestX64BuildOnlySmokeAcrossNativeTargets(), x64ReturnSlotName(), CodegenObjectMacOSX64(), CodegenObjectMacOSX64WithOptions(), CodegenObjectMacOSX64WithOptionsAndDataPrefix() (+19 more)
...
Cohesion: 0.13
Nodes (31): LowerUI(), uiCommandOperations(), uiCompoundStateDeltaOperation(), uiExprSummary(), uiStateAddOperation(), uiStateDeltaOperation(), UILoweredAccessibility, UILoweredBinding (+23 more)
...
Cohesion: 0.17
Nodes (20): brokerProcess, frameTypeName(), intPtr(), main(), nodeDownSource(), processExitCode(), readBrokerAddr(), readFrame() (+12 more)

### Community 141 - "Community 141"
Cohesion: 0.14
Nodes (30): parseEcoMaterializeArgs(), runEcoMaterialize(), ensureEcoDirectoryNoSymlink(), packageMetadataFingerprint(), packCapsule(), packCapsuleProject(), packFiles(), parseEcoPackArgs() (+22 more)

### Community 142 - "Community 142"
Cohesion: 0.15
Nodes (32): adjustDiagnosticForRecoveredSyntheticClose(), allCallLabelsEmpty(), blankSourceSpan(), cloneCompoundTarget(), diagnosticFromError(), firstSourceColumn(), includeLeadingAttributeLines(), integerLiteralRangeError() (+24 more)
...
Cohesion: 0.15
Nodes (23): isUpdateQuery(), parseWorldUpdate(), pgAppendCString(), pgAppendInt16(), pgAppendInt32(), pgBackendKeyPayload(), pgCStringPayload(), pgCStringsPayload() (+15 more)
...
Cohesion: 0.12
Nodes (27): DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects(), readI32LE() (+19 more)
...
Cohesion: 0.12
Nodes (32): atomicMaskedFetchAdd(), atomicMaskedFetchXor(), atomicStressIterations(), atomicStressYield(), atomicSuiteOrderAllowed(), atomicSuiteTargetPrefix(), checkAtomicABAStampedPointer(), checkAtomicConcurrencyStressOracle() (+24 more)

### Community 150 - "Community 150"
Cohesion: 0.13
Nodes (30): childRuntimeEvidence, hostRuntime, buildPlatformUIRuntimeReport(), buildPlatformUIRuntimeReportWithRunner(), currentGitHead(), currentHostRuntime(), dispatchEvent(), exitCodeFromError() (+22 more)
...
Cohesion: 0.16
Nodes (29): cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), describeProjectDependencyCycle() (+21 more)

### Community 154 - "Community 154"
Cohesion: 0.1
Nodes (24): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+16 more)

### Community 155 - "Community 155"
Cohesion: 0.11
Nodes (33): assertLSPTestError(), assertLSPTestID(), assertLSPTestLocationsContainRange(), assertLSPTestLocationsDoNotContainRange(), assertLSPTestResultArrayLen(), assertLSPTestResultNil(), assertLSPTestResultObject(), loadLSPTranscriptFixture() (+25 more)
...
Cohesion: 0.23
Nodes (28): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+20 more)

### Community 159 - "Community 159"
Cohesion: 0.07
Nodes (23): TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildOnly(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke() (+15 more)

### Community 160 - "Community 160"
Cohesion: 0.12
Nodes (25): Diagnostic, DiagnosticError, DiagnosticForError(), hintForDiagnosticMessage(), shiftDiagnosticColumn(), TestNormalizeFlowForMigrationHandlesIfLetAndMatchCases(), TestNormalizeFlowForMigrationRewritesCompatibilitySurface(), TestNormalizeFlowForMigrationSpanCRLFUnicode() (+17 more)
...
Cohesion: 0.17
Nodes (27): ecoLockArtifact, ecoLockCapsule, ecoLockDependency, ecoLockEnvelope, cleanArtifactPath(), containsString(), isCapsuleSemver(), lockGraphFingerprint() (+19 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (26): Diagnostic, DiagnosticCodeInfo, defaultString(), DiagnosticCodeRegistry(), DiagnosticFromError(), TestDiagnosticCodeRegistryListsPublicCodes(), TestDiagnosticFromCapsuleParserError(), TestDiagnosticFromCrossModuleSemanticError() (+18 more)
...
Cohesion: 0.21
Nodes (24): assertFrame(), dialTestNode(), readTestFrame(), startTestBroker(), TestBrokerReportsNodeDownForMissingDestination(), TestBrokerRoutesFramesBetweenLoopbackNodesAndWritesReport(), TestBrokerTreatsClosedDestinationWriteAsDroppedFrame(), TestClosedConnectionErrorsIncludePeerReset() (+16 more)

### Community 167 - "Community 167"
Cohesion: 0.14
Nodes (26): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+18 more)

### Community 168 - "Community 168"
Cohesion: 0.14
Nodes (22): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+14 more)

### Community 169 - "Community 169"
Cohesion: 0.13
Nodes (28): TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionDuplicateRecursiveWorkMonomorphizesOnce(), TestGenericFunctionInfersOptionalParameterElement(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionMultiTypeParametersMonomorphized(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses() (+20 more)
...
Cohesion: 0.18
Nodes (26): validateWorkspaceReportFormat(), decodeStrictJSON(), main(), TestValidateWorkspaceReportAcceptsCheckFailure(), TestValidateWorkspaceReportAcceptsGraph(), TestValidateWorkspaceReportAcceptsList(), TestValidateWorkspaceReportRejectsCheckStatusMismatch(), TestValidateWorkspaceReportRejectsDuplicateMemberPath() (+18 more)

### Community 172 - "Community 172"
Cohesion: 0.12
Nodes (23): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+15 more)
...
Cohesion: 0.19
Nodes (25): buildEcoLock(), buildEcoLockWithArtifactHashes(), copySortedPolicy(), decodeEcoLock(), hydrateLockArtifactHashes(), lockArtifactsFromCapsuleArtifacts(), lockGraphFingerprint(), normalizeLock() (+17 more)

### Community 185 - "Community 185"
Cohesion: 0.21
Nodes (27): intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection(), TestSmokeReportToChecklistValidateOnly(), TestValidateSmokeReportCountsAcceptsConsistentCounts(), TestValidateSmokeReportCountsAcceptsLegacyReportsWithoutCounts(), TestValidateSmokeReportCountsRejectsExplicitZeroCountsWithCases() (+19 more)
...
Cohesion: 0.13
Nodes (23): TestEmitTaskJoinTypedSlotBounds(), TestEmitTaskJoinTypedWrapperWindowsX64SlotBounds(), emitActorExitWindowsX64(), emitActorNoArgWrapperWindowsX64(), emitActorOneArgWrapperWindowsX64(), emitActorSendBeginWrapperWindowsX64(), emitActorSendMsgWrapperWindowsX64(), emitActorSendSlotWrapperWindowsX64() (+15 more)
...
Cohesion: 0.2
Nodes (21): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB, dialServer() (+13 more)
...
Cohesion: 0.13
Nodes (25): appConfig, configFromEnv(), envOr(), main(), newPprofHandler(), newRandomWorldIDs(), parseIPv4(), parsePositiveInt() (+17 more)
...
Cohesion: 0.24
Nodes (25): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver(), normalizeCapsuleArtifactKind() (+17 more)

### Community 197 - "Community 197"
Cohesion: 0.21
Nodes (23): makePublishFixture(), runPublishValidator(), runPublishValidatorWithChannel(), TestValidateEcoPublishAcceptsStableMetadata(), TestValidateEcoPublishAcceptsValidMetadata(), TestValidateEcoPublishRejectsDownloadPathMismatch(), TestValidateEcoPublishRejectsHashMismatch(), TestValidateEcoPublishRejectsTrustSnapshotHashMismatch() (+15 more)

### Community 198 - "Community 198"
Cohesion: 0.17
Nodes (21): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+13 more)

### Community 199 - "Community 199"
Cohesion: 0.18
Nodes (23): decodeStrictJSON(), main(), readTargetsReport(), TestReadTargetsReportDefaultsToTargetsCommand(), TestReadTargetsReportReportsTargetsCommandFailure(), TestValidateRunContractAcceptsHostProbedBuildOnly(), TestValidateTargetsReportAcceptsExpectedShape(), TestValidateTargetsReportAcceptsMissingWASIRunner() (+15 more)
...
Cohesion: 0.16
Nodes (23): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), TestNewTechEmpowerServerAppliesConfigAndRoutes(), TestRegisterTechEmpowerRoutesMountsAllEndpoints(), TestRegisterTechEmpowerRoutesRequiresPool(), startDBBenchmarkServerWithRandom(), TestNormalizeQueryCount() (+15 more)
...
Cohesion: 0.13
Nodes (22): BuildFile(), findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio() (+14 more)
...
Cohesion: 0.12
Nodes (23): TestOwnershipGenericFunctionTypedGlobalPreservesConsumeMarker(), TestOwnershipLoopBreakExitReportsMaybeConsumedWithBreakLabel(), TestOwnershipLoopBreakMakesFollowingBodyStatementsUnreachable(), TestOwnershipLoopContinueExitReportsMaybeConsumedWithContinueLabel(), TestOwnershipRejectsGenericFunctionTypedGlobalOwnershipMismatch(), TestOwnershipRejectsIndirectRecursiveEnumPayloadCycle(), TestOwnershipRejectsInterproceduralStructReturnResourceLeafDoubleFree(), TestOwnershipReturnThrowTerminalBranchesDoNotPoisonFallthroughFlow() (+15 more)

### Community 209 - "Community 209"
Cohesion: 0.16
Nodes (19): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), replaceOwnershipAuditRowEvidence(), TestValidateOwnershipAuditAcceptsRowEvidenceDetails(), ownershipAuditRow (+11 more)
...
Cohesion: 0.32
Nodes (21): actualForExpected(), artifactCases(), buildOnlyCases(), caseJSON(), intLiteral(), runtimeCases(), runtimeReport(), TestValidateWASISmokeReportAcceptsArtifactPreflightReport() (+13 more)

### Community 214 - "Community 214"
Cohesion: 0.19
Nodes (17): TestLowerUIBundle(), TestLowerUIBundleRecognizesCompoundStateDeltaCommands(), TestLowerUIBundleRecognizesStateSubtractCommands(), TestLowerUIBundleRejectsNilCheckedProgram(), TestLowerUIBundleReturnsNilWhenUIDeclsAreMissing(), lowerUIForTest(), marshalLoweredUIForTest(), TestLoweredUIAccessibilityMetadataAllowsScalarTypes() (+9 more)
...
Cohesion: 0.25
Nodes (21): Object, checkedObjectCountCapacity(), ensureObjectBytesAvailable(), ensureObjectRecordTableAvailable(), maxObjectInt(), minSymbolRecordBytes(), objectRemainingBytes(), readBool() (+13 more)
...
Cohesion: 0.2
Nodes (21): accessibilityValue(), addLine(), appendRuntimeControls(), applyAccessibilityMetadata(), applyStyleMetadata(), applyTetraCommand(), bindingValue(), dispatchTetraEvent() (+13 more)
...
Cohesion: 0.13
Nodes (21): Bounds, CaseReport, ContractReport, EventReport, OperationReport, Options, ProcessReport, Report (+13 more)
...
Cohesion: 0.2
Nodes (17): BrokerReport, CaseReport, FrameCounts, ProcessReport, Report, decodeStrict(), TestValidateReportAcceptsExecutableLinuxX64Evidence(), TestValidateReportRejectsMissingFailureCase() (+9 more)

### Community 228 - "Community 228"
Cohesion: 0.22
Nodes (18): Frame, DecodeFrame(), DecodeRemoteHandle(), EncodeFrame(), EncodeRemoteHandle(), isKnownFrameType(), IsRemoteHandle(), TestDecodeRejectsBadHeaderAndInvalidSlotCount() (+10 more)
...
Cohesion: 0.18
Nodes (19): defaultOutputPath(), gitRoot(), intFromInt64(), isUnderDir(), main(), normalizeOutputPath(), printDumpResult(), printUsage() (+11 more)
...
Cohesion: 0.15
Nodes (14): expectedContentType(), TestRunBenchmarkChecksEndpointsAndWritesReport(), TestRunBenchmarkFailsWhenThresholdIsMissed(), TestRunBenchmarkRecordsLatencyPercentilesAndIntegrityMetadata(), TestValidateReportAllowsFailedEndpointWithZeroRPS(), TestValidateReportRejectsWeakEvidenceMarkers(), TestValidateReportRequiresAllTechEmpowerEndpoints(), validTestReport() (+6 more)

### Community 239 - "Community 239"
Cohesion: 0.16
Nodes (11): Connector, countingRWC, Pool, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections() (+3 more)
...
Cohesion: 0.31
Nodes (18): TestObjectRoundTripPreservesV4MetadataSymbolsAndRelocs(), TestReadObjectRejectsInvalidMagicAndBoolEncoding(), TestReadObjectRejectsMalformedSymbolAndRelocNames(), TestReadObjectRejectsMalformedSymbolAndRelocRanges(), TestReadObjectRejectsNonDataRelocationAddends(), TestReadObjectRejectsTruncatedDeclaredSections(), TestWriteObjectRejectsMalformedSymbolAndRelocNames(), TestWriteObjectRejectsMalformedSymbolAndRelocRanges() (+10 more)
...
Cohesion: 0.18
Nodes (15): classifyOwnershipAuditResult(), isOwnershipAuditSeparatorRow(), main(), normalizeOwnershipAuditStatus(), ownershipAuditSection(), parseOwnershipAuditRows(), parseOwnershipAuditStatus(), splitOwnershipAuditTableRow() (+7 more)
...
Cohesion: 0.34
Nodes (13): validateDiagnosticsMode(), diagnostic, main(), parseDiagnostic(), TestValidateDiagnosticAcceptsStableShape(), TestValidateDiagnosticRejectsInvalidSeverity(), TestValidateDiagnosticRejectsMissingRequiredFields(), TestValidateDiagnosticRejectsMissingRequiredPosition() (+5 more)

### Community 283 - "Community 283"
Cohesion: 0.2
Nodes (12): hmacSHA256(), newSCRAMSHA256Client(), newSCRAMSHA256ClientWithRandomNonce(), parseSCRAMAttributes(), pbkdf2HMACSHA256(), scramEscapeName(), scramSHA256ProofAndServerSignature(), scramSHA256ServerSignature() (+4 more)

### Community 284 - "Community 284"
Cohesion: 0.15
Nodes (6): emitIndexLoad(), emitIndexStore(), emitMmapFailureBranch(), emitRawLoad(), emitRawStore(), scaleIndex()
...
Cohesion: 0.18
Nodes (15): actionsAvailabilityCheckSuite, actionsAvailabilityReport, actionsAvailabilityRun, actionsWorkflowRegistry, actionsWorkflows, decodeStrictJSON(), main(), TestValidateActionsAvailabilityAcceptsJobBackedSuccess() (+7 more)
...
Cohesion: 0.22
Nodes (6): emitAllocBytes(), emitExit(), emitMakeSlice(), emitMMIOWriteI32(), emitWrite(), patchExitBranch()
...
Cohesion: 0.28
Nodes (14): writeInterfaceHashOnlySurface(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail() (+6 more)
...
Cohesion: 0.37
Nodes (13): completionAuditOptions, completionAuditRow, classifyCompletionAuditResult(), completionAuditSection(), hasCompletionAuditSection(), isCompletionAuditSeparatorRow(), main(), normalizeCompletionAuditStatus() (+5 more)
...
Cohesion: 0.2
Nodes (13): appendExpectedIssue(), decodeStrictJSON(), main(), TestValidateTargetHostEvidenceRequestAcceptsExactHandoff(), TestValidateTargetHostEvidenceRequestRejectsRuntimeEvidenceClaims(), validateAggregation(), validateRequestTargets(), validateTargetCommand() (+5 more)
...
Cohesion: 0.36
Nodes (12): TestValidateWorkspaceExecAcceptsBuildPassReport(), TestValidateWorkspaceExecAcceptsTestFailureAndSkipReport(), TestValidateWorkspaceExecRejectsCountMismatch(), TestValidateWorkspaceExecRejectsDuplicateMember(), TestValidateWorkspaceExecRejectsInvalidCommand(), TestValidateWorkspaceExecRejectsInvalidMemberPaths(), TestValidateWorkspaceExecRejectsMissingRequiredReportFields(), TestValidateWorkspaceExecRejectsNullRequiredReportFields() (+4 more)
...
Cohesion: 0.33
Nodes (12): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+4 more)
...
Cohesion: 0.32
Nodes (8): effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), sortedEffectSet(), normalizedEffects
...
Cohesion: 0.22
Nodes (11): decodeStrictJSON(), main(), TestValidateStartupBlockerAcceptsZeroJobStartupFailure(), TestValidateStartupBlockerRejectsPassingOrJobBackedEvidence(), TestValidateStartupBlockerRequiresRepositoryDiagnostics(), validateStartupBlocker(), validateStartupRun(), startupBlockerCanary (+3 more)

### Community 355 - "Community 355"
Cohesion: 0.17
Nodes (9): TestBuildIslandMakeBoolSliceSmoke(), TestBuildMakeBoolSliceSmoke(), TestSliceBoolSemanticsAcceptance(), TestSliceBoolSemanticsRejectWrongElementType(), TestSliceBoolWasmBuildOnlyIslandMakeBoolSmoke(), TestBuildIslandMakeU16SliceSmoke(), TestBuildMakeU16SliceSmoke(), TestSliceU16SemanticsAcceptance() (+1 more)
...
Cohesion: 0.24
Nodes (8): buildActorTaskStressFile(), TestActorTaskBoundedStressExamples(), BenchmarkBenchmarkExamplesBuild(), BenchmarkBenchmarkExamplesRun(), TestBenchmarkExamplesCompileAndRun(), RepoPath(), RepoRoot(), RunBinary()
...
Cohesion: 0.3
Nodes (10): containsMovEaxImm32(), emitObjectHasSymbol(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryLinuxX32BuildsI64AndWeakAtomicObject(), TestEmitLibraryLinuxX32WritesRealX32TOBJ(), TestEmitLibraryLinuxX86StillRejectsMissingObjectBackend(), TestEmitLibraryLinuxX86WritesRealI386TOBJ(), TestEmitLibraryObjectRelocProfileByTarget() (+2 more)
...
Cohesion: 0.44
Nodes (9): decodeStrictJSON(), knownSeverity(), main(), missingOrUnknown(), risksFieldIsArray(), validateResidualRisk(), validateResidualRisks(), residualRisk (+1 more)
...
Cohesion: 0.42
Nodes (8): decodeStrictJSON(), isASCIIAlpha(), isWorkspaceExecWindowsAbsPath(), main(), validateWorkspaceExecMember(), validateWorkspaceExecReportShape(), workspaceExecMember, workspaceExecReport
...
Cohesion: 0.61
Nodes (7): TestValidateResidualRisksAcceptsOwnedBlockedRisk(), TestValidateResidualRisksRejectsNullRisks(), TestValidateResidualRisksRejectsUnknownFields(), TestValidateResidualRisksRejectsUnownedCriticalRisk(), TestValidateResidualRisksRejectsWrongVersion(), writeResidualRisks(), validateResidualRisksFile()
...
Cohesion: 0.39
Nodes (7): TestCheckWorldRejectsDuplicateInterfaceFunctionParams(), TestResolutionDiagnosticForInvalidAliasCallShape(), TestResolutionDisplayTextForEnumCaseUsesLocalTypeName(), TestResolutionImportAliasConflictWithTopLevelDeclaration(), TestResolutionImportAliasRequiredBoundary(), TestResolutionImportPathRequiredBoundary(), TestResolutionModuleImportAliasResolvesCallAndType()
...
Cohesion: 0.28
Nodes (9): nativeLinuxX86ExecutableBackend(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), TestCodegenObjectLinuxX86DebugIslandsEmitDoubleFreeGuardAndProtect(), TestCodegenObjectLinuxX86EmitsAbsoluteGlobalRelocs() (+1 more)

### Community 436 - "Community 436"
Cohesion: 0.39
Nodes (7): TypeRefKind, TestCheckWorldAliasesImportedMutableFunctionTypedGlobalsAsBoundary(), TestCheckWorldAliasesImportedPublicFunctionTypedGlobals(), TestResolveTypeNameFunctionTypeRefMVP(), TestResolveTypeNameFunctionTypeRefRequiresReturn(), TestResolveTypeNameUnsupportedPathsArePositioned(), TestValidateGenericTypeRefUnsupportedKindIsActionable()
...
Cohesion: 0.33
Nodes (5): buildObjectsForEntry(), TestLinkCrossModuleCall(), TestLinkCrossModuleCallSevenPlusArgs(), TestLinkUnresolvedSymbol(), requireCheckWorldFilesErrorContains()
...
Cohesion: 0.61
Nodes (6): TestModuleBoundaryAllowsPublicImportedFunction(), TestModuleBoundaryRejectsPrivateImportedFunction(), TestPublicReExportSupportsSelectiveImport(), TestSelectiveImportRejectsDuplicateImportedSymbol(), TestSelectiveImportResolvesPublicFunctionAndType(), writeCompilerModuleFiles()

### Community 497 - "Community 497"
Cohesion: 0.61
Nodes (6): TestValidateCompletionAuditAcceptsCurrentBlockedAudit(), TestValidateCompletionAuditRejectsAchievedStatusWithFailingRows(), TestValidateCompletionAuditRejectsBlockedAuditWithoutMissingWorkSummary(), TestValidateCompletionAuditRejectsMissingRequiredRequirement(), TestValidateCompletionAuditRequiresMemoryParallelCompilerProductionRows(), validBlockedCompletionAudit()
...
Cohesion: 0.5
Nodes (6): main(), validateWASISmokeCase(), validateWASISmokeReportContract(), validationMode, wasiSmokeReport, wasiSmokeReportCase

### Community 501 - "Community 501"
Cohesion: 0.5
Nodes (6): main(), metricsHash(), validatePerformanceReport(), performanceMetric, performanceReport, performanceSummary
...
Cohesion: 0.62
Nodes (5): mustReportJSON(), TestValidatePerformanceReportAcceptsEvidence(), TestValidatePerformanceReportRejectsMissingMetrics(), TestValidatePerformanceReportRejectsSummaryHashMismatch(), TestValidatePerformanceReportRejectsUnsortedMetrics()
...
Cohesion: 0.52
Nodes (5): TestLowerModuleCallableFunctionTypedCrossModulePath(), TestLowerPublicAPIVerifiesRepresentativeIR(), TestPublicCodegenRejectsInvalidIRBeforeBackend(), TestPublicIRVerifierRejectsProgramAndFunctionDriftWithStableDiagnostic(), writeTestFiles()
...
Cohesion: 0.52
Nodes (5): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPIDisplayTextForBoundaryError(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), TestPublicCheckAPISingleSourcePositive(), writeTestFiles()
...
Cohesion: 0.6
Nodes (5): boundedFuzzInt(), byteAt(), FuzzFormatSourceIdempotent(), FuzzLoweringPipelineVerifiesIR(), loweringFuzzSource()
...
Cohesion: 0.53
Nodes (6): assertPtrContainingNestedAggregateCallDiagnostic(), ptrAggregateBorrowArg(), ptrAggregateBorrowParam(), ptrAggregateCallEscapeSource(), ptrAggregateSinkSource(), TestSafetyDiagnosticCodesForPtrContainingNestedAggregateCallRejections()
...
- `Roadmap v0.12 to v0.13` → `Actors Linux Smoke Checklist (Deprecated)`  [AMBIGUOUS]
  docs/roadmap_0_12_to_0_13.md · relation: conceptually_related_to
- `Codex Current Release Gate Summary (Pass)` → `Release Gate State (Blocked Run Artifacts)`  [AMBIGUOUS]
  reports/codex-current-release-gate/summary.md · relation: conceptually_related_to
- `v0.1.3 Post-Bump Release Gate-2 Summary (Pass)` → `Security Review Signoff Document (v0.1.2)`  [AMBIGUOUS]
  reports/codex-v0_1_3-post-bump-release-gate-2/artifacts/security-review.md · relation: rationale_for
- `Wave-F Implementer 4 Plan Sync` → `Wave-F Named Security Signoff Artifact`  [AMBIGUOUS]
  reports/plan250/waveF-impl4-plan-sync.md · relation: conceptually_related_to
- `Final Candidate Test-All Stabilization Summary` → `Backend Web UI Smoke DOM Snapshot`  [AMBIGUOUS]
  reports/plan250/backend/web-ui-smoke.dom.html · relation: conceptually_related_to
- `Wave G Web UI Smoke DOM Snapshot` → `Wave H Test-All Summary Report`  [AMBIGUOUS]
  reports/plan250/waveG-v0_3_gate/artifacts/test-all/web-ui-smoke.dom.html · relation: conceptually_related_to
- `Wave H Reviewer Test-All Summary Report` → `Wave H Reviewer Test-All Web UI DOM Snapshot`  [AMBIGUOUS]
  reports/plan250/waveH-reviewer-v0_3_gate/artifacts/test-all/web-ui-smoke.dom.html · relation: conceptually_related_to
- `v0.2.0 Candidate Release Gate Summary (Blocked)` → `Security Review Signoff in 175907 Artifacts`  [AMBIGUOUS]
  reports/v0_2_0_candidate_20260428-175907/artifacts/security-review.md · relation: conceptually_related_to

## Knowledge Gaps
- **409 isolated node(s):** `executableMatrixCase`, `apiDocTitle`, `ABICheck`, `targetRuntimeBoundaryCase`, `AtomicStressCheck` (+404 more)
...
- **What is the exact relationship between `Roadmap v0.12 to v0.13` and `Actors Linux Smoke Checklist (Deprecated)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Codex Current Release Gate Summary (Pass)` and `Release Gate State (Blocked Run Artifacts)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `v0.1.3 Post-Bump Release Gate-2 Summary (Pass)` and `Security Review Signoff Document (v0.1.2)`?**
  _Edge tagged AMBIGUOUS (relation: rationale_for) - confidence is low._
- **What is the exact relationship between `Wave-F Implementer 4 Plan Sync` and `Wave-F Named Security Signoff Artifact`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Final Candidate Test-All Stabilization Summary` and `Backend Web UI Smoke DOM Snapshot`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Wave G Web UI Smoke DOM Snapshot` and `Wave H Test-All Summary Report`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Wave H Reviewer Test-All Summary Report` and `Wave H Reviewer Test-All Web UI DOM Snapshot`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._