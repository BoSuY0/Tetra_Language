...
## Corpus Check
- 4465 files · ~6,506,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22057 nodes · 85399 edges · 1061 communities (910 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13775 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1209758b`
...
## Communities (1061 total, 151 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (610): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets() (+602 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (522): buildAndRun(), buildAndRunFiles(), TestBuildMakeZeroLengthSlices(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+514 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (337): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+329 more)
...
Cohesion: 0.03
Nodes (246): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+238 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (222): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), buildAndRunFile(), buildAndRunFileWithOptions() (+214 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (189): BuildFileWithStatsOpt(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithImportedSignatureType(), TestBuildInterfaceOnlyModeAcceptsGeneratedT4IWithStructReturnStub(), TestBuildInterfaceOnlyModeAllowsT4IDependencyWithoutOutput(), TestBuildInterfaceOnlyModeDoesNotRequireMain(), TestBuildInterfaceOnlyModeFunctionTypedEnumParameterWholeReturnGlobalEscapeDiagnostic(), TestBuildInterfaceOnlyModeFunctionTypedEnumPayloadMatchReturnGlobalEscapeDiagnostic(), TestBuildInterfaceOnlyModeFunctionTypedNestedStructFieldReturnGlobalEscapeDiagnostic() (+181 more)
...
Cohesion: 0.05
Nodes (62): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+54 more)
...
Cohesion: 0.05
Nodes (98): FormatPos(), resolveFieldChainLower(), msg, runPlatformWindowProbe(), runPlatformWindowProbe(), createWin32Control(), exerciseWin32UIRuntime(), runPlatformWindowProbe() (+90 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (110): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+102 more)
...
Cohesion: 0.07
Nodes (99): hasPrefix(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendUniqueString(), buildEcoLock(), buildEcoLockWithArtifactHashes(), buildNeedMap() (+91 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (42): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope() (+34 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+77 more)
...
Cohesion: 0.05
Nodes (76): atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder(), TestAtomicFenceKindForOrderMapsEveryMemoryOrder() (+68 more)
...
Cohesion: 0.04
Nodes (46): AssignStmt, itoa(), AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr (+38 more)
...
Cohesion: 0.06
Nodes (76): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+68 more)
...
Cohesion: 0.09
Nodes (77): ownershipAt(), validateFunctionTypeCallableEffects(), validateFunctionTypeParamOwnership(), validateReturnedFunctionSignature(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic() (+69 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (62): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+54 more)
...
Cohesion: 0.06
Nodes (22): BreakStmt, ContinueStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, LetStmt, lexer (+14 more)
...
Cohesion: 0.11
Nodes (53): cliProjectContext, capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir(), appendDependencyToCapsule() (+45 more)
...
Cohesion: 0.14
Nodes (37): sortedStrings(), collectTransitiveNeeds(), decodeStrictJSON(), dedupeStrings(), isCapsuleSemver(), main(), nodesByID(), parseSHA256Hash() (+29 more)
...
Cohesion: 0.1
Nodes (27): TestNormalizeFlowForMigrationAPI(), TestNormalizeFlowForMigrationAPICoversFlowTestAndMatchSurface(), Diagnostic, DiagnosticError, DiagnosticForError(), hintForDiagnosticMessage(), shiftDiagnosticColumn(), TestNormalizeFlowForMigrationHandlesIfLetAndMatchCases() (+19 more)
...
Cohesion: 0.15
Nodes (23): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+15 more)
...
Cohesion: 0.16
Nodes (21): requireLinuxX86Execution(), requireLocalTCPBind(), TestExecWebProgramWithBrowserRunnerParsesBrowserExitResult(), TestExecWebProgramWithRunnerParsesBrowserExitResult(), TestRunCommandPropagatesLinuxX86AllocBytesZeroExitCode(), TestRunCommandPropagatesLinuxX86DirectCallbackExitCode(), TestRunCommandPropagatesLinuxX86FunctionArgumentExitCode(), TestRunCommandPropagatesLinuxX86GlobalExitCode() (+13 more)
