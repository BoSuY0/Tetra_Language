...
## Corpus Check
- 620 files · ~1,272,463 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18680 nodes · 73344 edges · 502 communities (425 shown, 77 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13547 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23edd09f`
...
## Communities (502 total, 77 thin omitted)
...
Cohesion: 0.02
Nodes (327): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestReleaseV030GateRequireCleanRejectsDirtyWorktree(), TestReleaseV040GateRejectsNonEmptyReportDirBeforeSideEffects(), TestReleaseV040GateWritesBlockedSummaryOnReadinessFailure(), TestReleaseV040SecurityReviewBlocksUntilFullValidationExists() (+319 more)
...
Cohesion: 0.02
Nodes (282): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions() (+274 more)
...
Cohesion: 0.03
Nodes (202): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+194 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (214): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+206 more)
...
Cohesion: 0.03
Nodes (190): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+182 more)
...
Cohesion: 0.03
Nodes (173): BuildMacOSX64(), TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc() (+165 more)
...
Cohesion: 0.05
Nodes (111): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+103 more)
...
Cohesion: 0.04
Nodes (95): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+87 more)
...
Cohesion: 0.05
Nodes (92): buildAndRunWithOptions(), TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl() (+84 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (92): FormatPos(), ClosureCapture, captureMode, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), cloneBoolMap(), functionTypedCallArgumentHasCaptures(), functionTypedClosureAssignmentTargetPhrase() (+84 more)
...
Cohesion: 0.08
Nodes (76): hasPrefix(), validatePlaintext(), apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata() (+68 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (43): AssignStmt, itoa(), BreakStmt, CapsuleEntryDecl, CatchExprCase, ClosureExpr, ContinueStmt, DeferStmt (+35 more)

### Community 54 - "Community 54"
Cohesion: 0.11
Nodes (81): resolveFunctionFieldName(), CallableEscapeKind, applyInterfaceFunctionReturnMetadata(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs(), functionAssignmentValueTouchesMutableGlobals() (+73 more)
...
Cohesion: 0.09
Nodes (70): TypeRefKind, functionTypeRefSignature(), functionTypeRefSignatureAndEffects(), firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType() (+62 more)
...
Cohesion: 0.09
Nodes (75): ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion(), borrowedOwnerFromExpr(), callbackExpectedThrowsType(), canonicalOwnershipAccessPath() (+67 more)

### Community 60 - "Community 60"
Cohesion: 0.12
Nodes (72): releaseV030RunnableFakeRepo(), runReleaseV030RunnableGate(), runReleaseV030RunnableGateWithEnv(), writeReleaseV030RuntimeSmokeReports(), TestReleaseV030GateRejectsEmptyRuntimeSmokeCaseName(), TestReleaseV030GateRejectsInvalidTimestampRuntimeSmokeEvidence(), TestReleaseV030GateRejectsLooseTimestampRuntimeSmokeEvidence(), TestReleaseV030GateRejectsMissingRequiredRuntimeSmokeCase() (+64 more)
...
Cohesion: 0.05
Nodes (23): AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CatchExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr (+15 more)

### Community 69 - "Community 69"
Cohesion: 0.07
Nodes (50): hashedArtifact, hashManifest, buildHashManifest(), decodeStrictJSON(), detectJSONSchema(), hashFile(), listArtifactPaths(), main() (+42 more)
...
Cohesion: 0.06
Nodes (55): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest(), targetsJSONForTest() (+47 more)
...
Cohesion: 0.11
Nodes (53): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+45 more)
...
Cohesion: 0.12
Nodes (42): bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns(), catchPatternType() (+34 more)
...
Cohesion: 0.1
Nodes (39): resolveFieldChainLower(), assignTargetInfo, bindMatchPatternLocalsForInference(), cloneLocalMap(), collectExprLocals(), collectPatternLocals(), collectScopedLocal(), inferCatchExprType() (+31 more)
...
Cohesion: 0.05
Nodes (42): finalReleaseStateRefreshFollowsSummary(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers(), releaseV10GateFakeRepo(), releaseV10WASISmokeFakeRepo(), shellSingleQuote() (+34 more)
...
Cohesion: 0.1
Nodes (40): BuildFile(), findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio() (+32 more)
...
Cohesion: 0.12
Nodes (33): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+25 more)
...
Cohesion: 0.2
Nodes (25): TestCurrentSupportedSurfaceDocumentIsReleaseAligned(), currentGitHead(), currentReleaseVersion(), releaseV10SecurityReviewPathFakeRepo(), runReleaseV10SecurityReview(), sha256ForTest(), TestReleaseV040SecurityReviewValidatesScopedSignoff(), TestReleaseV040SecurityReviewWorkflowLivesInVersionedReleaseScript() (+17 more)
...
Cohesion: 0.3
Nodes (10): TestReleaseV030GateAcceptsResidualRisksSourcePathStartingWithDash(), TestReleaseV030GateAcceptsTriagedUnstableSeeds(), TestReleaseV030GateRejectsMalformedResidualRisksJSON(), TestReleaseV030GateRejectsNullResidualRisksArray(), TestReleaseV030GateRejectsResidualRiskMissingRequiredFields(), TestReleaseV030GateRejectsResidualRisksJSONForWrongReleaseVersion(), TestReleaseV030GateRejectsUnownedHighMediumResidualRisk(), TestReleaseV030GateRejectsUntriagedUnstableSeeds() (+2 more)
...
Cohesion: 0.53
Nodes (4): TestReleaseV030GateCIMissingSignoffWritesDetachedHashOutsideCanonicalManifest(), TestReleaseV030GateCIModeAllowsMissingSecuritySignoffWithArtifact(), TestReleaseV030GateRequireCleanRequiresSecuritySignoffEvenInCIMode(), TestReleaseV030GateRequiresSecuritySignoffOutsideCIMode()
