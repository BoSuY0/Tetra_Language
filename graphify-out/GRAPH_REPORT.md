...
## Corpus Check
- 4465 files · ~6,499,018 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22036 nodes · 85345 edges · 1059 communities (910 shown, 149 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13767 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e08f066`
...
## Communities (1059 total, 149 thin omitted)
...
Cohesion: 0.01
Nodes (428): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestMachOCStringInSection(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode() (+420 more)
...
Cohesion: 0.03
Nodes (253): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindBorrowedPtrAliasFromExpr() (+245 more)
...
Cohesion: 0.03
Nodes (159): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+151 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (122): branchScopeInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindResourceFromExpr(), recordTryCallThrowResourceSummary(), returnRegionSummaryForInterfaceExpr(), ownershipDiagnosticf() (+114 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (164): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+156 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (152): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+144 more)
...
Cohesion: 0.08
Nodes (109): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), collectLocals(), functionAssignmentEscapeMetadata() (+101 more)
...
Cohesion: 0.05
Nodes (91): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason() (+83 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (98): benchLevel, benchmarkEnvironment, buildEvidence, buildPlan, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState (+90 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke() (+77 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics() (+90 more)
...
Cohesion: 0.08
Nodes (85): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+77 more)
...
Cohesion: 0.04
Nodes (44): AssignStmt, itoa(), BoolLitExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt, DeferStmt (+36 more)
...
Cohesion: 0.09
Nodes (72): validateDiagnosticsMode(), writeDiagnostic(), writeValidationDiagnostic(), firstFormatterDiffPosition(), runCheck(), runDoc(), runFmt(), appendWorkspaceExecutionMember() (+64 more)
...
Cohesion: 0.1
Nodes (60): capsuleSectionHeader(), FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs() (+52 more)
...
Cohesion: 0.05
Nodes (48): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+40 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (24): AwaitExpr, BinaryExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, IndexExpr, lexer (+16 more)
...
Cohesion: 0.1
Nodes (45): TypeRefKind, resolveFieldChainLower(), assignTargetInfo, cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), resolveCallSigForInference() (+37 more)
...
Cohesion: 0.07
Nodes (49): TestCapturePprofProfilesWritesCPUAndHeap(), BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats (+41 more)
...
Cohesion: 0.12
Nodes (46): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+38 more)
...
Cohesion: 0.08
Nodes (44): BenchmarkEnvironment, EndpointReport, GitState, requiredMatrixSemanticProbeNames(), validateMatrixBuild(), validateMatrixPostgres(), ValidateMatrixReport(), validateMatrixResource() (+36 more)
...
Cohesion: 0.13
Nodes (27): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+19 more)
...
Cohesion: 0.15
Nodes (19): countingRWC, NewPool(), newTestConn(), TestPoolCloseRejectsFutureCheckoutAndClosesIdle(), TestPoolDropsBadConnectionsAndCreatesReplacement(), TestPoolReusesReleasedConnectionAndCapsOpenConnections(), TestPoolStatsTrackOpenIdleInUseAndClosedState(), TestNewTechEmpowerServerAppliesConfigAndRoutes() (+11 more)
...
Cohesion: 0.13
Nodes (18): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), dialTCP4Localhost(), netListenTCP4Localhost(), TestCollectNetRuntimeUsage(), TestNetRuntimeEpollReadinessBuildAndRunLinuxX64(), TestNetRuntimeEpollWaitOneIntoBuildAndRunLinuxX64(), TestNetRuntimeHTTPPipelinedPlaintextJSONBuildAndRunLinuxX64() (+10 more)
...
Cohesion: 0.13
Nodes (12): emitCmp(), emitIndexLoad(), emitIndexStore(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+4 more)
...
Cohesion: 0.2
Nodes (19): NewTechEmpowerServer(), PlaintextHandler(), RegisterTechEmpowerRoutes(), TestNormalizeQueryCount(), dbErrorResponse(), DBHandler(), fetchFortunes(), fetchWorld() (+11 more)
...
Cohesion: 0.22
Nodes (14): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+6 more)
