...
## Corpus Check
- 4465 files · ~6,514,838 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22076 nodes · 85453 edges · 1083 communities (930 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13785 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fff7411d`
...
Cohesion: 0.01
Nodes (294): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+286 more)
...
Cohesion: 0.02
Nodes (212): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+204 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (216): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), capsulePermissionEntry() (+208 more)
...
Cohesion: 0.03
Nodes (150): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+142 more)
...
Cohesion: 0.04
Nodes (68): branchScopeInfo, bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), catchExprHasCompleteEnumPatterns(), catchPatternType(), checkDeferBody() (+60 more)
...
Cohesion: 0.04
Nodes (117): requireCheckWorldFilesErrorContains(), TestActorConsumeRejectsAggregateAliasConsumedTwiceInSingleCall(), TestActorConsumeRejectsAggregateAliasFieldReuse(), TestActorConsumeRejectsAliasConsumedTwiceInSingleCall(), TestActorConsumeRejectsAliasReuse(), TestActorConsumeRejectsCrossModuleEnumPayloadAliasReuse(), TestActorConsumeRejectsCrossModuleGenericStructFieldAliasReuse(), TestActorConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse() (+109 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (112): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindResourceFromExpr() (+104 more)
...
Cohesion: 0.09
Nodes (104): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), collectLocals() (+96 more)
...
Cohesion: 0.07
Nodes (78): bindMatchPatternLocalsForInference(), cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType(), resolveCallSigForInference(), firstCapture(), genericDef (+70 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (44): AssignStmt, AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase (+36 more)
...
Cohesion: 0.07
Nodes (83): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+75 more)
...
Cohesion: 0.07
Nodes (64): TestOwnershipAllowsPartialEnumPayloadConsumeAndSiblingPayloadUse(), TestOwnershipAllowsPartialStructFieldConsumeAndRemainingFieldUse(), TestOwnershipAllowsProtocolImplMatchingParameterOwnership(), TestOwnershipAllowsStructFieldsFromDistinctBorrowRegions(), TestOwnershipAllowsWholeEnumReassignmentAfterPartialPayloadConsume(), TestOwnershipAllowsWholeStructConsume(), checkEffectsFileProgram(), checkEffectsProgram() (+56 more)
...
Cohesion: 0.06
Nodes (22): BreakStmt, DeferStmt, ExprStmt, FreeStmt, IslandStmt, LetStmt, lexer, hexValue() (+14 more)
...
Cohesion: 0.07
Nodes (46): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), requireUnsupportedReasonContains(), targetMetaForTest() (+38 more)
...
Cohesion: 0.12
Nodes (31): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+23 more)
...
Cohesion: 0.11
Nodes (25): nativeLinuxX86ExecutableBackend(), callPatch, buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitCmp() (+17 more)
...
Cohesion: 0.17
Nodes (29): capsuleIDDirectory(), decodeEcoPublishMetadata(), downloadPackage(), ecoPublishPackageHashHex(), ecoPublishSchemaForChannel(), ecoPublishSHA256HashHex(), fetchEcoHTTPStoreFile(), fetchPublishedPackage() (+21 more)
