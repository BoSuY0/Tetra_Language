...
## Corpus Check
- 4401 files · ~6,262,670 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21848 nodes · 84540 edges · 1062 communities (912 shown, 150 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13703 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b92429af`
...
## Communities (1062 total, 150 thin omitted)
...
Cohesion: 0.03
Nodes (244): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+236 more)
...
Cohesion: 0.03
Nodes (168): BuildMacOSX64(), TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc() (+160 more)
...
Cohesion: 0.03
Nodes (153): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+145 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (170): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot() (+162 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (153): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+145 more)
...
Cohesion: 0.06
Nodes (121): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindMatchPatternLocalsForInference(), borrowedPtrOwnerFromExpr(), catchExprHasCompleteEnumPatterns() (+113 more)
...
Cohesion: 0.08
Nodes (111): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+103 more)
...
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+77 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+90 more)
...
Cohesion: 0.07
Nodes (10): emitCall(), emitExit(), emitFunc(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitReturn(), emitWrite() (+2 more)
...
Cohesion: 0.08
Nodes (66): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+58 more)
...
Cohesion: 0.1
Nodes (49): FuzzParseCapsuleDoesNotPanic(), buildEcoLock(), buildEcoLockWithArtifactHashes(), copySortedPolicy(), decodeEcoLock(), hydrateLockArtifactHashes(), lockArtifactsFromCapsuleArtifacts(), lockGraphFingerprint() (+41 more)
...
Cohesion: 0.07
Nodes (48): BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats, averageMS() (+40 more)
...
Cohesion: 0.1
Nodes (33): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+25 more)
...
Cohesion: 0.12
Nodes (36): ecoLockArtifact, ecoLockCapsule, ecoLockDependency, ecoLockEnvelope, cleanArtifactPath(), containsString(), isCapsuleSemver(), lockGraphFingerprint() (+28 more)
...
Cohesion: 0.14
Nodes (8): atomicFetchAdd32(), atomicFetchSub32(), emitAllocBytes(), emitIslandNew(), emitMakeSlice(), emitMmapFailureBranch(), emitMMIOWriteI32(), patchExitBranch()
...
Cohesion: 0.17
Nodes (12): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleRelPath(), SourceExtensions() (+4 more)
...
Cohesion: 0.41
Nodes (10): actorTransportMessage, actorTransportReport, actorTransportTraceEvent, actorTransportMessageSHA256(), decodeStrictActorTransportJSON(), main(), parseActorTransportSHA256(), validateActorTransport() (+2 more)
...
Cohesion: 0.76
Nodes (5): TestValidateActorTransportAcceptsValidReport(), TestValidateActorTransportRejectsHashMismatch(), TestValidateActorTransportRejectsMissingReceive(), validActorTransportReport(), validActorTransportReportFrom()
