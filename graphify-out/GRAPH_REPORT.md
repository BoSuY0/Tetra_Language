...
## Corpus Check
- 4465 files · ~6,487,738 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22006 nodes · 85222 edges · 1095 communities (938 shown, 157 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13735 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd31b87d`
...
## Communities (1095 total, 157 thin omitted)
...
Cohesion: 0.01
Nodes (403): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+395 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (442): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics() (+434 more)
...
Cohesion: 0.02
Nodes (276): TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+268 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (267): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+259 more)
...
Cohesion: 0.03
Nodes (157): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+149 more)
...
Cohesion: 0.02
Nodes (149): requireCheckFileErrorContains(), requireCheckFileOK(), TestActorSpawnRejectsMutableGlobalTarget(), TestActorSpawnRejectsThrowingTarget(), TestAsyncRejectAwaitOutsideAsync(), TestAsyncRejectBareAsyncCall(), TestAsyncSmokeExampleBuildAndRun(), TestAsyncTypedErrorBoundaryRejectsAwaitTryForm() (+141 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (146): normalizeOwnershipAuditStatus(), parseOwnershipAuditStatus(), auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), stableForbiddenCaseDiagnosticsFixtureEvidence(), TestOwnershipAuditFixtureHelpersLiveInFocusedFile(), TestOwnershipAuditValidatorPackageIsSplitByResponsibility() (+138 more)
...
Cohesion: 0.05
Nodes (108): FormatPos(), ClosureCapture, atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName() (+100 more)
...
Cohesion: 0.06
Nodes (93): resolveFieldChainLower(), assignTargetInfo, collectExprLocals(), inferCatchExprType(), resolveCallSigForInference(), firstCapture(), genericDef, genericProtocolInfo (+85 more)
...
Cohesion: 0.1
Nodes (90): resolveFunctionFieldName(), CallableEscapeKind, checkStmts(), collectionElementType(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs() (+82 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (76): BuildOptions, featuresReport, formatsReport, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost() (+68 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (87): TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestDeferRejectsBreakToOuterLoopInsideCleanup(), TestDeferRejectsLaterActorTransferOfCapturedIsland(), TestDeferRejectsLaterConsumeOfCapturedValue(), TestDeferRejectsReturnInsideCleanup(), TestDeferRejectsThrowInsideCleanup(), TestDeferRunsBeforeScopedIslandAutoFree() (+79 more)
...
Cohesion: 0.08
Nodes (82): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), resourcePathForExpr(), resourceSourceForExpr(), resourceSourceForPath() (+74 more)
...
Cohesion: 0.05
Nodes (72): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+64 more)
...
Cohesion: 0.1
Nodes (65): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+57 more)
...
Cohesion: 0.12
Nodes (55): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), main(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReportExcept(), makeV040PassingReleaseGateSummaryReportInOrder() (+47 more)
...
Cohesion: 0.06
Nodes (21): AssignStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt, IslandStmt, LetStmt (+13 more)
...
Cohesion: 0.11
Nodes (27): buildReport(), compilerProductionAudit(), failedCase(), intPtr(), main(), processExitCode(), requireFileWithPrefix(), runCommand() (+19 more)
...
Cohesion: 0.14
Nodes (25): effectDiagnosticf(), effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), normalizeEffects() (+17 more)
...
Cohesion: 0.18
Nodes (23): newFakeWorldDB(), sequenceIDs(), startDBBenchmarkServer(), startDBBenchmarkServerWithRandom(), TestServerDBEndpointUsesPoolAndSerializesWorld(), TestServerQueriesEndpointNormalizesCountAndSerializesWorldArray(), TestServerUpdatesEndpointReadsUpdatesThenSerializesWorldArray(), fakeWorldDB (+15 more)
...
Cohesion: 0.14
Nodes (21): classifyOwnershipAuditResult(), isOwnershipAuditSeparatorRow(), main(), ownershipAuditSection(), parseOwnershipAuditRows(), splitOwnershipAuditTableRow(), replaceOwnershipAuditRowEvidence(), validateOwnershipAuditRows() (+13 more)
...
Cohesion: 0.24
Nodes (18): writeInterfaceEnum(), writeInterfaceHashOnlySurface(), writeInterfaceImpl(), writeInterfaceStruct(), canonicalLSPTypeName(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail() (+10 more)
...
Cohesion: 0.25
Nodes (11): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), TestValidateOwnershipAuditAcceptsRowEvidenceDetails(), TestValidateOwnershipAuditAcceptsBlockedAudit(), TestValidateOwnershipAuditAcceptsRowEvidenceDetails() (+3 more)
