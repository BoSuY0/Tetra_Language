...
## Corpus Check
- 746 files · ~1,518,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18829 nodes · 74252 edges · 515 communities (437 shown, 78 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 13556 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `358fa229`
...
## Communities (515 total, 78 thin omitted)
...
Cohesion: 0.01
Nodes (427): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestMachOCStringInSection(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics() (+419 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (297): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+289 more)
...
Cohesion: 0.02
Nodes (258): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly() (+250 more)
...
Cohesion: 0.03
Nodes (232): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata() (+224 more)
...
Cohesion: 0.03
Nodes (150): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+142 more)
...
Cohesion: 0.09
Nodes (98): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata() (+90 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (92): resolveFieldChainLower(), assignTargetInfo, ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion(), borrowedOwnerFromExpr() (+84 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (84): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceFromExpr() (+76 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (78): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+70 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (98): TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCrossModuleUnsupportedCaptureDiagnostics(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+90 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke() (+77 more)
...
Cohesion: 0.07
Nodes (83): appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString(), buildEcoLock(), buildNeedMap(), capsuleArtifactKey() (+75 more)
...
Cohesion: 0.07
Nodes (66): BuildOptions, runInterface(), allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost() (+58 more)
...
Cohesion: 0.05
Nodes (62): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), requireUnsupportedReasonContains(), targetMetaForTest() (+54 more)
...
Cohesion: 0.07
Nodes (4): ownershipPathParent(), parentOwnershipPath(), resourceFinalizationAllows(), regionState
...
Cohesion: 0.14
Nodes (43): artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), buildEcoLockWithArtifactHashes(), capsuleSourceModules(), checkCapsuleArtifacts(), checkCapsuleArtifactsOpt(), checkDeclaredCapsuleArtifacts() (+35 more)
...
Cohesion: 0.08
Nodes (26): callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitCmp() (+18 more)
...
Cohesion: 0.06
Nodes (30): TestGenericFunctionCrossModuleMonomorphizedCall(), TestGenericFunctionMonomorphizedNamesAvoidTypeCollisions(), TestGenericFunctionParseCheckAndDocs(), TestGenericFunctionProtocolBoundCrossModuleConformancePasses(), TestGenericFunctionProtocolBoundCrossModuleRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsMismatchedImplSignature(), TestGenericFunctionProtocolBoundRejectsMissingImpl(), TestGenericFunctionProtocolBoundRejectsNonProtocolBound() (+22 more)
...
Cohesion: 0.16
Nodes (29): apiDocTitle(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), disambiguatedAPIDocTitles(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+21 more)
...
Cohesion: 0.22
Nodes (23): FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), isCapsuleSemver(), normalizeCapsuleArtifactKind() (+15 more)
