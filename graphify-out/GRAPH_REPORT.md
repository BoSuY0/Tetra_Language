# Graph Report - Tetra_Language  (2026-05-21)

## Corpus Check
- 2693 files · ~4,099,734 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18326 nodes · 72637 edges · 490 communities (411 shown, 79 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 13498 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `489814f8`
...
## Communities (490 total, 79 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (503): buildAndRun(), buildAndRunFiles(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke(), TestBuildCapturedPtrClosureDirectCallbackArgumentSmoke() (+495 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (440): TestELFHasRWDataSegmentAndStringNotInText(), TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestMachOCStringInSection(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry() (+432 more)
...
Cohesion: 0.03
Nodes (255): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+247 more)
...
Cohesion: 0.02
Nodes (202): BuildMacOSX64(), TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse() (+194 more)
...
Cohesion: 0.03
Nodes (170): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+162 more)
...
Cohesion: 0.05
Nodes (146): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+138 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (147): TestActorTaskBoundedStressExamples(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK(), TestBuildAsyncSmoke() (+139 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (136): FormatPos(), builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindResourceFromExpr(), catchPatternType(), ownershipAt(), resourceSourceForExpr() (+128 more)
...
Cohesion: 0.08
Nodes (102): TestReleaseV011GateValidatesJSONDiagnostics(), testAllFakeRepo(), assertExitCode(), decodeTestAllSummary(), hasTestAllStep(), readReleaseV06GateScript(), readTestAllScript(), runTestAll() (+94 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (51): branchScopeInfo, bindFreshResourceTree(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr(), copyResourceTreeFromPath(), joinResourcePath(), markResourceTreeUnknown(), resourceLeafPaths() (+43 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (104): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+96 more)
...
Cohesion: 0.07
Nodes (81): canRunLinuxX32OnHost(), probeLinuxX32Execution(), artifactCheck, fakeFileInfo, fileInfo, freshnessCheck, gateEvidenceReport, generatedArtifactsReport (+73 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (79): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+71 more)
...
Cohesion: 0.04
Nodes (42): itoa(), AwaitExpr, BinaryExpr, BoolLitExpr, CallExpr, CapsuleEntryDecl, CatchExpr, CatchExprCase (+34 more)
...
Cohesion: 0.07
Nodes (74): buildAndRunWithOptions(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionReturningGenericStructMonomorphizesStruct(), buildAndRunWithOptionsTimeout(), containsString(), findIRFunc(), hasIRCall() (+66 more)
...
Cohesion: 0.05
Nodes (58): TestBuildRejectsInterfaceImplementationMissingSymbol(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip() (+50 more)
...
Cohesion: 0.05
Nodes (18): AssignStmt, BreakStmt, ContinueStmt, DeferStmt, ExpectStmt, ExprStmt, ForRangeStmt, FreeStmt (+10 more)
...
Cohesion: 0.13
Nodes (55): parseCapsuleBareOrQuoted(), parseCapsuleString(), writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember() (+47 more)
...
Cohesion: 0.12
Nodes (43): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+35 more)
...
Cohesion: 0.1
Nodes (42): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultTarget() (+34 more)
...
Cohesion: 0.14
Nodes (35): fakeColumn, partialWriteRWC, authSASLContinuePayload(), authSASLFinalPayload(), authSASLPayload(), backendKeyPayload(), buildSCRAMServerFinalForTest(), cstringPayload() (+27 more)
...
Cohesion: 0.11
Nodes (25): callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitIndexLoad() (+17 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (28): DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), FuzzLinkX64ObjectsDoesNotPanic(), LinkX64Objects(), readI32LE() (+20 more)

### Community 118 - "Community 118"
Cohesion: 0.12
Nodes (32): appendEscapedByte(), AppendMessageObject(), AppendString(), AppendWorldArray(), AppendWorldObject(), assertValidJSONString(), FuzzAppendStringProducesValidJSON(), repairInvalidUTF8Bytewise() (+24 more)
...
Cohesion: 0.09
Nodes (35): Current Supported Surface Spec, V0 1 1 Release Gate, V0 1 2 Release Gate, V0 1 3 Release Gate, V0 4 0 Release Gate, V1 0 Release Gate, Known Issues, 2026 04 27 Tetra Real Stabilization Agent Backlog (+27 more)
...
Cohesion: 0.13
Nodes (23): emitX64ReturnSlotPushes(), TestX64ABICallsZeroThroughTenArgs(), TestX64ABIReturnSlotsThreeAndFourRegisterMapping(), TestX64BuildOnlySmokeAcrossNativeTargets(), x64ReturnSlotName(), argCountName(), containsMovEaxImm32(), emitReturnSlotPushes() (+15 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (31): benchLevel, benchmarkEnvironment, buildEvidence, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState, latencyStats (+23 more)
...
Cohesion: 0.19
Nodes (30): artifactSlug(), buildCapsuleArtifacts(), capsuleSourceModules(), defaultCapsulePath(), interfaceArtifactRelPath(), writeEcoLock(), parseCapsuleGraphArgs(), validateCapsuleGraph() (+22 more)

### Community 140 - "Community 140"
Cohesion: 0.24
Nodes (28): TestValidateUIBundleArtifactRejectsMissingRequiredNestedField(), TestValidateUIBundleArtifactRejectsTrailingJSONPayload(), TestValidateUIBundleArtifactRejectsUnsupportedCommandOperation(), TestValidateUIBundleSchemaArtifactAcceptsCheckedInSchema(), TestValidateUIBundleSchemaArtifactRejectsInvalidID(), TestValidateUIBundleSchemaArtifactRejectsTrailingJSONPayload(), TestValidateWebUISmokeReportAcceptsCommandOperations(), TestValidateWebUISmokeReportAcceptsHostBlockedReport() (+20 more)
...
Cohesion: 0.1
Nodes (23): Handler, Header, appendHeader(), AppendResponse(), applyHeaderMetadata(), containsControl(), normalizeLimits(), parseHeaderLine() (+15 more)
...
Cohesion: 0.16
Nodes (21): IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths(), ModuleRelPath() (+13 more)
...
Cohesion: 0.11
Nodes (17): Connector, countingRWC, Dial(), DialConnector(), NewDialPool(), DialConfig, Pool, NewPool() (+9 more)
...
Cohesion: 0.22
Nodes (21): validateWorkspaceReportFormat(), decodeStrictJSON(), isASCIIAlpha(), isWorkspaceExecWindowsAbsPath(), main(), TestValidateWorkspaceExecAcceptsBuildPassReport(), TestValidateWorkspaceExecAcceptsTestFailureAndSkipReport(), TestValidateWorkspaceExecRejectsCountMismatch() (+13 more)
...
Cohesion: 0.17
Nodes (17): apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+9 more)
...
Cohesion: 0.23
Nodes (17): TestBuildCacheSeparatesNativeDebugAndReleaseModes(), TestBuildWASMCacheStatsRemainColdAcrossBuilds(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+9 more)
...
Cohesion: 0.22
Nodes (17): decodeStrictJSON(), main(), TestValidateRunContractAcceptsHostProbedBuildOnly(), TestValidateTargetsReportAcceptsExpectedShape(), TestValidateTargetsReportAcceptsMissingWASIRunner(), TestValidateTargetsReportRejectsDuplicate(), TestValidateTargetsReportRejectsMissingMetadata(), TestValidateTargetsReportRejectsMissingStatus() (+9 more)
...
Cohesion: 0.31
Nodes (18): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures(), collectDeferCaptures() (+10 more)
...
Cohesion: 0.12
Nodes (20): absPath(), buildRelease(), defaultEmbeddedPostgresCacheDir(), endpointBenchmarkSpecs(), freeTCPPort(), main(), postgresDSN(), prepareWorkDir() (+12 more)
...
Cohesion: 0.19
Nodes (17): defaultOutputPath(), gitRoot(), intFromInt64(), isUnderDir(), main(), normalizeOutputPath(), printDumpResult(), printUsage() (+9 more)
...
Cohesion: 0.31
Nodes (11): featuresReport, formatsReport, targetReportEntryForTest(), TestTargetMetadataCheck(), atomicPointerWidthBits(), buildTargetReportEntries(), describeTargetForText(), runTargets() (+3 more)
...
Cohesion: 0.2
Nodes (4): emitAllocBytes(), emitMakeSlice(), emitMmapFailureBranch(), patchExitBranch()
...
Cohesion: 0.17
Nodes (10): orderedMarkers(), parseEndpointNames(), parseLevels(), parsePositiveIntList(), rewritePGHBAForSCRAM(), startSCRAMPostgres(), TestOrderedMarkers(), TestParseEndpointNamesAndWorkerLevels() (+2 more)
...
Cohesion: 0.5
Nodes (6): isDigit(), isIdentPart(), isIdentStart(), newLexer(), token, TokenType
...
Cohesion: 0.39
Nodes (8): decodeWorldResponse(), get(), getWorldArray(), runSemanticProbe(), validateFortunesHTTP(), validateWorld(), validateWorldArrayHTTP(), validateWorldHTTP()
...
## Knowledge Gaps
- **342 isolated node(s):** `executableMatrixCase`, `ABICheck`, `targetRuntimeBoundaryCase`, `AtomicStressCheck`, `FuzzCheck` (+337 more)
