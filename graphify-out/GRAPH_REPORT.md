...
## Corpus Check
- 4465 files · ~6,366,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22112 nodes · 85576 edges · 1066 communities (912 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13815 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4320e1cf`
...
Cohesion: 0.01
Nodes (439): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildCommandLinuxX32AutoRuntimeWritesSelfHostELF(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes() (+431 more)
...
Cohesion: 0.02
Nodes (265): TestActorTaskBoundedStressExamples(), TestArrayMVPBuildSmoke(), TestArrayMVPBuildSupportsOptionalFixedArrayGlobal(), TestArrayMVPBuildSupportsZeroedFixedArrayFieldGlobal(), BuildFileWithStatsOpt(), readLinkObjects(), buildAndRunFile(), buildAndRunFileWithOptions() (+257 more)
...
Cohesion: 0.03
Nodes (248): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+240 more)
...
Cohesion: 0.04
Nodes (140): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+132 more)
...
Cohesion: 0.04
Nodes (133): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), executableMatrixCase, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason() (+125 more)
...
Cohesion: 0.04
Nodes (112): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+104 more)
...
Cohesion: 0.08
Nodes (111): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectLocals() (+103 more)
...
Cohesion: 0.06
Nodes (99): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+91 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (97): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindResourceFromExpr(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr() (+89 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+77 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (37): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree(), constructorRegionFromTree() (+29 more)
...
Cohesion: 0.05
Nodes (84): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+76 more)
...
Cohesion: 0.07
Nodes (63): TestCheckCommandJSONDiagnosticsForCallableMutableCaptureGlobalEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableMutableCaptureHeapEscapeCode(), TestCheckCommandJSONDiagnosticsForCallableResourceCaptureEscapeCode(), TestCheckCommandJSONDiagnosticsForCapturedCallableGlobalStorageCode(), TestCheckCommandJSONDiagnosticsForCapturedClosureExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForCapturingClosureRawPointerEscapeCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedExplicitTypeArgsCode(), TestCheckCommandJSONDiagnosticsForFunctionTypedParameterGlobalStorageCode() (+55 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (58): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+50 more)
...
Cohesion: 0.08
Nodes (50): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+42 more)
...
Cohesion: 0.07
Nodes (52): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+44 more)
...
Cohesion: 0.13
Nodes (26): atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16(), atomicFetchAdd8() (+18 more)
...
Cohesion: 0.14
Nodes (21): classifyOwnershipAuditResult(), isOwnershipAuditSeparatorRow(), main(), normalizeOwnershipAuditStatus(), ownershipAuditSection(), parseOwnershipAuditRows(), parseOwnershipAuditStatus(), splitOwnershipAuditTableRow() (+13 more)
...
Cohesion: 0.13
Nodes (16): nativeLinuxX86ExecutableBackend(), callPatch, alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix() (+8 more)
...
Cohesion: 0.1
Nodes (21): API Diff No-Change Policy, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register, WaveD Fuzz Seed Triage Policy (+13 more)
...
Cohesion: 0.13
Nodes (3): atomicFetchAdd32(), atomicFetchSub32(), emitFunc()
...
Cohesion: 0.21
Nodes (13): auditParagraph(), markdownAuditRow(), renderBlockedOwnershipAudit(), replaceOwnershipAuditRowEvidence(), stableForbiddenCaseDiagnosticsFixtureEvidence(), replaceOwnershipAuditRowEvidence(), TestValidateOwnershipAuditAcceptsRowEvidenceDetails(), splitOwnershipAuditTableRow() (+5 more)
...
Cohesion: 0.29
Nodes (10): assertResourceAliasFinalizationDiagnostic(), assertTaskGroupAliasCloseDiagnostic(), assertTaskHandleAliasJoinDiagnostic(), TestSafetyDiagnosticCodesForEnumConstructorReturnResourceAliases(), TestSafetyDiagnosticCodesForGenericResourceAliasFinalization(), TestSafetyDiagnosticCodesForTaskGroupCancelReturnProvenance(), TestSafetyDiagnosticCodesForTaskGroupStructFieldEnumPayloadAliasClose(), TestSafetyDiagnosticCodesForTaskHandleGroupOptionalPayloadJoinCloseAliases() (+2 more)
