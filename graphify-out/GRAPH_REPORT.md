...
## Corpus Check
- 4465 files · ~6,359,368 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22099 nodes · 85531 edges · 1082 communities (931 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13803 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd89d8e5`
...
## Communities (1082 total, 151 thin omitted)
...
Cohesion: 0.03
Nodes (259): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata() (+251 more)
...
Cohesion: 0.02
Nodes (231): TestActorTaskBoundedStressExamples(), TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains() (+223 more)
...
Cohesion: 0.03
Nodes (155): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), BuildStats, checkedBuildWorld, annotateRuntimeObjectSignatures(), blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc() (+147 more)
...
Cohesion: 0.04
Nodes (147): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot() (+139 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (140): canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), execProgram(), probeLinuxX32Execution(), flowIssue, firstCodeColumn() (+132 more)
...
Cohesion: 0.05
Nodes (97): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+89 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (113): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+105 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (104): dumpOptions, boolToYesNo(), buildDump(), collectFromFileList(), collectRelPaths(), defaultExcludedDirParts(), defaultExcludePrefixes(), defaultOnlyPrefixes() (+96 more)
...
Cohesion: 0.04
Nodes (51): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), borrowedEscapeShouldInspect(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree() (+43 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureStructFieldDirectCallSmoke() (+90 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+77 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (84): TestObjectRoundTrip(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames(), TestObjectWriteRejectsMalformedSymbolAndRelocRanges(), TestObjectWriteRejectsTooLongHeaderString() (+76 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (90): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+82 more)
...
Cohesion: 0.08
Nodes (76): BuildOptions, runInterface(), defaultTarget(), runRun(), validateDiagnosticsMode(), writeDiagnostic(), writeValidationDiagnostic(), firstFormatterDiffPosition() (+68 more)

### Community 61 - "Community 61"
Cohesion: 0.09
Nodes (80): bindResourceFromExpr(), borrowedPtrOwnerFromExpr(), resourcePathForExpr(), resourceSourceForExpr(), ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic() (+72 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (78): main(), buildBaseline(), buildDiff(), buildReviewSummary(), deterministicTimestampISO(), entryIdentity(), main(), normalizeEntry() (+70 more)
...
Cohesion: 0.05
Nodes (79): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+71 more)
...
Cohesion: 0.11
Nodes (61): ecoPublishSchemaForChannel(), findCapsulePath(), isSupportedEcoPublishChannel(), attachEcoPublishTrust(), availableEcoPackageTargets(), buildEcoPublishMetadata(), capsuleIDDirectory(), decodeEcoPublishMetadata() (+53 more)
...
Cohesion: 0.09
Nodes (51): IRInstrKind, irVerifierError(), irVerifierErrorAt(), lowerDiagnostic(), lowerUnsupportedError(), runtimeCallSig, RuntimeCallSignature, stackState (+43 more)
...
Cohesion: 0.11
Nodes (40): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, appendDataRow(), authSASLContinuePayload() (+32 more)
...
Cohesion: 0.08
Nodes (39): BenchmarkEnvironment, benchOptions, EndpointReport, endpointResult, endpointSpec, GitState, latencyStats, averageMS() (+31 more)
...
Cohesion: 0.12
Nodes (27): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+19 more)
...
Cohesion: 0.07
Nodes (35): benchLevel, benchmarkEnvironment, buildEvidence, buildPlan, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState (+27 more)
...
Cohesion: 0.14
Nodes (23): effectContext, canonicalizeEffectName(), effectSet(), expandEffectGroup(), newEffectContext(), normalizeEffectDecl(), normalizeEffects(), sortedEffectSet() (+15 more)
...
Cohesion: 0.15
Nodes (14): expectedContentType(), TestRunBenchmarkFailsWhenThresholdIsMissed(), TestRunBenchmarkRecordsLatencyPercentilesAndIntegrityMetadata(), TestValidateReportAllowsFailedEndpointWithZeroRPS(), TestValidateReportRejectsWeakEvidenceMarkers(), TestValidateReportRequiresAllTechEmpowerEndpoints(), validTestReport(), TestPprofHandlerExposesIndex() (+6 more)
...
Cohesion: 0.15
Nodes (14): emitEntryStubSysVLinuxX86(), LinkLinuxX86(), containsMovEaxImm32LinkerTest(), emitEntryStubForTestX86(), TestLinkLinuxRejectsNonLinuxTargetObject(), TestLinkLinuxX32RejectsNonX32TargetObject(), TestLinkLinuxX32UsesX32ExitSyscall(), TestLinkLinuxX64RejectsAbsoluteDataRelocs() (+6 more)
...
Cohesion: 0.13
Nodes (14): buildPlanForMode(), orderedMarkers(), parseLevels(), rewritePGHBAForSCRAM(), serverEnv(), startSCRAMPostgres(), startServer(), TestBuildPlanForModeKeepsReleaseDefaultAndAddsProfileSymbols() (+6 more)
...
Cohesion: 0.36
Nodes (8): TestModuleBoundaryAllowsPublicImportedFunction(), TestModuleBoundaryRejectsPrivateImportedFunction(), TestPublicReExportSupportsSelectiveImport(), TestSelectiveImportRejectsDuplicateImportedSymbol(), TestSelectiveImportResolvesPublicFunctionAndType(), writeCompilerModuleFiles(), TestPlan250ExtensionResolutionOrderStableAcrossImports(), TestPlan250ModuleBoundaryVisibilityDiagnosticStable()
...
Cohesion: 0.43
Nodes (4): fakeFortuneRow, newFakeFortuneDB(), startFortunesBenchmarkServer(), TestServerFortunesEndpointFetchesSortsAndEscapesHTML()
...
Cohesion: 0.6
Nodes (6): decodeWorldResponse(), get(), getWorldArray(), runSemanticProbe(), validateWorld(), validateWorldArrayHTTP()
...
Cohesion: 0.4
Nodes (5): requiredSemanticProbeNames(), semanticFailed(), TestValidateCheckedInSCRAMMatrixReports(), validateMatrixReport(), validateSemanticProbeCoverage()
