...
## Corpus Check
- 4465 files · ~6,521,090 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22087 nodes · 85486 edges · 1075 communities (924 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13793 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff0280aa`
...
## Communities (1075 total, 151 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (504): buildAndRun(), buildAndRunFiles(), TestBuildCrossModuleNoPayloadEnumMatchSmoke(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke(), TestBuildForCollectionStringSmoke(), TestBuildForCollectionU16SliceSmoke(), TestBuildForCollectionU8SliceSmoke() (+496 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (461): writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget() (+453 more)
...
Cohesion: 0.03
Nodes (228): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+220 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (229): BuildFileWithStatsOpt(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK(), TestBuildAsyncSmoke() (+221 more)
...
Cohesion: 0.03
Nodes (173): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+165 more)
...
Cohesion: 0.03
Nodes (155): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+147 more)
...
Cohesion: 0.04
Nodes (123): TestBuildCommandArtifactsAutoRepairsStaleObject(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes() (+115 more)
...
Cohesion: 0.04
Nodes (79): branchScopeInfo, bindBorrowedPtrAliasFromExpr(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals(), bindResourceTreeFromCallSummary() (+71 more)
...
Cohesion: 0.05
Nodes (112): capsuleArtifact, capsuleDependency, capsuleManifest, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule(), appendUniqueString() (+104 more)
...
Cohesion: 0.08
Nodes (109): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType() (+101 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (104): TestReleaseV011GateValidatesJSONDiagnostics(), testAllFakeRepo(), assertExitCode(), decodeTestAllSummary(), hasTestAllStep(), readReleaseV06GateScript(), readTestAllScript(), runTestAll() (+96 more)
...
Cohesion: 0.06
Nodes (94): BuildStats, checkedBuildWorld, blockedWASMIRPolicy(), buildActorDispatchFunc(), buildActorMainEntryIDFunc(), buildObjectFileWithStatsOpt(), buildTagFromOptions(), buildWASM32WASIWithStatsOpt() (+86 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (89): resolveFieldChainLower(), assignTargetInfo, ownershipDiagnosticf(), actorTaskWorkerBoundaryEffect(), bareEnumPatternCaseName(), barePayloadRequiredDiagnostic(), borrowedOwnerForRegion(), borrowedOwnerFromExpr() (+81 more)
...
Cohesion: 0.04
Nodes (42): AssignStmt, BreakStmt, CallExpr, CapsuleEntryDecl, CatchExprCase, ClosureExpr, ContinueStmt, DeferStmt (+34 more)
...
Cohesion: 0.04
Nodes (67): TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsTooLongHeaderString(), Version(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestObjectReadRejectsInvalidMagicAndVersion(), TestObjectRoundTrip(), TestObjectWriteRejectsMalformedSymbolAndRelocNames() (+59 more)
...
Cohesion: 0.07
Nodes (72): TestActorSpawnsTaskAndReceivesCompletionBuildAndRun(), TestActorStateLowerUsesRuntimeLoadStoreCalls(), buildAndRunWithOptions(), TestGenericFunctionMonomorphizedCall(), TestGenericFunctionProtocolBoundConformancePasses(), TestGenericFunctionReturningGenericStructMonomorphizesStruct(), buildAndRunWithOptionsTimeout(), containsString() (+64 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (72): BenchmarkEnvironment, EndpointReport, GitState, formatIntSequence(), matrixCoverageKey(), matrixCoverageLabel(), matrixEndpointSpecs(), matrixLevelKey() (+64 more)

### Community 70 - "Community 70"
Cohesion: 0.1
Nodes (68): BuildOptions, buildOptions(), defaultTarget(), parseBuildTargetOrReport(), projectBuildTargets(), projectDefaultTarget(), runBuild(), runRun() (+60 more)
...
Cohesion: 0.1
Nodes (66): cliProjectContext, dependencyArtifactBuildOptions(), buildCapsuleArtifacts(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), writeEcoLock(), parseCapsuleGraphArgs(), validateCapsuleGraph() (+58 more)
...
Cohesion: 0.08
Nodes (60): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), abiObjectHasSymbol(), abiObjectHasSymbolSignature() (+52 more)

### Community 80 - "Community 80"
Cohesion: 0.05
Nodes (24): AwaitExpr, BinaryExpr, BoolLitExpr, CatchExpr, EnumCasePatternExpr, FieldAccessExpr, IdentExpr, IndexExpr (+16 more)
...
Cohesion: 0.08
Nodes (51): TestGeneratedActorGlueIsVerifiedBeforeNativeCodegen(), TestSelfHostRuntimeObjectsExportRequiredSymbols(), requiredActorRuntimeSymbols(), requiredActorStateRuntimeSymbols(), requiredDistributedActorRuntimeSymbols(), requiredFilesystemRuntimeSymbols(), requiredNetRuntimeSymbols(), requiredTaskGroupRuntimeSymbols() (+43 more)
...
Cohesion: 0.13
Nodes (47): LSPAnalysis, LSPHover, LSPSymbol, isLSPIdentifierChar(), isLSPIdentifierStart(), lspCodeActionDiagnosticsFromCompiler(), lspCodeActions(), lspCodeLineDeclaresLocalName() (+39 more)
...
Cohesion: 0.08
Nodes (45): assertObjectHasSymbols(), TestActorDeclarationAllowsExtendedScalarStateFieldTypes(), TestActorDeclarationAllowsImmutableStateFields(), TestActorDeclarationAllowsMutableStateField(), TestActorDeclarationMethodRequiresExplicitUsesActors(), TestActorDeclarationMVPCheckAndLower(), TestActorDeclarationRejectsNonConstStateInitializer(), TestActorDeclarationRejectsPtrStateFieldType() (+37 more)
...
Cohesion: 0.09
Nodes (40): featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), discoverWASIRunner(), discoverWebRunner(), discoverWebRuntimeRunner(), execProgram() (+32 more)
...
Cohesion: 0.11
Nodes (33): LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile(), ModuleCandidateRelPaths() (+25 more)
...
Cohesion: 0.16
Nodes (37): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+29 more)
...
Cohesion: 0.11
Nodes (35): FuzzLexer(), FuzzParser(), lspDiagnostic, lspHover, lspSmokeEnvelope, lspSymbol, main(), strictDecodeJSON() (+27 more)
...
Cohesion: 0.1
Nodes (37): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), summarizeMatrixRunsForTest(), TestValidateReportAcceptsFullSixEndpointReport() (+29 more)
...
Cohesion: 0.16
Nodes (34): hasPrefix(), FuzzParseCapsuleDoesNotPanic(), validateEcoLockModel(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath() (+26 more)
...
Cohesion: 0.12
Nodes (26): nativeLinuxX86ExecutableBackend(), callPatch, buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitIndexLoad() (+18 more)
...
Cohesion: 0.15
Nodes (26): BuildSigMap(), BuildTypeSigMap(), cacheDir(), cacheKey(), cachePath(), DepSigHashFromDeps(), DepSigHashFromDepsWithInterfaceHashes(), formatFuncSig() (+18 more)
...
Cohesion: 0.17
Nodes (27): ClosureCapture, captureMode, bindMatchPatternLocalsForInference(), cloneBoolMap(), cloneLocalMap(), collectExprLocals(), inferCatchExprType(), inferMatchExprType() (+19 more)
...
Cohesion: 0.16
Nodes (21): BuildMacOSX64(), annotateRuntimeObjectSignatures(), collectActorEntries(), checkedDistributedActorProgram(), TestCollectDistributedActorRuntimeUsage(), TestDistributedActorRuntimeBuildsWithLinuxBuiltinRuntime(), TestDistributedActorRuntimeRejectsUnsupportedNativeTargets(), TestRequiredDistributedActorRuntimeSymbols() (+13 more)
...
Cohesion: 0.17
Nodes (20): doctorCheck, doctorReport, decodeStrictJSON(), main(), TestValidateDoctorReportAcceptsExpectedShape(), TestValidateDoctorReportRejectsFailingRequiredCheck(), TestValidateDoctorReportRejectsFailingStatus(), TestValidateDoctorReportRejectsMissingRequiredCheck() (+12 more)
...
Cohesion: 0.21
Nodes (22): buildEcoLock(), buildEcoLockWithArtifactHashes(), copySortedPolicy(), decodeEcoLock(), hydrateLockArtifactHashes(), lockArtifactsFromCapsuleArtifacts(), lockGraphFingerprint(), normalizeLock() (+14 more)

### Community 200 - "Community 200"
Cohesion: 0.07
Nodes (16): TestActorTaskBoundedStressExamples(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke(), TestBuildGlobalVarPtrZeroInitializerSmoke(), TestBuildGlobalVarStringFieldAccessAfterAssignmentSmoke() (+8 more)
...
Cohesion: 0.17
Nodes (7): atomicFetchAdd32(), emitAllocBytes(), emitExit(), emitMakeSlice(), emitMmapFailureBranch(), emitWrite(), patchExitBranch()
...
Cohesion: 0.22
Nodes (11): containsMovEaxImm32LinkerTest(), emitEntryStubForTestX86(), TestLinkLinuxRejectsNonLinuxTargetObject(), TestLinkLinuxX32RejectsNonX32TargetObject(), TestLinkLinuxX32UsesX32ExitSyscall(), TestLinkLinuxX64RejectsAbsoluteDataRelocs(), TestLinkLinuxX64RejectsAbsoluteFunctionAddressRelocs(), TestLinkLinuxX86PatchesAbsoluteFunctionAddressRelocs() (+3 more)
...
Cohesion: 0.8
Nodes (3): CodegenObjectWindowsX64(), CodegenObjectWindowsX64WithOptions(), CodegenObjectWindowsX64WithOptionsAndDataPrefix()
