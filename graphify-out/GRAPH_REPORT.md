...
## Corpus Check
- 4465 files · ~6,500,966 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22038 nodes · 85351 edges · 1059 communities (906 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13769 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68029b35`
...
## Communities (1059 total, 153 thin omitted)
...
Cohesion: 0.02
Nodes (218): TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+210 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (242): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt() (+234 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (191): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+183 more)
...
Cohesion: 0.04
Nodes (169): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+161 more)
...
Cohesion: 0.02
Nodes (159): TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+151 more)
...
Cohesion: 0.03
Nodes (161): TestActorTaskBoundedStressExamples(), buildAndRunFile(), buildAndRunFileWithOptions(), buildOnly(), projectRoot(), requireCheckFileErrorContains(), requireCheckFileOK(), TestBuildAsyncSmoke() (+153 more)
...
Cohesion: 0.05
Nodes (59): budgetCharge, callableClosureTargetName(), callableTargetFromAssignedExpr(), collectFunctionTypedParamTargets(), enumCaseConstructorInfoForTargets(), enumCasePatternInfoForTargets(), enumPayloadFieldTargetsFromExpr(), enumPayloadTargetInfo() (+51 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (117): runAPIDocsValidator(), TestValidateAPIDocsAcceptsGeneratedShape(), TestValidateAPIDocsRejectsAPIMetadataHashMismatch(), TestValidateAPIDocsRejectsBrokenInternalLink(), TestValidateAPIDocsRejectsDuplicateModules(), TestValidateAPIDocsRejectsEmptyDocument(), TestValidateAPIDocsRejectsEntryBeforeSection(), TestValidateAPIDocsRejectsErrorOutput() (+109 more)
...
Cohesion: 0.05
Nodes (124): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases() (+116 more)
...
Cohesion: 0.05
Nodes (108): checkTargetAliasFuzz(), checkTargetArrayBoundaryFuzz(), checkTargetLayoutFuzz(), checkTargetObjectSignatureFuzz(), compareFuzzAggregateLayout(), expectArrayLayoutError(), fuzzAlignUp(), referenceFuzzStructLayout() (+100 more)
...
Cohesion: 0.06
Nodes (106): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultTarget() (+98 more)
...
Cohesion: 0.09
Nodes (99): buildSysVUnixX64(), actorGroupPtrFromEaxToRdi(), actorGroupPtrFromR12ToRdi(), actorPtrFromEaxToRdi(), actorPtrFromR12ToRdi(), actorPtrInRax(), actorWaitTargetPtrFromEaxToRdi(), actorWakeAtPtrFromEaxToRdi() (+91 more)

### Community 57 - "Community 57"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentCallbackSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+90 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (85): TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke() (+77 more)
...
Cohesion: 0.11
Nodes (88): checkStmts(), collectLocals(), functionAssignmentEscapeMetadata(), functionAssignmentMetadata(), functionAssignmentMetadataWithReturnParamRefs(), functionAssignmentValueTouchesMutableGlobals(), functionDirectSnapshotAliasForExpr(), functionEnumPayloadInfoFromCallArgument() (+80 more)
...
Cohesion: 0.08
Nodes (41): buildReport(), compilerProductionAudit(), failedCase(), intPtr(), main(), processExitCode(), requireFileWithPrefix(), runCommand() (+33 more)
...
Cohesion: 0.08
Nodes (54): capsuleUnpackManifest, ecoPackageMetadata, ecoPackageMetadataFile, appendUnpackSourceRoot(), findCapsuleManifest(), main(), parseSHA256Hash(), readRegularUnpackedFile() (+46 more)
...
Cohesion: 0.07
Nodes (47): Agent 12 API Docs, Agent 12 Full API Docs, Agent 12 Full Test Summary, agent-12 full rerun tetra docs, Agent 12 Stdlib API Docs, agent-4 full API docs, agent-4 full tetra docs, agent-8 full API docs (+39 more)
...
Cohesion: 0.07
Nodes (37): TestELFLinuxLayoutStaysInSyncWithWriter(), alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage() (+29 more)
...
Cohesion: 0.09
Nodes (27): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+19 more)
...
Cohesion: 0.09
Nodes (33): Tetra Tooling Summary Schema v1alpha1, WaveH Test-All Tooling Summary, WaveI Test-All API Docs, WaveI Test-All Tetra Docs, WaveI Test-All Tooling Summary, WaveI Reviewer Test-All API Docs, WaveI Reviewer Test-All Tooling Summary, WaveB Stabilization API Docs Snapshot (+25 more)
...
Cohesion: 0.08
Nodes (28): API Diff No-Change Policy, Release State Audit, WaveB Full Rerun Test Report, WaveB Short Fuzz Nightly Summary, WaveB Release State Audit Output, WaveB Stabilization Test Report, WaveB Gate Test-All Stabilization Report, Unstable Fuzz Seeds Register (+20 more)
...
Cohesion: 0.3
Nodes (19): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+11 more)
...
Cohesion: 0.2
Nodes (18): emitActorExitWindowsX64(), emitActorNoArgWrapperWindowsX64(), emitActorOneArgWrapperWindowsX64(), emitActorSendBeginWrapperWindowsX64(), emitActorSendMsgWrapperWindowsX64(), emitActorSendSlotWrapperWindowsX64(), emitActorSendWrapperWindowsX64(), emitActorSpawnWrapperWindowsX64() (+10 more)
...
Cohesion: 0.19
Nodes (16): endpointName(), expectedContentType(), mustMatrixReportJSON(), mustReportJSON(), reportFixture(), semanticChecksForPath(), TestValidateReportAcceptsFullSixEndpointReport(), TestValidateReportRejectsNonMonotonicLatencyPercentiles() (+8 more)
