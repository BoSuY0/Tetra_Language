...
## Corpus Check
- 4465 files · ~6,491,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22017 nodes · 85267 edges · 1076 communities (923 shown, 153 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13747 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16183399`
...
## Communities (1076 total, 153 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (522): buildAndRun(), buildAndRunFiles(), TestBuildStructCrossModule(), TestBuildConstBoolGlobalSmoke(), TestBuildConstGlobalExpressionSmoke(), TestBuildConstGlobalSmoke(), TestBuildGlobalVarConstInitializerSmoke(), TestBuildGlobalVarExpandedScalarInitializerSmoke() (+514 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (451): TestELFHasRWDataSegmentAndStringNotInText(), TestActorStateSlotLimitRejectsMoreThanEightBeforeRuntime(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets() (+443 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (324): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+316 more)
...
Cohesion: 0.03
Nodes (222): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals(), capsulePermissionEntry() (+214 more)
...
Cohesion: 0.04
Nodes (125): FormatPos(), atomicBuiltinOrderAllowed(), atomicFenceKindForOrder(), atomicPointerKindForOp(), atomicValueKindForOp(), atomicValueKindForOpWidth(), parseAtomicBuiltinName(), parseAtomicBuiltinOrder() (+117 more)
...
Cohesion: 0.04
Nodes (104): TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes(), TestCheckCommandJSONDiagnosticsForProtocolImplOwnershipMismatchCodes(), TestCheckCommandJSONDiagnosticsForScopedIslandOptionalRegionEscapeCode(), TestCheckCommandJSONDiagnosticsForSemanticError(), TestCheckCommandJSONDiagnosticsForCrossModulePartialCopyAfterConsumeCodes(), TestCheckCommandJSONDiagnosticsForCrossModulePartialEnumConstructorAfterConsumeCodes() (+96 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (111): builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases() (+103 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (104): AnalyzeLSPFile(), AnalyzeLSPSource(), TestAnalyzeLSPSourceActorDeclarationDiagnostic(), TestAnalyzeLSPSourceImportedFileDoesNotReportMissingWorkspace(), TestAnalyzeLSPSourcePrivacyConsentDiagnosticCode(), TestAnalyzeLSPSourceRecursiveSecretSignatureDiagnosticCode(), TestAnalyzeLSPSourceSemanticDiagnostics(), TestAnalyzeLSPSourceSymbolsAndHovers() (+96 more)
...
Cohesion: 0.06
Nodes (108): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+100 more)
...
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCapturedClosureCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentCrossModuleSmoke() (+90 more)
...
Cohesion: 0.05
Nodes (40): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree(), constructorRegionFromTree() (+32 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (75): BuildMacOSX64(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer(), TestBuildCacheTargetChangeInvalidatesObjects() (+67 more)
...
Cohesion: 0.07
Nodes (83): canRunLinuxX32OnHost(), canRunLinuxX86OnHost(), printUsage(), probeLinuxX32Execution(), wasiRunner, webRuntimeRunner, decodeStrictNativeUIJSON(), main() (+75 more)
...
Cohesion: 0.04
Nodes (44): AssignStmt, itoa(), AwaitExpr, BoolLitExpr, BreakStmt, CapsuleEntryDecl, CatchExprCase, ContinueStmt (+36 more)
...
Cohesion: 0.08
Nodes (76): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), appendClosureCaptureArgs(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+68 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (82): addInterfaceFuncSigTypeRefs(), addInterfaceFuncTypeRefs(), addInterfaceTypeRef(), formatInterfaceExtensionMethodDetail(), GenerateInterfaceFile(), interfaceAggregateMatchReturnExpr(), interfaceAggregateReturnExpr(), interfaceAggregateReturnFromBranches() (+74 more)
...
Cohesion: 0.05
Nodes (60): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), GenerateAPIDocs(), GenerateAPIDocsFromSource(), isDocSourceFile() (+52 more)
...
Cohesion: 0.1
Nodes (65): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+57 more)
...
Cohesion: 0.1
Nodes (61): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), findCapsulePath(), validateCapsuleGraph(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath() (+53 more)
...
Cohesion: 0.05
Nodes (24): BinaryExpr, CallExpr, CatchExpr, ClosureExpr, EnumCasePatternExpr, IdentExpr, IndexExpr, lexer (+16 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (60): RunTargetABIChecks(), TestRunTargetABIChecksCoversX86X64AndRejectsWASM(), executableMatrixCase, parseBuildTargetOrReport(), writeDiagnostic(), writeDiagnosticObject(), writeDiagnosticWithHint(), abiObjectHasSymbol() (+52 more)
...
Cohesion: 0.09
Nodes (7): emitExit(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitWrite(), guardAllocationOffsetRawAccess(), emitter

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (48): LoadWorld(), LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile() (+40 more)

### Community 81 - "Community 81"
Cohesion: 0.09
Nodes (54): IRFunc, IRInstr, IRInstrKind, IRPolicy, IRProgram, runtimeCallSig, RuntimeCallSignature, stackState (+46 more)
...
Cohesion: 0.08
Nodes (51): BuildOptions, featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunNativeExecutableTargetOnHost() (+43 more)
...
Cohesion: 0.13
Nodes (54): writeValidationDiagnostic(), appendWorkspaceExecutionMember(), buildWorkspaceGraph(), cleanWorkspaceMemberPath(), dedupeWorkspaceIssues(), describeWorkspaceMember(), describeWorkspaceMembers(), encodeWorkspaceJSON() (+46 more)
...
Cohesion: 0.08
Nodes (41): objectHasSymbol(), TestEmitLibraryAllowsNoMainAndWritesTOBJ(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryObjectRelocProfileByTarget(), TestEmitLibraryWritesPublicAPIHash(), TestEmitObjectRequiresMain(), InterfaceFingerprintFromSource(), TestBuildRejectsInterfaceImplementationGenericExport() (+33 more)

### Community 101 - "Community 101"
Cohesion: 0.11
Nodes (43): Dial(), DialConnector(), NewDialPool(), DialConfig, fakeColumn, partialWriteRWC, appendDataRow(), appendRowDescription() (+35 more)
...
Cohesion: 0.08
Nodes (43): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+35 more)
...
Cohesion: 0.13
Nodes (39): TestAllocBytesRequiresUnsafe(), TestCapabilitiesAllowMmioInUnsafe(), TestCapabilitiesRequireUnsafe(), TestCapabilitiesTypeMismatch(), TestCapMemAllowsLoadStoreInUnsafe(), TestCapMemAllowsLoadStoreU8InUnsafe(), TestCapMemBuiltinsRequireUnsafe(), TestCapMemTypeMismatch() (+31 more)
...
Cohesion: 0.05
Nodes (33): requireCheckWorldFilesOK(), TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse() (+25 more)
...
Cohesion: 0.18
Nodes (30): FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs(), isCapsuleSemver() (+22 more)
...
Cohesion: 0.14
Nodes (26): DataAbs32Reloc, DataDisp32Reloc, FuncAbs32Reloc, IATDisp32Reloc, CollectImports(), LinkX64Objects(), readI32LE(), TestCollectImportsSortsAndDedupes() (+18 more)
...
Cohesion: 0.19
Nodes (28): importEntry, canonicalTarget(), caseName(), importPolicy(), main(), parseImportSection(), parseWASMImports(), readName() (+20 more)
...
Cohesion: 0.12
Nodes (29): requireLinuxX86Execution(), requireLocalTCPBind(), requireX32ExecutableFile(), TestExecWebProgramWithBrowserRunnerParsesBrowserExitResult(), TestExecWebProgramWithRunnerParsesBrowserExitResult(), TestRunCommandJSONDiagnosticsForLinuxX32HostUnsupported(), TestRunCommandJSONDiagnosticsForWASMWebRuntimeUnsupported(), TestRunCommandPropagatesLinuxX86AllocBytesZeroExitCode() (+21 more)
...
Cohesion: 0.16
Nodes (23): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+15 more)
...
Cohesion: 0.12
Nodes (4): alignUp(), emitCall(), emitFunc(), emitReturn()
...
Cohesion: 0.25
Nodes (13): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+5 more)
...
Cohesion: 0.22
Nodes (8): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), buildWASMUIFixture(), TestNativeShellUIExampleWritesMetadataPreviewSidecar(), TestWASIDogfoodTargetBuildOnlyAndNoUIRuntimeArtifacts(), TestWASMUIExamplesBuildWithDeterministicMetadataSidecars(), TestWASMUISidecarsAreDeterministicAcrossBuilds(), TestWebUIDogfoodBuildWritesSchemaCheckedArtifacts()
...
Cohesion: 0.31
Nodes (9): containsMovEaxImm32(), emitObjectHasSymbol(), TestEmitLibraryBuildOnlyAcrossNativeTargets(), TestEmitLibraryLinuxX32BuildsI64AndWeakAtomicObject(), TestEmitLibraryLinuxX32WritesRealX32TOBJ(), TestEmitLibraryLinuxX86StillRejectsMissingObjectBackend(), TestEmitLibraryLinuxX86WritesRealI386TOBJ(), TestEmitLibraryObjectRelocProfileByTarget() (+1 more)
...
Cohesion: 0.36
Nodes (4): FuzzLexer(), FuzzParser(), FuzzValidateManifestDoesNotPanic(), TestManifestNegativePropertySuite()
