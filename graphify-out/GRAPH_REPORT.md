...
## Corpus Check
- 4465 files · ~6,496,659 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22031 nodes · 85330 edges · 1058 communities (907 shown, 151 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13763 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11ba858e`
...
## Communities (1058 total, 151 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (425): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+417 more)
...
Cohesion: 0.01
Nodes (478): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), intPtr(), nativeSmokeReportForTest(), smokeReportToolDir(), TestSmokeReportToChecklistUpdatesTargetSection() (+470 more)
...
Cohesion: 0.03
Nodes (229): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), appendResourceProvenance(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindCatchErrorResourceSummary() (+221 more)
...
Cohesion: 0.02
Nodes (187): TestArgumentLabelsAcceptedByChecker(), TestArgumentLabelsRejectMismatchedOrder(), TestEnumMatchDefaultMustBeLastDiagnostic(), TestEnumMatchDuplicateUnguardedPayloadCaseDiagnostic(), TestEnumMatchExhaustiveThreeCasesNoDefaultCheck(), TestEnumMatchGuardedCasesDoNotCountAsExhaustive(), TestEnumMatchMissingCaseStillNeedsReturn(), TestEnumMatchRejectsWrongEnumCaseDiagnostic() (+179 more)
...
Cohesion: 0.04
Nodes (161): capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), appendGeneratedArtifactsToCapsule() (+153 more)
...
Cohesion: 0.04
Nodes (146): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+138 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (150): TestActorAndTaskTransfersCannotBeReusedAfterConsume(), TestActorSpawnOwnershipMatrix(), TestReleaseTraceabilityCrossModuleCallableMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleImmutableCallableGlobalMutableTargetBoundary(), TestReleaseTraceabilityCrossModuleReturnedAggregateCallableMutableTargetBoundary(), TestReleaseTraceabilityLifetimeAndRaceSafetyNegativeActorTaskOwnership(), TestTaskConsumeRejectsCrossModuleOptionalMatchPayloadAliasReuse(), TestTaskConsumeRejectsInterproceduralOptionalMatchPayloadAliasReuse() (+142 more)
...
Cohesion: 0.05
Nodes (133): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), allTargetsOutput(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost() (+125 more)
...
Cohesion: 0.05
Nodes (123): apiDocTitle, apiDocTitles(), apiSurfaceMetadata(), collectDocFiles(), countTetraDoctests(), isDocSourceFile(), isExperimentalModuleTitle(), writeAPIDocsHeader() (+115 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (129): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), bindBorrowedPtrAliasFromExpr(), bindMatchPatternLocalsForInference(), bindPatternBorrowedPtrAliases() (+121 more)
...
Cohesion: 0.09
Nodes (105): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+97 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (51): branchScopeInfo, bindFreshResourceTree(), bindResourceFromExpr(), bindResourceTreeFromCallSummary(), bindResourceTreeFromExpr(), bindResourceTreeFromPathOrUnknown(), copyResourceTreeFromPath(), joinResourcePath() (+43 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (101): benchLevel, benchmarkEnvironment, buildEvidence, buildPlan, dbLoadResult, dbRunReport, endpointBenchmarkSpec, gitState (+93 more)
...
Cohesion: 0.02
Nodes (98): TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureFourSlotCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedDirectClosureLiteralCallbackArgumentSmoke(), TestBuildFunctionTypedEnumPayloadCallbackArgumentSmoke() (+90 more)
...
Cohesion: 0.07
Nodes (85): ClosureCapture, TypeRefKind, captureMode, cloneBoolMap(), addPatternCaptureBindings(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures() (+77 more)
...
Cohesion: 0.1
Nodes (53): actorRuntimeSymbols(), buildDoctorReport(), buildDoctorReportForRoot(), buildDoctorReportForRootWithChecks(), buildProjectDoctorReport(), doctorStatus(), failCheck(), manifestSurfaceCheck() (+45 more)
...
Cohesion: 0.1
Nodes (55): capsuleSectionHeader(), FuzzParseCapsuleDoesNotPanic(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget(), capsuleSectionHeader(), cleanCapsuleArtifactPath(), defaultCapsuleArgs() (+47 more)
...
Cohesion: 0.11
Nodes (48): itoa(), CodegenObjectLinuxX64(), CodegenObjectLinuxX64WithOptions(), applyOperation(), bindingTraces(), bindingValue(), buildReport(), commandByName() (+40 more)
...
Cohesion: 0.11
Nodes (49): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, capsuleSourceModule, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts() (+41 more)
...
Cohesion: 0.1
Nodes (48): IRInstrKind, irVerifierError(), runtimeCallSig, RuntimeCallSignature, stackState, matchesBudgetGuardAt(), matchesBudgetGuardBefore(), matchesBudgetInitializerAt() (+40 more)
...
Cohesion: 0.09
Nodes (41): targetReportEntryForTest(), TestDoctorCommandJSON(), TestDoctorCommandProjectJSON(), TestDoctorCommandRejectsUnsupportedFormat(), TestDoctorReportFilesystemProbesFailInIncompleteRepo(), TestTargetMetadataCheck(), stubLookPath(), targetMetaForTest() (+33 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (38): TestPublicCheckAPICrossModuleWorldPositive(), TestPublicCheckAPISingleSourceNegativeDiagnostic(), InterfaceFingerprintFromT4I(), TestGeneratedInterfaceFunctionTypeRefsCheckAndLowerAcrossModules(), TestGeneratedInterfaceGenericStructTypeArgsCheckAndLowerAcrossModules(), TestGenerateInterfaceFromSourceEmitsProtocolImplDeclarationsBeforeFunctions(), TestGenerateInterfaceFromSourceEmitsTypecheckableExtensionDeclarations(), TestGenerateInterfaceFromSourceFiltersPrivateSurfaceAndHashesPublicAPI() (+30 more)
...
Cohesion: 0.1
Nodes (33): BuildFile(), findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget() (+25 more)
...
Cohesion: 0.14
Nodes (23): appConfig, configFromEnv(), envOr(), main(), newRandomWorldIDs(), parseIPv4(), parsePositiveInt(), serve() (+15 more)
...
Cohesion: 0.21
Nodes (19): Frame, DecodeFrame(), DecodeRemoteHandle(), EncodeFrame(), EncodeRemoteHandle(), isKnownFrameType(), IsRemoteHandle(), TestDecodeRejectsBadHeaderAndInvalidSlotCount() (+11 more)
