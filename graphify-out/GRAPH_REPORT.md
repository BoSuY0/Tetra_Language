...
## Corpus Check
- 4465 files · ~6,492,063 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22019 nodes · 85276 edges · 1061 communities (907 shown, 154 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13749 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e100ddba`
...
## Communities (1061 total, 154 thin omitted)
...
Cohesion: 0.01
Nodes (378): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+370 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (441): TestActorStateSlotLimitRejectsMoreThanEightBeforeRuntime(), findELFLoadSegment(), parseELF64ProgramHeaders(), TestELFBuildsHighArityCallSurface(), TestELFDataRelocPointsToDataMarker(), TestELFExecutableModeAndHeaderContract(), TestELFHasRWDataSegmentAndStringNotInText(), TestELFLinkRejectsNonLinuxObjectTarget() (+433 more)
...
Cohesion: 0.03
Nodes (218): CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnMetadata(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals() (+210 more)
...
Cohesion: 0.03
Nodes (183): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+175 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (154): abiSuiteObjectHasReloc(), abiSuiteObjectHasRelocKind(), abiSuiteObjectHasSymbolSignature(), checkPointerNativeLibcFFIDiagnostics(), checkSourceNativeScalarDiagnostics(), checkStdlibRuntimeBoundaryDiagnostics(), checkTargetRuntimeBoundaryDiagnostics(), checkX32PointerFFIDiagnostics() (+146 more)
...
Cohesion: 0.04
Nodes (156): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+148 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (160): resolveFieldChainLower(), assignTargetInfo, builtinCapsulePermission(), builtinNeedsUnsafe(), isCoreAtomicBuiltin(), appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary() (+152 more)
...
Cohesion: 0.04
Nodes (160): capsuleArtifact, capsuleDependency, capsuleManifest, capsuleSourceModule, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+152 more)
...
Cohesion: 0.03
Nodes (139): Examples Index, releaseV10APIDiffFakeRepo(), releaseV10APIDiffToolFakeRepo(), runReleaseV10APIDiff(), TestAPIDiffBaselineWriteIsDeterministicWithoutWallClockTimestamp(), TestAPIDiffReportClassifiesAdditionsAndRemovalsForReview(), TestAPIDiffReportClassifiesSignatureDriftAsChanged(), TestReleaseV10APIDiffRejectsDashPrefixedNonEmptyReportDirBeforeRawFind() (+131 more)
...
Cohesion: 0.05
Nodes (120): BuildOptions, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason(), buildOptions(), canRunBuildOnlyNativeTargetOnHost(), canRunLinuxX86OnHost(), canRunNativeExecutableTargetOnHost(), defaultOutput() (+112 more)
...
Cohesion: 0.06
Nodes (103): AnalyzeLSPFile(), AnalyzeLSPSource(), TestAnalyzeLSPSourceActorDeclarationDiagnostic(), TestAnalyzeLSPSourceImportedFileDoesNotReportMissingWorkspace(), TestAnalyzeLSPSourcePrivacyConsentDiagnosticCode(), TestAnalyzeLSPSourceRecursiveSecretSignatureDiagnosticCode(), TestAnalyzeLSPSourceSemanticDiagnostics(), TestAnalyzeLSPSourceSymbolsAndHovers() (+95 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (110): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), checkStmts(), collectionElementType(), collectLocals() (+102 more)
...
Cohesion: 0.05
Nodes (85): LoadWorld(), LoadWorldOpt(), IsSourceFile(), SourceExtensions(), T4Formats(), TestT4FormatRegistryDeclaresOfficialFamily(), All(), IsSourceFile() (+77 more)
...
Cohesion: 0.04
Nodes (80): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+72 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (90): artifactIssue, capsuleArtifactBuildOptions, capsuleArtifactPlan, appendGeneratedArtifactsToCapsule(), artifactRepairCommand(), artifactSlug(), buildCapsuleArtifacts(), capsuleArtifactKey() (+82 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (98): TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentDirectCallSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromStructFieldSmoke(), TestBuildFunctionTypedCallableMVPRejectsUnsupportedForms(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureAliasCallbackArgumentSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+90 more)
...
Cohesion: 0.05
Nodes (33): branchScopeInfo, checkLocalScope(), checkRegionTreeWithinScope(), checkRegionUsable(), commonRegionFromTree(), constructorRegionFromTree(), containsSyntheticOwnershipSegment(), copyRegionTree() (+25 more)
...
Cohesion: 0.08
Nodes (74): cliProjectContext, dependencyArtifactBuildOptions(), capsuleSectionHeader(), dependencyArtifactBuildOptions(), capsuleHasInterfaceArtifacts(), cleanProjectRelPath(), cleanProjectSourceRoots(), cliProjectStartDir() (+66 more)
...
Cohesion: 0.07
Nodes (70): ecoLockArtifact, ecoLockCapsule, ecoLockDependency, ecoLockEnvelope, cleanArtifactPath(), containsString(), isCapsuleSemver(), lockGraphFingerprint() (+62 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (55): Check(), CheckWorld(), CodegenObjectLinuxX64(), CodegenObjectLinuxX86(), CodegenObjectMacOSX64(), CodegenObjectWindowsX64(), LinkLinuxX64(), LinkMacOSX64() (+47 more)
...
Cohesion: 0.1
Nodes (67): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+59 more)
...
Cohesion: 0.09
Nodes (6): emitCall(), emitIslandMakeSlice(), emitIslandNew(), emitMmap2Anonymous(), guardAllocationOffsetRawAccess(), emitter
...
Cohesion: 0.11
Nodes (34): callPatch, atomicCompareExchange16(), atomicCompareExchange32(), atomicCompareExchange8(), atomicExchange16(), atomicExchange32(), atomicExchange8(), atomicFetchAdd16() (+26 more)
...
Cohesion: 0.1
Nodes (34): apiMetadata, decodeStrictJSON(), hashAPISurface(), main(), markdownAnchor(), parseAPIMetadata(), validateAPIDocs(), validateInternalLinks() (+26 more)
...
Cohesion: 0.14
Nodes (27): findMachOSection(), machoSectionData(), parseMachOInfo(), readMachOName(), TestBuildMachOActors(), TestBuildMachOHeaders(), TestBuildMachOMmio(), TestMachOBuildsHighArityCallSurface() (+19 more)
...
Cohesion: 0.2
Nodes (25): TestCurrentSupportedSurfaceDocumentIsReleaseAligned(), TestCurrentSupportedSurfaceDocumentIsReleaseAligned(), currentGitHead(), currentReleaseVersion(), releaseV10SecurityReviewPathFakeRepo(), runReleaseV10SecurityReview(), sha256ForTest(), TestReleaseV040SecurityReviewBlocksUntilFullValidationExists() (+17 more)
...
Cohesion: 0.23
Nodes (23): Object, checkedObjectCountCapacity(), ensureObjectBytesAvailable(), ensureObjectRecordTableAvailable(), maxObjectInt(), minSymbolRecordBytes(), objectRemainingBytes(), readBool() (+15 more)
...
Cohesion: 0.16
Nodes (13): TestNormalizeFlowForMigrationAPI(), TestNormalizeFlowForMigrationAPICoversFlowTestAndMatchSurface(), TestNormalizeFlowForMigrationAPITabDiagnostic(), finalReleaseStateRefreshFollowsSummary(), TestReleaseV030GateHashesEntireReportDirectory(), TestReleaseV030GateRefreshesReleaseStateAfterFinalSummaryWrite(), TestReleaseV030GateRequireCleanRejectsDirtyWorktree(), TestReleaseV030GateValidatesFuzzArtifactsAfterShortFuzz() (+5 more)
...
Cohesion: 0.35
Nodes (16): TestObjectRoundTripPreservesV4MetadataSymbolsAndRelocs(), TestReadObjectRejectsMalformedSymbolAndRelocNames(), TestReadObjectRejectsMalformedSymbolAndRelocRanges(), TestReadObjectRejectsNonDataRelocationAddends(), TestReadObjectRejectsTruncatedDeclaredSections(), TestWriteObjectRejectsMalformedSymbolAndRelocNames(), TestWriteObjectRejectsMalformedSymbolAndRelocRanges(), TestWriteObjectRejectsNegativeSignatureSlots() (+8 more)
...
Cohesion: 0.25
Nodes (7): BenchmarkBinarySizeBaselines(), BenchmarkCompileRepresentativeExamples(), BenchmarkFormatRepresentativeSources(), BenchmarkGenerateAPIDocsDogfoodProjects(), buildAndRunFile(), buildAndRunWithOptions(), buildOnlyFiles()
