...
## Corpus Check
- 4465 files · ~6,493,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22023 nodes · 85295 edges · 1065 communities (913 shown, 152 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 13754 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee47256c`
...
## Communities (1065 total, 152 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (507): buildAndRun(), buildAndRunFiles(), TestExprStmtQualified(), TestBuildFlowElseIfSmoke(), TestBuildLegacyElseIfSmoke(), TestFormatSourceElseIf(), TestBuildForCollectionBoolSliceSmoke(), TestBuildForCollectionSliceSmoke() (+499 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (318): TestFunctionTypedCallableTestsAreSplitByDomain(), assertBudgetFailureTail(), assertBudgetFailureTailImms(), findIRFuncByName(), hasInstrKind(), TestBudgetFailureABIReturnAndThrowShapesAreLowered(), TestBudgetRuntimeChecksAreLowered(), TestCapturedFunctionTypedEnumParameterPayloadReturnCannotEscapeIntoGlobalFunctionValue() (+310 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (388): TestELFHasRWDataSegmentAndStringNotInText(), writeFile(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestStabilizationRejectsAssignToConstGlobal(), TestAnalyzeLSPFileChecksImportedModuleGraph(), TestCheckCommandJSONDiagnosticsForCrossModuleGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForGenericBorrowReturnCodes(), TestCheckCommandJSONDiagnosticsForImportedOwnershipBorrowSliceAggregateCallEscapeCodes() (+380 more)
...
Cohesion: 0.03
Nodes (234): hasPrefix(), capsuleArtifact, capsuleDependency, capsuleManifest, addVaultRecord(), appendCapsuleArtifact(), appendCapsuleSourceRoot(), appendCapsuleTarget() (+226 more)
...
Cohesion: 0.03
Nodes (222): Check(), CheckWorldOpt(), actorMailboxSendHasSecretPayload(), addFinalizationStates(), addImportedFunctionTypedGlobalAliases(), addPublicImportFunctionAliases(), applyInterfaceFunctionReturnParamMetadataFromNestedStmt(), bindPatternSecretTaintLocals() (+214 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (192): TestBuildAndRunCommandsAcceptExplicitProjectDirectory(), TestBuildCheckRunCommandsAcceptExplicitProjectSourceFile(), TestBuildCommandAllTargetsBuildsCapsuleTargets(), TestBuildCommandArtifactsAutoRepairsStaleObject(), TestBuildCommandDiscoversCapsuleT4ProjectEntry(), TestBuildCommandJSONDiagnostics(), TestBuildCommandJSONDiagnosticsForInvalidTarget(), TestBuildCommandJSONDiagnosticsForOptionValidation() (+184 more)
...
Cohesion: 0.04
Nodes (165): shellSingleQuote(), envHasPrefix(), filteredReleaseV030GateEnv(), installReleaseV030CanonicalArtifactGo(), installReleaseV030CIMissingSignoffFailingFinalArtifactHashGo(), installReleaseV030FailingFinalArtifactHashGo(), installReleaseV030FailingSecurityReviewSha256(), installReleaseV030PortablePythonCanonicalizers() (+157 more)
...
Cohesion: 0.04
Nodes (137): canRunLinuxX32OnHost(), probeLinuxX32Execution(), flowIssue, firstCodeColumn(), isTetraSourceFile(), main(), stripInlineStructLiterals(), stripStringsAndLineComment() (+129 more)
...
Cohesion: 0.04
Nodes (112): BuildOptions, cliProjectContext, dependencyArtifactBuildOptions(), dependencyArtifactBuildOptions(), featuresReport, formatsReport, allTargetsOutput(), buildOnlyNativeRunUnsupportedReason() (+104 more)
...
Cohesion: 0.06
Nodes (116): appendResourceProvenance(), bindBorrowedPtrAliasFromExpr(), bindCatchErrorResourceSummary(), bindFreshResourceTree(), bindPatternBorrowedPtrAliases(), bindPatternOwnershipAliases(), bindPatternRegionLocals(), bindPatternResourceLocals() (+108 more)
...
Cohesion: 0.09
Nodes (97): resolveFunctionFieldName(), classifyCallableEscape(), callableEscapeBoundary, CallableEscapeKind, allowCapturedGlobalFunctionSnapshot(), allowFunctionFieldGlobalSnapshot(), applyInterfaceFunctionReturnMetadata(), checkStmts() (+89 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (86): resolveFieldChainLower(), assignTargetInfo, firstCapture(), genericDef, genericProtocolInfo, arrayElemName(), bindGenericType(), checkGenericProtocolBounds() (+78 more)
...
Cohesion: 0.02
Nodes (85): TestBuildCapturedFunctionTypedEnumPayloadReturnSmoke(), TestBuildCapturedFunctionTypedStructFieldReturnSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromClosureSmoke(), TestBuildFunctionTypedCallableMutableReassignmentFromReturnSmoke(), TestBuildFunctionTypedCallableParamSmoke(), TestBuildFunctionTypedCapturedClosureEnumPayloadDirectCallSmoke(), TestBuildFunctionTypedCapturedClosureReturnCallbackSmoke(), TestBuildFunctionTypedCapturedClosureReturnDirectCallSmoke() (+77 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (40): branchScopeInfo, returnRegionSummaryForInterfaceExpr(), ownershipPathParent(), appendRegionTree(), bindRegionTreeFromExpr(), checkLocalScope(), checkRegionTreeWithinScope(), commonRegionFromTree() (+32 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (75): BuildMacOSX64(), TestArrayMVPWasmBuildSmoke(), assertModules(), TestBuildCacheAddingUnusedExportDoesNotRebuildConsumer(), TestBuildCacheCorruptObjectFallsBackToRebuild(), TestBuildCacheReuse(), TestBuildCacheSliceModuleChangeRebuildsOnlyProducer(), TestBuildCacheStructDependencyChangeRebuildsConsumer() (+67 more)
...
Cohesion: 0.09
Nodes (71): decodeStrictJSON(), defaultReleaseGateSummaryExpectations(), expectedV040RequiredStepCommand(), expectedV040RequiredStepLog(), main(), normalizeReleaseGateReportDir(), makeReleaseGateSummaryReport(), makeV040PassingReleaseGateSummaryReport() (+63 more)
...
Cohesion: 0.09
Nodes (9): emitCall(), emitExit(), emitIslandFree(), emitIslandMakeSlice(), emitMmap2Anonymous(), emitWrite(), guardAllocationBaseRawAccess(), guardAllocationOffsetRawAccess() (+1 more)
...
Cohesion: 0.06
Nodes (33): Handler, Header, appendHeader(), AppendResponse(), applyHeaderMetadata(), containsControl(), matchParameterizedPath(), normalizeLimits() (+25 more)
...
Cohesion: 0.11
Nodes (42): assertFrame(), dialTestNode(), readTestFrame(), startTestBroker(), TestBrokerReportsNodeDownForMissingDestination(), TestBrokerRoutesFramesBetweenLoopbackNodesAndWritesReport(), TestBrokerTreatsClosedDestinationWriteAsDroppedFrame(), TestClosedConnectionErrorsIncludePeerReset() (+34 more)
...
Cohesion: 0.08
Nodes (42): Agent 12 Stdlib API Docs, Final Candidate API Diff Docs, Stdlib API Docs, tetra.api.v1alpha1 Schema, API Snapshot sha256:0966eb.. (81 modules, 226 entries), Tetra Tooling Summary Schema v1alpha1, WaveH API Diff Docs, WaveH Test-All Tooling Summary (+34 more)
...
Cohesion: 0.11
Nodes (35): checkboxUpdate, applyToChecklist(), extractSection(), main(), parseSmokeReport(), sectionHeadingForTarget(), setCheckboxState(), setHeaderField() (+27 more)
...
Cohesion: 0.17
Nodes (31): DataReloc, alignUp(), patchRipDisp32From64(), validDisp32PatchOffset(), WriteMachO64MacOSX64(), writeMachOName(), writeMachOU32(), writeMachOU64() (+23 more)
...
Cohesion: 0.08
Nodes (13): nativeLinuxX86ExecutableBackend(), alignUp(), buildObject(), CodegenObjectLinuxX86(), CodegenObjectLinuxX86WithDataPrefix(), CodegenObjectLinuxX86WithOptions(), CodegenObjectLinuxX86WithOptionsAndDataPrefix(), emitCmp() (+5 more)
...
Cohesion: 0.13
Nodes (24): tetra.release.v0_3_0.gate-report.v1, tetra.release.v0_3_0.test-all-summary.v1, API Diff No-Change Enforcement, Release Gate v0.3.0, Stabilization Test-All Pipeline, Tetra UI v1 Bundle Validation, Web UI Browser Smoke Check, tetra.ui.v1 (+16 more)
...
Cohesion: 0.15
Nodes (11): emitIndexLoad(), emitIndexStore(), emitMMIOReadI32(), emitRawLoad(), emitRawMemoryOffsetRead(), emitRawMemoryOffsetWrite(), emitRawMemoryRead(), emitRawMemoryWrite() (+3 more)
...
Cohesion: 0.16
Nodes (19): alignUp(), LinuxX32Layout(), LinuxX64Layout(), LinuxX86Layout(), TestLinuxX64LayoutKeepsDataPageAligned(), TestWriteELF32LinuxX32HeaderContract(), TestWriteELF32LinuxX32RejectsInvalidImage(), TestWriteELF32LinuxX86HeaderContract() (+11 more)
...
Cohesion: 0.18
Nodes (22): API Diff No-Change Gate, API Diff Regression Event at 13:28:51, Full Mode Test Cycle, Generated API Docs Gate, Quick Mode Test Cycle, Stabilization Mode Test Cycle, Test-All 2026-04-29 13:17:12 Summary, Test-All 2026-04-29 13:28:38 Summary (+14 more)
...
Cohesion: 0.26
Nodes (21): T250 Master Plan Board, Plan250 Final Change Inventory, Plan250 Final Risk Register, Plan250 Final Summary, Plan250 Final Verification Matrix, Plan250 QA Index, Wave-C Controller v0.3.0 Gate Archive, Residual Risk: Dirty Worktree Before Promotion (+13 more)

### Community 230 - "Community 230"
Cohesion: 0.12
Nodes (21): Docs Manifest Freshness Check, Short Fuzz Nightly Mode, Short Fuzz Nightly Run, Unstable Fuzz Seed Promotion Policy, Unstable Seed Tracking Policy, Fuzz Nightly Smoke Wave F Summary, Fuzz Nightly Summary (Opencode Fuzz Short), Property Stress Regressions Step (+13 more)
...
Cohesion: 0.33
Nodes (17): ClosureCapture, captureMode, cloneBoolMap(), addPatternCaptureBindings(), closureCaptureSupportedSubsetText(), closureLiteralDirectCallCaptureText(), collectClosureCaptures(), collectDeferCaptures() (+9 more)
...
Cohesion: 0.16
Nodes (18): Current Supported Surface Spec, V0 4 0 Release Gate, V1 0 Release Gate, V0 3 0, V0 4 0, Tetra v1.0 Release Notes Placeholder, V0 3 0 Final Handoff, V0 4 0 Completion Audit (+10 more)
...
Cohesion: 0.14
Nodes (17): GitHub CI Workflow, CLI Contracts Spec, Eco Publishing Model v1, Eco Package Guide, Compiler Features Registry, Release Gate Blocked by Web UI Smoke Failure, release_v0_3_0_gate.sh, release_v1_0_security_review.sh (+9 more)
...
Cohesion: 0.18
Nodes (15): API Diff Snapshot (81 modules, 226 entries), Flow Grammar Surface Coverage, Test-All 2026-04-29 12:49:15 Tetra Docs, Test-All 2026-04-29 13:28:45 API Docs, Test-All 2026-04-29 13:28:45 Tetra Docs, Test-All 2026-04-29 13:28:51 Tetra Docs, Test-All 2026-04-29 13:30:35 Tetra Docs, Test-All 2026-04-29 13:30:40 API Docs (+7 more)
...
Cohesion: 0.19
Nodes (15): API Snapshot sha256:09e83e.. (83 modules, 228 entries), WaveD API Diff API Docs, Wave E API-Diff API Docs, Wave E Test-All API Docs, Wave E Test-All Tetra Docs, Wave F Tooling Summary, Wave G Tetra API Docs Artifact, Wave G Tooling Summary (+7 more)
...
Cohesion: 0.31
Nodes (13): writeInterfaceHashOnlySurface(), collectLSPHovers(), collectLSPSymbols(), formatLSPFuncDetail(), formatLSPFuncSigDecl(), formatLSPGlobalDetail(), formatLSPImplDetail(), formatLSPImplName() (+5 more)
...
Cohesion: 0.22
Nodes (14): V0 1 1 Release Gate, V0 1 2 Release Gate, V0 1 3 Release Gate, Known Issues, 2026 04 27 Tetra Real Stabilization Agent Backlog, Artifact Policy, Tetra v0.1.1 Release Notes, Tetra v0.1.2 Release Notes (+6 more)

### Community 337 - "Community 337"
Cohesion: 0.21
Nodes (14): Artifact Evidence Policy, Release Artifact Policy, Known Issues Evidence Contract v0.3.0, v0.3.0 Candidate Known Issues, RC Evidence Discipline, v1.0 Release Candidate Process, Tetra v0.1.1 Final Handoff, Tetra v0.3.0 Completion Audit (+6 more)
...
Cohesion: 0.17
Nodes (13): Final Reports Artifact Alignment Gap, Named Security Reviewer Signoff Required Before Tagging, Plan250 Consolidated Evidence Index, Superseded Wave-C Dry-Run Security Signoff, Wave-E Implementer 1 Plan Integrity, Wave-E Implementer 2 Integrity Check, Wave-E Implementer 3 Summary Sync, Wave-F Implementer 1 Security Signoff Evidence (+5 more)
...
Cohesion: 0.7
Nodes (5): Tetra v0.4.0 Callable Evidence Map, Tetra v0.4.0 Production Backlog, Tetra v0.4.0 Production Gap Audit, v0.4.0 Callable Scope Boundary, v0.4.0 Production Gap Matrix

### Community 537 - "Community 537"
Cohesion: 0.4
Nodes (5): Known Issues Template, Tetra v0.2.0 Release Cut Guide, v0.2.x Maintenance Constraints, v0.2.0 Release Cut Procedure, v0.2.x Maintenance Policy
...
Cohesion: 1.0
Nodes (3): Tetra UI v1 Smoke Result, WaveC Controller v0.3 Gate Web UI DOM Smoke, WaveC Security Web UI DOM Smoke
