...
var smokeCaseRegistry = map[smokeSourceSet][]smokeCase{
	smokeSourceSetNative: {
		...
		{name: "core_component_smoke", srcPath: "examples/core_component_smoke.tetra", expectedExit: 42},
		...
		{name: "surface_counter", srcPath: "examples/surface_counter.tetra", expectedExit: 1},
		{name: "surface_text_input", srcPath: "examples/surface_text_input.tetra", expectedExit: 42},
		{name: "surface_migration_ui_web_smoke", srcPath: "examples/surface_migration_ui_web_smoke.tetra", expectedExit: 2},
		{name: "surface_migration_ui_native_shell_smoke", srcPath: "examples/surface_migration_ui_native_shell_smoke.tetra", expectedExit: 11},
		{name: "surface_migration_dogfood_web_ui", srcPath: "examples/surface_migration_dogfood_web_ui.tetra", expectedExit: 3},
		{name: "surface_migration_tetra_control_center", srcPath: "examples/surface_migration_tetra_control_center.tetra", expectedExit: 5},
