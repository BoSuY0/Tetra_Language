...
morph_rendered_beauty_source="examples/surface/morph_flagship/surface_morph_rendered_studio_shell.tetra"
...
write_drift_golden \
  "$morph_rendered_beauty_artifacts/surface-morph-rendered-beauty-frame-order-1-initial.rgba" \
  "$morph_rendered_beauty_goldens/order-1-initial.rgba"
write_drift_golden \
  "$morph_rendered_beauty_artifacts/surface-morph-rendered-beauty-frame-order-2-focused.rgba" \
  "$morph_rendered_beauty_goldens/order-2-focused.rgba"
write_drift_golden \
  "$morph_rendered_beauty_artifacts/surface-morph-rendered-beauty-frame-order-3-motion.rgba" \
  "$morph_rendered_beauty_goldens/order-3-motion.rgba"
mrb_golden_order_1="$morph_rendered_beauty_source,headless,1,"
mrb_golden_order_1+="$morph_rendered_beauty_goldens/order-1-initial.rgba"
mrb_golden_order_2="$morph_rendered_beauty_source,headless,2,"
mrb_golden_order_2+="$morph_rendered_beauty_goldens/order-2-focused.rgba"
mrb_golden_order_3="$morph_rendered_beauty_source,headless,3,"
mrb_golden_order_3+="$morph_rendered_beauty_goldens/order-3-motion.rgba"
go run ./tools/cmd/surface-visual-diff \
	--runtime-report "$morph_rendered_beauty_runtime" \
	--required-target headless \
	--golden-artifact "$mrb_golden_order_1" \
	--golden-artifact "$mrb_golden_order_2" \
	--golden-artifact "$mrb_golden_order_3" \
