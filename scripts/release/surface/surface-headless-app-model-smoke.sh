...
evidence for examples/surface_app_model.tetra with navigation, focus scopes,
...
go run ./tools/cmd/surface-runtime-smoke --mode headless-app-model --source examples/surface_app_model.tetra --report "$report_path"
