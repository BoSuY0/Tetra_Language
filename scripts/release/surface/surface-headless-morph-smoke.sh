...
examples/surface_morph_command_palette.tetra and proves Morph recipes expand
...
go run ./tools/cmd/surface-runtime-smoke --mode headless-morph --source examples/surface_morph_command_palette.tetra --report "$report_path"
