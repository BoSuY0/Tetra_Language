...
The gate builds examples/surface_toolkit_settings.tetra, runs it in a browser
...
go run ./tools/cmd/surface-runtime-smoke --mode wasm32-web-browser-canvas-toolkit-reuse --source examples/surface_toolkit_settings.tetra --report "$report_path"
