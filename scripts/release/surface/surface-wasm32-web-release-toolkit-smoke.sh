...
The gate builds examples/surface_release_form.tetra, runs it in a browser
...
go run ./tools/cmd/surface-runtime-smoke --mode wasm32-web-release-toolkit --source examples/surface_release_form.tetra --report "$report_path"
