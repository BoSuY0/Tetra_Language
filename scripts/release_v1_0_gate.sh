...
if [[ -z "$report_dir" ]]; then
  report_dir="/tmp/release-v1_0-gate-$(date -u +%Y%m%d-%H%M%S)"
fi
...
Generated by \`scripts/release_v1_0_gate.sh\`.
...
- Last release gate command: \`bash scripts/release_v1_0_gate.sh --report-dir $report_dir\`
