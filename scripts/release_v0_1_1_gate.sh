...
usage() {
  cat <<'USAGE'
Usage: bash scripts/release_v0_1_1_gate.sh [--report-dir DIR]
USAGE
}
...
Generated by \`scripts/release_v0_1_1_gate.sh\`.
...
- Last release gate command: \`bash scripts/release_v0_1_1_gate.sh --report-dir $report_dir\`
