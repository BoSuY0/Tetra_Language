...
- `ACCEPTANCE-FULL`: every item in the canonical plan's `Acceptance Criteria`
  ...
  `PARTIAL` explanation.
- `docs/spec/surface_morph_rendered_beauty.md` and the corresponding contract
...
- 2026-06-16: `MRB-01` completed locally. Added
  `docs/spec/surface_morph_rendered_beauty.md`,
  `docs/spec/surface_morph_rendered_beauty_contract.json`, and
  `tools/cmd/validate-surface-morph-rendered-beauty/`; updated
  `docs/spec/surface_morph.md` and `docs/spec/surface_v1.md` to reference the
  ...
  passed, and
  `go run ./tools/cmd/validate-surface-morph-rendered-beauty --contract docs/spec/surface_morph_rendered_beauty_contract.json`
...
- 2026-06-16: `MRB-02` completed locally/integration. Added typed
  ...
  `lib/core/block.tetra` exports so Morph examples can check through
  `lib.core.block` without changing the compact `BlockProps` ABI. Evidence:
  `./tetra check examples/surface_morph_studio_shell.tetra`,
  `./tetra check examples/surface_block_system.tetra`,
  `./tetra check examples/surface_morph_command_palette.tetra`,
  ...
  `go run -buildvcs=false ./tools/cmd/validate-surface-morph-rendered-beauty --contract docs/spec/surface_morph_rendered_beauty_contract.json`,
  `jq empty docs/spec/surface_morph_rendered_beauty_contract.json`, and
...
- 2026-06-16: `MRB-03` completed locally/integration. Added typed
  ...
  `go run -buildvcs=false ./tools/cmd/validate-surface-morph-rendered-beauty --contract docs/spec/surface_morph_rendered_beauty_contract.json`,
  `jq empty docs/spec/surface_morph_rendered_beauty_contract.json`,
...
- 2026-06-16: `MRB-04` completed locally/integration. Added deterministic
  non-marker text/icon raster evidence across `lib/core/draw.tetra`,
  ...
  `./tetra check examples/surface_block_system.tetra`,
  `./tetra check examples/surface_morph_command_palette.tetra`,
  `./tetra check examples/surface_block_text.tetra`,
  `./tetra check examples/surface_counter.tetra`,
  `./tetra check examples/surface_window_counter.tetra`,
  `./tetra check examples/surface_browser_counter.tetra`,
  `./tetra check examples/surface_release_counter.tetra`,
  `./tetra check examples/surface_textbox_app.tetra`,
  `go run -buildvcs=false ./tools/cmd/validate-surface-morph-rendered-beauty --contract docs/spec/surface_morph_rendered_beauty_contract.json`,
  `jq empty docs/spec/surface_morph_rendered_beauty_contract.json`,
  `git diff --check`, and `graphify update .`. Bridge: next task is
  `MRB-05` true pixel golden visual gate.
...
- 2026-06-16: `MRB-07` completed locally/integration, with a local
  ...
  `tetra.surface.morph-rendered-beauty.v1 headless headless-morph:examples/surface_morph_command_palette.tetra`.
  Evidence:
  ...
  `GOTELEMETRY=off GOCACHE="$PWD/.cache/go-build-surface-morph-report" GOTMPDIR="$PWD/.cache/go-tmp-surface-morph-report" go run -buildvcs=false ./tools/cmd/validate-surface-morph-rendered-beauty --contract docs/spec/surface_morph_rendered_beauty_contract.json`,
  `jq empty docs/spec/surface_morph_rendered_beauty_contract.json`,
  `git diff --check`, `graphify update .`, and
...
- 2026-06-16: `MRB-08` completed locally/integration with a headless
  ...
  `examples/surface_morph_rendered_studio_shell.tetra`. Added source-aware
  ...
  `headless-morph:examples/surface_morph_rendered_studio_shell.tetra` with 19
  ...
  `GOTELEMETRY=off GOCACHE="$PWD/.cache/go-build-surface-flagship" GOTMPDIR="$PWD/.cache/go-tmp-surface-flagship" go run -buildvcs=false ./tools/cmd/surface-runtime-smoke --mode headless-morph --source examples/surface_morph_rendered_studio_shell.tetra --report reports/surface/mrb08-flagship-runtime.json`,
  `GOTELEMETRY=off GOCACHE="$PWD/.cache/go-build-surface-flagship" GOTMPDIR="$PWD/.cache/go-tmp-surface-flagship" go run -buildvcs=false ./tools/cmd/surface-visual-diff --runtime-report reports/surface/mrb08-flagship-runtime.json --required-target headless --golden-set surface-morph-rendered-beauty-mrb08 --golden-artifact examples/surface_morph_rendered_studio_shell.tetra,headless,1,reports/surface/mrb08-flagship-goldens/headless/order-1-initial.rgba --golden-artifact examples/surface_morph_rendered_studio_shell.tetra,headless,2,reports/surface/mrb08-flagship-goldens/headless/order-2-focused.rgba --golden-artifact examples/surface_morph_rendered_studio_shell.tetra,headless,3,reports/surface/mrb08-flagship-goldens/headless/order-3-motion.rgba --out reports/surface/mrb08-flagship-visual.json`,
  `GOTELEMETRY=off GOCACHE="$PWD/.cache/go-build-surface-flagship" GOTMPDIR="$PWD/.cache/go-tmp-surface-flagship" go run -buildvcs=false ./tools/cmd/surface-runtime-smoke --mode headless-morph --source examples/surface_morph_rendered_studio_shell.tetra --report reports/surface/mrb08-flagship-runtime.json --visual-report reports/surface/mrb08-flagship-visual.json --morph-rendered-beauty-report reports/surface/mrb08-flagship-morph-rendered-beauty.json`,
  ...
  `git diff --check -- tools/cmd/surface-runtime-smoke tools/validators/surface examples/surface_morph_rendered_studio_shell.tetra lib/core/block.tetra`,
...
- 2026-06-16: `MRB-11` completed locally/integration. Claim scanning now
  ...
  and `docs/user/surface_cookbook.md`. Evidence: focused and full claim
...
- 2026-06-16: `MRB-12` completed locally/integration. Added the integrated
  ...
  -> flagship source `examples/surface_morph_rendered_studio_shell.tetra`,
...
- 2026-06-16: `MRB-13` completed as a stable-promotion denial, not a stable
  ...
  and updated `docs/spec/surface_morph_stable_candidate.md`. Fresh gate
  evidence:
