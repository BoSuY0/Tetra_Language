	...
	memory["domain_bytes"] = []map[string]any{
		{
			...
			"mailbox_current_bytes": uint64(64),
			"mailbox_peak_bytes":    uint64(96),
			"stack_live_bytes":      uint64(64),
			"stack_reserved_bytes":  uint64(96),
			"stack_retained_bytes":  uint64(0),
			"stack_released_bytes":  uint64(0),
			"byte_budget":           uint64(1088),
