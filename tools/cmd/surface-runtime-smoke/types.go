...
type headlessSurfaceRunnerTrace struct {
	...
	BlockSceneSnapshot              *surface.BlockSceneSnapshotReport       `json:"block_scene_snapshot,omitempty"`
	RenderCommandStream             *surface.RenderCommandStreamReport      `json:"render_command_stream,omitempty"`
