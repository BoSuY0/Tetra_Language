...
func blockPaintCommandsForScenario() []surface.PaintCommandReport {
	return []surface.PaintCommandReport{
		...
		{Order: 10, Command: "icon", LayerID: "root-icon", BlockID: 2, Rect: surface.RectReport{X: 56, Y: 16, W: 12, H: 12}, Quality: "monochrome-mask-raster-v1", Checksum: "sha256:" + checksumText("paint-icon")},
	}
}
...
func blockTextRenderCommandsForScenario() []surface.TextRenderCommandReport {
	return []surface.TextRenderCommandReport{
		...
		{Order: 2, Command: "render_glyphs", MeasurementID: "title-measure", BlockID: 2, Rect: surface.RectReport{X: 12, Y: 10, W: 96, H: 40}, Clip: surface.RectReport{X: 12, Y: 10, W: 96, H: 40}, Color: "#edf2f7ff", Opacity: 255, Quality: "deterministic-glyph-raster-v1", RasterFormat: "builtin-5x7-alpha-mask-v1", RasterHash: "sha256:" + checksumText("text-command-glyph-raster"), RasterWidth: 96, RasterHeight: 40, RasterCoverage: 476, MarkerOnly: false, Checksum: "sha256:" + checksumText("text-command-glyphs")},
...
func runMorphScenario() headlessScenario {
	return runMorphScenarioForSource("examples/surface_morph_command_palette.tetra")
}
