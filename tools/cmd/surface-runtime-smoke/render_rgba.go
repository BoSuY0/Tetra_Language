...
func renderMorphStudioShellFrameRGBA(width int, height int, active bool) rgbaFrame {
	...
	if active {
		rectOutlineRGBA(frame, rect{X: commandRect.X - 3, Y: commandRect.Y - 3, W: commandRect.W + 6, H: commandRect.H + 6}, focus)
		rectOutlineRGBA(frame, rect{X: metricRect.X - 3, Y: metricRect.Y - 3, W: metricRect.W + 6, H: metricRect.H + 6}, focus)
