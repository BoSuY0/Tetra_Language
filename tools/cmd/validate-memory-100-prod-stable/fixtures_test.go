		...
		return map[string]any{
			...
			"benchmarks": []any{
				map[string]any{
					...
					"evidence":          "allocation report schema v2 estimates per_core_small_heap allocation intents and 64KiB chunk refill syscalls; allocation_report_estimate only, not a runtime measurement",
					"ran":               true,
					"pass":              true,
				},
			},
		...
		return map[string]any{
			...
			"rows": []any{
				map[string]any{
					...
					"severity":               "P1",
					"reason":                 "unknown_size",
					"suggested_fix":          "add no-escape, lifetime, or bounded allocation proof before changing this heap fallback",
