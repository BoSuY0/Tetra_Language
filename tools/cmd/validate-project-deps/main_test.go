...
func TestValidateProjectDepsReportRejectsUnknownFields(t *testing.T) {
	raw := []byte(
		`{"root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[],"extra":true}`,
	)
	if err := validateProjectDepsReport(raw); err == nil ||
	...
	raw = []byte(
		`{"root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"tetra://math","version":"0.1.0","path":"../Math","resolved_path":"/repo/Math","status":"ok","extra":true}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil ||
		!strings.Contains(err.Error(), "unknown field") {
...
func TestValidateProjectDepsReportRejectsInvalidTopLevelStatus(t *testing.T) {
	raw := []byte(
		`{"status":"ok","root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
...
func TestValidateProjectDepsReportRejectsPassWithNonOKDependency(t *testing.T) {
	raw := []byte(
		`{"status":"pass","root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"tetra://math","version":"0.1.0","path":"../Math","status":"missing","detail":"missing"}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
...
func TestValidateProjectDepsReportRejectsFailWithoutIssue(t *testing.T) {
	raw := []byte(
		`{"status":"fail","root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"tetra://math","version":"0.1.0","path":"../Math","resolved_path":"/repo/Math","status":"ok"}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
...
func TestValidateProjectDepsReportRejectsBadDependencyFields(t *testing.T) {
	raw := []byte(
		`{"root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"math","version":"0.1.0","path":"../Math","resolved_path":"/repo/Math","status":"ok"}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
		t.Fatalf("expected invalid dependency id failure")
	}
	raw = []byte(
		`{"root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"tetra://math","version":"0.1","path":"../Math","resolved_path":"/repo/Math","status":"ok"}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
		t.Fatalf("expected invalid dependency version failure")
	}
	raw = []byte(
		`{"root":"/repo/App","capsule_path":"/repo/App/Capsule.t4","dependencies":[{"id":"tetra://math","version":"0.1.0","path":"../Math","status":"ok"}]}`,
	)
	if err := validateProjectDepsReport(raw); err == nil {
