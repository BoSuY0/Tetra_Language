...
func TestValidateManifestAcceptsGeneratedShape(t *testing.T) {
  ...
  "features": [
    ...
    {"id":"language.lifetime-ssa","name":"Lifetime SSA solver","status":"planned","scope":"planned full SSA lifetime analysis with precise merge reasoning","stability":"planned; no current v0.2.0 support guarantee and not required for the conservative ownership/resource MVP","docs":["docs/spec/current_supported_surface.md","docs/spec/ownership_v1.md","docs/spec/v1_scope.md"]},
