...
func TestValidateTargetsReportAcceptsExpectedShape(t *testing.T) {
  ...
  "targets":[
    ...
    {"triple":"wasm32-wasi","status":"build_only","os":"wasi","arch":"wasm32","abi":"wasi","format":"wasm","exe_ext":".wasm","build_only":true,"run_supported":false,"supports_debug_info":false,"supports_release_optimize":true},
    {"triple":"wasm32-web","status":"build_only","os":"web","arch":"wasm32","abi":"web","format":"wasm","exe_ext":".wasm","build_only":true,"run_supported":false,"supports_debug_info":false,"supports_release_optimize":true}
  ]
}`)
