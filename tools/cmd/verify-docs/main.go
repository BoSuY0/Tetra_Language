...
func verifySurfaceBlockSystemFeatureBoundary(features map[string]featureManifest) error {
	...
	for _, want := range []string{
		...
		"tetra.surface.ipc-lifecycle-report.v1",
		"surface-ipc-lifecycle-v1",
		"validate-surface-ipc-report",
		"Surface handle/frame/event actor transfer rejection",
		"background UI mutation without dispatcher rejection",
		"Electron main/renderer parity nonclaim",
		"tetra.surface.crash-report.v1",
		"surface-crash-diagnostics-v1",
		"validate-surface-crash-report",
		"crash swallowed as pass rejection",
		"secret leak rejection",
		"automatic crash recovery nonclaim",
		"Electron crash reporter compatibility nonclaim",
		"tetra.surface.i18n-report.v1",
		"surface-i18n-l10n-v1",
		"validate-surface-i18n-report",
		"locale resources",
		"stable string IDs",
		"silent fallback rejection",
		"full bidi shaping nonclaim",
		"full ICU/CLDR nonclaim",
...
func verifyFeatureTruthBoundaries(features map[string]featureManifest) error {
	...
	docChecks := map[string][]string{
		...
		"ui.surface-production-platform":          {"docs/spec/surface_production_platform.md", "docs/spec/surface_ci_release_gates.md", "docs/spec/current_supported_surface.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md", "docs/release/surface_prod_release_audit.md", "docs/benchmarks/surface_vs_electron.md"},
	}
