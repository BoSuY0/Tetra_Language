...
func TestReadFileRejectsInvalidMethodSchemaAndOS(t *testing.T) {
	for _, tc := range []struct {
		...
		{name: "heap method", field: "method", value: "tetra_linux_x64_heap_telemetry_v1", want: "method"},
...
func validRSSSampleMap() map[string]any {
	return map[string]any{
		...
		"samples":                []map[string]any{{"unix_nano": int64(110), "rss_bytes": uint64(4096)}, {"unix_nano": int64(120), "rss_bytes": uint64(4096)}},
