...
func validMemoryReport() memoryprod.Report {
	...
	return memoryprod.Report{
		...
		Benchmarks: []memoryprod.BenchmarkReport{
			{Name: "small heap allocation syscall reduction", Kind: "allocator", Metric: "estimated_os_syscalls", Unit: "syscalls", EvidenceClass: "allocation_report_estimate", Method: "allocation_report_summary", BaselineValue: 64, MeasuredValue: 1, ImprovementRatio: 64, Evidence: "allocation report schema v2 estimates 64 per_core_small_heap allocation intents and 1 estimated 64KiB chunk refill syscall instead of 64 mmap-per-allocation syscalls; allocation_report_estimate only, not a runtime measurement", Ran: true, Pass: true},
		},
...
func validParallelReport(t *testing.T) parallelprod.Report {
	...
	return parallelprod.Report{
		...
		Cases: []parallelprod.CaseReport{
			...
			{Name: "actor fanout mailbox drain soak", Kind: "stress", Ran: true, Pass: true, Iterations: 512, DeterministicSeed: "actor-fanout-mailbox-drain-v1", MaxDurationMS: 90000},
			{Name: "many tasks stress", Kind: "stress", Ran: true, Pass: true, Iterations: 64, DeterministicSeed: "task-bounded-stress-seed-17", MaxDurationMS: 10000},
			{Name: "many actor messages stress", Kind: "stress", Ran: true, Pass: true, Iterations: 256, DeterministicSeed: "actors-tagged-stress-v1", MaxDurationMS: 10000},
			{Name: "cancellation storm", Kind: "stress", Ran: true, Pass: true, Iterations: 16, DeterministicSeed: "parallel-cancellation-storm-v1", MaxDurationMS: 10000},
			{Name: "timeouts stress", Kind: "stress", Ran: true, Pass: true, Iterations: 1, DeterministicSeed: "deadline-aware-waits-v1", MaxDurationMS: 10000},
		},
