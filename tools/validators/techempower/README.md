...
consistency, command/soak consistency, command/server pool consistency, or clean
...
the semantic endpoint allowlist and endpoint identity, SCRAM evidence, semantic
probes, p99.9 latency, resource snapshots, optional soak evidence, shutdown
cleanup checks, and command executable provenance for the SCRAM local benchmark
harness.
