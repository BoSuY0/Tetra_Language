...
matrix run repeat metadata, observed content types, endpoint semantic check
lists, SCRAM evidence, matrix semantic probes, resource snapshots, declared
matrix grid coverage, or clean shutdown evidence when a soak is present.
