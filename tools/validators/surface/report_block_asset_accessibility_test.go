...
func blockAssetRenderCommandsForTest() []BlockAssetRenderCommandReport {
	return []BlockAssetRenderCommandReport{
		...
		{Order: 2, Command: "tint_icon", AssetID: "icon-settings", BlockID: 2, Rect: RectReport{X: 24, Y: 36, W: 32, H: 32}, Tint: "#60aef4ff", Scale: 1, Quality: "icon-mask-raster-v1", RasterFormat: "builtin-icon-mask-raster-v1", RasterHash: "sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", RasterWidth: 32, RasterHeight: 32, RasterCoverage: 341, Checksum: "sha256:ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"},
