...
func validMorphRecipes() []any {
	return []any{
		...
		map[string]any{"name": "app.shell@1", "output": "Block", "slots": []any{"nav", "toolbar", "content", "status"}, "inputs": []any{"title", "target", "mode"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "toolbar@1", "output": "Block", "slots": []any{"leading", "actions", "search"}, "inputs": []any{"title", "commands", "density"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "split.pane@1", "output": "Block", "slots": []any{"primary", "secondary", "divider"}, "inputs": []any{"ratio", "orientation", "resize"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "status.bar@1", "output": "Block", "slots": []any{"target", "state", "progress"}, "inputs": []any{"target", "dirty", "message"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "settings.form@1", "output": "Block", "slots": []any{"section", "fields", "actions"}, "inputs": []any{"profile", "validation", "save"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "log.row@1", "output": "Block", "slots": []any{"level", "message", "timestamp"}, "inputs": []any{"level", "message", "selected"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "empty.state@1", "output": "Block", "slots": []any{"title", "body", "action"}, "inputs": []any{"reason", "action", "illustration"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
		map[string]any{"name": "error.panel@1", "output": "Block", "slots": []any{"title", "body", "retry"}, "inputs": []any{"code", "message", "recover"}, "expands_to_block_graph": true, "hidden_app_state": false, "platform_widgets": false, "core_primitive_promotion": false},
	}
}
func validMorphRecipeExpansions() []any {
	return []any{
		...
		map[string]any{"recipe": "app.shell@1", "block_ids": []any{1, 2, 5}, "slot_bindings": []any{"nav", "toolbar", "content", "status"}, "variant": "studio", "reported": true},
		map[string]any{"recipe": "toolbar@1", "block_ids": []any{2, 4}, "slot_bindings": []any{"leading", "actions", "search"}, "variant": "compact", "reported": true},
		map[string]any{"recipe": "split.pane@1", "block_ids": []any{2, 3, 4}, "slot_bindings": []any{"primary", "secondary", "divider"}, "variant": "horizontal", "reported": true},
		map[string]any{"recipe": "status.bar@1", "block_ids": []any{5}, "slot_bindings": []any{"target", "state", "progress"}, "variant": "reporting", "reported": true},
		map[string]any{"recipe": "settings.form@1", "block_ids": []any{3, 4}, "slot_bindings": []any{"section", "fields", "actions"}, "variant": "validated", "reported": true},
		map[string]any{"recipe": "log.row@1", "block_ids": []any{4, 5}, "slot_bindings": []any{"level", "message", "timestamp"}, "variant": "selected", "reported": true},
		map[string]any{"recipe": "empty.state@1", "block_ids": []any{3}, "slot_bindings": []any{"title", "body", "action"}, "variant": "onboarding", "reported": true},
		map[string]any{"recipe": "error.panel@1", "block_ids": []any{2, 5}, "slot_bindings": []any{"title", "body", "retry"}, "variant": "recoverable", "reported": true},
	}
}
func validMorphRecipeApps() []any {
	return []any{
		...
		map[string]any{"source": "examples/surface_morph_studio_shell.tetra", "module": "examples.surface_morph_studio_shell", "recipes": []any{"app.shell@1", "toolbar@1", "split.pane@1", "status.bar@1", "settings.form@1", "log.row@1", "empty.state@1", "error.panel@1"}, "expands_to_block_graph": true, "block_count": 12, "accessibility_projection": true, "hidden_app_state": false, "react_runtime": false, "electron_runtime": false, "dom_runtime": false, "platform_widgets": false, "output_primitives": []any{"Block"}},
		map[string]any{"source": "examples/surface_morph_rendered_studio_shell.tetra", "module": "examples.surface_morph_rendered_studio_shell", "recipes": []any{"app.shell@1", "nav.item@1", "toolbar@1", "tab.item@1", "split.pane@1", "status.bar@1", "command.item@1", "settings.form@1", "log.row@1", "metric.tile@1", "toast.notification@1", "dialog.panel@1", "empty.state@1", "error.panel@1", "control.action@1", "field.text@1"}, "expands_to_block_graph": true, "block_count": 18, "accessibility_projection": true, "hidden_app_state": false, "react_runtime": false, "electron_runtime": false, "dom_runtime": false, "platform_widgets": false, "output_primitives": []any{"Block"}},
	}
}
