...
func blockPaintCommandsForTest() []PaintCommandReport {
	return []PaintCommandReport{
		...
		{Order: 10, Command: "icon", LayerID: "root-icon", BlockID: 1, Rect: RectReport{X: 56, Y: 16, W: 12, H: 12}, Quality: "monochrome-mask-raster-v1", Checksum: "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},
	}
}
...
func blockTextRenderCommandsForTest() []TextRenderCommandReport {
	return []TextRenderCommandReport{
		...
		{Order: 2, Command: "render_glyphs", MeasurementID: "title-measure", BlockID: 2, Rect: RectReport{X: 12, Y: 10, W: 96, H: 40}, Clip: RectReport{X: 12, Y: 10, W: 96, H: 40}, Color: "#edf2f7ff", Opacity: 255, Quality: "deterministic-glyph-raster-v1", RasterFormat: "builtin-5x7-alpha-mask-v1", RasterHash: "sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", RasterWidth: 96, RasterHeight: 40, RasterCoverage: 476, Checksum: "sha256:9999999999999999999999999999999999999999999999999999999999999999"},
