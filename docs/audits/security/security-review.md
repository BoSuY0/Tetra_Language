...
This file is an input to future release review. It is not the named reviewer release signoff
consumed by `scripts/release/v1_0/security-review.sh`.

## Scope

P24.0 reviews the surfaces that can bypass normal safety, touch host or runtime capabilities, parse
external protocol bytes, or move package trust across local boundaries:
...
- Primary evidence: `docs/spec/runtime/unsafe.md`.
- Primary evidence: `examples/flow/flow_unsafe_cap_mem_smoke.tetra`.
- Primary evidence: `lib/core/base/capability.tetra`.
- Current boundary: inventory and policy review; not proof that every unsafe
  caller is memory safe.

### Capabilities

- Primary evidence: `docs/spec/runtime/capabilities.md`.
- Primary evidence: `docs/spec/runtime/effects_capabilities_privacy_v1.md`.
...
- Primary evidence: `compiler/internal/actorsrt/actorsrt_core.go`.
- Primary evidence: `docs/spec/runtime/actors.md`.
...
- Primary evidence: `docs/spec/policy/eco_publishing_v1.md`.
- Primary evidence: `cli/cmd/tetra/tetra_eco.go`.
