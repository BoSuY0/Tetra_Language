...
P22.2 answers the master-plan question by keeping the current static
protocol/conformance model in this branch. Runtime protocol values, trait
objects, witness tables, dynamic dispatch, and conformance-table lookup are not
promoted without a later same-branch ABI/lifetime/ownership design.
