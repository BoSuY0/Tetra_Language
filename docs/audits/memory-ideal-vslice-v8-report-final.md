...
Decision: proceed for v8 evidence. This slice accepts only graph/report
projection integrity and claim-drift rejection. It is not "Memory 100%", not a
new memory semantics slice, not optimizer correctness, not target parity, not
performance evidence, and not arbitrary unsafe or FFI safety.
