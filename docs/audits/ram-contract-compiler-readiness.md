...
Git head: 113bfb607e187fc6088015b52f63431f761aa764
Working tree: clean worktree evidence for the DW17 latest-base RAM Contract refresh before the test-all CLI fixture de-duplication fix; this is
...
The DW17 latest-base clean-proof refresh before the test-all CLI fixture de-duplication fix produced direct-parent RAM Contract release
evidence under
`reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/`.
That RAM Contract slice was directly validated for
`113bfb607e187fc6088015b52f63431f761aa764` in clean worktree
`/home/tetra/.codex/worktrees/Tetra_Language/ram-contract-clean-113bfb6-dw17`,
then copied into this branch checkout's ignored `reports/` evidence directory. This audit
...
- `bash scripts/release/post_v0_4/ram-contract-linux-x64-smoke.sh --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6`
- `go run -buildvcs=false ./tools/cmd/validate-ram-contract-release --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6 --current-git-head 113bfb607e187fc6088015b52f63431f761aa764`
- `go run -buildvcs=false ./tools/cmd/validate-artifact-hashes --manifest reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/artifact-hashes.json`
- `go run ./tools/cmd/verify-docs --manifest docs/generated/manifest.json`
- `git diff --check`

## Artifact Evidence

- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/ram-contract-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/memory-grade-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/proof-store-summary.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/validation-pipeline-coverage.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/heap-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/copy-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/fuzz/ram-contract-fuzz-oracle.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/artifact-hashes.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-113bfb6/ram-contract-release-manifest.json`
