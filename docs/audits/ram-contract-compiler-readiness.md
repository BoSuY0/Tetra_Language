...
Git head: f548e2fa9486801ad3eb2db7de43b7ebd9e6fae2
Working tree: clean worktree evidence for the DW17 latest-base RAM Contract refresh before the validate-manifest fuzz input bound fix; this is
...
The DW17 latest-base clean-proof refresh before the validate-manifest fuzz input bound fix produced direct-parent RAM Contract release
evidence under
`reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/`.
That RAM Contract slice was directly validated for
`f548e2fa9486801ad3eb2db7de43b7ebd9e6fae2` in clean worktree
`/home/tetra/.codex/worktrees/Tetra_Language/ram-contract-clean-f548e2f-dw17`,
...
- `bash scripts/release/post_v0_4/ram-contract-linux-x64-smoke.sh --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f`
- `go run -buildvcs=false ./tools/cmd/validate-ram-contract-release --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f --current-git-head f548e2fa9486801ad3eb2db7de43b7ebd9e6fae2`
- `go run -buildvcs=false ./tools/cmd/validate-artifact-hashes --manifest reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/artifact-hashes.json`
- `go run ./tools/cmd/verify-docs --manifest docs/generated/manifest.json`
- `git diff --check`

## Artifact Evidence

- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/ram-contract-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/memory-grade-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/proof-store-summary.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/validation-pipeline-coverage.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/heap-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/copy-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/fuzz/ram-contract-fuzz-oracle.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/artifact-hashes.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-f548e2f/ram-contract-release-manifest.json`
