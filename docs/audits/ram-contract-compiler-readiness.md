...
Git head: acab832c92463eda33fc24700527d666bb4ac4b5
Working tree: clean worktree evidence for the DW17 latest-base RAM Contract refresh; this is
...
The DW17 latest-base clean-proof refresh produced direct-parent RAM Contract release
evidence under
`reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/`.
That RAM Contract slice was directly validated for
`acab832c92463eda33fc24700527d666bb4ac4b5` in clean worktree
...
- `bash scripts/release/post_v0_4/ram-contract-linux-x64-smoke.sh --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c`
- `go run -buildvcs=false ./tools/cmd/validate-ram-contract-release --report-dir reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c --current-git-head acab832c92463eda33fc24700527d666bb4ac4b5`
- `go run -buildvcs=false ./tools/cmd/validate-artifact-hashes --manifest reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/artifact-hashes.json`
- `go run ./tools/cmd/verify-docs --manifest docs/generated/manifest.json`
- `git diff --check`

## Artifact Evidence

- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/ram-contract-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/memory-grade-report.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/proof-store-summary.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/validation-pipeline-coverage.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/heap-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/copy-blockers.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/fuzz/ram-contract-fuzz-oracle.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/artifact-hashes.json`
- `reports/actor-runtime-foundation/dw17-latest-ram-contract-acab832c/ram-contract-release-manifest.json`
