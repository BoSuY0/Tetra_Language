...
- [x] `scripts/release_v0_2_0_gate.sh` runs to completion on the exact release
...
- [x] `bash scripts/test_all.sh --quick --report-dir <dir>/test-all-quick`
...
- [x] `bash scripts/release_v1_0_security_review.sh --signoff <dir>/artifacts/security-review.md`
      (covered by gate step `security review signoff`,
      `logs/25-security-review-signoff.log`)
- [x] `bash scripts/release_v1_0_repro.sh --report <dir>/artifacts/reproducible-build.json`
      (covered by gate step `reproducible build proof`,
      `logs/29-reproducible-build-proof.log`)
- [x] `bash scripts/release_v1_0_binary_size.sh --report <dir>/artifacts/binary-size-thresholds.json`
