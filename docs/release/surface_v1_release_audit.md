...
| release gate passed | pending final | P13 will run `bash scripts/release/surface/release-gate.sh --report-dir reports/surface-ui-production-final/surface-release-v1` |
...
| artifact hashes validated | pending final | packet manifests through P09 validate; P13 will validate the final release gate manifest |
