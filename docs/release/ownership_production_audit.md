...
| SSA local lifetime analysis | `language.lifetime-ssa`; `compiler/tests/ownership/ownership_test.go`; `compiler/tests/safety/islands_scope_test.go`; `compiler/tests/runtime/resource_finalization_test.go` | See `Evidence Details / SSA local lifetime analysis`. | pass |
...
| Ownership-aware generics/interfaces/callables | `compiler/tests/ownership/ownership_test.go`; `compiler/tests/semantics/generics_test.go`; `compiler/tests/callables/function_typed_callable_test.go`; `compiler/tests/semantics/closures_semantic_clauses_test.go`; `compiler/tests/runtime/resource_finalization_test.go`; `cli/cmd/tetra/test_command_test.go` | See `Evidence Details / Ownership-aware generics/interfaces/callables`. | pass |
