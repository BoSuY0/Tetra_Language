# Tetra v0.6.x Test Report

- mode: `full`
- status: `fail`
- started_at: `2026-04-26T19:56:20Z`
- ended_at: `2026-04-26T19:56:23Z`
- step_count: `23`
- failed_count: `2`

## Steps

- `go test all packages`: `fail` in 1s, exit `1`, command `go test ./compiler/... ./cli/... ./tools/...` ([logs/01-go-test-all-packages.log](logs/01-go-test-all-packages.log))
- `repo test script`: `fail` in 0s, exit `1`, command `bash scripts/test.sh` ([logs/02-repo-test-script.log](logs/02-repo-test-script.log))
...
- `short alias version`: `pass` in 1s, exit `0`, command `check_short_alias_version` ([logs/05-short-alias-version.log](logs/05-short-alias-version.log))
...
- `host smoke linux-x64`: `pass` in 0s, exit `0`, command `check_host_smoke` ([logs/15-host-smoke-linux-x64.log](logs/15-host-smoke-linux-x64.log))
...
- `generated api docs`: `pass` in 1s, exit `0`, command `check_generated_api_docs` ([logs/21-generated-api-docs.log](logs/21-generated-api-docs.log))
