...
Status: post-scope blocker ledger for Actor Runtime Production Foundation v1.
...
region transfer, official actor benchmarks, performance superiority, or a
formal race/liveness proof.
