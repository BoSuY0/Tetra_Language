...
var linuxX86BasicNetRuntimeSymbols = []struct {
...
}{
	{
		...
		code:        linuxX86NetSocketTCP4Code,
		paramSlots:  1,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_bind_tcp4_loopback",
		code:        func() []byte { return linuxX86NetTCP4LoopbackCode(linuxX86SocketOpBind) },
		paramSlots:  3,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_connect_tcp4_loopback",
		code:        func() []byte { return linuxX86NetTCP4LoopbackCode(linuxX86SocketOpConnect) },
		paramSlots:  3,
		returnSlots: 1,
	},
	...
	{name: "__tetra_net_accept4", code: linuxX86NetAccept4Code, paramSlots: 3, returnSlots: 1},
	{
		...
		code:        func() []byte { return linuxX86NetReadWriteCode(linuxX86SysRead) },
		paramSlots:  6,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_recv",
		code:        func() []byte { return linuxX86NetRecvSendCode(linuxX86SocketOpRecv) },
		paramSlots:  6,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_write",
		code:        func() []byte { return linuxX86NetReadWriteCode(linuxX86SysWrite) },
		paramSlots:  6,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_send",
		code:        func() []byte { return linuxX86NetRecvSendCode(linuxX86SocketOpSend) },
		paramSlots:  6,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_epoll_create",
		code:        linuxX86NetEpollCreateCode,
		paramSlots:  1,
		returnSlots: 1,
	},
	{
		...
		code: func() []byte {
			return linuxX86NetEpollCtlCode(
				linuxX86EpollCtlAdd,
				linuxX86EpollIn,
			)
		},
	...
	},
	{
		...
		code: func() []byte {
			return linuxX86NetEpollCtlCode(
				linuxX86EpollCtlAdd,
				linuxX86EpollIn|linuxX86EpollOut,
			)
		},
		paramSlots:  3,
		returnSlots: 1,
	...
	},
	{
		...
		code:        func() []byte { return linuxX86NetEpollCtlCode(linuxX86EpollCtlDel, 0) },
		paramSlots:  3,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_epoll_wait_one",
		code:        linuxX86NetEpollWaitOneCode,
		paramSlots:  3,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_epoll_wait_one_into",
		code:        linuxX86NetEpollWaitOneIntoCode,
		paramSlots:  5,
		returnSlots: 1,
	},
	{
		name:        "__tetra_net_set_nonblocking",
		code:        linuxX86NetSetNonblockingCode,
		paramSlots:  2,
		returnSlots: 1,
	},
	{
		...
		code: func() []byte {
			return linuxX86NetSetSockOptCode(
				linuxX86SolSocket,
				linuxX86SoReusePort,
			)
		},
...
func BuildLinuxX86BasicNetRuntimeObject() *tobj.Object {
	code := make([]byte, 0)
	symbols := make([]tobj.Symbol, 0, len(linuxX86BasicNetRuntimeSymbols))
