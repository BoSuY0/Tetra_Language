...
func TestWASMPolicyRejectsUnsafeCapabilityMemoryMMIOAndCtxSwitchIR(t *testing.T) {
	cases := []struct {
		...
		{name: "store_arch_ptr", instr: ir.IRInstr{Kind: ir.IRMemWriteArchPtr}, builtin: "core.store_arch_ptr"},
		...
		{name: "store_arch_ptr_offset", instr: ir.IRInstr{Kind: ir.IRMemWriteArchPtrOffset}, builtin: "core.store_arch_ptr"},
