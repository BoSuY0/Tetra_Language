...
func FeatureRegistry() []FeatureInfo {
	features := []FeatureInfo{
		...
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-v1-linux-web current release scope: pure-Tetra UI, tiny Surface Host ABI, software RGBA framebuffer presentation, owned/copy-safe event and text buffers, developer fast rebuild evidence through tetra surface dev, static Surface inspector report evidence, and release evidence for headless, linux-x64 real-window, and wasm32-web browser-canvas targets",
		...
		},
		{
			...
			Status:    FeatureStatusExperimental,
			Scope:     "experimental Morph Capsule authoring layer over the Surface Block System; `lib.core.morph` defines scoped capsule tokens, materials, seven affordances, state lenses, motion presets, and eleven recipes that expand into Block graph evidence for five `examples/surface_morph_*.tetra` reference apps; the recipe layer expands into Block and never promotes Button/Card/TextField-style helpers to core primitives; `tetra.surface.morph.gate.v1` records deterministic headless same-commit Morph reports plus artifact hashes and validates `tetra.surface.token-graph.contract.v1` scoped token graph diagnostics plus P08 recipe expansion evidence",
			...
			Docs:      []string{"docs/spec/surface_morph.md", "docs/spec/surface_token_graph.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/user/examples_index.md", "docs/user/surface_morph_recipe_cookbook.md", "docs/user/standard_library_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
		...
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "current linux-x64-release-window-v1 Surface target using Wayland shm RGBA real-window evidence, native event pump, text input, clipboard, IME/composition trace, toolkit, accessibility bridge evidence, linux-app-shell-subset-v1, electron-feature-ledger-v1 rows for app menu, lifecycle, multi-window, clipboard, IME, accessibility bridge, scoped crash/error reporting adapters, and blocked-pass dialog/file picker/notification/tray/deep-link nonclaims, plus surface-security-permission-v1 default-deny filesystem/network policy, capability-checked IPC/process boundaries, scoped clipboard policy, local hashed asset/font/image safety, surface-performance-budget-v1 local startup/frame/memory/cache/framebuffer/binary-size/CPU-proxy evidence, and surface-dev-workflow-v1 fast rebuild developer workflow evidence",
			Stability: "current only for the proven linux-x64 real-window release path, bounded app-shell feature ledger, scoped security permission model, local deterministic performance budget report, and fast rebuild developer workflow; no GTK, Qt, platform widget, metadata sidecar playback, macOS, Windows, unrestricted filesystem/network, remote asset fetch, tray/notification/file-picker/dialog support, official benchmark result, unsupported Electron speed comparison, hot reload, Electron dev server, React Fast Refresh, or broad Electron shell parity claim is implied",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "`tetra surface dev` emits tetra.surface.dev-workflow.v1 / surface-dev-workflow-v1 evidence for linux-x64 build-cache fast rebuilds, including initial build, warm-cache rebuild, token-change, recipe-change, source-change, source diagnostics, and artifact hashes",
			Stability: "current developer workflow evidence only; the loop is documented as fast rebuild and may require process restart; it is not a hot reload, Electron dev server, React Fast Refresh, DOM-authored app UI reload, or full IDE server claim",
			Docs:      []string{"docs/spec/cli_contracts.md", "docs/spec/surface_v1.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "tools/cmd/surface-inspector emits tetra.surface.inspector.v1 / surface-inspector-v1 static tool reports from validated Surface runtime reports, exposing Block tree, Morph tokens, layout, paint, accessibility, event routes, focus state, perf counters, source locations, hidden-state scan results, JSON evidence, and optional static HTML report",
			Stability: "current inspector evidence only; it is a static report tool and not browser devtools, React devtools, DOM runtime UI, hidden app state, an interactive runtime inspector, or a substitute for target-host accessibility evidence",
			Docs:      []string{"docs/spec/cli_contracts.md", "docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md", "docs/release/surface_v1_release_audit.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "`tetra new surface-app --template <kind>` generates Block/Morph Surface app projects for command palette, settings, dashboard, editor shell, multi-window notes, and web-canvas starts; surface-template-smoke-v1 evidence checks, builds, runs, inspects, visually tests, and packages generated app paths without React, Electron, DOM-authored app UI trees, CSS runtime, user JavaScript app logic, core widget primitives, or platform widgets",
			Stability: "current onboarding template evidence for the bounded Surface v1 Linux/web scope; templates are not a broad Electron/React/CSS replacement claim and do not promote Morph beyond the validated experimental authoring layer over Block",
			Docs:      []string{"docs/spec/cli_contracts.md", "docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/user/surface_cookbook.md", "docs/user/examples_index.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-reference-app-suite-v1 evidence covers ten polished Block/Morph reference app shapes: command palette, settings, dashboard, editor shell, file manager/list-detail, dialog/notification, localized form, accessibility-heavy form, multi-window notes, and widgets-to-Morph migration compatibility. Each app compiles, runs, uses stable Morph recipes that resolve to Block, and records headless, linux-x64 real-window, and wasm32-web browser-canvas visual, interaction, accessibility, performance, token/theme, layout, and artifact-hash evidence.",
			Stability: "current product-shape evidence for the bounded Surface v1 Linux/web scope; this is not a broad Electron shell parity claim, not a React runtime, not a CSS cascade runtime, not DOM-authored app UI, and widget compatibility is limited to the migration example.",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/user/examples_index.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-package-v1 evidence packages the command-palette reference app and product-slice studio-shell flagship source as linux-x64 and wasm32-web tar.gz artifacts, records surface-app-package-v1 manifests, local asset hashes, installed linux-x64 binary execution, web bundle HTML/wasm/compiler-owned loader output, and a hash-pinned update channel manifest",
			Stability: "current packaging evidence for the bounded Surface v1 Linux/web scope; signing, notarization, automatic runtime update, network update, Electron runtime, React runtime, CSS cascade runtime, DOM-authored app UI tree, remote asset fetch, and user JavaScript app logic remain explicit nonclaims",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-crash-report-v1 evidence records bounded linux-x64 command failure, host crash diagnostic capture, local ring-buffer trace/log collection, redacted tetra.surface.diagnostic.v1 artifacts, and scoped restart/recovery evidence for the command-palette reference app",
			Stability: "current diagnostic evidence for the bounded Surface v1 Linux/web scope; diagnostics are local-only and redacted, and validators reject user data leaks, network upload, docs-only crash claims, Electron crash reporter dependency, and restart claims without before/report/after evidence",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-i18n-v1 evidence records bounded string tables, locale selection, fallback from uk-UA to en-US, missing-key diagnostics, deterministic formatting hooks, localized-form reference app execution, and RTL placeholder nonclaim evidence",
			Stability: "current localization evidence for the bounded Surface v1 Linux/web scope; it is not full ICU, full bidi shaping, RTL production text layout, platform locale dependency, third-party intl runtime, or a general Unicode text engine claim",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-widget-migration-v1 evidence keeps lib.core.widgets supported as a Surface v1 compatibility layer, records the exact release widget set, proves Panel/Button/TextBox equivalence rows against Morph recipes that resolve to Block, runs the migration reference app, and records Block as the only core primitive",
			Stability: "current migration evidence for the bounded Surface v1 Linux/web scope; it is not a future core widget primitive promotion, not a breaking API change, not a docs-only migration claim, and not a platform toolkit/runtime claim",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/spec/current_supported_surface.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "current wasm32-web-browser-canvas-release-v1 Surface target with compiler-owned browser boot, DOM host canvas only, browser canvas RGBA presentation/readback, browser input, clipboard, composition, accessibility snapshot, accessibility mirror evidence, and tetra.surface.browser-surface.v1 report evidence",
			Stability: "current only for pure-Tetra apps running through the tiny Surface Host ABI; DOM-authored app UI trees, React, user JavaScript app logic, metadata-only UI sidecars, Node-only promotion, and arbitrary browser widget claims are rejected by validators",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/user/surface_guide.md", "docs/release/surface_v1_release_contract.md"},
		},
		{
		...
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "production-text-input-v1 baseline covering UTF-8 byte storage, invalid UTF-8 rejection, multiline byte storage, caret, selection, selection clipboard transfer, clipboard read/write, IME/composition trace, focused TextBox routing, host-boundary copy semantics, settings/editor reference traces, and scoped shaping-plan evidence",
			Stability: "current for the bounded Surface v1 text/input baseline; full rich text, full bidi shaping, grapheme-cluster caret movement, IDE-grade editing, arbitrary native text controls, and full Unicode editor semantics remain unsupported in this release",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/user/surface_guide.md", "docs/user/examples_index.md", "docs/release/surface_v1_release_notes.md"},
		},
		{
		...
		},
		{
			...
			Scope:     "unsupported for Surface v1; no production target evidence exists for macOS real-window Surface; tetra.surface.target-host-status.v1 records UNSUPPORTED nonclaim evidence",
			Stability: "no production target evidence in surface-v1-linux-web and no current macOS Surface support claim; build-only macOS artifacts do not promote Surface runtime support",
		...
		},
		{
			...
			Status:    FeatureStatusUnsupported,
			Scope:     "unsupported for Surface v1; no production target evidence exists for Windows real-window Surface; tetra.surface.target-host-status.v1 records UNSUPPORTED nonclaim evidence",
			Stability: "no production target evidence in surface-v1-linux-web and no current Windows Surface support claim; build-only Windows artifacts do not promote Surface runtime support",
			Docs:      []string{"docs/spec/surface_v1.md", "docs/release/surface_v1_release_contract.md"},
		},
		{
