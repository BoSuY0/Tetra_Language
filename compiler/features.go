...
func FeatureRegistry() []FeatureInfo {
	features := []FeatureInfo{
		...
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "v0.2.0",
			Scope:     "function type references and narrow symbol-backed non-capturing callable paths",
			Stability: "limited MVP; full first-class function values remain out of scope",
