...
func FeatureRegistry() []FeatureInfo {
	features := []FeatureInfo{
		...
		},
		{
			...
			Status:    FeatureStatusCurrent,
			Since:     "surface-v1",
			Scope:     "surface-package-v1 evidence packages the command-palette reference app as linux-x64 and wasm32-web tar.gz artifacts, records surface-app-package-v1 manifests, local asset hashes, installed linux-x64 binary execution, web bundle HTML/wasm/compiler-owned loader output, and a hash-pinned update channel manifest",
