...
var linuxX32BasicNetRuntimeSymbols = []struct {
	...
	{name: "__tetra_net_socket_tcp4", code: linuxX32NetSocketTCP4Code, paramSlots: 1, returnSlots: 1},
	{name: "__tetra_net_bind_tcp4_loopback", code: func() []byte { return linuxX32NetTCP4LoopbackCode(linuxX32SysBind) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_connect_tcp4_loopback", code: func() []byte { return linuxX32NetTCP4LoopbackCode(linuxX32SysConnect) }, paramSlots: 3, returnSlots: 1},
	...
	{name: "__tetra_net_read", code: func() []byte { return linuxX32NetReadWriteCode(linuxX32SysRead) }, paramSlots: 6, returnSlots: 1},
	{name: "__tetra_net_recv", code: func() []byte { return linuxX32NetRecvSendCode(linuxX32SysRecvfrom) }, paramSlots: 6, returnSlots: 1},
	{name: "__tetra_net_write", code: func() []byte { return linuxX32NetReadWriteCode(linuxX32SysWrite) }, paramSlots: 6, returnSlots: 1},
	{name: "__tetra_net_send", code: func() []byte { return linuxX32NetRecvSendCode(linuxX32SysSendto) }, paramSlots: 6, returnSlots: 1},
	{name: "__tetra_net_epoll_create", code: linuxX32NetEpollCreateCode, paramSlots: 1, returnSlots: 1},
	{name: "__tetra_net_epoll_ctl_add_read", code: func() []byte { return linuxX32NetEpollCtlCode(linuxX32EpollCtlAdd, linuxX32EpollIn) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_ctl_add_read_write", code: func() []byte { return linuxX32NetEpollCtlCode(linuxX32EpollCtlAdd, linuxX32EpollIn|linuxX32EpollOut) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_ctl_mod_read", code: func() []byte { return linuxX32NetEpollCtlCode(linuxX32EpollCtlMod, linuxX32EpollIn) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_ctl_mod_read_write", code: func() []byte { return linuxX32NetEpollCtlCode(linuxX32EpollCtlMod, linuxX32EpollIn|linuxX32EpollOut) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_ctl_delete", code: func() []byte { return linuxX32NetEpollCtlCode(linuxX32EpollCtlDel, 0) }, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_wait_one", code: linuxX32NetEpollWaitOneCode, paramSlots: 3, returnSlots: 1},
	{name: "__tetra_net_epoll_wait_one_into", code: linuxX32NetEpollWaitOneIntoCode, paramSlots: 5, returnSlots: 1},
	{name: "__tetra_net_set_nonblocking", code: linuxX32NetSetNonblockingCode, paramSlots: 2, returnSlots: 1},
	{name: "__tetra_net_set_reuseport", code: func() []byte { return linuxX32NetSetSockOptCode(linuxX32SolSocket, linuxX32SoReusePort) }, paramSlots: 2, returnSlots: 1},
	{name: "__tetra_net_set_tcp_nodelay", code: func() []byte { return linuxX32NetSetSockOptCode(linuxX32IPProtoTCP, linuxX32TCPNoDelay) }, paramSlots: 2, returnSlots: 1},
...
func buildLinuxX32BasicNetRuntimeObject() *Object {
	code := make([]byte, 0)
	symbols := make([]Symbol, 0, len(linuxX32BasicNetRuntimeSymbols))
...
func linuxX32NetSetNonblockingCode() []byte {
	...
	e.Emit(0x0D, byte(linuxX32ONonblock&0xff), byte((linuxX32ONonblock>>8)&0xff), byte((linuxX32ONonblock>>16)&0xff), byte((linuxX32ONonblock>>24)&0xff))
...
func linuxX32NetSetSockOptCode(level uint32, optname uint32) []byte {
	...
	e.Emit(0xBE, byte(level&0xff), byte((level>>8)&0xff), byte((level>>16)&0xff), byte((level>>24)&0xff))
