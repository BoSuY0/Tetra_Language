...
`, ("callback function symbol 'alloc_cb' requires effects alloc, mem " +
...
`, ("callback function symbol 'sleep_cb' requires effects runtime " +
		"but function type does not declare them"))
...
func main() -> Int:
  return apply(allocer, 41)
`, ("callback function symbol 'allocer' requires effects alloc, mem " +
		"but function type does not declare them"))
}
