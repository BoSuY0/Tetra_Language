...
- `protocol_trait_object_decision_test.go`: P22.2 protocol/trait-object
  ...
  lowering witnesses.
- `ram_contract_build_test.go`: RAM contract build coverage validates
  package-private native build planning and report wiring before a public
  command owns that integration evidence.
