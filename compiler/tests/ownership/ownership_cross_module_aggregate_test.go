...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'maybe' cannot be passed to non-borrow parameter 1",
	)
}
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'maybe' cannot be consumed",
	)
}
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'x' cannot be passed to non-borrow parameter 1",
	)
}
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'x' cannot be consumed",
	)
}
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'x' cannot be passed as inout",
	)
}

func TestOwnershipRejectsCrossModuleBorrowedPtrAggregatePassedToGenericOwnedParameter(
	t *testing.T,
) {
	files := map[string]string{
		"lib/sink.t4": `module lib.sink
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(t, files, "app/main.t4", "ownership")
}
...
func TestOwnershipRejectsCrossModuleGenericProtocolRequirementParameterOwnershipMismatch(
	t *testing.T,
) {
	files := map[string]string{
		"lib/model.t4": `module lib.model
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"parameter 2 ownership differs: expected 'consume', got 'owned'",
	)
}
...
func main() -> Int:
    return 0
	`, ("aggregate 'BufBox' contains borrowed slice field 'buf' that " +
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(
		...
		files,
		"app/main.t4",
		"borrowed value derived from 'msg' cannot be passed to non-borrow parameter 1 of 'app.main.sink'",
	)
}

func TestOwnershipRejectsCrossModuleBorrowedPtrEnumParamPayloadBindingGlobalAssignment(
	t *testing.T,
) {
	files := map[string]string{
		"lib/model.t4": `module lib.model
...
func TestOwnershipRejectsCrossModuleBorrowedPtrEnumParamPayloadBindingInoutAssignment(
	t *testing.T,
) {
	files := map[string]string{
		"lib/model.t4": `module lib.model
