...
func TestOwnershipRejectsCrossModuleBorrowedSliceAggregatePassedToFunctionTypedStructField(
	t *testing.T,
) {
	tests := []struct {
		name     string
...
func TestOwnershipRejectsCrossModuleBorrowedSliceAggregatePassedToFunctionTypedEnumPayload(
	t *testing.T,
) {
	tests := []struct {
		name     string
...
`, ("borrowed value derived from 'maybe' cannot be passed to non-" +
		"borrow parameter 1 of function-typed enum payload call 'cb'"))
}
...
func TestOwnershipRejectsCrossModuleBorrowedOptionalPtrPassedToFunctionTypedEnumPayload(
	t *testing.T,
) {
	files := map[string]string{
...
func TestOwnershipRejectsCrossModuleBorrowedOptionalPtrConsumedByFunctionTypedEnumPayload(
	t *testing.T,
) {
	files := map[string]string{
		"lib/callbacks.t4": `module lib.callbacks
