...
`,
	...
	testhelpers.RequireCheckWorldFilesOK(t, files, "app/main.t4")
}
...
func TestOwnershipRejectsWholeEnumUseAfterPartialPayloadConsumeWithAliasBindingCrossModule(
	t *testing.T,
) {
	files := map[string]string{
		"lib/model.t4": `module lib.model
...
`,
	...
	testhelpers.RequireCheckWorldFilesErrorContains(t, files, "app/main.t4", "borrowed")
}
...
func TestOwnershipRejectsCrossModuleBorrowedSliceEscapeViaOptionalAssignmentOwnedCall(
	t *testing.T,
) {
	files := map[string]string{
		"lib/leak.t4": `module lib.leak
...
func TestOwnershipRejectsCrossModuleBorrowedSliceEscapeViaOptionalAssignmentConsumeCall(
	t *testing.T,
) {
	files := map[string]string{
		"lib/leak.t4": `module lib.leak
...
func TestOwnershipRejectsCrossModuleBorrowedSliceEscapeViaOptionalAssignmentInoutAssignment(
	t *testing.T,
) {
	files := map[string]string{
		"lib/leak.t4": `module lib.leak
...
func TestOwnershipRejectsCrossModuleBorrowedPtrEscapeViaOptionalAssignmentConsumeCall(
	t *testing.T,
) {
	files := map[string]string{
		"lib/leak.t4": `module lib.leak
...
func TestOwnershipRejectsCrossModuleBorrowedPtrEscapeViaOptionalAssignmentInoutAssignment(
	t *testing.T,
) {
	files := map[string]string{
		"lib/leak.t4": `module lib.leak
