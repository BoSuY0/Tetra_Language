...
func TestP24RuntimeHardeningV1CoversMasterPlanTargets(t *testing.T) {
	...
	p24AssertRuntimeHardeningRow(t, rows[RuntimeHardeningActorMailboxOverflowPolicy], []string{"ErrMailboxFull", "blocking_recv_yield", "message pool overflow is not a checked runtime error"})
